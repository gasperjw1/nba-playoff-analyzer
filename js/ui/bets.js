...
function renderBetsPage(el) {
  ...
  <div style="max-width:900px;margin:0 auto;padding:20px 10px;">
    ...
    <p style="text-align:center;color:#aaa;font-size:13px;margin-bottom:8px;">Model-driven picks for all 8 first-round series | G1: 9/13 (69.2%) | G2 CLE-TOR: 1/2 (ML ✓, Harden ast ✗) | G3 projections live | Phase 25: 3PT variance regression model — Bayesian shooting regression, structural vs variance edges</p>
    ...
    <div class="parlay-featured">
      ...
      <div class="parlay-card headline">
        ...
        <div class="parlay-reasoning" style="border-left-color:#f0c040;">Phase 25 today-only parlay — all three games on Apr 21. <strong>Wemby Over 25.5</strong> (proj 28.2, 2.7pt cushion) — DPOY just announced, "good" outlook at 52% FG. Phase 25 3PT CAUTION: Wemby's .833 from 3 (5/6 G1) WILL regress hard toward .350 — but he compensates through paint scoring (8/15 2P). His foul discipline (2 PF G1) keeps him on the floor while POR bigs foul out. Even with 3PT regression, his 2P volume (15+ attempts) supports 25+ pts. <strong>Brown Over 24.5</strong> (proj 26.8, 2.3pt cushion) — Tatum's Achilles minutes cap pushes usage to Brown. Phase 25: BOS shot .364 from 3 (right at baseline) DESPITE Tatum (1/7), White (2/7), and Pritchard (2/9) shooting cold. Brown (2/2 from 3) could regress slightly, but BOS's overall 3PT regression is UP — more open looks for Brown in G2. <strong>Fox Over 6.5 ast</strong> (proj 7.8, 1.3pt cushion) — G1: 8ast sustainable. Phase 25: SAS's 3PT regression DOWN (.455→.370 expected) means fewer easy kick-out 3s — but Fox's assists come from PnR and dribble penetration, not 3PT creation. Three uncorrelated legs across two games and two stat types.</div>
      </div>
