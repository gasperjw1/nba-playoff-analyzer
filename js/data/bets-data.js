...
const FEATURED_PARLAYS = [
  ...
  },
  {
    ...
    legs: [
      { pick:'Hart Over 7.5 rebounds (alt — ECF G4)', odds:'-260', confidence:'floor', status:null,
        note:'Series 11/4/9 reb → 8 avg with workhorse-DD pattern in G1+G3. Phase 71 REB signal calibrated; deep alt absorbs role-variance. Closeout-game rebound floor.' },
      { pick:'KAT Over 7.5 rebounds (alt — ECF G4)', odds:'-240', confidence:'floor', status:null,
        note:'Series 13/9/8 → 10 avg. Mobley matchup keeps producing rebound volume regardless of KAT scoring efficiency. Calibrated REB signal.' },
    ],
  ...
  },
  {
    ...
    legs: [
      { pick:'NYK ML vs CLE (ECF G4)', odds:'-135', confidence:'medium', status:null,
        note:'NYK 10-0 in last 10 playoff games. Won G3 in CLE by 13. 0-156 historical for down-0-3 comebacks. Engine NYK by 7.' },
      { pick:'Brunson Over 24.5 points (ECF G4)', odds:'-115', confidence:'medium', status:null,
        note:'Series avg 29.0 (38/19/30). Engine ~27 after STARTER correction. Closeout-game volume add +1-2pts.' },
      { pick:'Under 218.5 total (ECF G4)', odds:'-110', confidence:'lean', status:null,
        note:'G1 reg 200 / G2 202 / G3 229 (NYK 11 threes + 24-27 FT outlier). Engine projects 217. Elimination games historically under (-3.2pts).' },
    ],
