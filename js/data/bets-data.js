...
const FEATURED_PARLAYS = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    legs: [
      { pick:'Wembanyama Over 21.5 points (alt — WCF G5)', odds:'-260', confidence:'floor', status:null,
      ...
      { pick:'Wembanyama Over 7.5 rebounds (alt — WCF G5)', odds:'-300', confidence:'floor', status:null,
  ...
  },
  {
    ...
    legs: [
      { pick:'Fox Over 4.5 assists (alt — WCF G5)', odds:'-240', confidence:'floor', status:null,
      ...
      { pick:'Caruso Over 8.5 points (alt — WCF G5)', odds:'-180', confidence:'floor', status:null,
  ...
  },
  {
    ...
    legs: [
      ...
      { pick:'SGA Over 7.5 assists (alt — WCF G5)', odds:'-220', confidence:'floor', status:null,
  ...
  },
  {
    ...
    legs: [
      { pick:'OKC ML vs SAS (WCF G5)', odds:'-218', confidence:'medium', status:null,
        note:'Engine OKC by 4 at home; bench depth structural edge. Mean-revert from G4 6-33 3PT anomaly expected.' },
      { pick:'SGA Over 27.5 points (WCF G5)', odds:'-115', confidence:'lean', status:null,
      ...
      { pick:'Over 215.5 total (WCF G5)', odds:'-110', confidence:'lean', status:null,
...
const BET_SLATES = {
  ...
  'CF-G5': {
    label: 'Conference Finals — Game 5 (Live)',
    games: [
      { series:'OKC-SAS', date:'2026-05-26', time:'8:30 PM ET', venue:'Paycom Center', context:'Series tied 2-2',
        recap:'<strong style="color:var(--purple)">WCF G5 Preview (Tue 5/26):</strong> Pivotal G5 at OKC after SAS evened the series 103-82 in G4. Wemby revenge-script delivered massively in G4 (33/8/5/3blk); OKC needs SGA + Caruso + bench to recover from worst postseason shooting night (6-of-33 from 3). Castle/Harper rotation has stabilized SAS at full health for the first time this CF. DK opener OKC -5.5 / 215.5; ML OKC -218 / SAS +180. Engine view: OKC home + bench depth pull back to roughly even after G4 anomaly; central margin OKC by ~4. Phase 71 R3 stake reduction stays at 50% (5 CF games settled — at the promote threshold; one more clean read clears it).' },
    ],
  },
};
