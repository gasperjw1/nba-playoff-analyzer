...
const FEATURED_PARLAYS = [
  ...
  },
  {
    ...
    legs: [
      { pick:'Cade Over 4.5 assists (deep alt line — DET-CLE G2)', odds:'~-700', confidence:'high', status:null,
        note:'Playoff avg 7.1 ast; G1: 7 ast. Cade hasn\'t gone under 5 ast in 12+ games — going to 4.5 makes it ~95% historical. Main DK line is 9.5; this is the deepest alt below it. Juice est. -700 to -1000.' },
