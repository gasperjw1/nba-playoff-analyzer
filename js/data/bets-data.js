...
const FEATURED_PARLAYS = [
  ...
  // ─── Finals G4 — Wed 6/10 @ MSG (NYK leads 2-1) ──────────────────
  {
    ...
    legs: [
      { pick:'Champagnie Over 9.5 PRA (alt — Finals G4)', odds:'-280', confidence:'floor', status:null,
        note:'Cleared ALL THREE Finals games (27, 13, 18) on 30-31 SECURE min. Locked SAS bench wing — no minutes-correlation risk. The anchor.' },
      { pick:'Harper Over 9.5 PRA (alt — Finals G4)', odds:'-230', confidence:'floor', status:null,
        note:'Cleared all three (25, 23, 25) in 28 SECURE min — a near-double-double in G3. Combo-guard composite, game-script-independent.' },
      { pick:'Wembanyama Over 27.5 PRA (alt — Finals G4)', odds:'-300', confidence:'floor', status:null,
        note:'40, 41, 46 PRA — the REB/FT/scoring composite is variance-proof across every shooting profile. OT-coin-flip = max usage; 38-40 guaranteed min. PRA line, NOT the REB-alt.' },
    ],
  ...
  },
  {
    ...
    stake: 100, odds: '+105', payout: 'To Win: ~$105 (verify Wed evening)',
    legs: [
      { pick:'Wembanyama Over 33.5 PRA (Finals G4)', odds:'-125', confidence:'floor', status:null,
        note:'40/41/46 PRA all three games. Carried by a guaranteed ~12-reb base, NOT scoring alone — the G3 KAT-break lesson keys floors to reb/ast-backed composites.' },
      { pick:'Champagnie Over 9.5 PRA (Finals G4)', odds:'-280', confidence:'floor', status:null,
        note:'27/13/18 PRA on 30-31 SECURE min every game. Locked rotation role; the tightest minutes floor on the board.' },
    ],
  ...
  },
  {
    ...
    legs: [
      { pick:'SAS +1.5 vs NYK (Finals G4)', odds:'-110', confidence:'lean', status:null,
        note:'Engine NYK by 1 sits inside the -1.5 → SAS +1.5 is the model value side. The spread-value side is 3-for-3 in the Finals. Lead leg.' },
      { pick:'Wembanyama Over 33.5 PRA (Finals G4)', odds:'-125', confidence:'lean', status:null,
        note:'40/41/46 PRA. A close SAS-covers game (or a SAS win evening the series) correlates with a monster Wemby composite. Correlated with SAS +1.5.' },
      { pick:'Harper Over 11.5 PRA (Finals G4)', odds:'-150', confidence:'lean', status:null,
        note:'25/23/25 PRA — pushed one tick deeper than the floor line. A SAS-covers script means the secure bench guard keeps producing. Rounds out the SAS-stays-close stack.' },
    ],
...
const BET_SLATES = {
  ...
  'Finals-G4': {
    label: 'NBA Finals — Game 4 (Live)',
    games: [
      { series:'SAS-NYK', date:'2026-06-10', time:'8:30 PM ET', venue:'Madison Square Garden', context:'NYK leads 2-1',
        recap:'<strong style="color:var(--purple)">Finals G4 Preview (Wed 6/10):</strong> Back at Madison Square Garden with the series tilted but not decided — NYK leads 2-1 after San Antonio finally CLOSED a fourth quarter in G3 (Wemby 32/8/6 closeout). <strong>The stakes:</strong> a NYK win goes up 3-1 (commanding, would need a SAS sweep of the next three); a SAS win EVENS it 2-2 with G5 back at Frost Bank, where San Antonio is 6-1 this playoff run. <strong>The model read:</strong> the engine sees the tightest game of the series — NYK by 1, character OVERTIME, projectedOT true. The home/+1pt nudge points NYK again but is now 0-3 on Finals winners, so the running rule is to TRUST the margin/spread (SAS +1.5 is the value side, 3-for-3) and DISTRUST the raw winner pick. <strong>The swing:</strong> KAT and Bridges both cratered in G3 (KAT 11/8, Bridges 15/4/3) — NYK\'s secondary creation is the whole margin, and its bounce-back is the difference between 3-1 and a 2-2 toss-up. Does SAS\'s newfound closing confidence carry, and does the MSG pace run fast again (G3 went 226 OVER, breaking the Finals-UNDER pattern)? DK (6/9): NYK -1.5 / 215.5 / ML NYK -125, SAS +105. Engine: NYK by 1 — SAS +1.5 the spread value, OT-adjusted total ~214 a thin UNDER lean (reduced conviction after the G3 break). <strong>Phase 71 R3 out-of-sample stake cap stays 50%</strong>; CAUTION pill auto-stamps. Finals stakes ($100 floor / $50 trad) hold.' },
    ],
  },
};
