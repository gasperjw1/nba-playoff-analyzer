...
const FEATURED_PARLAYS = [
  ...
  // ─── FINALS G3 (Mon 6/8 at MSG) — minutes-vetted floors + cross-star PRA ───
  {
    ...
    legs: [
      { pick:'Champagnie Over 9.5 PRA (alt — Finals G3)', odds:'-280', confidence:'floor', status:null,
        note:'Cleared in BOTH Finals games (27, 13) on 30-31 SECURE min. Locked SAS bench wing — no minutes-correlation risk. The anchor.' },
      { pick:'Harper Over 9.5 PRA (alt — Finals G3)', odds:'-230', confidence:'floor', status:null,
        note:'Cleared both games (25, 23) in 28 SECURE min. Combo-guard composite, game-script-independent; bench role locked 26-30 min.' },
      { pick:'Wembanyama Over 27.5 PRA (alt — Finals G3)', odds:'-300', confidence:'floor', status:null,
        note:'40, then 41 PRA — the REB/FT/scoring composite is variance-proof across both a 6-21 and an 11-21 night. 0-3 cliff → maximum usage; 38-40 guaranteed min. PRA line, NOT the REB-alt that broke G2.' },
    ],
  ...
  },
  {
    ...
    legs: [
      { pick:'Wembanyama Over 33.5 PRA (Finals G3)', odds:'-125', confidence:'floor', status:null,
        note:'40, then 41 PRA both games. The deep-alt PRA composite clears regardless of shooting; maximum-usage desperation game. Rebound-independent (keys the composite, not the REB alt).' },
      { pick:'Karl-Anthony Towns Over 30.5 PRA (Finals G3)', odds:'-120', confidence:'floor', status:null,
        note:'34, then 38 PRA both games (21/13/4 in G2). Stretch-5 scoring + locked ~12rpg glass + secondary playmaking; secure 34-36 min. Cross-team from Wemby so the two composites are independent, not stacked.' },
    ],
  ...
  },
  {
    ...
    legs: [
      { pick:'SAS +2.5 vs NYK (Finals G3)', odds:'-110', confidence:'lean', status:null,
        note:'Engine NYK by 1 sits inside the -2.5 → SAS +2.5 is the model value side. Same spread-value logic that cashed NYK +5.5 in BOTH prior games. Lead leg of the correlated grind stack.' },
      { pick:'Under 216.5 (Finals G3)', odds:'-110', confidence:'lean', status:null,
        note:'Both Finals totals went UNDER (200, 209); engine ~210. A tight SAS-covers game correlates with a lower-possession grind. Correlated with SAS +2.5.' },
      { pick:'Wembanyama Over 33.5 PRA (Finals G3)', odds:'-125', confidence:'lean', status:null,
        note:'40/41 PRA both games. A desperate SAS staying within the spread almost certainly means a monster Wemby composite. Rounds out the internally-consistent SAS-grind stack.' },
    ],
...
const BET_SLATES = {
  ...
  'Finals-G3': {
    label: 'NBA Finals — Game 3 (Live)',
    games: [
      { series:'SAS-NYK', date:'2026-06-08', time:'8:30 PM ET', venue:'Madison Square Garden', context:'NYK leads 2-0',
        recap:'<strong style="color:var(--purple)">Finals G3 Preview (Mon 6/8):</strong> The Finals come to Madison Square Garden for the first time since 1999 — and the Knicks are 2-0, having stolen both games in San Antonio. <strong>San Antonio faces the 0-3 cliff:</strong> a loss tonight drops them into a hole no NBA team has ever climbed out of, so expect maximum Wembanyama usage and the tightest, most desperate SAS game of the series. The Spurs have themselves to blame for the deficit — they led late in BOTH games and lost both on execution (the G2 Wemby turnover + missed buzzer look). <strong>What changed for G3:</strong> the rest edge that fueled NYK\'s second halves is gone (equal in-series rest now), and the home-court +1pt nudge — which misfired on SAS twice — now points at NYK. The engine\'s wrongStreak detector is at 2, so the read is to TRUST the margin/spread (NYK +5.5 and the UNDER both cashed twice) and DISTRUST the raw winner pick. Castle suppressed Brunson\'s POINTS in G2 (20 on 7-25); NYK won via Bridges 20/6/6 + KAT 21/13, so the NYK secondary-creator props are the more reliable plays than the Brunson points line. <strong>Swing factor:</strong> can SAS finally close a fourth quarter, and does the MSG crowd lift the NYK role-player shooting (Shamet/OG/McBride) at home. DK (6/8): NYK -2.5 / 216.5 / ML NYK -125, SAS +105. Engine view: NYK by 1 (COMPETITIVE) — INSIDE the -2.5 (so SAS +2.5 is the nominal spread value) and the ~210 total is UNDER 216.5 (Finals UNDER lean extends). <strong>Phase 71 R3 out-of-sample stake cap stays 50%</strong>; CAUTION pill auto-stamps. Finals stakes ($100 floor / $50 trad) hold.' },
    ],
  },
};
