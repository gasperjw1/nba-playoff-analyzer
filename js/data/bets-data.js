...
const FEATURED_PARLAYS = [
  ...
  // RELIABLE FLOOR PARLAYS
  {
    id: 'r2-g3-may8-floor-counting-stats',
    slate: 'R2-G3', date: '2026-05-08',
    category: 'floor', type: 'best-bet',
    name: 'Counting-Stat Floor (3-Leg)',
    stake: 100, odds: '+95', payout: 'To Win: ~$95 (verify on DK)',
    legs: [
      { pick:'Wembanyama Over 12.5 rebounds (SAS-MIN G3)', odds:'-140', confidence:'floor', status:null,
        note:'15reb in BOTH G1 and G2 — 2.5-reb cushion below series floor. Counting stats are blowout-proof. Real hit rate ~85-90%.' },
      { pick:'KAT Over 9.5 rebounds (NYK-PHI G3)', odds:'-130', confidence:'floor', status:null,
        note:'10reb in G2 (full triple-double-line). Stretch-5 vs Drummond/thin PHI bigs = open lanes. Real hit rate ~75-80%.' },
      { pick:'Edwards Under 4.5 rebounds (SAS-MIN G3)', odds:'-118', confidence:'floor', status:null,
        note:'3reb in BOTH G1 and G2 — knee restriction limits driving rebounds. Real hit rate ~80-85%.' },
    ],
    thesis:'All three legs are counting stats with strong historical patterns. Math: 0.87 × 0.78 × 0.82 ≈ 56% combined — below the 80% floor threshold but the closest to it on this slate. Honest read: this is a high-floor parlay, not a true 80%+ floor (which would require 3 legs at 93%+ each, which the slate doesn\'t offer cleanly). Still the most reliable parlay structure tonight given the props on offer.',
    result: null,
  },
  {
    id: 'r2-g3-may8-floor-sas-wemby',
    slate: 'R2-G3', date: '2026-05-08',
    category: 'floor', type: 'best-bet',
    name: 'SAS Lock + Wemby Boards (2-Leg)',
    stake: 100, odds: '+85', payout: 'To Win: ~$85',
    legs: [
      { pick:'SAS ML vs MIN', odds:'-198', confidence:'high', status:null,
        note:'~75-80% per engine. Tactical overhaul + Edwards limited + MIN nowhere-to-hide IC issues.' },
      { pick:'Wembanyama Over 12.5 rebounds (SAS-MIN G3)', odds:'-140', confidence:'floor', status:null,
        note:'Back-to-back 15-reb games. Independent of game flow.' },
    ],
    thesis:'Two-leg engineered to clear ~70% combined. Math: 0.78 × 0.87 ≈ 68% combined — slightly under the 80% threshold but cleaner than the 3-leg counting-stat parlay above. Wemby\'s rebounding is independent of SAS winning by 3 or 30, so even a SAS narrow win still produces both legs.',
    result: null,
  },
