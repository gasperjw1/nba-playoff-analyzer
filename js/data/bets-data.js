...
const FEATURED_PARLAYS = [
  ...
  // ─── Finals G5 — Sat 6/13 @ Frost Bank Center (NYK leads 3-1) ─────
  {
    ...
    stake: 100, odds: '+135', payout: 'To Win: ~$135 (verify Sat evening)',
    legs: [
      { pick:'Champagnie Over 9.5 PRA (alt — Finals G5)', odds:'-280', confidence:'floor', status:null,
      ...
      { pick:'Harper Over 9.5 PRA (alt — Finals G5)', odds:'-230', confidence:'floor', status:null,
      ...
      { pick:'Wembanyama Over 27.5 PRA (alt — Finals G5)', odds:'-320', confidence:'floor', status:null,
  ...
  },
  {
    ...
    stake: 100, odds: '+115', payout: 'To Win: ~$115 (verify Sat evening)',
    legs: [
      { pick:'Wembanyama Over 33.5 PRA (Finals G5)', odds:'-125', confidence:'floor', status:null,
      ...
      { pick:'Harper Over 9.5 PRA (Finals G5)', odds:'-230', confidence:'floor', status:null,
  ...
  },
  {
    ...
    legs: [
      { pick:'Under 211.5 (Finals G5)', odds:'-110', confidence:'lean', status:null,
      ...
      { pick:'Wembanyama Over 33.5 PRA (Finals G5)', odds:'-125', confidence:'lean', status:null,
      ...
      { pick:'Harper Over 11.5 PRA (Finals G5)', odds:'-150', confidence:'lean', status:null,
