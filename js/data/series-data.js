...
],reasoning:"G3 Friday May 8 at Target Center. Series tied 1-1. HCA flips to MIN — Phase 58 engine fix correctly applies the venue change for G3-G4 of the 2-2-1-1-1 format, bringing baseline from SAS by 11 to SAS by 9. MIN is coming off worst playoff loss in franchise history (Finch: 'we got punked'); Target Center is one of the league's loudest playoff environments. SAS's G2 tactical overhaul (pace + pressure + Wemby rim attacks) is structural and likely persists. Edwards minutes (knee permitting) are the biggest swing factor for MIN's ceiling. MODEL: SAS 111, MIN 102 (SAS by 9, MEDIUM confidence — but if Edwards plays 32+min near G1 efficiency, expect a tighter game in the SAS by 2-3 range). <strong>5/8 update:</strong> DK has SAS -3.5 / total 215.5 — market priced the Edwards-back-and-engaged scenario. Model still likes SAS but at a tighter spread than its baseline (SAS -8.5 was authored before market repriced).",xFactor:"Edwards minutes + MIN 3PT shooting + SAS pace/pressure scheme on the road",moneyline:"SAS -198 / MIN +164",spread:"SAS -3.5",ou:"O/U 215.5"},notes:""}]
  },
  {
