...
const SERIES_DATA = [
  {
    ...
    externalFactors: [
      ...
      { team:"LAL", player:"Austin Reaves", desc:"POTENTIAL G5 RETURN — CBS Sports lists return date Apr 29 (today). Oblique improving faster than Doncic's hamstring. If Reaves plays, LAL adds a proven 3rd scorer/playmaker to close out the series.", impact:4, category:"injury",
        evidence:"CBS Sports (Apr 29): Reaves listed with oblique injury, est. return Apr 29. If available even on limited minutes, his playmaking (7.5 APG) and shot creation would be a massive G5 boost for a team already up 3-1. Game-time decision.",
