...
const SERIES_DATA = [
  ...
  "<strong>Why SAS by 9 (engine baseline):</strong> Phase 58 engine fix now applies HCA flip correctly (G3 venue at MIN). Engine projects SAS by 9 (vs SAS by 11 pre-fix) — the baseline already accounts for HCA flip, MIN's home crowd, and the round-scaled HCA value of 1.7. Tactical add-ons (MIN desperation after worst playoff loss, Edwards potentially expanded) could compress this another 3-5pts toward MIN. PRIMARY HEDGE: Edwards minutes — 32+ at G1 efficiency (8-13, 18pts/25min) flips this to MIN by 2-3.",
],reasoning:"G3 Friday May 8 at Target Center. Series tied 1-1. HCA flips to MIN — Phase 58 engine fix correctly applies the venue change for G3-G4 of the 2-2-1-1-1 format, bringing baseline from SAS by 11 to SAS by 9. MIN is coming off worst playoff loss in franchise history (Finch: 'we got punked'); Target Center is one of the league's loudest playoff environments. SAS's G2 tactical overhaul (pace + pressure + Wemby rim attacks) is structural and likely persists. Edwards minutes (knee permitting) are the biggest swing factor for MIN's ceiling. MODEL: SAS 111, MIN 102 (SAS by 9, MEDIUM confidence — but if Edwards plays 32+min near G1 efficiency, expect a tighter game in the SAS by 2-3 range). <strong>5/8 update:</strong> DK has SAS -3.5 / total 215.5 — market priced the Edwards-back-and-engaged scenario. Model still likes SAS but at a tighter spread than its baseline (SAS -8.5 was authored before market repriced). Edwards QUESTIONABLE (bone bruise) — trending toward playing, completed full shootaround. Dosunmu GTD (heel, was calf). Edwards status is the single biggest swing factor.",xFactor:"Edwards minutes + MIN 3PT shooting + SAS pace/pressure scheme on the road",moneyline:"SAS -198 / MIN +164",spread:"SAS -3.5",ou:"O/U 215.5"},notes:"SAS 115-108 at Target Center. SAS leads 2-1. Wembanyama 39pts/15reb/5blk (3 made 3PT, 10/?? FT, 5 fouls) — joined Kareem/Hakeem/Shaq company with the stat line. Edwards returned to the starting lineup for the first time since the 4/26 hyperextension/bone bruise (15pts/7reb/1ast); knee held up but rust + SAS rotations limited his usual rim aggression. SAS led 18-3 to start, MIN clawed back to 23-22 after Q1, halftime tied 51-51, SAS up 86-79 entering Q4. Castle 8/2/7ast, Vassell 8/4. Carter Bryant, Keldon Johnson, Champagnie each made 2 threes. MIN held 31-27 lead halfway through Q2 before SAS surged. MIN couldn't sustain a Q4 run despite home crowd. Wemby's rebounding floor (15 in BOTH G2 and G3) was the structural anchor. MODEL: predicted SAS 111-MIN 102 (SAS by 9, MEDIUM); ACTUAL SAS 115-108 (SAS by 7) — RIGHT WINNER, margin within 2pts of model. Strong G3 prediction. Series: SAS leads 2-1; G4 in MIN Sunday May 10.\n\nKEY MODEL TAKEAWAYS:\n(1) HCA-FLIP OVERWEIGHTED (same lesson as NYK-PHI G3) — model went MEDIUM-confidence MIN by 9 leaning on the engine's HCA flip + Edwards-back-to-starting + crowd. Reality: SAS by 7. The HCA flip premium for R2 (currently 2.0pts in HCA_BY_ROUND) plus 'home team momentum' soft factor stacked too high. Calibration recommendation: trim HCA premium to 1.5 for series where the road favorite has a clear talent edge AND is coming off a regression-validated home win.\n(2) WEMBY TRANSCENDENT GAMES UNDERWEIGHTED — 39pts/15reb/5blk on the road, joining Kareem/Hakeem/Shaq company. Model treated Wemby as a 'star with variance' but his ceiling games are now showing up in elimination contexts, not just blowouts. Phase 32 ceiling lift for franchise-cornerstone bigs needs an 'on-the-road / hostile-crowd / down-1 in series' bump (~+4 expected pts).\n(3) EDWARDS MINUTES CAP CONFIRMED AGAIN — back to starting lineup but 'rust + SAS rotations limited his usual rim aggression' per the notes. 15pts/7reb/1ast on the night. Even fully-eligible Edwards at 75% knee health caps MIN's IC at ~1.7 stars. Model should keep his projection at ~75% of his pre-injury baseline until he proves it (probably needs G4 for this).\n(4) SAS DEPTH ADVANTAGE WIDENS ON ROAD — Castle 8pts/7ast as facilitator, Vassell + Champagnie + K.Johnson + Bryant each made 2 threes. Bench scoring spread = no single hot/cold variance to exploit. MIN can't trade haymakers with that kind of depth even at home.\n(5) FOX EFFICIENCY SLOPE — Fox went from 10pts (5-14 G1) to 16pts (G2) to ?pts G3 (specific not in notes but Wemby + Castle carried). Fox acts as floor-stabilizer, not ceiling-raiser, with this Wemby. Adjust Fox baseline downward in G4 (he's not the variance driver — Wemby is)."},{num:4,result:null,homeScore:null,awayScore:null,winner:null,prediction:{homeWin:true,homeScore:107,awayScore:104,margin:3,confidence:"MEDIUM",character:"COMPETITIVE",keyTakeaways:[
      "<strong>SAS road momentum + Wemby transcendent form:</strong> SAS won G3 at MIN behind Wemby's 39/15/5blk Kareem-tier line. Going for 3-1 series lead with G5 back at SAS. Wemby is in 'transcendent' mode — when he's hitting from 15-18 ft + drawing fouls + protecting rim, he's worth ~+8 vs his season baseline. Engine's static rating doesn't capture this.",
      ...
      "<strong>Edwards G4 expectation:</strong> Returned to starter minutes G3 (15pts/7reb/1ast) but rust + knee. Likely 30-32min G4 with more rim aggression. If he hits 22+ pts at full minutes, MIN can win. If he gets capped at 18 by SAS perimeter D (Castle, Vassell, Champagnie), MIN has no second creator (Randle's 12pts G3 shows the cap).",
      "<strong>SAS Q4 closing edge:</strong> Castle is the closer — 21pts on 8-14 G2, key Q4 baskets G3. Coordinates with Wemby in 5-out spacing, Fox as floor-spacer. SAS has positional flexibility MIN doesn't.",
