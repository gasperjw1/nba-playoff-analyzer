...
const SERIES_DATA = [
  {
    ...
    homeTeam: {
      ...
      players: [
        { name:"Kevin Durant", age:37, pos:"SF", rating:75, ppg:26.0, rpg:5.5, apg:4.8, fgp:52.4, per:25.8, ts:65.5, epm:5.5, bpm:6.1, ws48:.195, onOff:5.2, clutch:6.0, vorp:5.3, usg:29.5, injury:"Day-to-Day — left ankle injury (G4 exit, game-to-game per Udoka). Previously: right knee contusion.", lebron:2.377, oLebron:2.519, dLebron:-0.142, war:8.586, offRole:"Shot Creator", defRole:"Helper",
          matchupNote:"67% TS vs LAL reg season. Elite efficiency but burner scandal chemistry ding. Clutch 6.0. Right knee contusion Apr 17 — OUT Game 1, CONFIRMED SUITING UP Game 2 (Apr 21). Went through half of practice Mon. Udoka: knee 'tough to bend in certain ways'. At 37 with knee stiffness, expect limited explosiveness but midrange game is matchup-proof.", baseRating:89, starCeiling:2, injuryRisk:0.7, activeInjury:{type:"left ankle injury",severity:0.50,note:"Apr 27: Udoka said KD is game-to-game with left ankle injury sustained in G4. Separate from earlier knee contusion. At 37, accumulated injuries are compounding. Rating dropped to 75 reflecting limited availability. Had 16pts in G4 before tweaking ankle. Estimated return Apr 29 (G5). Previously: right knee contusion (OUT G1, limited G2-G4). Recovery volatility flag applies (Phase 28)."} },
    ...
    externalFactors: [
      ...
      { team:"LAL", player:null, desc:"Redick's defensive scheme mastery — zone/doubling/switching is structurally suppressing HOU offense. 2-0 as playoff HC.", impact:5, category:"coaching",
        ...
        sources:["ESPN: espn.com/nba/recap/_/gameId/401869397"], verdict:"verified" },
      { team:"HOU", player:"Kevin Durant", desc:"ANKLE INJURY — OUT until May 1. Misses G5 (Apr 29). KD missed G3-G4 as well. HOU is 2-2 without him this series. At 37, recovery timeline is conservative.", impact:-12, category:"injury",
        evidence:"CBS Sports injury report (Apr 29): KD listed OUT with ankle injury, est. return May 1. Combined with earlier knee contusion — KD has played only G1-G2 this series. HOU adapted: won G3 at home without him but lost G4. The dual-initiator thesis is moot without KD.",
    ...
    game6: {
      spread: "HOU -3.5", moneyline: "HOU -170 / LAL +140", ou: "O/U 210.5",
      pick: "LAL", confidence: "low", projScore: "LAL 106 — HOU 104",
      schedule: "TBD — Likely Fri May 1 or Sat May 2",
      reasoning: "MODEL PICK: LAL (LOW confidence — essentially a coin flip). REAVES UPGRADE SHIFTS THIS GAME. G5 was Reaves' first game back from oblique strain — 22pts but 4-16 FG (25%), all scoring via FTs. With one game of conditioning, expect his shooting to normalize toward 35-40% FG. Rating upgraded 68→74 (severity 0.6→0.35). This is significant: Reaves at 70-80% gives LAL their 3rd legitimate scoring option alongside LeBron and Ayton. LAL's G5 3PT shooting collapse (25.9%, 7-27) was their worst of the series — regression to the mean alone adds 5-8 points. Kennard (1pt G5) is due for a bounce-back at home where he averaged 17ppg in G1-G2. Smart's 6 TOs G5 were anomalous. HOWEVER: HOU is undefeated at Toyota Center (G4 +19, G5 +6) and this is a ROAD game for LAL. HOU's home court has been worth 10+ points of swing. Smith Jr's breakout (22pts G5) + Sengun's consistency (triple-double threat every game) means HOU's offense is functional without KD. The ensemble model now sees this as a genuine coin flip: LAL's talent+Reaves recovery vs HOU's home court+momentum. Slight lean LAL because Reaves' return is the single biggest variable change since G5.",
      g5Adjustments: [
        ...
        "KD STATUS: Still OUT. May return for potential G7. HOU winning without him changes the narrative entirely.",
  ...
  },
  {
    ...
    game6: {
      spread: "ORL -5.5", moneyline: "ORL -240 / DET +195", ou: "O/U 215.5",
      pick: "ORL", confidence: "medium", projScore: "ORL 110 — DET 103",
      schedule: "Thu May 1 — 7:00 PM ET — ESPN",
      reasoning: "MODEL PICK: ORL (MEDIUM confidence, COMPETITIVE). ORL returns home to Kia Center to close out the series for the second time after DET's G5 survival (116-109). Despite Cade's 45-point masterpiece, the fundamental dynamics favor ORL at home: (1) Wagner could return from calf injury with extra rest — his availability transforms ORL's offense from single-initiator (Banchero) to multi-initiator. (2) ORL is 8-1 at home in these playoffs — Kia Center has been a fortress. (3) Banchero's 45pts in G5 proved he can carry offensively even without Wagner — at home with crowd support, his ceiling is limitless. (4) DET's free throw advantage (28-33 vs ORL's 16-30) was the G5 difference — ORL's FT shooting should regress toward the mean.\n\nCade's 45 showed he can single-handedly keep DET alive, but his supporting cast was thin (only Harris with 23 contributed meaningfully). DET's bench scored just 18pts. The turnover battle (DET 16, ORL 16) was even but ORL's defensive identity should reassert at home. If Wagner returns, this is a comfortable ORL closeout. If Wagner is still out, it's a tighter game but ORL's home court and Banchero's evolved game should be enough.",
      g5Adjustments: [
        ...
        "WAGNER STILL OUT: Calf injury kept him out of G5. Extra rest before G6 could allow return.",
        ...
        "SERIES RETURNS TO ORLANDO: Kia Center where ORL is 8-1 in playoffs. Crowd advantage is massive.",
        "DET BENCH THIN: Only 18pts from bench (Stewart 5, Green 5, LeVert 2, Jenkins 6). Depth is a liability."
      ],
      prosHome: ["DESPERATION: Must-win or season over. Maximum effort from every player.", "Cade's G5 masterpiece (45pts, 14-14 FT) proves he's a playoff superstar", "Harris 23pts — reliable second scorer has emerged", "DET's Q1 dominance (38-26 in G5) shows they can control tempo early"],
      consHome: ["ROAD game at Kia Center where ORL is 8-1", "DET bench only scored 18pts — depth crisis continues", "Cade's 6 TOs in G5 — ball security remains a flaw even in his best games", "ORL's 3PT shooting (45% in G5) will travel — their shooters are legit"],
      prosAway: ["Kia Center fortress: 8-1 at home in playoffs — elite home court", "Wagner could return with extra rest — transforms offense to multi-initiator", "Banchero proved he can score 45 — at home, his ceiling is even higher", "FT regression: ORL shot 53% FT in G5 — unsustainably bad, will improve", "ORL's defensive identity (forced 16 DET TOs) should reassert at home"],
      consAway: ["Cade's 45 proves he can single-handedly extend series — hard to stop", "Harris 23pts showed he can be DET's reliable second scorer", "Ausar's 15reb/6ast/5stl/2blk is a game-changing stat line", "DET's desperation energy — facing elimination produces maximum effort"]
    },
    game4: {
  ...
  },
  {
    ...
    game6: {
      spread: "TOR -2.5", moneyline: "TOR -140 / CLE +120", ou: "O/U 220.5",
      pick: "CLE", confidence: "low", projScore: "CLE 112 — TOR 110",
      schedule: "Fri May 1 — 7:30 PM ET — ESPN",
      reasoning: "MODEL PICK: CLE (LOW confidence, COIN FLIP). CLE takes a 3-2 lead to Toronto for G6, but Scotiabank Arena has been a fortress — TOR won G3 by 22 and G4 by 4. The model narrowly picks CLE because: (1) CLE's talent surplus (Mitchell, Harden, Mobley, Schroder off bench) gives them more ways to win. (2) CLE has the closeout advantage — one win from advancing vs TOR's desperation. (3) Mobley's evolution (23pts/9reb/3blk G5, 3-3 3PT) adds a third star-level option that TOR can't match.\n\nHowever, TOR's home court has been dominant — they outscored CLE by a combined 26pts at home (G3+G4). Barnes (17/8/11 G5) is TOR's alpha and plays his best at home. Ingram's absence in G5 (11min/1pt) is the wild card — if he's healthy and engaged for G6, TOR gets a 20+PPG scorer back. Walter's bounce-back (20pts G5) may not repeat on the road. Quickley remains out.\n\nWHY LOW CONFIDENCE: This is genuinely a coin flip. TOR's home advantage offsets CLE's talent surplus. Harden's turnover liability (21 TOs in last 3 games) could cost CLE in a hostile environment. The model gives CLE a 52-48 edge based on talent and closeout advantage, but Toronto at Scotiabank is a different animal.",
      g5Adjustments: [
        "CLE WON G5 125-120: Home court advantage held — CLE has won all 3 home games.",
        "INGRAM 11min/1pt: Massive variable. If injury, TOR gets him back for G6 at home. If benched, TOR adjusts lineups.",
      ...
      prosHome: ["3-2 lead: One win from advancing regardless of location", "Mobley's evolution to 3-level scorer changes matchup dynamics", "Schroder 19pts — CLE bench provides reliable 30+ pts every game", "CLE has multiple closers (Mitchell, Harden, Mobley) — hard to scheme for all three"],
      consHome: ["ROAD game at Scotiabank where TOR is unbeatable so far", "Harden's 21 TOs in last 3 games — hostile crowd will amplify pressure", "Mitchell only 19pts in G5 — below his 27.9 season avg, may be fatigued", "TOR's home defense has been elite — held CLE to below season averages in G3-G4"],
      prosAway: ["Scotiabank Arena: TOR won both home games (G3 by 22, G4 by 4)", "Barnes plays best at home — 33pts in G3, near triple-double in G4", "Ingram should be fully available with 2 days rest — 20+ PPG scorer returns", "TOR's crowd energy at Scotiabank was historic in G3 — playoff atmosphere", "Desperation: Elimination game at home brings maximum intensity"],
      consAway: ["TOR Q4 collapse in G5 (17pts) raises closing concerns", "Quickley still out — missing starting PG's playmaking and spacing", "Murray-Boyles cooled off (8pts G5 after 14→17→22→15) — youth inconsistency", "CLE's bench depth (36pts G5) overwhelms TOR's depth every game"]
    },
    modelLessons: [
