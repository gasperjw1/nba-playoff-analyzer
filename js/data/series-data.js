...
const SERIES_DATA = [
  ...
  "<strong>Why SAS by 9 (engine baseline):</strong> Phase 58 engine fix now applies HCA flip correctly (G3 venue at MIN). Engine projects SAS by 9 (vs SAS by 11 pre-fix) — the baseline already accounts for HCA flip, MIN's home crowd, and the round-scaled HCA value of 1.7. Tactical add-ons (MIN desperation after worst playoff loss, Edwards potentially expanded) could compress this another 3-5pts toward MIN. PRIMARY HEDGE: Edwards minutes — 32+ at G1 efficiency (8-13, 18pts/25min) flips this to MIN by 2-3.",
      ...
      "<strong>Wemby availability = #1 swing factor:</strong> Flagrant 2 for the elbow to Reid's neck carries supplemental discipline risk. League precedent: similar contact-above-the-shoulders Flagrant 2s have drawn fines + 1-game suspension when contact was deemed deliberate. If Wemby is suspended for G5, SAS loses their 39/15/5blk anchor and the engine baseline flips from SAS by 9 to MIN by 1-2. If Wemby plays full minutes, SAS by 8-9 holds.",
      "<strong>Engine baseline SAS by 9 (with Wemby, full strength) → SAS by 8 after MIN momentum bump:</strong> MIN got the road-game scare in G4 even with the Wemby ejection forcing a depleted-roster scenario. They now know they can hang. Confidence MEDIUM because Wemby's discipline ruling is the load-bearing variable.",
    ...
    ],reasoning:"G5 Tuesday May 12 at Frost Bank Center. Series tied 2-2. Pivotal swing game in the 2-2-1-1-1 format. HCA goes to SAS (the higher seed); engine baseline returns to SAS by 9 with Wemby in full effect. Wemby's Flagrant 2 ejection carries supplemental discipline review — possible 1-game suspension. <strong>5/11 update:</strong> DK opens at SAS -4.5 / total 219.5 with Wemby PROBABLE pending league review. If Wemby is suspended (announced ~Monday afternoon), expect line to flip to MIN -1.5. Model leans SAS at the current line because (a) home crowd + Reid's offensive shaky status from neck contact, (b) Wemby unlikely to be suspended for a single-incident first-career ejection given the Flagrant 2 was a basketball play under double-team contact, not a fight or escalation. Edwards' Q4 closing is the chief MIN threat regardless of Wemby's status.",xFactor:"Wemby suspension ruling + Edwards Q4 closing + Reid health post-elbow",moneyline:"SAS -195 / MIN +162 (est, verify on DK Mon)",spread:"SAS -4.5 (est)",ou:"O/U 219.5 (est)"},notes:""}]
,
    modelLessons: [
