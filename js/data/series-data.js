...
const SERIES_DATA = [
  {
    ...
    game5: {
      ...
      prosHome: ["KD ankle injury creates uncertainty — if limited/out, HOU loses their best player", "HOU desperation already spent in G4 — harder to replicate that energy twice", "Sengun alone cannot carry HOU vs LAL's defensive scheme", "Young team losing composure after failing to complete the comeback narrative"],
      consHome: ["G4 WIN: 115-96 proved HOU CAN blow out LAL when things click", "Eason (20/8/5stl) showed he can be a series-changing X-factor", "Sheppard's rhythm could carry over — 14pts/4ast G4 was his best of series", "Thompson (18/8/5) is a consistent two-way contributor"],
  ...
  },
  {
    ...
    game5: {
      ...
      reasoning: "MODEL PICK: CLE (MEDIUM confidence, COMPETITIVE). Series returns to Cleveland with momentum swinging after TOR took both home games. CLE's home court advantage is critical — they won G1 126-113 and G2 115-105 at Rocket Mortgage FieldHouse. G4 was a horrific shooting game for both teams (CLE 37%, TOR 32% FG) that TOR won on free throws (27-36 vs 15-23). Mitchell's 6-24 FG (25%) was his worst game of the series — expect a bounce-back at home. Harden had 7 TOs in G4, continuing his turnover liability from G3 (8 TOs). However, CLE's core (Mitchell 27.9 PPG season, Harden, Mobley twin towers) is more talented and G4's shooting depression is unsustainable for both teams. TOR's Murray-Boyles (15pts/10reb) continues to be an X-factor, but CLE's home crowd and shooting regression toward the mean should reassert their talent advantage. Barnes (23/9/6 with 11-14 FT) is TOR's alpha but CLE's defense has held TOR to under 100 in 3 of 4 games at home historically. Quickley remains out (hamstring, expected May 5).",
      g4Adjustments: [
