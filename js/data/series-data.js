...
const SERIES_DATA = [
  ...
  },
  {
    ...
    game6: {
      ...
      prosHome: ["Kia Center fortress: 8-1 at home in playoffs — elite home court", "Wagner could return with extra rest — transforms offense to multi-initiator", "Banchero proved he can score 45 — at home, his ceiling is even higher", "FT regression: ORL shot 53% FT in G5 — unsustainably bad, will improve", "ORL's defensive identity (forced 16 DET TOs) should reassert at home"],
      consHome: ["Cade's 45 proves he can single-handedly extend series — hard to stop", "Harris 23pts showed he can be DET's reliable second scorer", "Ausar's 15reb/6ast/5stl/2blk is a game-changing stat line", "DET's desperation energy — facing elimination produces maximum effort"],
      prosAway: ["DESPERATION: Must-win or season over. Maximum effort from every player.", "Cade's G5 masterpiece (45pts, 14-14 FT) proves he's a playoff superstar", "Harris 23pts — reliable second scorer has emerged", "DET's Q1 dominance (38-26 in G5) shows they can control tempo early"],
      consAway: ["ROAD game at Kia Center where ORL is 8-1", "DET bench only scored 18pts — depth crisis continues", "Cade's 6 TOs in G5 — ball security remains a flaw even in his best games", "ORL's 3PT shooting (45% in G5) will travel — their shooters are legit"]
    },
    game4: {
  ...
  },
  {
    ...
    game6: {
      ...
      prosHome: ["Scotiabank Arena: TOR won both home games (G3 by 22, G4 by 4)", "Barnes plays best at home — 33pts in G3, near triple-double in G4", "Ingram should be fully available with 2 days rest — 20+ PPG scorer returns", "TOR's crowd energy at Scotiabank was historic in G3 — playoff atmosphere", "Desperation: Elimination game at home brings maximum intensity"],
      consHome: ["TOR Q4 collapse in G5 (17pts) raises closing concerns", "Quickley still out — missing starting PG's playmaking and spacing", "Murray-Boyles cooled off (8pts G5 after 14→17→22→15) — youth inconsistency", "CLE's bench depth (36pts G5) overwhelms TOR's depth every game"],
      prosAway: ["3-2 lead: One win from advancing regardless of location", "Mobley's evolution to 3-level scorer changes matchup dynamics", "Schroder 19pts — CLE bench provides reliable 30+ pts every game", "CLE has multiple closers (Mitchell, Harden, Mobley) — hard to scheme for all three"],
      consAway: ["ROAD game at Scotiabank where TOR is unbeatable so far", "Harden's 21 TOs in last 3 games — hostile crowd will amplify pressure", "Mitchell only 19pts in G5 — below his 27.9 season avg, may be fatigued", "TOR's home defense has been elite — held CLE to below season averages in G3-G4"]
    },
    modelLessons: [
