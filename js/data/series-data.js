...
const SERIES_DATA = [
  {
    ...
    awayTeam: {
      ...
      players: [
        ...
        { name:"Austin Reaves", pos:"SG", rating:68, ppg:25.4, rpg:5.1, apg:6.2, fgp:46.8, per:21.2, ts:58.4, epm:3.8, bpm:4.1, ws48:.152, onOff:5.1, clutch:6.8, vorp:3.5, usg:28.8, injury:"ACTIVE — returning from oblique strain (G5: 22pts, 4-16 FG, rusty)", activeInjury:{ type:"oblique", severity:0.6 }, lebron:2.39, oLebron:2.295, dLebron:0.095, war:5.341, offRole:"Shot Creator", defRole:"Point of Attack",
          matchupNote:"Returned G5 from oblique: 22pts but 4-16 FG (25%), 12-13 FT. Volume via fouls not shooting. Playmaking still valuable. Rust discount: rating 68 (base 80). Expect efficiency improvement G6+.", baseRating:80, injuryRisk:0.4 },
    ...
    externalFactors: [
      ...
      { team:"LAL", player:"Austin Reaves", desc:"RETURNED G5 — rusty. 22pts but 4-16 FG (25%), got points via FT (12-13). Oblique still limiting explosiveness. Expect gradual improvement G6+ but NOT at full capacity.", impact:2, category:"injury",
        evidence:"G5 result: 22pts, 4-16 FG, 12-13 FT, 3ast. Got to the line but couldn't shoot efficiently. Oblique clearly limiting his burst and finishing. Still a net positive for playmaking but not the 25ppg scorer LAL needs yet.",
    ...
    game6: {
      ...
      pick: "HOU", confidence: "medium", projScore: "HOU 108 — LAL 101",
      schedule: "TBD — Likely Fri May 1 or Sat May 2",
      reasoning: "MODEL PICK: HOU (MEDIUM confidence). G6 at Toyota Center where HOU is undefeated this series (G4 +19, G5 +6). HOU has won 2 straight including a ROAD win at Crypto.com in G5 (99-93), showing this is no longer a fluke — HOU has genuine momentum. LAL's G5 collapse was multi-dimensional: Smart 6 TOs, LeBron 0-6 from 3PT, Kennard 1pt (0-4 FG), and Reaves returned rusty (4-16 FG, 25%). LAL shot 25.9% from 3PT (7-27) — their worst shooting game of the series. KD still OUT (ankle, may return G7 if needed). Without KD, HOU has won 2 of 3 games. Smith Jr (22pts, 4-9 3PT in G5) has emerged as a legitimate second scorer alongside Sengun. Thompson's 4 steals and Sheppard's 6 assists show HOU's young core is peaking at the right time. LAL's primary concern is mental fragility — blowing a 3-1 lead would be historically devastating, and the pressure mounts with each loss. LeBron at 41 has now played 5 high-intensity playoff games. Smart's turnover problems (6 TOs G5) are becoming structural, not just variance. HOME COURT is the decisive factor — HOU's Toyota Center crowd has been worth 10+ points of swing this series.",
      g5Adjustments: [
