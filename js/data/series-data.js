...
],reasoning:"G3 Friday May 8 at Wells Fargo Center. NYK leads 2-0. PHI desperation game — a loss drops them to 0-3 (no team has come back from 0-3 without WAR-tier roster). HCA flips to PHI (Phase 58 engine fix now applies this correctly — the venue swap brings the engine baseline from NYK by 9 to NYK by 6). Embiid GTD; OG also GTD. NYK's depth, KAT stretch-5 vs PHI's thin C rotation, and +9.2 clutchNetRtg keep them favored even on the road, but the margin compresses with the HCA flip + PHI desperation. MODEL: NYK 111, PHI 105 (NYK by 6, LOW confidence — Embiid status is the biggest swing factor).",xFactor:"Embiid availability + OG Anunoby status + PHI Brunson double-team continuation",moneyline:"NYK -200 / PHI +170",spread:"NYK -5.5",ou:"O/U 216"},notes:""}]
  }
];
