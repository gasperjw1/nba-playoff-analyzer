...
,
  ...
  },
  {
    ...
    conf: "West", round: "CF",
    tbdOpponent: true,
    // OKC confirmed (swept LAL 4-0 in R2). SAS confirmed (beat MIN 4-2,
    // G6 closeout blowout 139-109 on 5/15). WCF G1 is tonight 5/18 at
    // Paycom Center. Scaffold keeps tbdOpponent:true until full SAS
    // roster is copied in from SAS-MIN R2 entry.
    confirmedSide: "home",
    homeTeam: {
      name: "Thunder", city: "Oklahoma City", abbr: "OKC", seed: 1, record: "64-18",
      systemBonus: 2.5, playoffPedigree: 2,
    ...
    awayTeam: {
      name: "Spurs", city: "San Antonio", abbr: "SAS", seed: 2, record: "60-22",
      tbd: true, players: [], synergy: [],
      note: "SAS beat MIN 4-2 in R2 (G6 139-109 closeout on 5/15). Roster copy from SAS-MIN R2 entry deferred to next-phase task.",
    },
    games: [],
    priorRound: {
      home: { seriesId: "OKC-LAL", gamesPlayed: 4, round: "R2", restDays: 7 },
      away: { seriesId: "SAS-MIN", gamesPlayed: 6, round: "R2", restDays: 3 },
    },
  },
];
