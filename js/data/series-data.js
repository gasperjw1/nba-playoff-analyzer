...
const SERIES_DATA = [
  ...
  "<strong>Why SAS by 4 (close to a coin flip):</strong> Engine projects SAS by 11 but ignores HCA flip. Adjusting: SAS by 11 minus HCA(2) minus crowd(2-3) minus desperation(2) minus expected road shooting regression(3-5) → SAS by ~0-2 on raw math. SAS's residual talent + depth advantage adds ~3-4 back, landing on SAS by 4 with LOW confidence. PRIMARY HEDGE: Edwards minutes — 32+ at G1 efficiency (8-13, 18pts/25min) flips it to MIN by 4-6.",
],reasoning:"G3 Friday May 8 at Target Center. Series tied 1-1. HCA flips to MIN. MIN coming off worst playoff loss in franchise history — Finch's 'we got punked' message will translate to extreme desperation, and Target Center is one of the league's loudest playoff environments. But SAS's G2 tactical overhaul (pace + pressure + Wemby rim attacks) is structural, not luck. The realistic margin is much tighter than the engine's SAS by 11 — closer to SAS by 4 once HCA flip + crowd + MIN desperation + likely SAS road shooting regression are layered in. Edwards' minutes are the biggest swing factor. MODEL: SAS 111, MIN 107 (SAS by 4, LOW confidence — coin-flip territory).",xFactor:"Edwards minutes + MIN 3PT shooting + SAS pace/pressure scheme on the road",moneyline:"SAS -160 / MIN +135",spread:"SAS -3.5",ou:"O/U 218"},notes:""}]
  },
  {
...
],reasoning:"G3 Friday May 8 at Wells Fargo Center. NYK leads 2-0. PHI desperation game — a loss drops them to 0-3 (no team has come back from 0-3 without WAR-tier roster). HCA flips to PHI (-2pts for NYK), crowd amplifies. Embiid GTD per ESPN/Heavy/Inquirer; OG also GTD. Engine projects NYK by 9 but doesn't account for the HCA flip — adjusting for venue change + PHI desperation + likely NYK shooting regression brings the realistic margin to NYK by 4. PHI's G2 scheme on Brunson + their proven shot-making on the road keep them within striking distance, but NYK's depth + clutch edge wins out. MODEL: NYK 108, PHI 104 (NYK by 4, LOW confidence — Embiid status is the swing).",xFactor:"Embiid availability + OG Anunoby status + PHI Brunson double-team continuation",moneyline:"NYK -160 / PHI +135",spread:"NYK -3.5",ou:"O/U 212"},notes:""}]
  }
];
