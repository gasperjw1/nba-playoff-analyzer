...
const SERIES_DATA = [
  {
    ...
    homeTeam: {
      ...
      players: [
        { name:"Kevin Durant", age:37, pos:"SF", rating:0, ppg:26.0, rpg:5.5, apg:4.8, fgp:52.4, per:25.8, ts:65.5, epm:5.5, bpm:6.1, ws48:.195, onOff:5.2, clutch:6.0, vorp:5.3, usg:29.5, injury:"OUT — left ankle injury. CBS Sports: expected out until at least May 3. Will miss G6.", lebron:2.377, oLebron:2.519, dLebron:-0.142, war:8.586, offRole:"Shot Creator", defRole:"Helper",
          matchupNote:"67% TS vs LAL reg season. Elite efficiency but burner scandal chemistry ding. Clutch 6.0. Has played only G1-G2 this series. G1: OUT (knee contusion), G2: 23pts/9TOs, G3-G5: OUT (ankle). At 37 with compounding injuries (knee + ankle), HOU must win without him.", baseRating:89, starCeiling:2, injuryRisk:1.0, activeInjury:{type:"left ankle injury",severity:1.0,note:"May 1: CBS Sports confirms KD OUT until at least May 3. Will miss G6 at minimum. Has played only 2 of 5 games this series (G1 OUT knee, G2 played, G3-G5 OUT ankle). Combined knee contusion + ankle injury at age 37 — recovery timeline conservative. If series goes to G7 (May 3+), game-time decision. Rating set to 0 for G6."} },
    ...
    awayTeam: {
      ...
      players: [
        ...
        { name:"Austin Reaves", pos:"SG", rating:74, ppg:25.4, rpg:5.1, apg:6.2, fgp:46.8, per:21.2, ts:58.4, epm:3.8, bpm:4.1, ws48:.152, onOff:5.1, clutch:6.8, vorp:3.5, usg:28.8, injury:"ACTIVE — 2nd game back from oblique (G5: 22pts 4-16 FG, expect improvement G6)", activeInjury:{ type:"oblique", severity:0.35 }, lebron:2.39, oLebron:2.295, dLebron:0.095, war:5.341, offRole:"Shot Creator", defRole:"Point of Attack",
          matchupNote:"G5 return: 22pts but 4-16 FG (25%), 12-13 FT — rust was real. Now with 1 game of conditioning and rhythm, expect FG% to climb back toward 40%+. Still not full health (base 80) but much closer. 3-level scoring returns: mid-range, drives, spot-up 3s. Playmaking (3ast G5) should improve with comfort.", baseRating:80, injuryRisk:0.3 },
    ...
    externalFactors: [
      { team:"LAL", player:"Luka Doncic", desc:"Custody battle + Grade 2 hamstring. OUT until May 3 per CBS Sports. LAL is 3-1 without him — team has fully adapted around LeBron/Smart/Kennard core.", impact:-5, category:"personal",
        evidence:"CBS Sports (Apr 29): Doncic listed OUT with hamstring, est. return May 3. Won't return this series unless it goes to G7. LAL has proven they don't need him — 3-1 and on the verge of advancing. Impact further downgraded from -8 to -5.",
        sources:["ESPN: espn.com/nba/story/_/id/48166967","CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" },
      { team:"LAL", player:"Austin Reaves", desc:"2nd game back from oblique — G5 rust fading. Expect improved efficiency G6 (FG% 25%→35-40%). Still not 100% but 2nd game conditioning + home crowd = significant upgrade.", impact:3, category:"injury",
        evidence:"G5 return: 22pts, 4-16 FG (25%), 12-13 FT. Oblique limited burst but got to the line at elite rate. With 1 game of conditioning and rhythm, expect efficiency climb. Historical precedent: players returning from oblique typically need 2-3 games to regain shooting touch. G6 should be ~70-80% capacity.",
      ...
      { team:"LAL", player:null, desc:"Redick's defensive scheme mastery — zone/doubling/switching is structurally suppressing HOU offense. 2-0 as playoff HC.", impact:5, category:"coaching",
        ...
        sources:["ESPN: espn.com/nba/recap/_/gameId/401869397"], verdict:"verified" },
      { team:"HOU", player:"Kevin Durant", desc:"ANKLE INJURY — OUT until at least May 3. Confirmed OUT G6 (May 1). Has played only G2 this series (OUT G1 knee, OUT G3-G6 ankle). HOU is 2-2 without him.", impact:-12, category:"injury",
        evidence:"CBS Sports injury report (May 1): KD listed OUT with ankle injury, est. return May 3. At 37, combined knee contusion + ankle = compounding injuries. HOU has won G3+G5 at home without him but lost G4. The dual-initiator thesis is moot without KD for the foreseeable future.",
        sources:["CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" },
      { team:"HOU", player:"Kevin Durant", desc:"Burner account scandal + extended absence. KD has missed G3-G5 with ankle injury — chemistry with teammates is now completely disrupted. HOU must win without him.", impact:-6, category:"chemistry",
        evidence:"Screenshots leaked Feb 15 mocking Sengun/Smith. KD played only G1-G2 before ankle injury sidelined him. Even if he returns for a potential G6, reintegration after 3+ games away would be rocky. HOU's identity has shifted to Sengun/Sheppard-led.",
        sources:["Yahoo: kevin-durant-burner-account-rumors","CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" },
    ...
    modelLessons: [
      ...
      {type: "missed", lesson: "G3: Model picked HOU 105-100 (medium). Actual: LAL 112-108 OT. Model is now 0-3 on this series. LAL's offensive adaptability in OT and LeBron's 29/13/6 continued the pattern of model underrating LAL's playoff ceiling. Sengun's 33/16/6 wasn't enough."},
      {type: "correct", lesson: "G4: No prediction was made (gap in model coverage), but HOU won 115-96 to avoid the sweep. HOU's desperation factor (facing elimination) was real — Eason 20/8/5stl led a balanced effort. KD had 16pts but tweaked left ankle (now day-to-day)."},
      {type: "missed", lesson: "G4: LAL shooting regression finally hit — role players went cold on the road in an elimination game for HOU. The model's 3PT regression thesis was correct in principle but took 2 extra games to manifest."},
      {type: "missed", lesson: "KD ankle injury in G4 creates new uncertainty for G5. At 37 with knee contusion + ankle injury, his availability and effectiveness are major question marks."},
      { type:"missed", lesson:"G5: Reaves return was NOT the predicted boost — 22pts but 4-16 FG (25%). FT-merchant mode (12-13 FT). Model assumed +4 impact from his return but he was rusty from oblique injury." },
      { type:"missed", lesson:"G5: Smart 6-turnover catastrophe — worst game of series. LAL 15 total TOs vs HOU 10. Turnover differential continues to be the series-defining factor." },
      { type:"missed", lesson:"G5: LeBron 0-6 from 3PT at age 41. Deep shooting unreliable in crunch time. Model needs age-adjusted 3PT regression for 40+ players." },
      { type:"missed", lesson:"G5: Kennard 1pt (0-4 FG) after 17ppg G1-G3 avg. Streaky shooter regression. Model didn't account for regression to mean after hot stretch." },
      { type:"correct", lesson:"G5: HOU home dominance confirmed — 2-0 at Toyota Center (G4 +19, G5 +6). Road team hasn't won at HOU this series. Home court factor was underweighted." },
      { type:"correct", lesson:"G6: Model picked LAL (LOW confidence). LAL won 98-78, closing out 4-2. Correct winner but massively wrong on margin — projected +2, actual +20. The coin-flip framing was wrong; LAL was clearly the better team." },
      { type:"missed", lesson:"G6: HOU home court advantage evaporated in closeout — Toyota Center went from +19/+6 margins (G4-G5) to -20. Model overweighted HOU's home record when facing elimination. Closeout game psychology trumped home court." },
      { type:"underweighted", lesson:"G6: Hachimura's 3PT breakout (5-7, 71.4%) was the game-breaking factor. 21pts from the 'neutral outlook' player. His shooting unlocked LAL's offense by forcing HOU to respect his shot. Model rated him 'neutral' with 0.48 projFgPct." },
      { type:"correct", lesson:"G6: Reaves return to form — 15pts (7-14 FG, 50%) after G5's rusty 4-16 (25%). Model correctly identified Reaves' conditioning improvement as a key variable (severity 0.6→0.35). His efficiency validated the upgrade." },
      { type:"missed", lesson:"G6: Sheppard's COLLAPSE — 4-19 FG (21.1%), 1-10 3PT. Worst game of series by far. Model had no mechanism for young player meltdown in closeout games. Sheppard's playoff inexperience was catastrophically underweighted." },
      { type:"missed", lesson:"G6: LAL's defensive scheme peaked in the closeout — held HOU to 78pts (season low for HOU). The zone+switching scheme wasn't just maintained, it IMPROVED over the series. Model assumed diminishing returns on defensive schemes over multiple games." },
      { type:"overweighted", lesson:"G6: HOU momentum from 2-game win streak was completely meaningless. Model cited 'all the momentum' but LAL's closeout mentality + LeBron's championship experience were the dominant forces." },
      { type:"missed", lesson:"SERIES SUMMARY: Model went 2-4 on winner picks (G1-G3 wrong, G4 no pick, G5 wrong, G6 correct). Systematically overrated HOU's depth/youth while underrating LAL's scheme mastery and LeBron's playoff ceiling. The fundamental error was treating this as a talent matchup when it was a scheme matchup." }
    ],
    game2: {
    ...
    game3: {
      ...
      g3Adjustments: [
      "SAS WON G3 115-108 at Target Center. SAS leads 2-1. Wemby 39/15/5blk (13-18 FG, 10-12 FT) — Kareem/Hakeem/Shaq company.",
      "Edwards BREAKOUT: 32pts/14reb/6ast in 41min (12-26 FG) — starting lineup, 22pts in first half. Knee is NO LONGER limiting his production.",
      "Randle (3-12 FG, 12pts) and McDaniels (5-22 FG, 17pts) neutralized by Wemby's paint presence — combined 8-34. Secondary scoring crisis.",
      "Conley played only 4 MINUTES (0pts, 0-1 FG). Major change from G1 (24min/12pts) and G2 (22min/7pts). Guard depth severely limited.",
      "Reid 18pts/9reb off bench — MIN's most consistent non-Edwards scorer across all 3 games.",
      "Castle had 13pts/12ast — shifted to facilitator role. Castle-Wemby PnR is increasingly the primary action.",
      "SAS Q3 dominance (35-28) was the game-breaker after 51-51 halftime tie. SAS's 3rd-quarter scoring: 35(G1), 34(G2 had 34-pt Q3 by HOU — wrong series), 35(G3).",
      "MIN's 18-3 deficit start was alarming — missed first 12 shots. But unlike G2 they fought back. Edwards' Q1 buzzer-beater 31-footer was a momentum swing.",
      "Wemby played through 5 fouls (picked up 5th with 6:18 left, sat 1min, came back). Coach Johnson: 'not leaving any bullets in the chamber.'",
      "G4 at Target Center Sun May 10. MIN must win to avoid 3-1 deficit. Edwards fully healthy changes the IC calculus — now 2-star vs 2-star."
    ],
    g2Adjustments: [
    ...
    game5: {
      spread: "LAL -6.5", moneyline: "LAL -280 / HOU +220", ou: "O/U 210.5",
      pick: "LAL", confidence: "medium", projScore: "LAL 108 — HOU 99",
      schedule: "TBD — Likely Wed Apr 29 or Thu Apr 30",
      reasoning: "RESULT: HOU 99-93. MODEL WRONG — picked LAL. MODEL PICK: LAL (MEDIUM confidence, COMPETITIVE). LAL returns home to close out at Crypto.com Arena where they won G1 107-98 and G2 101-94. Despite HOU's 115-96 G4 win that avoided the sweep, the fundamental dynamics favor LAL: Redick's defensive scheme (doubling KD, zone defense) has dominated this series, and home court returns the crowd advantage that amplified that scheme in G1-G2. KEY VARIABLE: KD's left ankle injury (day-to-day per Udoka, separate from earlier knee contusion). At 37 with compounding injuries, his availability and effectiveness are major question marks. If KD is limited or out, HOU reverts to the single-initiator team that lost G1 98-107. LeBron (18pts G4, down from 29pts G3 OT) should bounce back at home with rest. Smart and Kennard averaged 20pts and 25pts in the first 2 home games. The model's only concern is complacency — LAL may not play with closeout urgency after a comfortable 3-1 lead.",
      g4Adjustments: [
        "HOU WON G4 115-96: Avoided sweep with balanced effort. Eason 20/8/5stl led the charge.",
        "KD LEFT ANKLE INJURY: New injury from G4. Day-to-day per Udoka. Compounds earlier knee contusion. Major G5 question mark.",
        "LAL SHOOTING DIP: Role players went cold in G4 on the road. Kennard 12pts, Smart 14pts — below G1-G2 home averages.",
        "LEBRON 18pts G4: Down from 29pts G3 OT. May have conserved energy knowing LAL had 3-1 cushion.",
        "SENGUN CONSISTENT: 22/11/5 in G4 — reliable regardless of KD status.",
        "HOME COURT RETURNS TO LAL: Crypto.com Arena where they won G1-G2. Crowd + Redick scheme = dominant combination.",
        "SHEPPARD FOUND RHYTHM: 14pts/4ast in G4 after early series struggles."
      ],
      prosHome: ["G4 WIN: 115-96 proved HOU CAN blow out LAL when things click", "Eason (20/8/5stl) showed he can be a series-changing X-factor off bench", "Sheppard's rhythm could carry over — 14pts/4ast G4 was his best of series", "Thompson (18/8/5) is a consistent two-way contributor", "Sengun 22/11/5 G4 — reliable All-Star regardless of KD status"],
      consHome: ["KD ankle injury creates uncertainty — if limited/out, HOU loses their best player", "HOU desperation already spent in G4 — harder to replicate that energy twice", "Young team losing composure — closing weakness (-2.8 clutch NetRtg) is structural", "0-2 at LAL's Crypto.com Arena — couldn't win there in G1 or G2"],
      prosAway: ["HOME COURT at Crypto.com: won G1 by 9 and G2 by 7", "REDICK SCHEME: Doubling KD + zone defense has dominated 3 of 4 games", "LeBRON CLOSEOUT: At 41 with 4 championships, he knows how to finish series", "Smart + Kennard averaged 20pts and 25pts in home games — expect return to form", "REST: LAL has had extra days to recover. LeBron manages energy for closeout."],
      consAway: ["G4 showed LAL can be blown out when shooting goes cold", "Complacency risk after comfortable 3-1 lead", "LeBron fatigue at 41 — 4th playoff game is cumulative wear", "HOU playing free — nothing to lose, everything to gain"]
    },
    game6: {
      spread: "HOU -3.5", moneyline: "HOU -170 / LAL +140", ou: "O/U 205.5",
      pick: "LAL", confidence: "low", projScore: "LAL 106 — HOU 104",
      schedule: "Fri May 1 — 9:30 PM ET — Prime Video",
      reasoning: "MODEL PICK: LAL (LOW confidence — essentially a coin flip). KD CONFIRMED OUT (ankle, CBS Sports: until May 3). HOU must win without him for the 3rd straight game. REAVES UPGRADE SHIFTS THIS GAME. G5 was Reaves' first game back from oblique strain — 22pts but 4-16 FG (25%), all scoring via FTs. With one game of conditioning, expect his shooting to normalize toward 35-40% FG. Rating upgraded 68→74 (severity 0.6→0.35). This is significant: Reaves at 70-80% gives LAL their 3rd legitimate scoring option alongside LeBron and Ayton. LAL's G5 3PT shooting collapse (25.9%, 7-27) was their worst of the series — regression to the mean alone adds 5-8 points. Kennard (1pt G5) is due for a bounce-back. Smart's 6 TOs G5 were anomalous. HOWEVER: HOU is undefeated at Toyota Center (G4 +19, G5 +6) and this is a ROAD game for LAL. HOU's home court has been worth 10+ points of swing. Smith Jr's breakout (22pts G5) + Sengun's consistency (triple-double threat every game) means HOU's offense is functional without KD. The ensemble model now sees this as a genuine coin flip: LAL's talent+Reaves recovery vs HOU's home court+momentum. Slight lean LAL because Reaves' return + KD confirmed absence is the single biggest variable change since G5. Doncic also confirmed OUT (hamstring, May 3) — no LAL reinforcements either.",
      g5Adjustments: [
        "HOU WON G5 99-93 at Crypto.com Arena — ROAD WIN. HOU has won 2 straight. Series tightens to 3-2 LAL.",
        "REAVES RETURNED BUT RUSTY: 22pts but 4-16 FG (25%). Relied on 12-13 FT. Not the +4 boost model predicted.",
        "SMART TURNOVER CATASTROPHE: 6 TOs in G5 — worst game of series. LAL had 15 total TOs vs HOU 10.",
        "LEBRON 0-6 FROM 3PT: At 41, deep shooting increasingly unreliable. 25pts but inefficient beyond the arc.",
        "KENNARD COMPLETE REGRESSION: 1pt (0-4 FG) after averaging 17ppg G1-G3. Streaky shooter crashed hard.",
        "SMITH JR BREAKOUT: 22pts (4-9 3PT) — best game of series. Emerging as HOU's second scorer without KD.",
        "AYTON 18/17reb (10 OREB): Dominated glass but LAL still lost. Individual effort can't overcome team dysfunction.",
        "HOU MIDDLE QUARTER DOMINANCE: Won Q2 30-19 and Q3 25-20. Pattern: HOU makes halftime adjustments, LAL doesn't.",
        "LAL 25.9% FROM 3PT (7-27): Worst shooting game of series. Not just variance — HOU's perimeter defense is improving.",
        "KD CONFIRMED OUT G6: CBS Sports (May 1) — ankle injury, not expected back until at least May 3. Has played only 1 game (G2) this series.",
        "DONCIC CONFIRMED OUT: Hamstring, expected May 3. No LAL reinforcements coming for G6 either.",
        "G6 AT TOYOTA CENTER: HOU undefeated at home (G4 +19, G5 +6). Home court is the decisive factor."
      ],
      prosHome: ["UNDEFEATED AT HOME: 2-0 at Toyota Center (G4 +19, G5 +6). Home court has been worth 10+ points of swing.", "2-GAME WIN STREAK: HOU has all the momentum after winning G4 (home) and G5 (road).", "SMITH JR BREAKOUT: 22pts (4-9 3PT) G5 — emerging as reliable 2nd scorer without KD.", "SENGUN CONSISTENCY: 14/9/8ast G5, averaging near triple-double for the series.", "THOMPSON TWO-WAY IMPACT: 15pts/4stl G5. His perimeter defense on LeBron + transition scoring is elite.", "LAL MENTAL PRESSURE: Blowing a 3-1 lead would be historically devastating — pressure shifts to LAL."],
      consHome: ["KD STILL OUT: HOU missing their best player. If LAL adjusts, HOU's ceiling is limited without an elite ISO scorer.", "CLOSING PROBLEMS REMAIN: -2.8 clutch NetRtg hasn't been tested at home in a tight game yet.", "Young team inexperience: HOU has never forced a G7 — uncharted territory for this core.", "LAL has LeBron — 4 championships, has overcome 3-1 deficits before (2016). Never count him out."],
      prosAway: ["LEBRON LEGACY: Has come back from 3-1 before (2016 Finals). At 41, this could be his last stand — maximum motivation.", "REDICK ADJUSTMENTS: Redick hasn't made halftime adjustments to counter HOU's middle-quarter dominance. Extra prep time could help.", "REAVES RHYTHM: G5 was his first game back from oblique injury. With another game, expect improved shooting efficiency.", "AYTON DOMINANCE: 18/17reb (10 OREB) G5. If LAL feeds him consistently, HOU has no answer inside."],
      consAway: ["3PT SHOOTING COLLAPSE: 25.9% (7-27) G5. LAL's perimeter game has been unreliable for 3 straight games.", "SMART TURNOVER CRISIS: 6 TOs G5. His ball security issues are becoming structural, not variance.", "LEBRON 3PT REGRESSION: 0-6 from 3PT G5. At 41, his deep shooting is increasingly unreliable under pressure.", "KENNARD COLD: 1pt G5 after 17ppg G1-G3. Can't rely on him as a primary scorer anymore.", "ROAD RECORD: LAL is 0-2 at Toyota Center this series. HOU's crowd has been a massive factor."]
    },
    game4: {
      spread: "HOU -2.5", moneyline: "HOU -140 / LAL +120", ou: "O/U 207.5",
      pick: "HOU", confidence: "medium", projScore: "HOU 109 — LAL 106",
      schedule: "Sun Apr 26 — 8:00 PM ET — NBC/Peacock",
      reasoning: "PHASE 35 PICK: HOU (MEDIUM confidence). Despite LAL's stunning G3 OT win (LeBron's tying steal+3 with 13sec left), HOU remains at home for G4 with desperation motivation facing 0-3 deficit if they lose. KD's ankle status is the key variable — if he returns, HOU becomes a different team. Without KD, HOU scored 108 in regulation and led 101-95 with 30sec left before collapsing. Sengun (33/16 G3) is playing at an All-Star level. HOU's Q4 closing weakness is structural but home crowd may provide the emotional edge needed. LAL has LeBron (45min G3 at age 41) — fatigue is real even for transcendent players. Smart's veteran savvy (3-FT draw, OT heroics) travels but HOU will be more prepared. Model gives HOU a thin edge at home.",
      g3Adjustments: [
        "G3: LAL 112-108 OT. LAL leads 3-0. LeBron steal+tying 3 with 13sec left forced OT. Smart 8pts in OT.",
        "KD OUT (ankle) for G3 — 2nd absence in 3 games. Status for G4 unknown. If KD returns, HOU significantly upgraded.",
        "HOU led 101-95 with 30sec left but COLLAPSED — Smart 3-FT draw + LeBron steal+3. Q4 closing weakness confirmed structural.",
        "LeBron played 45+ min at age 41. Fatigue factor must increase for G4 — even transcendent vets have limits in B2B games.",
        "Sengun 33/16 — playing at MVP level. HOU's offense is elite when Sengun is engaged regardless of KD status."
      ],
      prosHome: ["Home court (Toyota Center) for consecutive game — crowd desperation facing potential 0-3 hole", "Sengun 33/16 in G3 — playing at elite level", "If KD returns from ankle, HOU becomes significantly different team", "LAL fatigue: LeBron 45min G3 at age 41, Smart heavy OT minutes"],
      consHome: ["Q4 closing weakness is STRUCTURAL — blew 6pt lead with 30sec left", "LAL has LeBron who defies age curves in crunch time", "Smart's veteran savvy creates free possessions (3-FT draw)", "Young team (Sengun 24, Amen 21, Sheppard 21) crack under pressure"],
      prosAway: ["LeBron's clutch gene transcends location — steal+3 with 13sec left", "Smart's veteran IQ exploits rules and situations", "Redick's coaching scheme is structural and travels", "LAL has won 3 straight — momentum and confidence at peak"],
      consAway: ["LeBron played 45+ min — fatigue accumulates even for GOAT", "B2B road games tax veterans physically", "Doncic and Reaves still OUT — LAL roster is thin", "HOU crowd desperation makes Toyota Center hostile"]
    },
    coaching: {
      home: {
        coach: "Ime Udoka",
    ...
    games: [{num:1,result:"LAL",homeScore:98,awayScore:107,winner:"LAL",notes:"UPSET. LAL 107-98. LeBron 19pts/13ast (facilitator masterclass — 93rd pctile points created, 95th rim assists per Databallr). Career-high 8 Q1 assists. Kennard 27pts/7-11 3PT (career playoff-high). Ayton 19pts/11reb. Smart 15pts/8ast/4 threes. LAL shot 60.6% FG, toggled zone/man defense (.960 PPP allowed in zone). HOU shot 37.6% — Sengun 6/19, Sheppard 6/20. HOU had 3 non-spacers on court at times vs LAL zone. WPA: MVP Kennard +15.2%, LVP Sheppard -14.6%. FG shooting was the decisive factor (LAL 60.6% vs HOU 37.6%)."},{num:2,result:"LAL",homeScore:94,awayScore:101,winner:"LAL",notes:"LAL 101-94 at Crypto.com Arena. LAL leads 2-0. LeBron 28/8/7 (shifted to scorer mode from G1 facilitator). Smart 25pts/5 3PM/7ast (8-13 FG — 2-game breakout pattern). Kennard 23pts (8-13 FG, sustained production). KD HOU playoff debut: 23pts but 9 TOs, only 3pts in 2H — LAL doubled him from possession one, early foul trouble. Sengun 20/11. Smith Jr 18. Thompson 16. HOU: 36-89 FG (40.4%), 7-29 3PT (24%), 15-19 FT, 42 REB, 23 AST, 15 TO. LAL: 33-72 FG (46%), 13-28 3PT (46%), 22-28 FT. LAL nursed small lead through 4Q. Smart→LeBron dunk with 55sec left sealed it. KD quote: 'They started doubling me from possession one.'"},{num:3,result:"LAL",homeScore:108,awayScore:112,winner:"LAL",notes:"LAL 112-108 OT. LAL leads 3-0. INSTANT CLASSIC. LeBron 29/13reb — stole ball from Sheppard, hit tying 3 with 13sec left to force OT at 101-101. Smart 21/10ast, 8pts in OT including go-ahead 3. Hachimura 22pts. KD OUT (ankle) for 2nd time. Sengun 33/16 for HOU. Amen Thompson 26/11. HOU led 101-95 with 30sec left but collapsed — Smart drew 3FT foul, LeBron steal+3. Udoka: closing is 'a weakness of ours.' LeBron 45+ min at age 41. Model picked HOU +5 — WRONG by 9pts (game went to OT)."},{num:4,result:"HOU",homeScore:115,awayScore:96,winner:"HOU",notes:"HOU 115-96 at Toyota Center. LAL leads 3-1 (HOU avoids sweep). HOU dominated with 34-pt Q3. Eason 20pts/8reb/5stl led HOU. Ayton 19pts/10reb best for LAL. Quarter scores: LAL 21-26-18-31, HOU 26-30-34-25."},{num:5,result:"HOU",homeScore:99,awayScore:93,winner:"HOU",notes:"HOU 99-93. LAL leads 3-2. HOU stays alive at Toyota Center. Smith Jr 22pts (4-9 3PT). Eason 18pts. Sengun 14/9/8ast. Thompson 15pts/4stl. Reaves returned for LAL (22pts but 4-16 FG, 25%, relied on 12-13 FT). LeBron 25pts but 0-6 3PT. Smart 6 TOs. Kennard 1pt (0-4). Ayton 18/17reb (10 OREB). Q scores: HOU 21-30-25-23, LAL 28-19-20-26. LAL won Q1 and Q4 but HOU dominated middle quarters. LAL shot 25.9% from 3PT (7-27). Model picked LAL medium — WRONG."},{num:6,result:"LAL",homeScore:78,awayScore:98,winner:"LAL",notes:"LAL 98-78. LAL WINS SERIES 4-2. CLOSEOUT BLOWOUT at Toyota Center. LeBron 28pts (10-25 FG, 2-5 3PT, 6-8 FT)/7reb/8ast — controlled pace from the start. Hachimura 21pts (8-15 FG, 5-7 3PT) — breakout 3PT shooting was the dagger. Reaves RETURN TO FORM: 15pts (7-14 FG, 50%) after rusty G5 (4-16). Smart locked down defensively (7pts but 2stl/2blk). Ayton 7pts but 16reb (3 OREB) controlled glass. HOU COLLAPSED: Sheppard 4-19 FG (21%) worst game of series, only 10pts. Sengun 17/11 but 4 TOs. Amen Thompson 18pts but couldn't create enough. Smith Jr DNP. Q scores showed LAL dominance from Q1. 20-point blowout was the largest closeout margin in the series. LAL's defensive scheme (zone+switching) held HOU to 78pts — lowest of any game. Model picked LAL (LOW) — CORRECT winner, but projected +2, actual +20. Massive margin miss."},{num:7,result:null,homeScore:null,awayScore:null,winner:null,notes:""}]
  },
  {
  ...
  },
  {
    ...
    awayTeam: {
      ...
      players: [
        { name:"Anthony Edwards", pos:"SG", rating:0, ppg:28.8, rpg:5.0, apg:3.7, fgp:48.9, per:21.8, ts:59.2, epm:5.8, bpm:4.5, ws48:.178, onOff:7.8, clutch:7.5, vorp:3.5, usg:32.5, injury:"OUT — hyperextended right knee (est. return May 9)", lebron:1.285, oLebron:2.623, dLebron:-1.337, war:5.014, offRole:"Shot Creator", defRole:"Chaser",
          matchupNote:"OUT for remainder of first round. Hyperextended right knee suffered in G4. CBS Sports est. return May 9. MIN won G4 112-96 WITHOUT him (Dosunmu 43pts). Lost G5 113-125 without him — 25 TOs. Through 4 games: 22/30/17/limited pts on declining efficiency. His absence transforms the series — MIN loses their #1 scorer, creator, and defensive engine.", baseRating:90, starCeiling:2, injuryRisk:1.0, playoffAscension:0.8, activeInjury:{type:"hyperextended right knee",severity:1.0,note:"Apr 26: Hyperextended right knee. OUT G4 and G5 (MIN won G4, lost G5). CBS Sports est. return May 9 — will miss remainder of R1. Combined with DiVincenzo's season-ending Achilles rupture, MIN is missing their #1 and #4 scorers."} },
    ...
    externalFactors: [
      { team:"MIN", player:"Anthony Edwards", desc:"KNEE INJURY — OUT until May 9. Misses remainder of series. MIN's franchise player and primary scorer is done. Without Ant, MIN loses their only player capable of matching Jokic's impact. CATASTROPHIC.", impact:-18, category:"injury",
        evidence:"CBS Sports (Apr 29): Edwards listed OUT with knee injury, est. return May 9. After managing the knee all season (missed 11 of final 14), the playoff grind proved too much. MIN must play without their best player for the rest of the series. This is a series-altering absence — Edwards averaged 26.5/7.4/6.0 in 31 career playoff games.",
        sources:["CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" },
      { team:"MIN", player:"Donte DiVincenzo", desc:"ACHILLES INJURY — OUT FOR SEASON. MIN loses their starting SG and key 3PT shooter (.387 3PT). Combined with Edwards OUT, MIN's backcourt is decimated.", impact:-8, category:"injury",
        evidence:"CBS Sports (Apr 29): DiVincenzo listed OUT for season with Achilles injury. No return date. MIN has now lost both starting guards (Edwards + DiVincenzo) — the remaining backcourt options (Conley, Hyland) are a massive downgrade in scoring and creation.",
        sources:["CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" },
      ...
      { team:"MIN", player:"Anthony Edwards", desc:"OUT for series (knee). His 18 technical fouls and emotional volatility are now moot — MIN's challenge is far more fundamental: they've lost their franchise player.", impact:-2, category:"personal",
      ...
      { team:"DEN", player:"Peyton Watson", desc:"HAMSTRING — OUT until Apr 30. Could return for G6 if series extends. DEN's defensive versatility piece has been missing the entire series.", impact:-3, category:"injury",
        evidence:"CBS Sports (Apr 29): Watson listed OUT with hamstring, est. return Apr 30. Has missed all 5 games. DEN has survived without him but his wing defense would help against MIN's remaining shooters.",
        sources:["CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" },
      { team:"DEN", player:"Aaron Gordon", desc:"CALF — OUT until Apr 30. Has been in and out of the series. DEN's defense (+12.79 on/off) suffers significantly without him. Could return for G6.", impact:-5, category:"injury",
        evidence:"CBS Sports (Apr 29): Gordon listed OUT with calf injury, est. return Apr 30. In only 36 games this season due to injuries. When healthy he's DEN's best perimeter defender and Jokic's frontcourt partner. His absence forces more minutes on Johnson/Strawther.",
        sources:["CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" }
    ],
    game1: {
    ...
    game6: {
      spread: "MIN -2.5", moneyline: "MIN -140 / DEN +120", ou: "O/U 220.5",
      pick: "DEN", confidence: "low", projScore: "DEN 114 — MIN 110",
      schedule: "Thu Apr 30 — TBD — NBC/Peacock",
      reasoning: "MODEL PICK: DEN (LOW confidence, COIN FLIP). DEN won G5 125-113 at Ball Arena and now travels to Target Center for G6 with momentum and confidence restored. The CRITICAL factor: MIN is WITHOUT Anthony Edwards (hyperextended knee, OUT until May 9) AND Donte DiVincenzo (ruptured Achilles, season-ending). MIN is missing their #1 and #4 scorers.\n\nJokic's G5 triple-double (27/12/16ast — 3rd all-time for career playoff TDs) showed the 2023 championship version of Jokic has arrived. Spencer Jones' 20pts (4-5 3PT) in G5 was a Star Absence Liberation breakout — Gordon's absence created opportunity. Murray's 24pts was efficient. DEN's 57% FG in G5 was dominant.\n\nMIN's G5 was a disaster: 25 turnovers (9 in Q1 alone), Gobert neutralized (1 basket with 20sec left in Q3, DEN up 25). Randle led with 27pts but couldn't stem the tide. Dosunmu dropped from 43pts G4 to 18pts G5 — DEN adjusted to his breakout. McDaniels was in foul trouble and heckled by crowd after G4 incident.\n\nHowever, this is at Target Center where MIN won G3 (113-96) and G4 (112-96) by an average of 16.5 points. Even without Edwards, MIN's home court advantage is massive — DEN shot 34% and 25% 3PT in G3 at Target Center. Conley (17pts G5) has stepped up as a veteran stabilizer. Randle (27pts G5) is becoming MIN's alpha. Hyland provided 15pts off bench.\n\nThe model leans DEN because Edwards/DiVincenzo absences are catastrophic for MIN's ceiling, Jokic is playing at MVP level, and G5's 25 MIN turnovers suggest structural ball security issues without their primary creators. But MIN's home court drops DEN's projected advantage to a coin flip margin.",
      g5Adjustments: [
        "DEN WON G5 125-113: Avoided elimination behind Jokic 27/12/16ast triple-double. DEN shot 57% FG.",
        "EDWARDS OUT (KNEE): Hyperextended right knee. CBS Sports est. return May 9. OUT for remainder of R1.",
        "DIVINCENZO OUT (ACHILLES): Season-ending ruptured Achilles surgery. MIN missing #1 and #4 scorers.",
        "SPENCER JONES BREAKOUT: 20pts (7-9 FG, 4-5 3PT) — had only 11pts total in G1-G4. Star Absence Liberation with Gordon out.",
        "MIN 25 TURNOVERS: 9 in Q1 alone. Without Edwards and DiVincenzo, ball security collapsed.",
        "DOSUNMU REGRESSION: 18pts G5 (down from historic 43pts G4). DEN adjusted to his breakout.",
        "GOBERT NEUTRALIZED: 1 basket with 20sec left in Q3, DEN up 25. Jokic dominated him.",
        "CONLEY STEPPED UP: 17pts/4ast. Veteran stabilizer role becomes critical without Edwards.",
        "SERIES RETURNS TO TARGET CENTER: MIN won G3 by 17 and G4 by 16 at home — massive HCA.",
        "GORDON STILL OUT: Calf injury. Watson still out (hamstring). But DEN found depth (Jones, Braun 19pts)."
      ],
      prosHome: ["Jokic MVP-level: 27/12/16ast G5 — 23rd career playoff triple-double, 3rd all-time", "DEN shot 57% FG in G5 — offensive rhythm fully restored", "Murray 24pts efficient — Jokic-Murray duo is clicking simultaneously again", "Spencer Jones 20pts breakout provides unexpected depth scoring", "Momentum: won G5 by 12, led by 27 at peak — commanding performance", "MIN 25 TOs in G5 — ball security issues compound without Edwards/DiVincenzo"],
      consHome: ["Target Center is MIN's fortress: won G3 by 17, G4 by 16 at home", "DEN shot 34% FG and 25% 3PT in G3 at Target Center — altitude-free environment disrupts", "Gordon STILL OUT (calf) + Watson OUT (hamstring) — DEN also depleted", "Jones' 20pts is likely a one-game outlier (11pts total in G1-G4)", "DEN could rest easy with 3-2 lead in hand and ease off"],
      prosAway: ["HOME COURT: Won G3 by 17 and G4 by 16 at Target Center — dominant home record", "Randle 27pts G5 — becoming MIN's new alpha scorer without Edwards", "Conley 17pts/4ast — veteran playmaker provides stability", "Hyland 15pts spark off bench — can be microwave scorer at home", "Desperation factor: facing elimination at home generates maximum crowd energy", "McDaniels defensive versatility still available — can guard anyone"],
      consAway: ["Edwards OUT: Missing 28.8 PPG scorer, primary creator, and defensive engine", "DiVincenzo OUT: Missing starting PG and floor spacer (.379 3PT)", "25 TURNOVERS in G5 — without primary ball-handlers, MIN can't protect possession", "Dosunmu regressed from 43pts to 18pts — DEN adjusted and his ceiling game is gone", "Gobert neutralized in G5 — Jokic has solved him when MIN can't generate help-side pressure"]
    },
    game5: {
      spread: "DEN -1.5", moneyline: "DEN -125 / MIN +105", ou: "O/U 219.5",
      pick: "MIN", confidence: "low", projScore: "MIN 112 — DEN 110",
      schedule: "Sun Apr 27 — 10:30 PM ET — NBC/Peacock",
      reasoning: "MODEL PICK: MIN (LOW confidence, COIN FLIP). MIN takes a 3-1 lead to Denver for G5, but faces catastrophic injury losses: Edwards (hyperextended knee, OUT) AND DiVincenzo (ruptured Achilles, season-ending). MIN won G4 112-96 without BOTH stars behind Dosunmu's historic 43pts — but replicating that performance is statistically near-impossible. DEN's home court in Ball Arena with altitude advantage should reassert itself. Jokic historically responds after a loss and ejection. DEN's championship DNA means they won't go quietly. Manual pick was MIN based on 3-1 series lead momentum, but engine picked DEN +1 which proved correct (DEN won 125-113).",
      g4Adjustments: [
        "MIN WON G4 112-96: WITHOUT Edwards and DiVincenzo. Dosunmu 43pts historic performance.",
        "EDWARDS OUT: Hyperextended knee from G4 warmups. OUT for G5+.",
        "DIVINCENZO OUT: Ruptured Achilles. Season-ending surgery. Devastating loss.",
        "JOKIC EJECTED G4: Confronted McDaniels after meaningless layup — psychological breaking point.",
        "DEN 6-27 3PT (22.2%): Shooting collapse continued. But home court should help regression.",
        "DOSUNMU 43pts: Historic — highest-scoring playoff reserve in 50 years. Unrepeatable performance."
      ],
      prosHome: ["Ball Arena altitude advantage — DEN's biggest environmental edge", "Jokic bounce-back after ejection — championship players respond to embarrassment", "DEN's 3PT shooting (22.2% G4) will regress hard toward 39.6% baseline at home", "Desperation: facing 0-4 sweep would be humiliating for 2023 champions"],
      consHome: ["Jokic-Murray combined 6-24 in H2 of G4 — duo struggling simultaneously", "Gordon still OUT (calf), Watson OUT (hamstring) — DEN also depleted", "MIN won G4 by 16 WITHOUT both stars — depth is proven"],
      prosAway: ["3-1 series lead — need one more win to advance", "Dosunmu proved he can carry (43pts G4)", "McDaniels/Randle/Gobert trio still formidable defensively", "Conley veteran steadiness in closeout situations"],
      consAway: ["Edwards OUT — losing 28.8 PPG scorer", "DiVincenzo OUT — losing starting PG and floor spacer", "Dosunmu's 43pts is statistically unrepeatable", "Road game at altitude — physical toll is real"]
    },
    game4: {
      spread: "MIN -4.5", moneyline: "MIN -195 / DEN +165", ou: "O/U 216.5",
      pick: "MIN", confidence: "medium", projScore: "MIN 110 — DEN 103",
      schedule: "Mon Apr 27 — 10:30 PM ET — NBC/Peacock",
      reasoning: "PHASE 30 PICK: MIN (MEDIUM confidence, COMPETITIVE). The model flips from DEN to MIN for G4 after Denver's historically poor 34%/25% shooting in G3. At Target Center for a second consecutive home game, Minnesota has structural advantages that Denver cannot overcome with star power alone. (1) DEN'S SHOOTING FLOOR COLLAPSED — 34% FG and 25% from 3 in G3 are catastrophic numbers. Jokic's 7-26 (26.9%) was his worst playoff shooting game in 5 years. Murray went 0-5 from 3. Even with regression toward the mean, DEN's rhythm is broken. (2) DOSUNMU BREAKOUT CONFIRMATION — 25pts/9ast (10-15 FG) in G3. Phase 29 flags him as a sustained breakout at age 23. His ability to orchestrate MIN's bench units while scoring efficiently transforms the series. (3) MCDANIELS TWO-WAY DOMINANCE — 20pts/10reb (9-13 FG) in G3. His defensive versatility (can guard Jokic in switches, contest Murray's jumpers, protect the rim) combined with 69% FG is elite. (4) TARGET CENTER HCA — DEN shot 34%/25% without altitude advantage. MIN's crowd generates genuine disruption. (5) GOBERT DEFENSIVE ANCHOR — 12reb/3blk in G3, held DEN to 34% shooting. When Gobert stays out of foul trouble, MIN's defense is elite.\n\nEdwards was limited to 24min/17pts due to 5 fouls — MIN won by 17 WITHOUT their best player at full capacity. That's a devastating signal for DEN. Even if Edwards is again foul-limited, MIN has enough depth (Dosunmu, McDaniels, DiVincenzo) to win. DEN needs Jokic and Murray to simultaneously play at peak levels — G3 showed that's not guaranteed even in must-win situations.\n\nRISK: DEN's championship DNA (2023 title) means Jokic/Murray can elevate. Jokic historically responds after poor games. Murray's 30pts in G2 showed his ceiling. Aaron Gordon's calf is a concern (Day-to-Day) and Watson remains out (hamstring). But even with a Jokic bounce-back, DEN needs their role players (Braun 0-4, Johnson 2-6) to contribute, and MIN's defense makes that difficult.",
      g3Adjustments: [
        "DEN SHOOTING CATASTROPHE: 34% FG, 25% from 3. Worst shooting game of the series by a wide margin. Jokic 7-26 (26.9%), Murray 5-17 (0-5 3PT). Altitude-free environment crushed DEN's rhythm.",
        "DOSUNMU BREAKOUT: 25pts/9ast (10-15 FG). Phase 29 youth breakout at age 23 — now the model's top bench player in the series. His playmaking transforms MIN's second unit.",
        "MCDANIELS ELITE: 20pts/10reb (9-13 FG, 69.2%). Two-way monster. His defensive versatility and offensive efficiency make him MIN's most important non-Edwards player.",
        "EDWARDS FOUL TROUBLE: 5 fouls, 24min, 17pts. MIN WON BY 17 WITHOUT EDWARDS AT FULL CAPACITY. This is the most damning signal for DEN — MIN doesn't need Edwards to dominate at home.",
        "GORDON CALF CONCERN: Day-to-day with left calf tightness. If Gordon misses G4, DEN loses their best wing defender and transition scorer. Watson already out (hamstring).",
        "GOBERT DOMINATED: 12reb/3blk, anchored defense. When he avoids foul trouble (only 4 fouls G3 vs 5 in G2), MIN's DRtg is elite.",
        "BRAUN DISAPPEARED: 0-4 FG, 2pts in 24min. DEN's starting wing is a non-factor offensively.",
        "DIVINCENZO ORCHESTRATING: 15pts/7ast/4stl in G3. His promotion to starter over Conley has been validated — he's MIN's best perimeter playmaker."
      ],
      prosHome: ["Jokic historically bounces back after bad games — 7-26 is a floor, not a trend", "Murray's 30pts in G2 proves his ceiling remains elite", "DEN's 3PT shooting (25%) WILL regress up significantly — 39.6% season average", "Championship DNA: DEN won title in 2023 — Jokic/Murray know how to respond in elimination-adjacent games"],
      consHome: ["Jokic and Murray both shot poorly simultaneously — rare but devastating for DEN", "Gordon Day-to-Day (calf) + Watson out (hamstring) = missing 2 key rotation players", "Braun's 0-4 FG makes DEN's starting wing a defensive liability NYK can exploit", "DEN's bench (outside Hardaway/Nnaji) offers no creation — they're a Jokic-or-bust team on the road"],
      prosAway: ["MIN won G3 by 17 with Edwards in foul trouble (24min) — staggering depth signal", "Dosunmu 25pts/9ast breakout — Phase 29 sustained, adds a new offensive weapon", "McDaniels 20pts/10reb on 69% FG — two-way dominance is repeatable given his defensive role", "Target Center HCA — DEN shot 34%/25% without altitude. HOME crowd disrupts DEN's offensive flow", "Gobert defensive anchor: 12reb/3blk, held DEN to 34% — when he avoids fouls, MIN's D is elite"],
      consAway: ["Edwards' foul trouble is a recurring risk — 5 fouls G3, and refs may continue tight whistle", "Dosunmu's 10-15 FG (66.7%) is unsustainable efficiency — expect regression to ~48-52%", "MIN's 26% from 3 in G3 — they won despite poor perimeter shooting, but that's not reliable", "DEN's desperation factor — facing 1-3 deficit motivates Jokic/Murray to peak performances"]
    },
    modelLessons: [
      {type: "missed", lesson: "G3: Model picked DEN by 2 (low), MIN won by 17. Correctly identified this as a coin flip but picked the wrong side by a massive margin. Edwards' 5 fouls limited him to 24min but MIN won ANYWAY — Dosunmu's 25/9 breakout and McDaniels' 20/10 were not in the model."},
      {type: "underweighted", lesson: "MIN's home court advantage was dramatically undervalued. DEN shot 34%/25% — the altitude-free environment and Target Center crowd completely disrupted DEN's shooting rhythm."},
      {type: "overweighted", lesson: "Jokic's 'playoff bounce-back after a loss' narrative was wrong — he went 7-26 FG (26.9%). Championship DNA didn't prevent a historically bad shooting night."},
      {type: "missed", lesson: "Dosunmu's emergence as a legitimate 2nd-unit star (25pts/9ast) was not modeled. His Phase 29 youth breakout qualification should have been flagged more aggressively."},
      {type: "correct", lesson: "G4: Model picked MIN (MEDIUM). MIN won 112-96. Dosunmu HISTORIC 43pts (13-17 FG, 5-5 3PT, 12-12 FT) — highest-scoring playoff reserve in 50 years. MIN won WITHOUT Edwards AND DiVincenzo. Model was correct on winner but completely missed the magnitude (projected +7, actual +16)."},
      {type: "missed", lesson: "G4: Dosunmu's 43pts was completely unforeseeable. No model can predict a 6th man scoring 43pts. However, the model should have flagged his G3 breakout (25pts) as a persistent trend rather than mean-reverting. Youth breakout momentum persists."},
      {type: "missed", lesson: "G4: Jokic ejection for confronting McDaniels exposed psychological fragility under pressure. Model treats Jokic as purely rational — needs an emotional composure factor for extended series frustration."},
      {type: "correct", lesson: "G5: Engine picked DEN +1 — CORRECT winner (DEN won 125-113, actual +12). Manual picked MIN — WRONG. Lesson: trust engine's talent assessment over narrative (3-1 momentum). Without Edwards AND DiVincenzo, MIN's talent floor drops below DEN's ceiling."},
      {type: "underweighted", lesson: "G5: Spencer Jones 20pts (4-5 3PT) — Star Absence Liberation with Gordon OUT. Had only 11pts total in G1-G4. Model has no mechanism for role player liberation when stars are absent."},
      {type: "overweighted", lesson: "G5: MIN's 3-1 series lead momentum was meaningless once Edwards went down. The model should discount series lead momentum proportionally to star player availability. A 3-1 lead without your best player is structurally different from a 3-1 lead at full strength."},
      {type: "missed", lesson: "G5: MIN 25 turnovers — catastrophic. Without Edwards and DiVincenzo as primary ball-handlers, MIN had no one to protect possession. Conley (17pts/4ast) and Dosunmu (18pts) tried but couldn't replicate Edwards' ball security under pressure."},
      {type: "missed", lesson: "G6: MIN 110-98. Model predicted DEN 114-110 (LOW confidence) — WRONG. MIN closed out series 4-2. McDaniels 32pts/10reb double-double was the series-clinching performance — backed up his trash talk with action. Model underestimated MIN's ability to close without Edwards/DiVincenzo by relying on McDaniels, Shannon Jr (24pts), and dominant rebounding (50-33, 19 OREB)."},
      {type: "missed", lesson: "G6: Murray's 4-17 shooting (-18) in an elimination game was catastrophic. Model's Jokic-Murray duo thesis assumes Murray shows up in big games, but he shot 4-17 in the most important game of the series. The model needs a Murray playoff inconsistency factor — his variance is much wider than his rating suggests."},
      {type: "underweighted", lesson: "G6: MIN's rebounding dominance (50-33, 19 OREB) was the game's decisive factor. Gobert (13reb, 8ast, 2blk) anchored the paint while McDaniels and Shannon Jr crashed the glass aggressively. The model underweights offensive rebounding's cumulative impact — 19 OREB creates ~12-15 extra possessions."},
      {type: "overweighted", lesson: "G6: Model picked DEN based on Jokic's elimination-game track record and home-court advantage in DEN's favor (Target Center is MIN home, but model overvalued Jokic's individual brilliance). Jokic had 28/9/10 but was -9 — good individual stats in a losing effort. LESSON: Jokic's individual production doesn't override team-wide failures (Murray 4-17, 13 team TOs)."},
      {type: "correct", lesson: "G6: Model's LOW confidence was appropriate — the pick was wrong but the uncertainty was correctly calibrated. A 50-50 game that the model leaned DEN on is an acceptable miss. The model should NOT have picked DEN at all given MIN's home court and DEN's Murray unreliability, but the low confidence reflected genuine uncertainty."}
    ],
    coaching: {
      home: {
        coach: "David Adelman",
    ...
    games: [{num:1,result:"DEN",homeScore:116,awayScore:105,winner:"DEN",notes:"DEN 116-105. Murray 30pts (historic 16/16 FT), Jokic 25/13/11 (22nd playoff triple-double — slow start w/ 3pts in Q1, then dominated). DEN dominated middle quarters outscoring MIN 68-46 with a 14-0 run. Edwards 22/9/7/3blk (7-of-19 FG — knee limiting efficiency, not availability), Gobert 17pts (8/9 FG), Randle 16pts. MIN led 33-23 after Q1, cut to 97-95 in Q4 but couldn't sustain. WPA: MVP Gobert +15.0%, LVP Edwards -8.2%. FT was the biggest factor (+23.1% WPA for DEN — Murray's 16/16), Rebounds +13.7%, TOV +7.2%."},{num:2,result:"MIN",homeScore:114,awayScore:119,winner:"MIN",notes:"MIN 119-114. Series tied 1-1. MIN completed 19-point comeback on road in Denver. Edwards 30pts/10reb double-double (10-25 FG, 3-11 3PT, 7-9 FT), +20. Randle bounce-back 24pts/9reb/6ast (7-14 FG). DiVincenzo 16/7reb/6ast (4-7 3PT). Murray 30pts (11-25, 6-14 3PT) 7reb/7ast but 4TO and -4. Jokic 24/15reb/8ast (8-20, 1-7 3PT) — quiet Q1 (2pts), exploded Q3 (12pts in 3min), collapsed Q4 (2-12 combined with Murray). DEN led 39-25 after Q1, MIN stormed back 39-25 in Q2 to tie 64-64 at half (Murray midcourt buzzer-beater). MIN won Q4 29-21 to close it out. Hardaway 16pts off bench (3-3 3PT). Hyland 13pts in 10min (3-4 3PT) sparked MIN bench. MIN: 48% FG, 41% 3PT. DEN: 44% FG, 37% 3PT. MIN won rebounding 49-43. Physical game — Gobert/Valanciunas altercation, Gobert 5 fouls."},{num:3,result:"MIN",homeScore:96,awayScore:113,winner:"MIN",notes:"MIN 113-96. MIN leads 2-1. DOMINANT defense — held DEN to 11pts in Q1 (franchise playoff record). McDaniels 20/10 backed up 'bad defenders' trash talk. Dosunmu 25/9ast off bench. DiVincenzo 15/4stl. Gobert 10/12/3blk stifled Jokic (7-26 FG, 26.9%). Murray 16 (5-17). Gordon OUT (calf). MIN 68-34 paint advantage. Built 27pt Q3 lead. DEN 30% 3PT for series. Model picked DEN +2 — WRONG by 19pts."},{num:4,result:"MIN",homeScore:96,awayScore:112,winner:"MIN",notes:"MIN 112-96. MIN leads 3-1. DOSUNMU 43pts HISTORIC — career-high, highest-scoring playoff reserve in 50 years (since Fred Brown 45pts 1976). 13-17 FG, 5-5 3PT, 12-12 FT in 42min. Edwards AND DiVincenzo both OUT (leg injuries) — MIN won by 16 WITHOUT both. Murray 30pts but Jokic-Murray 6-24 H2. DEN 6-27 3PT (22.2%). Jokic ejected for confronting McDaniels after meaningless layup — psychological collapse. Gordon still OUT. MIN can close out G5 at Denver. Model picked MIN — CORRECT. Engine picked DEN by 1 — WRONG (still overvalues Jokic rating)."},{num:5,result:"DEN",homeScore:125,awayScore:113,winner:"DEN",notes:"DEN 125-113. MIN leads 3-2. DEN avoids elimination. Jokic triple-double 27/16ast/12reb (23rd career playoff TD, 3rd all-time) — snapped out of his funk. Murray 24pts. Spencer Jones 20pts (had 11 total in G1-G4) — Star Absence Liberation with Gordon OUT (calf). MIN without Edwards (hyperextended knee) AND DiVincenzo (ruptured Achilles, season-ending surgery). MIN 25 turnovers (9 in Q1). Dosunmu 18pts (down from 43 G4). Gobert neutralized — 1 basket with 20sec left in Q3, DEN up 25. Randle 27pts led MIN. McDaniels 13pts in foul trouble, razzed by crowd after G4 incident. DEN led by 27 at peak. Engine picked DEN +1 — CORRECT winner (actual +12). Manual picked MIN — WRONG."},{num:6,result:"MIN",homeScore:98,awayScore:110,winner:"MIN",notes:"MIN 110-98 at Target Center. MIN WINS SERIES 4-2. Q scores: DEN 30-20-24-24, MIN 29-28-25-28. MIN shot 46% FG, 24% 3PT, 71% FT. DEN shot 45% FG, 37% 3PT, 80% FT. MIN dominated boards 50-33 (19 OREB). MIN 7 TOs vs DEN 13. MIN: McDaniels 32pts (13-25 FG, 1-4 3PT, 5-6 FT, 10reb, 3ast, +16) — backed up trash talk with series-best performance. Shannon Jr 24pts (9-20, 1-7 3PT, 5-5 FT, 6reb, +7). Randle 18pts (6-17, 2-5 3PT, 4-6 FT, 4reb, 5ast, 4TO, +15). Reid 15pts (7-13, 1-3 3PT, 7reb, 4ast, +11). Gobert 10pts (4-6 FG, 2-4 FT, 13reb, 8ast, 2blk, +11). Conley 7pts (3-7, 6reb, -1). DEN: Jokic 28pts (11-19, 1-5 3PT, 5-6 FT, 9reb, 10ast, 4TO, -9). C.Johnson 27pts (8-15, 5-10 3PT, 6-9 FT, 8reb, -3). Hardaway 13pts (4-7, -5). Murray 12pts (4-17, 0-2 3PT, 4-4 FT, 6reb, -18) — horrific shooting in closeout game. Dosunmu DNP (sore right calf). Model predicted DEN 114-110 (LOW confidence) — WRONG. MIN won behind McDaniels' 32/10 double-double and dominant rebounding (50-33)."},{num:7,result:null,homeScore:null,awayScore:null,winner:null,notes:""}]
  },
  {
    ...
    modelLessons: [
      ...
      {type: "correct", lesson: "G3: Wemby cleared concussion protocol and SAS won 120-108 at POR. Harper breakout (27pts/10reb off bench) added unexpected depth. SAS leads 2-1."},
      {type: "correct", lesson: "G4: SAS 114-93 — dominant 2H blowout (73-35). Wemby monster line: 27/12/4stl/7blk. Fox 28/7ast. Avdija fouled out attempting to contain Wemby. SAS takes commanding 3-1 lead."},
      {type: "missed", lesson: "G4: Henderson went 0-7 FG (0pts in 27min). POR's second-best player was a complete non-factor. The model assumed Henderson's G2 breakout (31pts) would sustain — instead he cratered."},
      {type: "underweighted", lesson: "Wemby's two-way impact is game-breaking: 7 blocks in G4 is historic. His shot-blocking + 3PT shooting combination has no historical comparison. Model's rating system can't capture this unicorn impact."},
      {type: "correct", lesson: "G5: SAS 114-95. MODEL CORRECT — predicted SAS 116-99, off by only 2 and 4pts respectively. Wemby 17/14/6blk (first since Ewing 1994 with consecutive double-double + 6blk). Fox closed: 13pts in Q4. Champagnie 19pts (5-7 3PT). SAS never trailed, led by 28. POR shot 23% from 3. Series 4-1. The model's HIGH confidence closeout prediction was perfectly calibrated."},
      {type: "correct", lesson: "G5: Henderson's youth breakout was a ONE-GAME SPIKE — 31pts G2, then invisible rest of series (5pts G5). Youth breakout persistence is NOT guaranteed; it depends on scheme and opponent adjustment. SAS schemed Henderson out after G2."},
      {type: "correct", lesson: "G5: SAS 3PT correlation validated: team shot 40% from 3 as Champagnie (5-7) led a collective hot shooting night. When Wemby's gravity pulls defenders in, role players shoot open 3s at high rates. SAS advances to R2 for first time since 2017."}
    ],
    game2: {
    ...
    game5: {
      spread: "SAS -11.5", moneyline: "SAS -550 / POR +400", ou: "O/U 214.5",
      pick: "SAS", confidence: "high", projScore: "SAS 116 — POR 99",
      schedule: "Tue Apr 28 — 9:30 PM ET — ESPN",
      reasoning: "MODEL PICK: SAS (HIGH confidence, SEPARATION). SAS returns home to close out after dominant G4 (114-93, 2H blowout 73-35). Wembanyama's G4 was historic: 27pts/12reb/4stl/7blk — a stat line that has no modern comparison. Fox added 28pts/7ast. POR's best player Avdija fouled out in G4 and Henderson went 0-7 FG. At Frost Bank Center where SAS won G1 111-98, the crowd and Wemby's dominance should close this series. POR's only win was G2 when Wemby exited with a concussion — with him healthy, SAS is a different caliber. SAS has too much talent, depth (Harper 27pts G3, Castle 16pts G4), and defensive versatility (10 blocks in G4). POR would need historic shooting and multiple SAS key players to struggle simultaneously to extend this series.",
      g4Adjustments: [
        "WEMBY MONSTER G4: 27/12/4stl/7blk (9-17 FG, 8-8 FT). Historic two-way performance. POR has no answer.",
        "FOX ELITE: 28pts/7ast (11-17 FG). Secondary star playing at peak efficiency.",
        "SAS 2H DOMINATION: 73-35 in 2H of G4. POR collapsed completely after competitive 1H.",
        "AVDIJA FOULED OUT: 26pts but 6pf means he was battling fouls all game. At SAS, refs may be even less favorable.",
        "HENDERSON 0-7 FG: After 31pt G2 breakout, has been invisible in G3 (didn't stand out) and G4 (0pts).",
        "SAS 10 BLOCKS G4: Rim protection completely eliminated POR's interior offense.",
        "HOME COURT FOR CLOSEOUT: Frost Bank Center, where SAS won G1 by 13. Crowd energy for potential series clincher."
      ],
      prosHome: ["Wemby's two-way dominance is historically unprecedented — 27/12/4stl/7blk", "Fox as elite secondary scorer: 28/7ast in G4 on 65% FG", "HOME for closeout at Frost Bank Center where they won G1 by 13", "SAS depth: Harper 27pts G3, Castle 16pts G4, K. Johnson 9pts — multiple contributors", "10 blocks in G4 — SAS rim protection eliminates POR's interior game"],
      consHome: ["Wemby's concussion history (G2) creates injury anxiety — one bad fall changes everything", "POR won G2 — they CAN beat SAS when things break right", "Closeout games historically see desperate opponent performance", "SAS young core hasn't closed out a series before — pressure could be a factor"],
      prosAway: ["Avdija is a legitimate star: 26pts G4, 30pts G1 — individual talent can steal a game", "Desperation: facing elimination often produces best effort games", "Holiday playoff experience (2021 champion) provides veteran leadership", "G2 proved POR can win when SAS has a key player issue"],
      consAway: ["Henderson 0-7 FG in G4 after 31pt G2 — completely unreliable", "Avdija fouled out G4 — foul trouble is a recurring problem", "POR shot 40% FG and had 18 TOs in G4 — structural offensive issues", "ROAD game where SAS crowd will be electric for potential clincher", "Clingan limited to 14min — POR's young center can't handle playoff intensity"]
    },
    game4: {
      spread: "SAS -3.5", moneyline: "SAS -160 / POR +135", ou: "O/U 218.5",
      pick: "SAS", confidence: "medium", projScore: "SAS 109 — POR 105",
      schedule: "Sun Apr 26 — 3:30 PM ET — NBC/Peacock",
      reasoning: "PHASE 35 PICK: SAS (MEDIUM confidence). SAS won G3 120-108 on the road WITHOUT Wemby (concussion) — proving their depth is elite. Castle (33pts career-high) and Harper (27/10) stepped up massively. Wemby's return status for G4 is the biggest variable: if he's cleared from concussion protocol, SAS becomes overwhelming favorites. Even without him, SAS's 21-5 comeback from 15 down showed elite resilience. POR's second-half fade (65pts H1, 43pts H2) is a youth vulnerability that compounds in G4. Holiday's 29pts wasn't enough when POR's supporting cast collapsed in Q3-Q4.",
      g3Adjustments: [
        "G3: SAS 120-108. SAS leads 2-1. SAS WON WITHOUT WEMBY — Castle 33pts, Harper 27/10, Kornet 14/10.",
        "WEMBY STATUS: Concussion protocol. Watching from bench G3. Return for G4 possible if neurologist clears.",
        "SAS 21-5 RUN from down 15 in Q3 — elite team resilience. POR collapsed in second half (65pts H1, 43pts H2).",
        "YOUTH FATIGUE: POR's young core (Henderson, Sharpe, Clingan) can't sustain playoff intensity for 48 minutes.",
        "Star Absence ≠ Pure Subtraction: Castle/Harper ELEVATED without Wemby — secondary players liberated by more touches."
      ],
      prosHome: ["SAS won G3 road WITHOUT Wemby — depth advantage is proven and structural", "Castle 33pts + Harper 27/10 = elite young core that elevates under pressure", "If Wemby returns, SAS becomes overwhelming favorites with extra firepower", "POR's second-half fade (65→43pts) is a repeatable youth vulnerability"],
      consHome: ["At Moda Center — POR's home crowd creates strong first-half energy", "Holiday (29pts G3) is an elite performer who doesn't fade", "Wemby may still be OUT — concussion protocols are unpredictable", "POR desperation facing 1-3 if they lose creates emotional intensity"],
      prosAway: ["HOME COURT for second straight game — Moda Center crowd", "Holiday is an elite two-way player who delivers consistently", "POR led by 15 in G3 before collapsing — the offensive potential is real", "Henderson's youth breakout potential (31pts G2) could re-emerge at home"],
      consAway: ["Second-half fatigue CONFIRMED — POR scored only 43pts in H2 of G3", "SAS depth proved it doesn't need Wemby to win — Castle/Harper/Fox/Vassell is enough", "If Wemby returns, POR has no answer for his rim protection + scoring", "SAS's 21-5 comeback run shows resilience POR can't match"]
    },
    coaching: {
      home: {
        coach: "Mitch Johnson",
  ...
  },
  {
    ...
    awayTeam: {
      ...
      players: [
        ...
        { name:"Franz Wagner", pos:"SF", rating:60, ppg:20.6, rpg:5.2, apg:3.3, fgp:48.1, per:18.4, ts:57.2, epm:2.2, bpm:2.0, ws48:.128, onOff:3.5, clutch:5.5, vorp:2.4, usg:26.2, injury:"GTD — right calf strain (uncertain for G5 per ESPN)", lebron:2.297, oLebron:1.688, dLebron:0.608, war:3.031, offRole:"Shot Creator", defRole:"Wing Stopper",
          matchupNote:"G4: 19pts/5reb/4stl in 24min before exiting Q3 with right calf strain. ESPN: uncertain for G5, return depends on treatment response. Had 19pts G1 (Q4 closer), 12pts G2, 17pts G3. If OUT for G5, ORL loses their clutch secondary scorer — da Silva/Black would absorb minutes but massive production gap. Rating downgraded to 60 reflecting uncertainty.", baseRating:75, starCeiling:1, injuryRisk:0.8, activeInjury:{type:"right calf strain",severity:0.6,note:"Apr 27: Left G4 Q3 with right calf strain. ESPN sources say uncertain for G5, depends on treatment response. 19pts in 24min before exiting. If OUT, ORL's offense loses its second creator. GTD for Apr 29."} },
    ...
    externalFactors: [
      ...
      { team:"DET", player:"Kevin Huerter", desc:"ADDUCTOR — Questionable for G5. Key perimeter shooter — his absence would thin DET's already limited shooting. Game-time decision.", impact:-2, category:"injury",
        evidence:"CBS Sports (Apr 29): Huerter listed questionable with adductor injury for G5. DET needs every shooter available facing elimination. If OUT, bench scoring options shrink further.",
        sources:["CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" },
      { team:"ORL", player:"Franz Wagner", desc:"CALF — Questionable for G5. Wagner is ORL's 2nd-best player and primary ball-handler. If limited or OUT, ORL's closeout ability is significantly impacted despite 3-1 lead.", impact:-4, category:"injury",
        evidence:"CBS Sports (Apr 29): Wagner listed questionable with calf injury for G5. Has been battling through calf tightness — the concern is aggravation in a game that could clinch the series. ORL may manage his minutes even if available.",
        sources:["CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" },
      { team:"ORL", player:"Jonathan Isaac", desc:"KNEE — Questionable for G5. Chronic knee issues have limited Isaac throughout his career. His defensive versatility off the bench would help in a closeout game.", impact:-1, category:"injury",
        evidence:"CBS Sports (Apr 29): Isaac listed questionable with knee injury. His switchable 6'10 defense adds a dimension off the bench, but ORL has managed without his full availability all series.",
        sources:["CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" }
    ],
    game1: {
    ...
    game3: {
      spread: "DET -2.5", moneyline: "DET -148 / ORL +124", ou: "O/U 213.5",
      pick: "DET", confidence: "medium", projScore: "DET 107 — ORL 101",
      schedule: "Sat Apr 25 — 1:00 PM ET — Peacock/NBCSN",
      reasoning: "PHASE 34 PICK: DET (MEDIUM confidence, COMPETITIVE). G2's 98-83 blowout was a STATEMENT. DET's #1 defense (107.2 DRtg) fully asserted itself — ORL shot 33% (season low) and scored just 16 in Q3. Cade's evolution from scorer (39pts G1) to distributor (27pts/11ast G2) is the key model learning: he can win BOTH ways.\n\nWHY DET ON THE ROAD: (1) MOMENTUM — DET ended the longest home playoff losing streak in NBA history. That psychological breakthrough carries forward. (2) CADE'S DUAL MODE — G1 proved he can score 39, G2 proved he can distribute for 11ast. Mosley can't scheme for both. (3) SUPPORTING CAST UNLOCKED — 6 players in double figures in G2 (Harris 16, Duren 11, Ausar 11, Robinson 10, Stewart 10). The single-initiator problem from G1 was coaching, not talent. (4) WCJ FOUL TROUBLE — WCJ fouled out in G2 (6PF, 3pts, 1-6). Bickerstaff found the counter to Mosley's Duren-neutralizing scheme: attack WCJ directly.\n\nWHY MEDIUM (not HIGH): (1) ROAD GAME — first road games for this DET core. Kia Center crowd will be electric. (2) ORL has home court and 2 days to adjust. (3) Mosley is a great coach (adj 7) — he'll have answers. (4) Banchero at home with crowd energy could unlock 25+ pts. (5) ORL's multi-initiator attack is structural, not variance — bad shooting nights happen but the system is sound.\n\nMODEL EDGE: DET's defense travels (schematic, not home-court dependent). Cade's dual-mode offense gives DET scheme flexibility ORL can't match with a single defensive approach. Market agrees: DET -2.5 as road favorite.",
      g2Adjustments: [
        "G2 RESULT: DET 98-83 BLOWOUT. Series tied 1-1. DET ended NBA's longest home playoff losing streak.",
        "CADE EVOLUTION: 39pts G1 → 27pts/11ast G2. Pivoted from scoring to distributing. Model must account for DUAL-MODE star capability.",
        "BICKERSTAFF ADJUSTMENT: COTY earned it — abandoned panic lineups, got 6 players in double figures. Duren freed via passing (4ast).",
        "WCJ VULNERABILITY EXPOSED: Fouled out (6PF, 3pts, 1-6 FG, 24min). Mosley's G1 hero became G2 liability. Foul trouble is REPEATABLE.",
        "ORL SHOOTING COLLAPSE: 33% FG (season low). Bane 2-11 (18.2%), Wagner 0-2 3PT, WCJ 1-6. Q3 was 38-16 DET.",
        "STEWART EMERGENCE: 4-4 FG (100%), 10pts off bench. DET bench is deeper than G1 suggested.",
        "SERIES SHIFTS TO ORLANDO: First road games for DET young core. Kia Center crowd = new variable.",
        "BANCHERO CONTAINED: 18pts on 7-17 (41.2%), 0-2 3PT, 4 TOs. DET's defense suppressed his efficiency."
      ],
      prosHome: ["DET #1 defense PROVEN across 2 games — held ORL to 33% G2 (season low), 38-16 Q3 dominance", "Cade DUAL-MODE: 39pts G1 + 27/11ast G2 = unguardable. Mosley can't scheme for both scoring and distributing", "6 in double figures G2 — single-initiator problem SOLVED. Harris 16/11reb, Duren 11/9reb, Stewart 10 (4-4)", "WCJ foul trouble is REPEATABLE — Bickerstaff found the counter to Mosley's Duren-neutralizing scheme", "Momentum: ended NBA's longest home playoff losing streak. Psychological breakthrough for young core", "Market favors DET (-2.5) as road favorite — sharp money confirms model edge"],
      consHome: ["FIRST ROAD GAME for DET's young core — Kia Center crowd is an unknown variable", "ORL has 2 full rest days to make adjustments — Mosley (adj 7) is a quality coach", "DET had 22 turnovers in G2 — if ORL's steals (16) repeat on their home court, DET could struggle", "Cade's 7 turnovers G2 may worsen with road crowd noise disrupting secondary reads", "G2 may have been a shooting outlier for ORL (33% is historically low) — regression toward ~42% likely"],
      prosAway: ["HOME COURT — Kia Center, first home game of the series. Electric crowd energy for ORL", "Banchero YOUTH BREAKOUT (age 23, Phase 29 active): Home game + adversity from G2 loss could produce 25+ pts", "Mosley has 2 days of film — his G1 game plan was A+ rated. He'll adjust to Cade's distribution mode", "Multi-initiator advantage (3 creators vs Cade's dual-mode) creates scheme versatility", "ORL's 33% FG G2 is unsustainably low — shooting regression toward ~42-44% is near-certain", "16 steals in G2 show ORL's defense can disrupt DET even when shots aren't falling"],
      consAway: ["ORL shot 33% in G2 — even with regression, confidence may be damaged for young players", "WCJ fouled out in 24min — if Bickerstaff attacks WCJ again, ORL's interior defense collapses", "Bane's shooting has been terrible (7-20 G1 + 2-11 G2 = 9-31 series, 29%) — can't rely on him from 3PT", "Wagner has been invisible offensively (4-11 G2, 0-2 3PT) — needs to step up as second star", "DET's defense is schematic (#1 DRtg) — travels to any building. Road defense drop may be minimal"]
    },
    game5: {
      spread: "DET -4.5", moneyline: "DET -200 / ORL +165", ou: "O/U 207.5",
      pick: "DET", confidence: "medium", projScore: "DET 104 — ORL 96",
      schedule: "Tue Apr 29 — 7:00 PM ET — Prime Video",
      reasoning: "RESULT: DET 116-109 — Model CORRECT (picked DET medium). Projected DET 104-96 (+8), actual DET 116-109 (+7). Winner and margin direction correct but scoring was 25pts higher than projected. Banchero and Cunningham both scored 45pts — an unprecedented duel. Wagner was confirmed OUT (calf) as predicted. KEY INSIGHT: ORL shot 48% FG and 45% from 3PT and STILL lost because of free throw shooting (16-30, 53%) vs DET's 28-33 FT (85%). Ausar Thompson had a historic stat line: 6pts/15reb/6ast/5stl/2blk — invisible scorer, dominant everywhere else. Anthony Black (19pts, 4-6 3PT) stepped up as ORL's secondary scorer with Wagner out.",
      g4Adjustments: [
        "ORL WON G4 94-88: Defensive grind. ORL shot 32.6% FG but won via 20 DET turnovers vs 12 ORL turnovers.",
        "WAGNER CALF STRAIN: Left G4 Q3 with right calf. ESPN: uncertain for G5. If OUT, ORL loses secondary creator (19pts in 24min G4).",
        "BANCHERO 4-18 FG (22.2%): Worst shooting game of series. DET's defense on Paolo has been suffocating when locked in.",
        "BANE CLUTCH: 22pts, banked 3-pointer with 1:16 left to seal it. Bane has been ORL's most reliable scorer: 17→12→17→22pts.",
        "CADE 8 TOs: Tied LeBron's unwanted playoff record. Ball security is DET's critical flaw — must get under 12 TOs to win.",
        "SUGGS 1-13 FG: Historic bad shooting (1-11 3PT). But ORL won anyway — depth and defense compensated.",
        "CAIN EMERGENCE: Undrafted F posterized Duren, putback for lead. New rotation piece for Mosley.",
        "SERIES RETURNS TO DETROIT: LCA where DET won G2 98-83 with Q3 blitz (38-16)."
      ],
      prosHome: ["HOME COURT: DET won G2 98-83 at LCA with devastating Q3 blitz (38-16)", "#1 regular-season defense is elite at home — held ORL to 83pts in G2", "Cade home splits: 27pts/11ast G2 — distributes effectively at LCA", "Harris 20pts G4 shows reliable secondary scoring has arrived", "Desperation: first elimination scenario brings focus and energy", "DET 60-22 overall, 32-9 at home — LCA is a fortress"],
      consHome: ["20 TURNOVERS in G4 — ball security issues are systemic, not one-game variance", "Down 1-3 historically yields only ~8% comeback rate", "Banchero can explode any game — 23pts G1, 25pts G3 near triple-double", "ORL has won 3 of 4 games — they are the better team in this series"],
      prosAway: ["Won 3 of 4 games — series dominance is real and sustained", "Wagner may play through calf (19pts in 24min G4 before exit)", "Bane has been clutch: 22pts G4 with dagger banked 3", "ORL's defense forced 20 DET TOs even while shooting 32.6%", "One win from advancing — confidence and composure edge"],
      consAway: ["Wagner UNCERTAIN: If OUT, ORL loses their #2 scorer and clutch closer", "Banchero 4-18 (22.2%) G4 — worst game of series. DET's defense is in his head", "Suggs 1-13 FG — if shooting stays cold, ORL has no third option", "ROAD game at LCA where DET won G2 by 15", "ORL shot 32.6% in G4 — winning while shooting that poorly is unsustainable"]
    },
    game6: {
      spread: "DET -3.5", moneyline: "DET -160 / ORL +135", ou: "O/U 210.5",
      pick: "DET", confidence: "medium", projScore: "DET 108 — ORL 102",
      schedule: "Fri May 1 — 7:00 PM ET — Prime Video",
      reasoning: "MODEL PICK: DET (MEDIUM confidence, COMPETITIVE). Market has FLIPPED — DET is now a 3.5-point road favorite despite ORL having home court. Three factors explain the shift: (1) WAGNER CONFIRMED OUT until May 3 (calf) — ORL remains a single-initiator team with Banchero as sole creator. Isaac may return (knee, est. May 1) but he's been out all series and provides defense, not offense. (2) CADE ASCENDING: 45pts (13-23 FG, 14-14 FT) in G5 after 25pts G4. He's found his playoff gear and DET's offense flows through him with devastating efficiency. Harris (23pts G5) has emerged as a reliable second option. (3) MOMENTUM: DET has won 2 straight after being down 3-1, and ORL's confidence is shaken — they shot 53% FT in G5 and blew a 45-point Banchero performance.\n\nHowever, ORL's home court cannot be dismissed — 8-1 at Kia Center in these playoffs. Banchero is capable of another 40+ game and ORL's defense (forced 16 DET TOs in G5) is elite at home. But without Wagner, ORL's offensive ceiling is capped. DET's Harris (ankle) participated in morning shootaround — expected to play. Huerter (adductor) is questionable. The turnover battle will decide this: DET's ball security vs ORL's disruptive defense.\n\nKEY VARIABLE: Jonathan Isaac's potential return. If he plays, ORL adds an elite defensive wing who could help contain Cade's drives. But he hasn't played all series — reintegration is risky.",
      g5Adjustments: [
        "DET WON G5 116-109: Cade 45pts (13-23, 14-14 FT) and Harris 23pts kept DET alive.",
        "BANCHERO 45pts (17-31, 6-11 3PT) — HISTORIC performance but ORL lost. FT shooting (5-12) cost him.",
        "WAGNER CONFIRMED OUT until May 3 (calf) — ORL locked into single-initiator mode for G6.",
        "ISAAC COULD RETURN (knee, est. May 1) — would add defensive wing but no offensive boost and hasn't played all series.",
        "HARRIS (ankle) Day-to-Day — participated in Friday morning shootaround. Expected to play G6.",
        "HUERTER (adductor) Questionable for G6 — if out, DET loses bench shooting.",
        "ORL FT CRISIS: 16-30 (53%) team-wide. Banchero 5-12, Cain 3-7. This cost ORL the game.",
        "AUSAR THOMPSON: 6pts but 15reb/6ast/5stl/2blk — DET's defensive anchor. His non-scoring impact is elite.",
        "BLACK STEPPED UP: 19pts (7-12, 4-6 3PT) as ORL's secondary option with Wagner out.",
        "MARKET FLIPPED: DET now -3.5 ROAD favorite. Market believes DET momentum > ORL home court.",
        "DET BENCH THIN: Only 18pts from bench (Stewart 5, Green 5, LeVert 2, Jenkins 6). Depth is a liability."
      ],
      prosHome: ["DESPERATION + MOMENTUM: DET has won 2 straight after trailing 3-1. Cade is locked in.", "Cade's G5 masterpiece (45pts, 14-14 FT) proves he's a playoff superstar — ascending each game", "Harris 23pts (ankle day-to-day but shootaround participant) — reliable second scorer emerged", "DET's Q1 dominance (38-26 in G5) shows they can control tempo early", "Market agrees: DET -3.5 road favorite — market has more confidence in DET than ORL at home"],
      consHome: ["ROAD game at Kia Center where ORL is 8-1 in playoffs", "DET bench only scored 18pts — depth crisis continues", "Cade's 6 TOs in G5 — ball security remains a flaw even in his best games", "Huerter (adductor) questionable — if out, DET loses bench shooting", "ORL's 3PT shooting (45% in G5) will travel — their shooters are legit"],
      prosAway: ["Kia Center fortress: 8-1 at home in playoffs — elite home court advantage", "Banchero proved he can score 45 — at home with crowd support, his ceiling is limitless", "FT regression: ORL shot 53% FT in G5 — unsustainably bad, will improve at home", "ORL's defensive identity (forced 16 DET TOs) should reassert at home", "Isaac could return (knee, est. May 1) — adds elite defensive wing if healthy"],
      consAway: ["WAGNER CONFIRMED OUT (calf, May 3) — ORL is single-initiator without him", "ORL's FT shooting crisis is mental, not physical — could persist in elimination game", "Cade's 45 proves he can single-handedly overwhelm ORL's defense", "Harris 23pts showed DET has a second scorer — ORL can't just focus on Cade", "Ausar's 15reb/6ast/5stl/2blk is a game-changing defensive stat line that suppresses ORL's role players"]
    },
    game7: {
      spread: "DET -7.5", moneyline: "DET -298 / ORL +240", ou: "O/U 204.5",
      pick: "DET", confidence: "high", projScore: "DET 104 — ORL 96",
      schedule: "Sun May 3 — 3:30 PM ET — ABC",
      reasoning: "MODEL PICK: DET (HIGH confidence, COMPETITIVE). This is the model's highest-confidence pick of the DET-ORL series. Three overwhelming factors converge: (1) HOME COURT FORTRESS — DET is 32-9 at home this season and won G2 98-83 at LCA with a devastating 38-16 Q3. LCA crowd will be volcanic for a Game 7. CLE-TOR proved home court is worth 8-10pts in Game 7 contexts. (2) CADE'S ASCENSION — Cunningham has averaged 38.5pts in elimination games (G5: 45, G6: 32) on efficient shooting. He's playing the best basketball of his career and carries DET's offense single-handedly when needed. Harris (22/10 G6) provides reliable secondary scoring. (3) WAGNER STILL OUT (calf, est. May 5) — ORL remains a single-initiator team with Banchero as sole creator. Banchero's G6 collapse (4-20 FG, 0-9 3PT) was the worst shooting game of his career and mental damage from that at DET's hostile arena is a real factor.\n\nORL's defense (forced DET into 4 TOs from Cade in G6) is elite, and Banchero's ability to bounce back from bad games has been proven (18pts G2 → 25pts G3). But the venue shift is devastating — ORL was 8-1 at home but their road record in this series is 1-2 (only G1 upset). DET's defense held ORL to 79pts in G6 and Ausar Thompson's 4-block game showed a new defensive ceiling. The model projects a COMPETITIVE-to-SEPARATION game where DET's home crowd + Cade's elimination gear + ORL's Wagner absence combine for a comfortable win.\n\nKEY RISK: Banchero revenge game. He's capable of 40+ and if he shoots even 35% (up from 20% G6), this becomes competitive. But DET's defense has held him under 25pts in 4 of 6 games.",
      g6Adjustments: [
        "DET WON G6 93-79 AT ORL: Dominant ROAD win in elimination game. DET has won 2 straight.",
        "CADE 32/10/3/4stl G6: Continues carrying DET. Averaging 38.5pts in elimination games (G5+G6).",
        "BANCHERO COLLAPSE: 4-20 FG (20%), 0-9 3PT in G6. Worst career shooting game. Mental damage?",
        "AUSAR THOMPSON DEFENSIVE PEAK: 4pts but 10reb/6ast/4blk — game-changing defensive impact.",
        "HARRIS DOUBLE-DOUBLE: 22pts/10reb — reliable 2nd scorer has arrived for DET.",
        "WAGNER STILL OUT (calf, est. May 5) — ORL remains single-initiator.",
        "ORL SHOT 34.6% AS A TEAM in G6 — DET's defense is suffocating them.",
        "SUGGS 1-10 FG G6 — ORL's guards are struggling alongside Banchero.",
        "ROBINSON 4-9 3PT G6 — DET's spacing from Robinson is a weapon Bickerstaff has unlocked.",
        "SERIES RETURNS TO LCA: DET won G2 98-83 there. LCA is a Game 7 fortress."
      ],
      prosHome: ["HOME COURT at LCA: DET is 32-9 at home, won G2 98-83 with 38-16 Q3 blitz", "CADE IN ELIMINATION MODE: 38.5pts avg in G5-G6, playing career-best basketball", "2-GAME WIN STREAK: DET has all momentum after forcing G7 from 3-1 down", "AUSAR DEFENSIVE WEAPON: 4blk G6 showed new level — ORL's interior is compromised", "HARRIS RELIABLE: 22/10 G6 — DET no longer a one-man team", "ORL's SHOOTING COLLAPSE: 34.6% G6, 4-20 from Banchero — confidence shattered", "DET DEFENSE PEAKED: Held ORL to 79pts (series low) — scheme is perfected"],
      consHome: ["Cade's 4 TOs G6 — ball security remains a flaw in high-usage games", "DET bench is razor-thin (Jenkins 7, Reed 6, everyone else 0 in G6)", "History: Only ~13% of teams down 3-1 complete the comeback — pressure is immense", "Banchero bounce-back potential is real — 45pts G5 after 18pts G2 shows his ceiling"],
      prosAway: ["Banchero bounce-back: He's responded to bad games before (18→25 G2-G3, worst→45 G4-G5)", "Bane has been steady (17pts G6) — veteran presence stabilizes young ORL team", "ORL won 3 of first 4 games — they've been the better team for most of the series", "Elimination game urgency brings maximum intensity — ORL has won elimination games before (G4)"],
      consAway: ["ROAD game at LCA where DET won G2 by 15 — hostile environment", "WAGNER OUT — ORL's #2 scorer and clutch closer remains unavailable", "Banchero 4-20 G6 = worst career game — mental damage in an elimination road game?", "ORL shooting collapse (34.6% G6) suggests DET's defensive scheme has been solved", "Suggs 1-10 G6, Black 3-7 — ORL's guards offer no secondary scoring threat", "DET's Ausar Thompson is neutralizing ORL's wing attack (4blk, 10reb G6)"]
    },
    game4: {
      spread: "DET -1.5", moneyline: "DET -125 / ORL +105", ou: "O/U 215.5",
      pick: "ORL", confidence: "low", projScore: "ORL 108 — DET 104",
      schedule: "Mon Apr 27 — 8:00 PM ET — NBC/Peacock",
      reasoning: "PHASE 34 PICK: ORL (LOW confidence, TRUE TOSS-UP). After splitting the first 3 games, G4 at Kia Center projects as the most volatile game of the series. The model FLIPS to ORL for G4 based on several factors:\n\n(1) HOME COURT ADJUSTMENT TIME — Mosley has had 4 full games of film by G4. His G1 game plan was A+ and his adjustment capacity (adj rating 7) is elite. By G4, he'll have solved Cade's distribution mode and WCJ's foul trouble problem.\n\n(2) BANE REGRESSION TO MEAN — Bane is shooting 9-31 (29%) through 2 games. His season average is 48.4% FG, 39.1% 3PT. Statistical regression is inevitable — when Bane gets hot, ORL's multi-initiator attack becomes overwhelming.\n\n(3) BANCHERO AT HOME — Paolo has been good but not great (23pts G1, 18pts G2). At home in a must-win (if down 2-1) or even-series scenario, his 28.0 PPG career playoff average and youth breakout potential (age 23) suggest a monster game.\n\n(4) DET ROAD FATIGUE — Back-to-back road games (G3 Sat, G4 Mon) with no home comfort. Young team's energy and confidence may dip.\n\nWHY LOW CONFIDENCE: DET's #1 defense has been dominant (held ORL to 33% G2). Cade's dual-mode capability makes him nearly unguardable. DET may carry G2 momentum deep into the series. This is genuinely a coin flip that the model barely tilts toward ORL.",
      prosHome: ["DET #1 defense is elite and travels — held ORL to 33% in G2", "Cade's dual-mode (scorer + distributor) is nearly unguardable through 2 games", "DET has momentum from G2 blowout — confidence and chemistry are peaking", "Bickerstaff's adjustments have been excellent since G1 panic"],
      consHome: ["Second consecutive road game — fatigue and travel wear on young teams", "DET had 22 turnovers G2 — ORL's defense creates live-ball turnovers at home", "Cade's 7 TO G2 suggests ball security issues that worsen in hostile environment"],
      prosAway: ["HOME COURT for consecutive games — Kia Center energy builds across G3-G4", "Mosley has multiple games of film — adjustment rating 7 means real schematic changes", "Bane's shooting regression is inevitable (29% through 2 games vs 48% season)", "Banchero's career playoff avg is 28.0 PPG — he's due for a breakout at home", "Wagner needs to step up and historically responds to adversity"],
      consAway: ["ORL shot 33% G2 — confidence damage to young players may linger", "WCJ's foul trouble is schematic, not random — Bickerstaff will attack him again", "Bane's inconsistency (7-20 G1, 2-11 G2) may be matchup-driven, not just variance", "DET's defense limits ORL's multi-initiator advantage by suffocating secondary options"]
    },
    coaching: {
      home: {
        ...
        g2Performance: "A | COMPLETE 180 from G1. Bickerstaff proved why he's COTY with masterful G2 adjustments: (1) Cade DISTRIBUTION MODE — instead of letting Cade try to score 40 again, designed sets that had Cade distributing (27pts/11ast on 57.9% FG). (2) Freed Duren — attacked WCJ directly, forcing 6 fouls and a foul-out in 24min. Duren's 4 assists show Bickerstaff had him passing out of doubles. (3) Abandoned panic lineups — Stewart got meaningful minutes (16min, 4-4 FG, 10pts) in PROVEN rotations. (4) Q3 BLITZ: 38-16 quarter, 6 players scored 5+ points. Defensive intensity reached its peak. (5) 6 players in double figures — the single-initiator problem was coaching, not talent. DET ended the longest home playoff losing streak in NBA history. Grade improvement: D → A."
      },
      away: {
        coach: "Jamahl Mosley",
        adjustmentRating: 7,
        ...
        g2Performance: "C | Mosley's G1 masterclass didn't carry over. Key failures: (1) NO ANSWER for Cade's distribution mode — G1 scheme ('let Cade score, suffocate the rest') failed when Cade pivoted to playmaking (27pts/11ast). DET had 6 in double figures. (2) WCJ FOUL TROUBLE — WCJ fouled out (6PF, 24min) trying to stop Duren. Mosley had no backup plan when his G1 hero became a liability. Bitadze got 21min but couldn't replace WCJ's impact. (3) SHOOTING COLLAPSE — ORL shot 33% (season low). While some of that is DET's defense, Mosley failed to generate quality looks in the half-court. (4) Q3 MELTDOWN: Outscored 38-16 in Q3. Lost control of the game's tempo and momentum. Bane's 2-11 FG is partly on Mosley — not enough screens/actions to get him open looks. Grade: A+ → C."
      },
      bestLineups: {
    ...
    modelLessons: [
      {type: "missed", lesson: "G1: Model picked DET -8.5 (HIGH confidence). ORL won 112-101 — 19.5pt swing from projection. Massive miss. #1 seed losing at home to #8 seed. Model overweighted DET's regular season dominance and underweighted ORL's multi-initiator advantage and Mosley's elite game plan."},
      {type: "correct", lesson: "G2: Model picked DET (LOW confidence). DET won 98-83 — correct. Bickerstaff's adjustments (Cade distribution mode, freed Duren) were exactly what the model suggested DET needed."},
      {type: "correct", lesson: "G4: Model picked ORL (LOW confidence). ORL won 94-88 — correct winner. The turnover thesis was validated: DET 20 TOs vs ORL 12 TOs was the decisive factor. ORL won despite shooting 32.6% because DET couldn't protect the ball."},
      {type: "missed", lesson: "G4: WAGNER INJURY — Model has no mechanism for mid-game injuries. Wagner exited Q3 with right calf strain (19pts in 24min). His uncertain status for G5 dramatically changes the series. Star injury variance is an asymmetric risk factor for ORL."},
      {type: "underweighted", lesson: "G4: TURNOVERS ARE THE SERIES — DET has averaged 19.3 TOs in their 3 losses vs 12.0 TOs in their 1 win. Ball security is the single strongest predictor of game outcomes in this series, not FG% or talent differential."},
      {type: "missed", lesson: "G4: Bane's emergence as ORL's most reliable scorer (17→12→17→22pts) was not predicted. Model focused on Banchero/Wagner but Bane's veteran playoff experience (Grizzlies) makes him the steadiest performer. His banked 3 sealed G4."},
      {type: "overweighted", lesson: "G4: DET's #1 defense rating was overweighted. ORL won shooting 32.6% because they forced 20 turnovers. Defensive rating alone doesn't account for turnover generation."},
      {type: "correct", lesson: "G5: Model picked DET at home facing elimination (medium confidence). DET 116-109. Winner correct, margin nearly exact (+7 actual vs +8 projected). Wagner OUT confirmed — model correctly identified this as the key variable."},
      {type: "missed", lesson: "G5: Scoring explosion — projected 200 total pts, actual 225. Both Banchero (45) and Cunningham (45) went nuclear simultaneously. The model doesn't project dual-star ceiling games where BOTH stars peak in the same game."},
      {type: "missed", lesson: "G5: ORL's free throw shooting (16-30, 53%) cost them the game. They shot 48% FG and 45% 3PT — should have won. Model has no mechanism for FT variance as a game-deciding factor."},
      {type: "underweighted", lesson: "G5: Ausar Thompson's non-scoring impact (6pts/15reb/6ast/5stl/2blk) is invisible to traditional box score analysis but was crucial. His +/- was only -2 despite DET winning by 7 — his teammates scored when he facilitated."},
      {type: "correct", lesson: "G5: Anthony Black (19pts, 4-6 3PT) emerged as ORL's secondary option with Wagner out — the model's 'multi-initiator' framework correctly predicted ORL would find another scorer, it just wasn't enough vs Cade's 45."},
      {type: "correct", lesson: "G6: Model picked DET (medium confidence). DET won 93-79. Correct winner. Projected +6, actual +14 — margin miss but correct direction. DET's road dominance in elimination games confirmed."},
      {type: "missed", lesson: "G6: Banchero's historic collapse — 4-20 FG (20%), 0-9 3PT. Worst shooting game of his career. Model projected Banchero as 'limitless ceiling at home' but DET's defense (especially Ausar Thompson) completely shut him down. Star meltdowns in elimination games are not modeled."},
      {type: "underweighted", lesson: "G6: Ausar Thompson's defensive impact (4pts/10reb/6ast/1stl/4blk) was game-defining. His 4 blocks altered ORL's interior attack. The model has no mechanism for individual defensive game-changing beyond D-LEBRON ratings."},
      {type: "missed", lesson: "G6: ORL's home court fortress (8-1 entering G6) failed them when it mattered most. Kia Center crowd couldn't overcome DET's desperation and defensive intensity. Model treated ORL's home record as a reliable predictor — it wasn't in elimination context."},
      {type: "underweighted", lesson: "G6: Robinson's 3PT shooting (4-9, 44%) provided crucial spacing that the model didn't emphasize. When Cade has a floor-spacer like Robinson hitting 4 threes, the drive-and-kick game becomes devastating."},
      {type: "correct", lesson: "G6: Wagner's continued absence confirmed as the key variable. Without him, ORL is truly a single-initiator team with Banchero as sole creator — and when Banchero is locked up (4-20), ORL has no offensive identity."},
      {type: "missed", lesson: "G6: DET bench was razor-thin (Jenkins 7pts, Reed 6pts, everyone else 0) but it didn't matter because the starters dominated. Model overweighted bench depth as a factor when star performance was decisive."}
    ],
    ...
    // ── G3 Per-Player Offensive Outlook (Phase 34 UPDATED) ──
    // G1: ORL 112-101 at DET (UPSET). G2: DET 98-83 (BLOWOUT). Series tied 1-1.
    // G3 at Kia Center (ORL home). Cade dual-mode (39pts G1, 27/11ast G2). WCJ fouled out G2.
    // ORL shot 33% G2 (season low). Bane 9-31 series (29%). DET 6 in double figures G2.
    // DET ended longest home playoff losing streak. Momentum favors DET but ORL has home court.
    g3PlayerOutlook: {
      home: [ // DET (AWAY at Kia Center for G3)
        // Cade: G1 13-27 (48.1%), 39pts. G2 11-19 (57.9%), 27pts/11ast. Avg ~53% FG.
        // DUAL-MODE: scorer G1, distributor G2. Road game adds difficulty.
        // Bayesian: 0.50*(53% 2-game avg) + 0.50*(45% season) = 0.49. Road → 0.46
        { player:"Cade Cunningham", outlook:"good", projFgPct:0.46, ptsRange:[24,34], reason:"DUAL-MODE STAR. G1: 39pts (48.1% FG) as scorer. G2: 27pts/11ast (57.9% FG) as distributor. Mosley can't scheme for both. Road game at Kia Center adds difficulty (crowd noise, unfamiliar sightlines) but Cade has proven he adapts. Average 33pts through 2 games on 53% combined FG. Expect slight road regression to ~46% FG but still 26-30pts with 6+ assists. His 7 turnovers G2 is the concern — crowd noise could amplify ball-handling issues.", confidence:"high" },

        // Harris: G1 17pts (5-15, 33%). G2 16pts (7-17, 41.2%), 11reb DOUBLE-DOUBLE.
        // Bayesian: 0.50*(37% 2-game avg) + 0.50*(47% season) = 0.42
        { player:"Tobias Harris", outlook:"neutral-good", projFgPct:0.42, ptsRange:[12,20], reason:"G2 bounce-back: 16pts/11reb double-double on improved 41.2% FG (vs 33.3% G1). Veterans stabilize on the road — his playoff experience (PHI/LAC) is invaluable. DET needs him as reliable 2nd scorer. Expect 14-18pts with 6+ rebounds. Shooting still below season norm (47%) but trending up.", confidence:"medium" },

        // Duren: G1 8pts (3-4, 75%). G2 11pts (4-10, 40%), 9reb, 4ast. FREED by Bickerstaff.
        // WCJ fouled out G2 trying to contain him. Matchup advantage if WCJ in foul trouble again.
        { player:"Jalen Duren", outlook:"neutral-good", projFgPct:0.50, ptsRange:[10,16], reason:"G2 BREAKOUT: 11pts/9reb/4ast — Bickerstaff found the counter to WCJ's fronting scheme. Duren's 4 assists show he's passing out of doubles, creating for teammates. WCJ fouled out G2 trying to contain him. If Bickerstaff attacks WCJ again, Duren gets easy looks. Road game slight dip but matchup advantage is real.", confidence:"medium" },

        // A. Thompson: G1 8pts (3-7, 43%). G2 11pts (5-9, 55.6%), 8reb, 2stl, 1blk.
        { player:"Ausar Thompson", outlook:"neutral", projFgPct:0.45, ptsRange:[8,14], reason:"G2 was excellent: 11pts/8reb/2stl/1blk on 55.6% FG. Defensive assignment on Banchero (held him to 41.2% G2). Road game energy may dip but his defense travels. Expect 10-12pts with elite defensive impact.", confidence:"medium" },

        // Robinson: G1 9pts (3-6 3PT). G2 10pts (3-8 3PT). Consistent 3PT shooting.
        { player:"Duncan Robinson", outlook:"neutral", projFgPct:0.38, ptsRange:[8,14], reason:"Consistent through 2 games: 3-6 3PT G1, 3-8 3PT G2. DET's primary floor spacer. Road game catch-and-shoot is harder (crowd noise) but Robinson is a veteran shooter. Expect 8-12pts with 2-3 threes.", confidence:"medium" },

        // Stewart: G1 3pts (0-2). G2 10pts (4-4 FG, 100%!). Bench X-factor.
        { player:"Isaiah Stewart", outlook:"neutral", projFgPct:0.50, ptsRange:[6,12], reason:"G2 EXPLOSION: 4-4 FG (100%), 10pts, 5reb, 2blk off bench. Massive upgrade from G1's 3pts (0-2). Physicality and energy don't require home court. Expect 6-10pts — G2's perfection won't repeat but he's an established bench weapon now.", confidence:"low" }
      ],
      away: [ // ORL (HOME at Kia Center for G3)
        // Banchero: G1 23pts (8-15, 53.3%). G2 18pts (7-17, 41.2%), 8ast, 4TO.
        // AT HOME — youth breakout candidate (age 23). Needs efficiency bounce-back.
        { player:"Paolo Banchero", outlook:"good", projFgPct:0.48, ptsRange:[22,30], reason:"YOUTH BREAKOUT WATCH (age 23). G1: 23pts (53.3%), G2: 18pts (41.2%) — DET's defense suppressed him G2. NOW AT HOME: Kia Center crowd + adversity from G2 loss = motivation. His 8 assists G2 show he creates for others when scoring is tough. Career playoff avg 28.0 PPG. Expect 24-28pts with improved efficiency at home (~48% FG). The 4 turnovers G2 need to decrease.", confidence:"high" },

        // Wagner: G1 19pts (7-13, 53.8%). G2 12pts (4-11, 36.4%), 0-2 3PT. NEEDS to step up.
        { player:"Franz Wagner", outlook:"neutral", projFgPct:0.44, ptsRange:[14,22], reason:"G2 was concerning: 12pts on 36.4% FG, 0-2 3PT, just 1 assist. His Q4 closer role from G1 (11pts) didn't materialize. AT HOME, Wagner typically plays better — familiar sightlines and crowd energy. But DET's defense has been elite on him. Regression UP toward 44% expected. Needs 18+ to give ORL a chance.", confidence:"medium" },

        // Bane: G1 17pts (7-20, 35%). G2 12pts (2-11, 18.2%). SERIES SLUMP: 9-31 (29%).
        { player:"Desmond Bane", outlook:"neutral", projFgPct:0.40, ptsRange:[12,20], reason:"SERIES SLUMP: 9-31 FG (29%) through 2 games. Season: 48.4% FG, 39.1% 3PT. Home court and regression should help — he can't keep shooting 29%. MEM playoff experience means he won't mentally collapse. But DET's perimeter defense is legit. Expect 14-18pts on improved ~40% FG. His 6-7 FT G2 shows he gets to the line.", confidence:"medium" },

        // Suggs: G1 16pts (6-16, 37.5%). G2 19pts (7-18, 38.9%), 3-10 3PT. ORL's best scorer G2.
        { player:"Jalen Suggs", outlook:"neutral-good", projFgPct:0.40, ptsRange:[14,22], reason:"ORL's most consistent player through 2 games: 16pts G1, 19pts G2. His defensive energy (3stl G1) sets the tone even when shots aren't falling. AT HOME, his intensity amplifies with crowd noise. 3-10 3PT G2 is below average but volume shows confidence. Expect 16-20pts — reliable two-way contributor.", confidence:"medium" },

        // WCJ: G1 17pts (8-9, 88.9%). G2 3pts (1-6, 16.7%), FOULED OUT (6PF, 24min).
        // MASSIVE SWING — G1 hero to G2 liability. Foul trouble is the key variable.
        { player:"Wendell Carter Jr.", outlook:"bad", projFgPct:0.45, ptsRange:[6,14], reason:"G2 DISASTER: 3pts (1-6), FOULED OUT in 24min with 6PF. Bickerstaff attacked WCJ directly and he couldn't handle it. G1's 88.9% FG was an extreme outlier. At HOME, referees may give him slightly more leeway but foul trouble is now a schematic exploit for DET. If WCJ fouls out again, Bitadze gets extended run and ORL's interior defense collapses. Expect 8-12pts IF he stays on the floor.", confidence:"low" },

        // Black: G1 7pts. G2 5pts (1-6, 16.7%). Bench contributor struggling.
        { player:"Anthony Black", outlook:"neutral", projFgPct:0.38, ptsRange:[4,10], reason:"G2 was poor: 5pts on 1-6 FG (16.7%). But 3 steals showed defensive value. Home court helps young players' confidence. Expect 6-8pts with defensive contributions.", confidence:"low" },

        // Bitadze: G2 3pts (0-0 FG, 3-4 FT), 5reb, 2stl, 2blk. CRITICAL if WCJ in foul trouble.
  ...
  },
  {
    ...
    awayTeam: {
      ...
      players: [
        ...
        { name:"Joel Embiid", pos:"C", rating:72, ppg:26.9, rpg:7.7, apg:3.9, fgp:49.2, per:29.2, ts:64.5, epm:7.8, bpm:9.0, ws48:.250, onOff:13.2, clutch:8.8, vorp:6.2, usg:33.0, injury:"PROBABLE G5 — abdomen issue (per ESPN, probable). Returned G3 post-appendectomy. Had 26/10/6 in G4 but was -25 in blowout loss.", lebron:1.736, oLebron:2.452, dLebron:-0.716, war:3.154, offRole:"Shot Creator", defRole:"Anchor Big",
          matchupNote:"Emergency appendectomy Apr 9. OUT G1-G2. Returned G3. G4: 26/10/6 but -25 in 128-96 blowout loss. Now listed probable with abdomen issue per ESPN. Conditioning and rust still a factor — individual stats look fine but team impact is minimal when PHI collapses around him. At 72 rating (down from 92 base) reflecting post-surgery limitations and abdomen concern.", baseRating:92, starCeiling:2, injuryRisk:0.6 },
    ...
    game5: {
      spread: "BOS -12.5", moneyline: "BOS -700 / PHI +475", ou: "O/U 218.5",
      pick: "BOS", confidence: "high", projScore: "BOS 118 — PHI 101",
      schedule: "Tue Apr 28 — 7:00 PM ET — ESPN",
      reasoning: "MODEL PICK: BOS (HIGH confidence, SEPARATION). BOS returns home for the closeout after a franchise-record 24 made 3-pointers in a 128-96 G4 demolition. Tatum (30/7/11) and Pritchard (32pts off bench) were unstoppable. PHI's 25 turnovers in G4 exposed a fundamental flaw that BOS's ball-pressure defense will continue to exploit at TD Garden. Embiid had 26/10/6 but was -25 — individual brilliance cannot overcome systematic team dysfunction. PHI's supporting cast (Oubre 2pts, Edgecombe 6pts) provides no help. BOS won G1 123-91 at home and their playoff pedigree (2024 champions) means they know how to close. Embiid is probable with an abdomen issue but that won't change the talent gap. BOS's five-out offense with 3 initiators (Tatum/Brown/Pritchard) is simply too much for PHI's defense.",
      g5BoxComparison: {
        summary: "MODEL: BOS 118 — PHI 101 (HIGH, SEPARATION). ACTUAL: PHI 113 — BOS 97. 33-POINT SWING. Model wrong on winner, margin, and game character.",
        teamComparison: {
          projected: { bos: 118, phi: 101, bosFgPct: 0.47, phiFgPct: 0.40, bos3ptPct: 0.38, phi3ptPct: 0.33 },
          actual:    { bos: 97,  phi: 113, bosFgPct: 0.40, phiFgPct: 0.50, bos3ptPct: 0.28, phi3ptPct: 0.36, bosFtPct: 0.61, phiFtPct: 0.87 }
        },
        playerByPlayer: [
          { team: "BOS", player: "Jayson Tatum",     projPts: "28-30", actPts: 24, actLine: "8-19 FG, 4-12 3PT, 4-7 FT, 16reb, 4ast, 4TO, 3stl, -9",    verdict: "CLOSE but inefficient. Model expected ~28-30pts as closeout alpha. Got 24 on 42% FG — respectable volume but 4 TOs and -9. The 16 rebounds show effort but team collapsed around him in Q4 (3-22 FG)." },
          { team: "BOS", player: "Jaylen Brown",     projPts: "24-26", actPts: 22, actLine: "9-23 FG, 1-4 3PT, 3-5 FT, 5reb, 5ast, 3TO, -17",             verdict: "CLOSE on points but terrible efficiency. 39% FG, 25% 3PT. Model expected Brown as co-closer (~24-26pts on ~48% FG). His -17 was worst on team. 1-4 from 3 after going 3-7 in G4. Closeout pressure hit both stars." },
          { team: "BOS", player: "Payton Pritchard",  projPts: "20-24", actPts: 12, actLine: "5-10 FG, 1-5 3PT, 1-1 FT, 2reb, 6ast, +8",                   verdict: "BIG MISS. Model expected Pritchard to replicate G4 explosion (32pts). Got 12 on 50% FG. His 3PT collapsed (1-5, 20%) after going 6-12 in G4. Coaching Counter Decay: Nurse schemed specifically for Pritchard after G4 film." },
          { team: "BOS", player: "Derrick White",     projPts: "10-14", actPts: 6,  actLine: "2-8 FG, 0-4 3PT, 2-2 FT, 1reb, 3ast, 1TO, -14",             verdict: "MISS. Model expected White as steady 2-way contributor. Instead 25% FG, 0-4 from 3. His defensive assignment on Maxey was less effective (Maxey 10-18 FG). White's -14 reflects team-wide collapse." },
          { team: "BOS", player: "Sam Hauser",        projPts: "8-12",  actPts: 8,  actLine: "3-7 FG, 2-5 3PT, 5reb, -21",                                  verdict: "CORRECT on points. Model had him as role player floor-spacer (~8-12pts). His -21 was worst +/- on the team despite decent shooting." },
          { team: "BOS", player: "Neemias Queta",     projPts: "6-10",  actPts: 8,  actLine: "4-8 FG, 0-2 FT, 14reb, 1ast, -10",                            verdict: "CORRECT on points. 14 rebounds dominated glass. But 5 fouls limited his effectiveness and he couldn't anchor the defense when BOS collapsed in Q4." },
          { team: "PHI", player: "Joel Embiid",       projPts: "18-22", actPts: 33, actLine: "12-23 FG, 0-5 3PT, 9-10 FT, 4reb, 8ast, 3TO, +13",          verdict: "MASSIVE MISS (+11-15 pts over projection). Model treated Embiid as diminished post-appendectomy (~18-22pts). He ERUPTED: 2pts Q1 (1-6), then 31pts in Q2-Q4. FT line (9-10) shows he attacked rim relentlessly. 8ast = career playoff high. ELIMINATION GAME STAR ELEVATION concept born here." },
          { team: "PHI", player: "Tyrese Maxey",      projPts: "20-24", actPts: 25, actLine: "10-18 FG, 3-10 3PT, 2-2 FT, 10reb, 5ast, 2stl, 1blk, +15", verdict: "CLOSE but underestimated. Model had ~20-24pts. Got 25 on elite 55.6% FG with 10reb (career high). His all-around game (5ast, 2stl, 1blk) was best of series. Elimination elevated his production across every stat." },
          { team: "PHI", player: "Paul George",       projPts: "12-16", actPts: 16, actLine: "6-13 FG, 4-9 3PT, 0-0 FT, 9reb, 7ast, 2stl, +19",          verdict: "CORRECT on scoring, MISSED facilitator role. Model had ~12-16pts. Got exactly 16 but 7ast + 9reb = triple-double caliber. His 4-9 from 3 was critical for spacing. +19 best on team. The PHI trio (Embiid/Maxey/George) co-elevated — model treated them as individuals, not a unit." },
          { team: "PHI", player: "VJ Edgecombe",      projPts: "6-10",  actPts: 10, actLine: "3-8 FG, 3-6 3PT, 1-2 FT, 7reb, 3ast, +9",                   verdict: "CORRECT. Model expected ~6-10pts with reduced role after counter-scheming. Got 10 on 3-6 3PT — efficient but modest. His 7reb in 40min shows energy contribution beyond scoring." },
          { team: "PHI", player: "Quentin Grimes",    projPts: "8-12",  actPts: 18, actLine: "5-8 FG, 4-7 3PT, 4-4 FT, 2reb, +18",                         verdict: "BIG MISS. Model had Grimes as bench contributor (~8-12pts). He EXPLODED: 18pts on 62.5% FG, 57% from 3. His +18 in 24min was best on PHI. Hidden X-factor the model completely missed — Nurse deployed him as the 3PT flamethrower that stretched BOS's defense." },
          { team: "PHI", player: "Kelly Oubre Jr.",    projPts: "8-12",  actPts: 4,  actLine: "2-5 FG, 0-2 3PT, 0-1 FT, 6reb, +7",                         verdict: "OVERESTIMATED. Model had ~8-12pts. Oubre struggled (40% FG) but 6reb and +7 show defensive effort. Scoring wasn't needed with Embiid/Maxey/Grimes carrying." }
        ],
        keyTakeaways: [
          "BOS Q4 CATASTROPHE: 10pts on 3-22 FG (13.6%). 1-14 from 2PT in Q4. Team-wide shooting paralysis — not one player, ALL of them.",
          "PHI trio co-elevation: Embiid 33 + Maxey 25 + George 16 = 74pts combined. Model projected ~55pts combined. When all 3 fire simultaneously, PHI is a different team.",
          "GRIMES was the hidden variable: 18pts off bench on 4-7 3PT. Model had no mechanism for bench player breakout in elimination games.",
          "BOS 3PT regression DOWN: 11-39 (28%) after going 24-53 (45%) in G4. Team 3PT correlation works in reverse — when cold, EVERYONE is cold.",
          "EMBIID ELIMINATION GEAR: 2pts in Q1 then 31 in final 3 quarters. The slow start masked the explosion. Model used series avg (~20pts) as projection anchor — missed the elimination multiplier.",
          "Projected margin: BOS +17. Actual margin: PHI +16. A 33-point swing. This is the model's worst single-game prediction of the playoffs."
        ]
      },
      g4Adjustments: [
        "BOS FRANCHISE RECORD: 24 made 3s (24-53, 45%). PHI has no perimeter defense to stop this.",
        "TATUM DOMINANT: 30pts/7reb/11ast — true superstar closeout mode.",
        "PRITCHARD 32 OFF BENCH: 12-21 FG, 6-12 3PT. BOS's bench is better than PHI's starters.",
        "PHI 25 TURNOVERS: Catastrophic. BOS's defensive pressure creates systemic ball security issues.",
        "EMBIID 26/10/6 but -25: Individual stats meaningless when team is dysfunctional.",
        "HOME FOR CLOSEOUT: TD Garden where BOS won G1 by 32. 2024 champions know how to finish.",
        "EMBIID ABDOMEN: Probable for G5 but another physical concern compounds his limitations."
      ],
      prosHome: ["G1 at home: BOS 123-91 (+32). TD Garden is a fortress", "Franchise record 24 3PM in G4 — BOS's shooting is elite and travels home", "Tatum/Brown/Pritchard = 3 initiators, PHI has 1.5 (Maxey + limited Embiid)", "2024 championship pedigree — BOS knows how to close out series", "PHI's 25 TOs are structural — BOS ball pressure is repeatable"],
      consHome: ["PHI won G2 111-97 at BOS — they've proven they can win at TD Garden once", "Embiid's desperation could produce a historic individual performance", "Closeout complacency — BOS may not play with G4's intensity", "Maxey had 31pts in G3 — he has a ceiling game in him"],
      prosAway: ["Embiid is a generational talent: 26/10/6 in G4 despite blowout", "Maxey G3: 31pts/6ast — showed he can carry in a competitive game", "Facing elimination often produces career-best performances", "George's 3PT shooting (3-3 in G4) could sustain if given open looks"],
      consAway: ["25 TURNOVERS in G4 — PHI cannot take care of the ball against BOS pressure", "Supporting cast collapse: Oubre 2pts, Edgecombe 6pts in G4", "BOS won 3 of 4 games — only G2 was competitive", "ROAD game at TD Garden where BOS won G1 by 32", "Embiid abdomen issue + general health concerns limit his ceiling"]
    },
    game6: {
      spread: "BOS -3.5", moneyline: "BOS -170 / PHI +140", ou: "O/U 215.5",
      pick: "BOS", confidence: "medium", projScore: "BOS 110 — PHI 105",
      schedule: "Thu Apr 30 — 8:00 PM ET — ESPN",
      reasoning: "MODEL PICK: BOS (MEDIUM confidence, COMPETITIVE). Series shifts to Wells Fargo Center with BOS leading 3-2 after PHI's elimination-game win in G5 (113-97). Embiid's 33-point explosion proved he can dominate when facing elimination, and the home crowd energy at Wells Fargo will be electric. However, BOS remains the better team talent-wise — they have championship pedigree (2024 title), 3 initiators (Tatum/Brown/Pritchard), and their G5 Q4 collapse (3-22 FG) was an anomaly driven by closeout pressure, not a structural flaw. BOS shot 47% FG through 3 quarters before collapsing. The model applies Closeout Pressure Inversion to reduce BOS's margin vs G5's prediction, and PHI's home court advantage (~3pt boost). But BOS's talent advantage is structural: they've won 3 of 5 games in this series, and Tatum (24/16reb G5) remains effective even when BOS loses. KEY VARIABLE: Can BOS avoid another Q4 shooting collapse? Their historical clutch performance (Tatum 8.5 clutch, Brown 7.5 clutch) says yes. PHI's turnover problem (25 in G4) is structural even if G5 was cleaner.",
      g5Adjustments: [
        "PHI 113-97 — Embiid 33pts ERUPTION (2pts Q1, then 31 in final 3Q). Elimination-game star elevation is REAL.",
        "BOS Q4 COLLAPSE: 10pts on 3-22 FG (1-14 2PT). Closeout pressure inverted — BOS felt the pressure, not PHI.",
        "Maxey 25/10/5 in 43min — triple-threat game. George 16/9/7 — all-around contribution.",
        "BOS shot 47% through 3Q, then fell apart. Q4 was the anomaly, not the trend.",
        "Series goes to Wells Fargo — PHI 24-17 at home. First-home-game boost concept applies to G6.",
        "PHI's G5 win breaks 'supporting cast insufficient' narrative — George + Maxey + Embiid can co-elevate."
      ],
      prosHome: ["2024 championship DNA — BOS knows how to close even after a setback", "3 initiators (Tatum/Brown/Pritchard) vs PHI's 2.5 (Embiid/Maxey/George-limited)", "Won 3 of 5 games in series — structurally the better team", "Q4 collapse was closeout pressure anomaly, not structural flaw", "Tatum's 24pts/16reb even in loss shows consistent production"],
      consHome: ["Playing at Wells Fargo Center — PHI crowd will be ELECTRIC after G5 elimination save", "Embiid's elimination-game gear is now PROVEN: 33pts after only 2 in Q1", "BOS Q4 shooting collapse could haunt them mentally — team-wide crisis of confidence?", "PHI's trio (Embiid/Maxey/George) combined for 74pts in G5 — when all 3 fire, they're dangerous"],
      prosAway: ["HOME COURT — Wells Fargo Center, 24-17 at home, crowd energy from G5 win carries over", "Embiid ASCENDING: 26pts G4 → 33pts G5. Elimination urgency unlocks his ceiling", "George's all-around game (16/9/7) shows he's found his role as facilitator + scorer", "Momentum: PHI dominated 2nd half of G5 (63-40). Confidence is at series peak"],
      consAway: ["BOS has won 3 of 5 games — one bad Q4 doesn't erase talent gap", "PHI's turnover problem (25 in G4) is structural even if G5 was cleaner", "Edgecombe was quiet in G5 — PHI may be down to 2 reliable scorers without his breakout", "BOS's 3PT shooting (24 made in G4) is elite talent that travels — regression UP for shooters after cold G5"]
    },
    game7: {
      spread: "BOS -4.5", moneyline: "BOS -200 / PHI +165", ou: "O/U 210.5",
      pick: "BOS", confidence: "medium", projScore: "BOS 108 — PHI 103",
      schedule: "Sat May 2 — 7:30 PM ET",
      reasoning: "MODEL PICK: BOS (MEDIUM confidence). Game 7 at TD Garden. BOS returns home after losing G5 and G6 on the road — PHI has won 3 straight elimination games (G4 loss aside, G5+G6 were must-wins). However, Game 7 home teams win ~78% historically, and BOS has 2024 championship DNA — they've been here before. TD Garden crowd will be a massive factor. BOS's 3PT shooting has been wildly inconsistent (45% G4, 29% G6) but home court should normalize it closer to their 38% season average. PHI's Embiid/Maxey/George trio has elevated in elimination games (combined 72pts G6, 74pts G5) but they've never won a Game 7 together. Maxey's zero-turnover G6 was elite but replicating that in a hostile environment is harder. BOS's depth (Pritchard, White, Garza) gives them more margin for error. The model applies Game 7 Override (+5 HCA) which swings this to BOS. KEY VARIABLE: BOS's 3PT shooting — if they hit 35%+ from 3, they win comfortably. If they shoot sub-30% again, PHI's defense and trio elevation could steal it.",
      g6Adjustments: [
        "PHI 106-93 — Maxey 30pts (0 TOs), George 23pts (5-9 3PT), Embiid 19/10/8. PHI trio combined 72pts.",
        "BOS 3PT COLLAPSED AGAIN: 12-41 (29%). Pritchard 1-8 from 3. Brown 2-6. Tatum 2-6. Team-wide cold.",
        "BOS Q3 COLLAPSE: 14pts in Q3. PHI's Q2 explosion (38pts) broke the game open early.",
        "PHI has won 3 straight elimination games — psychological momentum is with PHI.",
        "BOS returns home to TD Garden — Game 7 home teams win ~78% historically.",
        "Oubre (14/9/2stl/2blk, +23) and Edgecombe (14/8/2blk, +18) gave PHI crucial depth scoring."
      ],
      prosHome: ["TD Garden Game 7 — home teams win ~78% historically, BOS crowd will be deafening", "2024 championship DNA — Tatum/Brown have won a title together, know how to perform in elimination", "BOS 56-26 record, best in East — this is structurally the better team over 82 games", "3PT shooting should regress UP at home: 29% G6 is unsustainable for a team that shoots 38% seasonally", "Depth advantage: Pritchard (32pts G4), White (defensive anchor), Garza emerging as reliable option"],
      consHome: ["PHI has won 3 straight elimination games — momentum and confidence are real", "BOS 3PT shooting has been inconsistent all series (26% G2, 29% G6 vs 45% G4, 43% G3)", "Brown's 5 turnovers and -24 in G6 suggest potential mental fragility in closeout situations", "PHI's trio (Embiid/Maxey/George) averaged 73pts combined in G5-G6 — if all 3 fire again, BOS is in trouble"],
      prosAway: ["3 STRAIGHT elimination wins — PHI is the most battle-tested team remaining", "Maxey's G6 (30pts, 0 TOs) was the best guard performance of the series — he's ASCENDING", "George's 3PT shooting (5-9 G6) gives PHI a lethal 4th scoring threat beyond the big 3", "Embiid's 19/10/8 with only 1 TO shows he can dominate without forcing — facilitator mode"],
      consAway: ["ROAD Game 7 — only ~22% of road teams win Game 7s historically", "TD Garden is one of the loudest arenas in the NBA — hostile environment for PHI's young players", "Embiid's health is always a concern — 6-18 FG in G6 suggests physical limitations returning", "PHI's depth beyond the big 3 is thin — Drummond only 2pts/7reb, bench production is inconsistent"]
    },
    modelLessons: [
      ...
      {type: "correct", lesson: "G4: BOS 128-96 — 32-point blowout. Tatum 30/7/11, Pritchard 32 off bench. BOS set franchise record for made 3s (24). PHI had 25 turnovers. BOS leads 3-1 and should close out."},
      {type: "missed", lesson: "G4: Pritchard's 32pts off the bench was the game's MVP performance. Model has no mechanism for bench player ceiling games. His 12-21 FG (6-12 3PT) was elite."},
      {type: "underweighted", lesson: "PHI's turnover problem is catastrophic: 25 TOs in G4. BOS's defensive pressure creates live-ball turnovers that fuel transition. This is structural, not variance."},
      {type: "missed", lesson: "Embiid had 26/10/6 but was -25 in a blowout. Individual star performance means nothing when the team falls apart around him. PHI's supporting cast is insufficient."},
      {type: "missed", lesson: "G5: PHI 113-97. Model predicted BOS 118-101 (HIGH confidence) — WRONG by 33pt swing. EMBIID ELIMINATION GAME EXPLOSION: 33pts after only 2pts in Q1 (1-6). Model treated Embiid as diminished post-appendectomy but elimination games unlock a different gear for generational talents. His 31pts over final 3 quarters was unstoppable midrange. CONCEPT: 'Elimination Game Star Elevation' — facing elimination multiplies star output by 1.2-1.5x above their series average."},
      {type: "missed", lesson: "G5: BOS Q4 COLLAPSE — 10pts on 3-22 shooting (1-14 from 2PT, 13.6% FG). Model has no mechanism for team-wide 4th-quarter shooting collapses in closeout games. The pressure of closing shifted from PHI to BOS. CONCEPT: 'Closeout Pressure Inversion' — the team trying to close often faces equal or greater pressure than the team facing elimination."},
      {type: "underweighted", lesson: "G5: Maxey (25/10/5) and George (16/9/7) both elevated in elimination game. The full PHI trio (Embiid/Maxey/George) can produce 74pts combined when all three are 'on'. Model treated them as diminished individuals rather than a co-elevating unit."},
      {type: "overweighted", lesson: "G5: Model gave BOS HIGH confidence based on 3-1 lead, G4 blowout, and home court. But 3-1 leads are closed at home ~70% of the time, not 90%. The model's confidence was too high for a closeout game against a team with a generational talent (Embiid)."},
      {type: "missed", lesson: "G6: PHI 106-93. Model predicted BOS 110-105 (MEDIUM confidence) — WRONG. PHI won their 2nd straight elimination game. Maxey 30pts (0 turnovers!) was the difference — his zero-turnover masterclass in an elimination game is elite-tier performance. George added 23pts with 5 made 3s. BOS's 3PT shooting collapsed AGAIN: 29% (12-41) after 45% in G4. The model's 3PT regression thesis works in BOS's favor over large samples but not game-to-game."},
      {type: "missed", lesson: "G6: BOS Q3 COLLAPSE — 14pts in Q3 (after 49 in H1). PHI's 38-point Q2 broke the game open. The model has no mechanism for quarter-specific collapses. BOS's inconsistency across quarters (23-26-14-30) suggests psychological fragility in closeout situations."},
      {type: "underweighted", lesson: "G6: PHI's elimination-game trio continues to co-elevate: Embiid 19/10/8, Maxey 30/5ast, George 23/5 3PM. Combined 72pts in G6 after 74pts in G5. The model treats each player independently but their combined elevation in elimination games is a SYSTEM effect, not individual variance."},
      {type: "overweighted", lesson: "G6: Model assumed BOS's 3-2 lead and talent gap would assert itself at Wells Fargo. But PHI's home court advantage was massive — 48reb to 46, 89% FT, crowd energy turned Q2 into a 38-26 PHI quarter that broke BOS. Closeout Pressure Inversion concept from G5 carried into G6."},
      {type: "underweighted", lesson: "G6: Oubre (14pts, 9reb, 2stl, 2blk, +23) and Edgecombe (14pts, 8reb, 2blk, +18) provided crucial supporting performances. PHI's role players are elevating in elimination games — not just the stars. Model focuses on star performance but role player elevation is equally important in elimination scenarios."}
    ],
    game4: {
      spread: "BOS -3.5", moneyline: "BOS -180 / PHI +150", ou: "O/U 210.5",
      pick: "BOS", confidence: "medium", projScore: "BOS 107 — PHI 105",
      schedule: "Sun Apr 26 — 1:00 PM ET — ESPN",
      reasoning: "PHASE 35 PICK: BOS (MEDIUM confidence). BOS took G3 on the road 108-100 behind Tatum/Brown's combined 50pts and elite 3PT shooting (42.6%). The model's 3PT regression thesis was validated — PHI's 48.7% from G2 dropped to 34.3%. G4 at PHI is tighter: Embiid may return (appendectomy recovery progressing), and Nurse's adjustments will continue. But BOS's talent gap (Tatum+Brown > Maxey+anyone else) is structural. Edgecombe was counter-schemed (0-7 3PT G3) — he needs to adjust. BOS has been the better team in 2 of 3 games and their depth advantage increases in a 4-game grind.",
      g3Adjustments: [
        "G3: BOS 108-100. BOS leads 2-1. Tatum 25pts (5-9 3PT dagger). Brown 25pts, 8 straight in Q4.",
        "3PT REGRESSION VALIDATED: PHI 48.7% G2 → 34.3% G3. BOS 26% G2 → 42.6% G3. Model's strongest thesis confirmed.",
        "MAZZULLA COUNTER-SCHEMED EDGECOMBE: 30pts G2 → 10pts/0-7 3PT G3. Youth breakout regressed exactly as predicted.",
        "Embiid STILL OUT but progressing. If he returns for G4, PHI gets a massive interior upgrade. Status is the key variable.",
        "Maxey remains elite (31pts G3) but can't carry alone without interior star power."
      ],
      prosHome: ["Tatum+Brown combined 50pts G3 — dual-star closer mode is sustainable", "3PT regression favors BOS consistently — their shooters regress UP, PHI's regress DOWN", "Mazzulla's G3 counter on Edgecombe will carry into G4 scheme", "BOS depth (Pritchard 15pts) outproduces PHI bench"],
      consHome: ["Playing at Wells Fargo Center — PHI crowd will be desperate at 1-2", "Embiid could return — if healthy, changes the entire series dynamic", "Maxey's 31pts/6ast shows he can produce against BOS's defense", "Nurse's adj 8 means continuous scheme evolution game-to-game"],
      prosAway: ["HOME COURT — Wells Fargo for second straight game", "If Embiid returns, PHI adds 25+pts and interior dominance", "Nurse will adjust Edgecombe's role after 0-7 3PT G3 — won't repeat same approach", "PHI shot 34.3% from 3 G3 — home shooting should improve to ~37%"],
      consAway: ["Without Embiid, Bona+Drummond combined only 22pts — not enough vs BOS bigs", "Edgecombe's G2 breakout was counter-schemed — he needs a new offensive identity", "BOS's talent gap is structural: Tatum(87)+Brown(85) > Maxey(84)+George(78)", "BOS 3PT shooting travels — 42.6% G3 wasn't just home variance"]
    },
    coaching: {
      home: {
        coach: "Joe Mazzulla",
  ...
  },
  {
    ...
    game4: {
      spread: "ATL -2.5", moneyline: "ATL -135 / NYK +115", ou: "O/U 213.5",
      pick: "ATL", confidence: "low-medium", projScore: "ATL 108 — NYK 103",
      schedule: "Sat Apr 25 — 7:00 PM ET — NBC/Peacock",
      reasoning: "PHASE 30 PICK: ATL (LOW-MEDIUM confidence, ATL by 5). After stealing home court and winning G3 109-108, Atlanta has genuine series momentum and another home game. The model shifts to ATL for G4 based on: (1) KUMINGA'S SUSTAINED BREAKOUT — 8pts G1→19pts G2→21pts G3. This is no longer variance — it's a genuine level-up. Phase 29 youth breakout persistence confirms consecutive improvements for ≤23-year-olds. He shot 9-14 FG (64.3%) in G3. (2) NYK WING CRISIS — Bridges had 0pts/4TOs in 21min G3, and Hart went 1-9 FG for 2pts. Two of NYK's top-4 players combined for 2pts on 1-12 shooting. This is a matchup problem, not just variance — Snyder's defensive scheme is neutralizing them. (3) HOME COURT CONTINUITY — ATL is 26-15 at home and won G3 at State Farm Arena. Back-to-back home games favor the home team historically. (4) BRUNSON'S 3PT DROUGHT — 0-5 from 3 in G3 (now 4-19 from 3PT for the series, 21%). His mid-range and driving game still works (11-23 overall) but the complete absence of 3PT shooting makes NYK's spacing predictable. (5) JALEN JOHNSON STEADY EXCELLENCE — 24pts/10reb/8ast in G3, averaging 22.3/9.3/6.3 for the series. His two-way impact is the series' most consistent force.\n\nCOUNTER: OG Anunoby is having an all-time series (29pts/9reb/3blk G3, averaging 20.7/7.7 through 3 games). KAT's 21pts/17reb in G3 shows the paint remains NYK's domain. McBride's 15pts (5-10 3PT) proved bench shooting can materialize. If Brunson's 3PT comes back (21% vs 37% season), NYK's offense transforms overnight. But the model weighs ATL's home court, scheme advantages, and Kuminga's trajectory over NYK's regression arguments.",
      g3Adjustments: [
        "KUMINGA SUSTAINED BREAKOUT CONFIRMED: 8→19→21pts across 3 games. 9-14 FG (64.3%) in G3. Phase 29 persistence is REAL — this is a genuine level-up, not variance.",
        "BRIDGES INVISIBLE: 0pts, 0-3 FG, 4 TOs in 21min. Snyder's scheme has completely neutralized him. Brown may reduce his minutes or change his role G4.",
        "HART COLLAPSE: 1-9 FG (11.1%) for 2pts in 40min. Hart's scoring was never his primary value (boards/playmaking), but 1-9 is concerning.",
        "BRUNSON 3PT DROUGHT: 0-5 from 3 in G3, 4-19 (21%) from 3 for the series. His driving/mid-range game (11-23 overall) still works but no 3PT threat makes spacing predictable.",
        "DANIELS REBOUNDING EXPLOSION: 13reb/6ast/3stl in G3. His all-around impact (4pts/11ast/9reb G1, 9pts/3reb/3ast G2, 8pts/13reb/6ast G3) is consistently high even when scoring is low.",
        "MCBRIDE BENCH LIFELINE: 15pts on 5-10 3PT in 31min. After the bench went 0pts G2, McBride showed NYK's bench CAN shoot. His expanded role may continue G4.",
        "OG ANUNOBY ALL-TIME SERIES: 29pts/9reb/3blk G3, averaging 20.7 PPG. He's NYK's best player this series by a wide margin — carrying the scoring load.",
        "LANDALE STILL OUT: ATL's backup center remains sidelined (ankle, expected May 2). Okongwu's minutes load (37min G3) is a fatigue concern."
      ],
      prosHome: ["Brunson 3PT drought (21% for series) creates predictable spacing — ATL can pack paint", "Bridges completely neutralized by Snyder's scheme (0pts/4TOs G3)", "Hart's 1-9 shooting exposes that NYK can't rely on secondary scoring", "ATL road team (25-16) but NYK's scoring inconsistency is structural, not venue-dependent"],
      consHome: ["OG Anunoby averaging 20.7 PPG — NYK's alpha scorer is playing at All-NBA level", "KAT's 21pts/17reb G3 shows paint dominance remains NYK's strength", "McBride's 15pts/5-10 3PT proves bench CAN produce — G2 zeroes were the anomaly", "Brunson's 3PT regression UP is the most predictable correction in the series"],
      prosAway: ["Kuminga's 8→19→21pts breakout arc — Phase 29 sustained, not variance", "Home court continuity — back-to-back games at State Farm Arena after G3 win", "Snyder's defensive scheme on Bridges/Hart is REPEATABLE and devastating", "Johnson 24/10/8 G3 — the series' most consistent two-way force (22.3/9.3/6.3 avg)", "Series momentum — ATL won 2 straight after dropping G1 on the road"],
      consAway: ["Okongwu fatigue risk — 37min G3 with no Landale backup, knee inflammation ongoing", "McCollum 3PT regression: 7-20 (35%) for series, came back to earth in G3 (2-4)", "ATL FT shooting: 69% G3 (18-26) — below-average free throw shooting could cost them in close game", "Daniels 5 TOs in G3 — turnover-prone despite great rebounding/playmaking"]
    },
    game5: {
      pick: "NYK", confidence: "high", projScore: "NYK 118 — ATL 101",
      schedule: "Tue Apr 28 — 8:00 PM ET — NBC/Peacock",
      reasoning: "POST-HOC NOTE: No formal prediction block was created before game. Based on G4 lesson (trust engine talent assessment), engine favored NYK at home. NYK 126-97 actual. Brunson 39pts masterclass."
    },
    game6: {
      spread: "NYK -4.5", moneyline: "NYK -200 / ATL +165", ou: "O/U 216.5",
      pick: "NYK", confidence: "high", projScore: "NYK 115 — ATL 104",
      schedule: "Thu Apr 30 — 7:00 PM ET — ESPN",
      reasoning: "MODEL PICK: NYK (HIGH confidence, SEPARATION). NYK leads 3-2 and can close out at State Farm Arena. Brunson's G5 masterclass (39pts, 15-23 FG, 65.2%) was the series' most dominant individual performance. NYK shot 57% FG in G5 and dominated the boards 48-27. Brown's defensive scheme has BROKEN McCollum — he went from 32pts G2 to 6pts G5 (3-10 FG, 0-2 3PT, 4 TOs). With McCollum neutralized, ATL's offense runs through J.Johnson (18/10/6 G5) and NAW (16pts G5 on 4-9 3PT), but neither can create at Brunson's level. The model trusts NYK's talent advantage: Brunson (87 rating, 9.2 clutch) + KAT (79, 16/14/6 G5) + OG (74, 17/10 G5) is structurally superior. ATL's home court gives them a 3-4pt boost, but NYK has already won AT State Farm (G4: 114-98, 'Let's go Knicks' chants). Kuminga regressed from 21pts G3 to 13pts G5. ATL would need McCollum to rediscover his G2 form AND Brunson to have a rare off night — both are unlikely given current trajectories.",
      g5Adjustments: [
        "BRUNSON MASTERCLASS: 39pts (15-23 FG, 65.2%, 3-5 3PT, 8ast, 1TO). Historic MSG performance.",
        "MCCOLLUM BROKEN: 6pts (3-10 FG, 0-2 3PT, 4 TOs, -14). Brown's defensive scheme has fully neutralized him.",
        "NYK SHOT 57% FG: Team efficiency was elite. Board domination 48-27 created extra possessions.",
        "KAT COMPLETE GAME: 16/14reb/6ast/2stl/2blk. His versatility is overwhelming ATL's bigs.",
        "ATL SHOT 31% 3PT: Can't win a series shooting this poorly from deep. 59% FT also hurt.",
        "KUMINGA REGRESSION: 21pts G3 → 13pts G5 off bench. Youth breakout may have peaked.",
        "NYK WON AT ATL G4: 114-98. Already proved they can dominate on the road in this series."
      ],
      prosHome: ["3-2 lead with chance to close — NYK has full control of this series", "Brunson's MSG performances (39pts G5, 28pts G1) show home court elevation", "Brown's McCollum scheme is REPEATABLE: 0 made 3s G4, 0-2 3PT G5", "KAT triple-double-caliber (16/14/6) consistently dominates ATL bigs", "NYK already won AT ATL in G4 by 16 — closing road games is within capability"],
      consHome: ["Away game at State Farm Arena — ATL crowd in elimination could boost energy", "J.Johnson (18/10/6) is ATL's most reliable player — could have a 30pt ceiling game at home", "Daniels' defensive energy on Brunson could disrupt if he plays 35+ min with urgency", "Elimination games historically produce best-effort performances from underdog"],
      prosAway: ["HOME COURT ELIMINATION GAME — crowd energy at State Farm will be maximal", "J.Johnson is averaging 19/9/5 for series — genuine All-Star-level play", "Daniels' overall impact (steals, rebounds, assists) is consistently high", "ATL won G2 and G3 — they've shown they can beat NYK when things click"],
      consAway: ["McCollum (6pts G5) has been completely scheme-broken — no 3PT threat from ATL's secondary creator", "Kuminga's breakout regressed: 21→13pts. Youth breakout persistence NOT guaranteed.", "ATL shot 31% from 3 and 59% from FT — structural shooting problems", "NYK won AT ATL in G4 114-98 — State Farm Arena doesn't guarantee home advantage"]
    },
    modelLessons: [
      {type: "missed", lesson: "G3: Model picked NYK by 6 (medium), ATL won by 1. Overweighted NYK talent edge and FT regression; underweighted ATL's home crowd energy, Kuminga's sustained breakout (now 8→19→21pts trend), and Bridges' complete disappearance (0pts, 4 TOs). Hart's 1-9 shooting was an unforeseen collapse."},
      {type: "underweighted", lesson: "Kuminga's youth breakout is not random variance — it's a genuine level-up. Phase 29 should have flagged this as persistent, not mean-reverting."},
      {type: "overweighted", lesson: "Brunson FT/FG regression narrative was correct in theory but the overall team regression didn't materialize — Hart and Bridges combined for 2pts on 1-12 FG."},
      {type: "correct", lesson: "G4: NYK 114-98 at ATL. Model's manual pick was ATL, but ENGINE correctly projected NYK +4. KAT triple-double 20/10/10. Anunoby 22pts. Brunson hit dagger 3. Brown's McCollum scheme adjustment (0 made 3s) was decisive. LESSON: trust engine talent assessment over narrative picks."},
      {type: "correct", lesson: "G5: NYK 126-97 at MSG. No formal G5 prediction block existed, but based on G4 lesson, engine favored NYK — CORRECT. Brunson MASTERCLASS: 39pts (15-23 FG, 65.2%). NYK shot 57% FG, dominated boards 48-27, never led by fewer than 10 after Q1. ATL had no answer for Brunson's home-court elevation. CONCEPT: 'Home Star Ceiling Games' — elite stars produce their ceiling games disproportionately at home when series is competitive."},
      {type: "underweighted", lesson: "G5: Brunson's 3PT drought (21% through G3) CORRECTED at home: 3-5 (60%) in G5. Model's 3PT regression thesis was right but took longer to materialize because it needed the home court environment. 3PT regression timing correlates with venue."},
      {type: "missed", lesson: "G5: ATL's bench and secondary scoring evaporated on the road. NAW (16pts) and Okongwu (16pts) were the only ATL players to score meaningfully. Kuminga, McCollum, and Daniels all underperformed. Road pressure compounds for lower-seeded teams in G5."},
      {type: "correct", lesson: "G6: NYK 140-89 at ATL. Model predicted NYK 115-104 (HIGH confidence) — got the WINNER correct. NYK closed out the series 4-2. However, margin was catastrophically underestimated: +51 actual vs +11 projected. Largest halftime lead in NBA playoff history. Model had no mechanism for a complete team meltdown by the lower seed in an elimination road game."},
      {type: "missed", lesson: "G6: MARGIN MISS of 40pts is the largest in model history. NYK shot 59% FG with 6 players posting +29 or better. Anunoby 29pts on 11-14 FG and Bridges 24pts on 10-12 FG — both had historically efficient shooting nights. ATL committed 19 turnovers (16 NYK steals). The model cannot predict complete defensive capitulation events."},
      {type: "underweighted", lesson: "G6: ATL's psychological collapse was total — Daniels ejected after a fight, Kuminga -44 in 3-7 shooting, NAW 5 turnovers. Elimination games on the road for lower seeds can produce historically bad performances. Model's 'elimination game energy boost' assumption works for the FAVORED team trying to close, not the underdog."},
      {type: "overweighted", lesson: "G6: Model assumed ATL's home court would keep the game competitive (projected only +11 NYK margin). But ATL's State Farm Arena was irrelevant — NYK fans chanting in ATL (as in G4). Home court advantage evaporates when the home team is psychologically broken."}
    ],
    games: [{num:1,result:"NYK",homeScore:113,awayScore:102,winner:"NYK",notes:"Brunson 28pts/5reb/7ast (19 in Q1, 8/10 FG), Towns 25pts/8reb/4ast/3blk (19 in 2H after 1/6 start), OG 19pts, Hart 10pts/14reb. ATL: McCollum 26pts, J.Johnson 23pts, Okongwu 19pts, NAW 17pts, Daniels 4pts/11ast/9reb/3stl (glue guy). ATL bench crisis: Kuminga 8pts/27min, Gueye+Vincent 5pts combined. NYK held ATL (5th-best post-ASB ORtg) to 102. Brown's halftime transition D adjustment decisive — ATL had 18 fast-break pts in 1H, nearly zero in 2H. WPA: MVP OG Anunoby +20.8%, LVP Daniels -13.0%. NYK dominated all four factors: FG +30.9%, FT +7.9%, Reb +2.7%, TOV +9.6%."},{num:2,result:"ATL",homeScore:106,awayScore:107,winner:"ATL",notes:"ATL 107-106. Series tied 1-1. Hawks erased 12-point Q4 deficit to stun Knicks at MSG. McCollum 32pts (12-22 FG, 3-10 3PT, 5-7 FT) 3reb/6ast, +9 — hunted Brunson in crunch time, hit go-ahead jumpers. Kuminga 19pts off bench (7-12 FG) in 34min, +10 — massive G2 bounce-back. J.Johnson 17pts/8reb/3ast. Okongwu 15pts/8reb (6-9 FG, 2-3 3PT) played through knee inflammation. NYK: Brunson 29pts (10-26 FG, 4-10 3PT) 7ast but 3-11 in Q4s for series. KAT 18pts/8reb (8-12 FG, 14 in Q3). Hart 15/13reb/6ast. OG 14pts but missed 2 crucial FTs with 1:54 left. Bridges 10pts, missed game-winner at buzzer. M.Robinson 13pts/7reb (6-6 FG) but -10. Q4 collapse: NYK 5-22 FG (22.7%), ATL 13-18 (72.2%). ATL won Q4 28-15. NYK shot 63% FT (17-27). Snyder Q4 adjustments: Kuminga on KAT, Okongwu on Hart. NYK bench (McBride/Shamet/Alvarado) combined 0pts on 0-7 FG. Series shifts to Atlanta for G3 Thu."},{num:3,result:"ATL",homeScore:108,awayScore:109,winner:"ATL",notes:"ATL 109-108. ATL leads 2-1. McCollum fadeaway jumper with 12.5sec left for game-winner (23pts). Kuminga 21pts off bench (9-14 FG). J.Johnson 24/10/8. Anunoby led NYK with 29/9/3blk. Brunson 26pts but 0-5 3PT, turned it over on final play — Daniels denied him the ball. Hart had nightmare: 2pts (1-9 FG). Bridges 0pts/21min (possible injury). ATL built 18pt Q1 lead, NYK rallied to take 108-105 lead, but McCollum struck again. Model picked NYK +6 — WRONG by 7pts."},{num:4,result:"NYK",homeScore:114,awayScore:98,winner:"NYK",notes:"NYK 114-98 at ATL. Series tied 2-2. KAT triple-double 20/10/10 (4th Knick ever in playoffs — Frazier, McGuire, Hart). Anunoby 22pts. Brunson 19pts, hit dagger 3 'chef's kiss'. NYK led 68-44 at halftime, never threatened. McCollum contained: 17pts, 0 made 3s (after 9 3s in G1-G3 — Brown's defensive adjustment). J.Johnson held to 14pts. 'Let's go Knicks' chants at State Farm Arena. G4 model pick was ATL — ENGINE predicted NYK +4 which was correct. Manual override was wrong. Lesson: trust engine talent assessment over narrative-based picks for G4+ games."},{num:5,result:"NYK",homeScore:126,awayScore:97,winner:"NYK",notes:"NYK 126-97 at MSG. NYK leads 3-2. BRUNSON MASTERCLASS: 39pts (15-23 FG, 3-5 3PT, 6-8 FT) + 8ast + 1TO in 35min — 65.2% FG. KAT triple-double-caliber: 16/14reb/6ast/2stl/2blk (5-7 FG). OG 17/10reb/2stl/1blk (5-8 FG, 2-3 3PT, 5-5 FT). Alvarado 12pts off bench. NYK shot 57% FG, dominated boards 48-27, led 35-22 after Q1, 64-48 at half. Never led by fewer than 10 after Q1 run. ATL: NAW 16pts, Okongwu 16pts. Hawks shot poorly from 3PT. NYK's defense + Brunson's scoring created SEPARATION from the opening minutes. No G5 prediction existed in model — but G4 lesson taught us to trust engine (which favored NYK). Series goes to ATL for G6 Thu."},{num:6,result:"NYK",homeScore:140,awayScore:89,winner:"NYK",notes:"NYK 140-89 at State Farm Arena. NYK WINS SERIES 4-2. HISTORIC BLOWOUT — largest halftime lead in NBA playoff history. Q scores: NYK 40-43-34-23, ATL 15-21-28-25. NYK shot 59% FG (50-85), 36% 3PT (13-36), 79% FT (27-34), 46reb, 33ast, 9TO, 16stl. ATL shot 38% FG (31-82), 26% 3PT (9-35), 78% FT (18-23), 35reb, 22ast, 19TO, 5stl. NYK: Anunoby 29pts (11-14 FG, 4-6 3PT, 3-5 FT, 7reb, 2ast, 4stl, +42), Bridges 24pts (10-12 FG, 2-2 3PT, 5reb, 3ast, +40), Brunson 17pts (6-12 FG, 1-6 3PT, 4-4 FT, 2reb, 8ast, +41), Hart 14pts (6-10 FG, 2-4 3PT, 5reb, +35), KAT 12pts (1-4 FG, 0-1 3PT, 10-10 FT, 11reb, 10ast — TRIPLE-DOUBLE, +35), M.Robinson 6pts (3-3 FG, 3reb, 2blk, +29). ATL: J.Johnson 21pts (7-15 FG, 2-5 3PT, 5-5 FT, 8reb, 6ast, 3TO, -43), McCollum 11pts (4-13 FG, 1-4 3PT, -24), NAW 11pts (3-8, 5TO, -29), Daniels 3pts (1-4 FG, 2TO, EJECTED after fight, -36), Kuminga 11pts (3-7 FG, -44), Risacher 8pts (4-9). Daniels and Robinson ejected after fight. Model predicted NYK 115-104 (HIGH confidence) — got winner RIGHT but massively underestimated margin (+51 actual vs +11 projected)."},{num:7,result:null,homeScore:null,awayScore:null,winner:null,notes:""}]
  },
  {
    ...
    homeTeam: {
      ...
      players: [
        ...
        { name:"Sam Merrill", pos:"SG", rating:60, ppg:12.8, rpg:2.8, apg:1.8, fgp:44.2, per:14.2, ts:60.5, epm:0.5, bpm:0.2, ws48:.078, onOff:1.0, clutch:5.0, vorp:0.9, usg:20.0, injury:"DAY-TO-DAY — hamstring (exited G1 after 7min, est. return May 7)", lebron:1.289, oLebron:1.567, dLebron:-0.278, war:3.235, offRole:"Movement Shooter", defRole:"Chaser",
    ...
    externalFactors: [
      ...
      { team:"TOR", player:"Immanuel Quickley", desc:"HAMSTRING — OUT until May 5. Has missed all 4 games. TOR has won G2 and G4 without him, proving partial adaptation, but his 16.4 PPG/6.1 APG/.374 3PT is still sorely missed. Won't return for G5.", impact:-5, category:"injury",
        evidence:"CBS Sports (Apr 29): Quickley listed OUT with hamstring, est. return May 5. Has missed the entire series. TOR has adapted by going 2-2 without him — Shead and Walter have filled in admirably — but the halfcourt creation gap is still visible in tight games.",
        sources:["CBS Sports: cbssports.com/nba/injuries"], verdict:"verified" },
    ...
    game4: {
      spread: "TOR -1.5", moneyline: "TOR -125 / CLE +105", ou: "O/U 222.5",
      pick: "TOR", confidence: "low", projScore: "TOR 114 — CLE 110",
      schedule: "Sat Apr 25 — 5:00 PM ET — TNT",
      reasoning: "PHASE 30 PICK: TOR (LOW confidence, COIN FLIP). After Toronto's emphatic 126-104 G3 blowout, the model flips to TOR for G4 at Scotiabank Arena. This is the first time the model has picked against CLE in this series, reflecting G3's seismic shift. (1) SCOTIABANK ARENA FACTOR — TOR's home court was worth far more than the model's 3-4 point HCA estimate. They shot 48% from 3 at home and scored 126 points — the most CLE has allowed all playoffs. (2) BARNES-BARRETT DUAL EXPLOSION — both scored 33pts in G3, combining for 66 on 23-36 FG (63.9%). This wasn't just hot shooting — Barnes had 11ast showing elite playmaking, and Barrett hit 6-8 3PT showing evolved range. CLE has no answer for BOTH being aggressive simultaneously. (3) HARDEN TURNOVER LIABILITY — 8 TOs in G3, CLE had 20 as a team. This isn't new: Harden averaged 4.5 TOs per game in the 2022 and 2023 playoffs. Under Toronto's ball pressure at home, expect continued issues. (4) MURRAY-BOYLES YOUTH BREAKOUT — 22pts/8reb (11-15 FG) off bench. Phase 29 flags him as a sustained breakout candidate. (5) MITCHELL-MOBLEY REGRESSION — Mitchell 15pts (1-7 3PT), Mobley 15pts (4-13 FG). CLE's stars were simultaneously cold for the first time.\n\nCOUNTER: CLE is still 2-1 and historically dominant vs TOR (12-2 all-time playoffs). Teams down 1-2 win game 4 at home ~55% of the time. CLE's 3PT shooting (31% G3) will regress UP. Harden's 8 TOs was an outlier (averaged 3 in G1-G2). Quickley STILL OUT (hamstring, now expected May 5) — TOR is winning without their starting PG. If CLE tightens ball security, their talent advantage reasserts.",
      g3Adjustments: [
        "BLOWOUT ALERT: TOR 126-104 (+22). Largest margin of the series. CLE's defensive scheme was shredded by Barnes/Barrett dual aggression.",
        "BARNES ASCENSION: 21pts G1→26pts G2→33pts/11ast G3. He's now TOR's clear alpha and Mobley cannot contain him when Barrett is also hot.",
        "BARRETT CAREER GAME: 33pts (12-19 FG, 6-8 3PT). His 3PT shooting (6-8 = 75%) won't sustain but his aggressiveness and shot-making are real.",
        "HARDEN 8 TOs: His worst game as a Cavalier. CLE's 20 TOs as a team generated 26 TOR transition points. Ball security was the game's decisive factor.",
        "MURRAY-BOYLES BREAKOUT: 22pts/8reb (11-15 FG, 73.3%). Rookie PF is physically overwhelming CLE's frontcourt. Phase 29 youth breakout confirmed.",
        "BATTLE PERFECT SHOOTING: 14pts (5-5 FG, 4-4 3PT). Bench sharpshooting transforms TOR's offense. Unsustainable efficiency but real confidence.",
        "QUICKLEY STILL OUT: Updated Apr 24 — hamstring now expected May 5. TOR is winning without him, which means his return will be a BOOST, not a necessity.",
        "MITCHELL SILENCED: 15pts (7-16 FG, 1-7 3PT). His 31 PPG average dropped to 20.7 for the series. TOR's home crowd and defensive intensity rattled him.",
        "CLE 3PT COLLAPSE: 14-45 (31.1%). Strus (4-8) was the only reliable shooter. If this continues at TOR, CLE's offense becomes one-dimensional.",
        "INGRAM QUIET BUT EFFICIENT: 12pts (5-9 FG). CLE's scheme on Ingram still works (12.3 PPG for series) but it doesn't matter when Barnes/Barrett combine for 66."
      ],
      prosHome: ["Mitchell dropped from 31 PPG to 15pts — TOR's crowd and defense disrupted him", "Harden's 8 TOs expose a historical playoff weakness that intensifies under pressure", "Mobley regression: 4-13 FG (30.8%) after shooting 67% in G1-G2", "CLE shot 31% from 3 — below their 36.8% season average, suggesting further cold shooting on the road"],
      consHome: ["CLE leads 2-1 — they can afford to lose G4 and still hold series lead", "Harden's 8 TOs was an outlier — he averaged 3 TOs in G1-G2", "CLE's 3PT shooting WILL regress up from 31% — Strus/Merrill/Tyson are proven shooters", "Quickley still out — TOR is operating without their starting PG's spacing and organization"],
      prosAway: ["Scotiabank Arena erupted in G3 — first home playoff game since 2022, crowd energy is REAL", "Barnes trending 21→26→33pts — genuine playoff ascension arc", "Murray-Boyles youth breakout (22pts/8reb) adds a weapon CLE hasn't game-planned for", "TOR transition offense fed by CLE's 20 TOs — systemic ball pressure, not random", "Barrett's 3PT evolution (6-8 G3) spaces the floor in ways CLE's scheme can't cover"],
      consAway: ["Barrett's 6-8 3PT (75%) is wildly unsustainable — expect regression to ~35%", "Battle's 5-5 FG/4-4 3PT was perfect and unrepeatable", "No Quickley means TOR still lacks a true PG — Barnes fills the role but it taxes his energy", "CLE historically dominates TOR (12-2 all-time) — playoff pedigree matters in pressure spots"]
    },
    game5: {
      spread: "CLE -5.5", moneyline: "CLE -230 / TOR +185", ou: "O/U 215.5",
      pick: "CLE", confidence: "medium", projScore: "CLE 108 — TOR 100",
      schedule: "Wed Apr 29 — 7:30 PM ET — ESPN",
      reasoning: "RESULT: CLE 125-120 — Model CORRECT (picked CLE medium). Projected CLE 108-100 (+8), actual CLE 125-120 (+5). Winner correct but scoring was 37pts higher than projected (245 total vs 208). Ingram played only 11 minutes (1pt) — possible injury or matchup benching. Walter MASSIVELY bounced back: 20pts (6-14 3PT) after going 0-9 in G4. Schroder 19pts off CLE bench continues to prove depth advantage. Harden had 23pts/9reb/5ast but 6 TOs — turnover liability is a permanent feature. Mobley was excellent: 23pts (8-13, 3-3 3PT)/9reb/3blk. TOR's Q4 collapse (17pts vs CLE's 25) was decisive — home court closing power.",
      g4Adjustments: [
        "G4 SHOOTING NIGHTMARE: CLE 37% FG (25% 3PT), TOR 32% FG (13% 3PT). Both teams at historic lows. Expect heavy regression up for both.",
        "TOR WON ON FTs: 27-36 FT vs CLE's 15-23 FT. Barnes 11-14 FT, Ingram 8-9 FT. Net +12 FT points = entire margin of victory.",
        "MITCHELL 6-24 FG (25%): Worst shooting game of series. Home court + bounce-back tendency = project 28-32pts in G5.",
        "HARDEN 7 TOs: Now averaging 6.5 TOs in G3-G4. Turnover liability is systemic under TOR's ball pressure.",
        "WALTER 0-9 FG: TOR's starting guard was invisible. But TOR won anyway — depth resilience.",
        "MURRAY-BOYLES 15/10: Continued breakout off bench. CLE has no answer for his interior scoring.",
        "HOME COURT RETURNS TO CLE: CLE won both home games by double digits (126-113, 115-105). Rocket Mortgage is their fortress."
      ],
      prosHome: ["HOME COURT: CLE won G1 by 13 and G2 by 10 at Rocket Mortgage FieldHouse", "Mitchell bounce-back inevitable after 6-24 (25%) shooting — season average is 47.5%", "3PT regression: CLE shot 25% from 3 in G4 vs 36.8% season — massive correction expected at home", "Twin towers (Mobley/Allen) dominate paint at home — 48-30 paint advantage in G1"],
      consHome: ["Harden turnover liability (6.5 TOs avg G3-G4) worsens under pressure", "CLE DRtg concerning — allowed TOR to win G4 shooting just 32% through sheer FT volume", "Allen knee tendonitis could limit him as series extends", "CLE's complacency after 2-0 lead led to losing both road games"],
      prosAway: ["Barnes playoff ascension: 21→26→33→23pts — TOR's alpha has arrived", "Murray-Boyles youth breakout sustained: 14→17→22→15pts off bench", "TOR won G3 by 22 and G4 by 4 — different styles, same result. Adaptable team.", "FT aggression won G4 — TOR attacked the paint and got to the line"],
      consAway: ["ROAD game at Rocket Mortgage where CLE won both by double digits", "Quickley still out (hamstring, May 5) — missing starting PG's spacing", "Walter 0-9 FG in G4 — if he can't shoot, TOR loses floor spacing", "TOR shot 32% FG and 13% 3PT in G4 — can't sustain winning while shooting that poorly"]
    },
    game6: {
      spread: "CLE -4.5", moneyline: "CLE -200 / TOR +165", ou: "O/U 218.5",
      pick: "CLE", confidence: "medium", projScore: "CLE 114 — TOR 108",
      schedule: "Fri May 1 — 7:30 PM ET — Prime Video",
      reasoning: "MODEL PICK: CLE (MEDIUM confidence, COMPETITIVE). CLE takes a 3-2 lead to Toronto and the market has them as 4.5-point road favorites — a significant line for a road closeout game. Three factors justify upgrading from LOW to MEDIUM confidence: (1) INGRAM DOUBTFUL (heel, downgraded per ESPN) — TOR may be without their SF for the 2nd straight game. Ingram played only 11min/1pt in G5. Without him, TOR loses a 20+PPG scorer and becomes dangerously thin. (2) CLE's talent surplus (Mitchell, Harden, Mobley, Schroder off bench) gives them multiple ways to win — they've won all 3 home games AND showed they can win on the road in a series they control. (3) Mobley's evolution (23pts/9reb/3blk G5, 3-3 3PT) adds a third star-level option that TOR can't match.\n\nHowever, TOR's home court has been dominant — they won G3 by 22 and G4 by 4 at Scotiabank. Barnes plays his best at home and is TOR's alpha. Elimination games produce maximum desperation. But TOR's Q4 collapse in G5 (17pts) raises serious closing concerns even at home.\n\nWHY MEDIUM NOT HIGH: Harden's turnover liability (21 TOs in last 3 games) is a ticking time bomb in a hostile environment. Scotiabank Arena's crowd energy is real. TOR has shown they can win ugly (93-89 G4 on 32% FG). But the Ingram downgrade tilts this firmly toward CLE.",
      g5Adjustments: [
        "CLE WON G5 125-120: Home court advantage held — CLE has won all 3 home games.",
        "INGRAM DOUBTFUL G6 (heel) — downgraded per ESPN. Played only 11min/1pt in G5. TOR may be without him again.",
        "WALTER BOUNCE-BACK: 20pts (6-14 3PT) after 0-9 G4. Shooting regression confirmed — but will it travel?",
        "SCHRODER 19pts OFF BENCH: CLE's depth advantage continues to be the series' defining feature.",
        "HARDEN 6 TOs: 21 TOs in last 3 games. Systemic ball security issue under TOR pressure.",
        "MOBLEY 23/9/3blk (3-3 3PT): Best game of series. His evolution to 3-level scorer changes the math.",
        "SERIES GOES TO TORONTO: Scotiabank Arena where TOR won G3 by 22 and G4 by 4.",
        "TOR Q4 COLLAPSE: Only 17pts in Q4 vs CLE's 25. Closing ability is a concern for TOR on the road — but at home?",
        "MARKET SHIFT: CLE now -4.5 ROAD favorite. Ingram's downgrade + CLE talent surplus = market strongly favors CLE.",
        "QUICKLEY STILL OUT (hamstring, May 5) — TOR missing starting PG for entire series."
      ],
      prosHome: ["3-2 lead: One win from advancing — closeout mentality", "Mobley's evolution to 3-level scorer (23/9/3blk, 3-3 3PT G5) changes matchup dynamics", "Schroder 19pts — CLE bench provides reliable 30+ pts every game", "CLE has multiple closers (Mitchell, Harden, Mobley) — hard to scheme for all three", "Market favors CLE at -4.5 even on the road — talent gap is undeniable"],
      consHome: ["ROAD game at Scotiabank where TOR is unbeatable so far (2-0 at home)", "Harden's 21 TOs in last 3 games — hostile crowd will amplify pressure", "Mitchell only 19pts in G5 — below his 27.9 season avg, may be fatigued", "TOR's home defense has been elite — held CLE to below season averages in G3-G4"],
      prosAway: ["Scotiabank Arena: TOR won both home games (G3 by 22, G4 by 4)", "Barnes plays best at home — 33pts in G3, near triple-double in G4", "Desperation: Elimination game at home brings maximum intensity", "TOR's crowd energy at Scotiabank was historic in G3 — playoff atmosphere"],
      consAway: ["INGRAM DOUBTFUL (heel) — TOR may be without 20+ PPG scorer for 2nd straight game", "TOR Q4 collapse in G5 (17pts) raises closing concerns even at home", "Quickley still out — missing starting PG's playmaking and spacing for entire series", "Murray-Boyles cooled off (8pts G5 after 14→17→22→15) — youth inconsistency", "CLE's bench depth (36pts G5) overwhelms TOR's thin depth every game"]
    },
    game7: {
      spread: "CLE -8.5", moneyline: "CLE -333 / TOR +260", ou: "O/U 211.5",
      pick: "CLE", confidence: "medium", projScore: "CLE 112 — TOR 104",
      schedule: "Sun May 3 — 7:30 PM ET — NBC/Peacock",
      reasoning: "MODEL PICK: CLE (MEDIUM confidence, COMPETITIVE). CLE returns home to Rocket Mortgage FieldHouse where they are 3-0 this series (G1 +13, G2 +10, G5 +5) with an average margin of +9.3pts. The market agrees at -8.5, the largest home spread of any G7 this round. Three factors favor CLE: (1) HOME COURT DOMINANCE — CLE has won ALL three home games by comfortable margins. Their offense at Rocket Mortgage (avg 122pts) vs road (avg 101pts) is a 21-point scoring differential. Mitchell, Harden, and Mobley all perform better at home. (2) TALENT SURPLUS — CLE has three star-caliber players (Mitchell 24.3ppg series, Mobley 21.5ppg, Harden 20.7ppg) plus elite bench depth (Schroder, Wade, Merrill). TOR is missing Ingram (heel) and Quickley (hamstring) — their two best players after Barnes/Barrett. (3) MOBLEY'S EVOLUTION — Mobley's 26/14 G6 (9-15 FG, 3-7 3PT) confirmed his ascension to a three-level scorer. He's no longer just a defensive anchor; he's CLE's most efficient offensive weapon.\n\nHOWEVER: The model's confidence is MEDIUM not HIGH because TOR has defied expectations all series. Barnes' 14-assist G6 showed a facilitator gear the model didn't project. Walter (24pts G6) has emerged as a legitimate scoring option. Murray-Boyles (17pts/7reb/3blk) continues to overperform his rookie status. TOR has shown they can win ugly (G4: 93-89 on 32% FG) and in OT thrillers (G6: 112-110). Their resilience is real.\n\nKEY VARIABLE: Harden's turnovers. He's had 25 TOs in the last 4 games (avg 6.25/game). In a high-pressure G7, Scotiabank-level ball pressure at Rocket Mortgage could trigger another TO epidemic. If Harden has 7+ TOs, TOR has a real chance despite venue disadvantage.\n\nWHY NOT HIGH: TOR won G6 112-110 OT at Scotiabank. Barnes/Walter/Murray-Boyles form a core that has proven it can compete with CLE's stars. Home court is worth ~9pts for CLE, but TOR's ceiling in elimination games is higher than any model can capture. The 3-3 series proves these teams are closer than the talent gap suggests.",
      g6Adjustments: [
        "TOR WON G6 112-110 OT at Scotiabank Arena. Series tied 3-3.",
        "BARNES FACILITATOR MODE: 25pts/14ast career-high playoff assists. Transformed TOR's offense through playmaking.",
        "WALTER BREAKOUT: 24pts (7-13 FG, 4-9 3PT, 6-6 FT). TOR's legitimate #2 scorer when Ingram is out.",
        "MURRAY-BOYLES CONTINUED: 17pts/7reb/3blk. Undrafted rookie playing starter-level basketball.",
        "MOBLEY 26/14 IN A LOSS: Monster game but CLE still lost. Even 26/14 from Mobley wasn't enough at Scotiabank.",
        "MITCHELL 2-10 3PT G6: His 3PT shooting at TOR is 5-26 (19.2%) in last 3 games. Venue-suppressed.",
        "HARDEN 4 TOs G6: 25 TOs in last 4 games. Turnover liability finally cost CLE in tight G6.",
        "CLE BENCH DISAPPEARED: Schroder 7pts (0-4 FG), total bench 14pts vs 36pts G5. Venue-dependent.",
        "INGRAM STILL OUT (heel) — TOR confirmed without him for G7.",
        "QUICKLEY STILL OUT (hamstring, May 5) — TOR missing starting PG entire series.",
        "SERIES RETURNS TO ROCKET MORTGAGE: CLE 3-0 at home (avg +9.3pts margin)."
      ],
      prosHome: ["HOME FORTRESS: CLE 3-0 at Rocket Mortgage (G1 +13, G2 +10, G5 +5) — avg +9.3pt margin", "TALENT SURPLUS: Mitchell (24.3ppg) + Mobley (21.5ppg) + Harden (20.7ppg) = three stars", "MOBLEY ASCENSION: 26/14 G6 confirmed three-level scorer. CLE's most efficient weapon.", "BENCH DEPTH AT HOME: Schroder averaged 15pts at Rocket Mortgage vs 7pts on road", "MARKET AGREES: -8.5 spread is the largest G7 home spread this round", "Mitchell's home shooting: 49% FG at Rocket Mortgage vs 38% on road this series"],
      consHome: ["HARDEN TURNOVER BOMB: 25 TOs in last 4 games. G7 pressure amplifies the liability.", "Mitchell 3PT struggles (2-10 G6) may not fully correct even at home", "TOR HAS PROVEN RESILIENCE: Won G6 OT despite being road underdog. Can't be counted out.", "CLE BLEW 3-2 LEAD: Losing G6 at TOR when favored -4.5 raises questions about closing ability"],
      prosAway: ["BARNES IN G7 MODE: 14ast G6 showed facilitator gear. At his best, he's a top-15 player.", "WALTER AS #2: 24pts G6 — no longer a role player, he's TOR's reliable second option", "MURRAY-BOYLES FEARLESS: 17/7/3blk as a rookie. No stage is too big for him.", "TOR's ELIMINATION RESILIENCE: Won G3, G4, G6 when facing elimination. They know how to survive.", "INGRAM'S ABSENCE MAY HELP: TOR is 2-1 without Ingram (excl G5 road loss). Walter/Barnes are better with more usage."],
      consAway: ["ROAD game at Rocket Mortgage where CLE is 3-0 with avg +9.3pt margin", "INGRAM OUT — TOR missing 20+ PPG scorer", "QUICKLEY OUT — TOR missing starting PG's playmaking for entire series", "TOR has NEVER won at Rocket Mortgage this series (0-3)", "CLE's home defense is elite — held TOR below 115pts in all 3 home games", "Barrett's 5 TOs G6 — ball security issues match Harden's but without the talent surplus"]
    },
    modelLessons: [
      {type: "missed", lesson: "G3: Model picked CLE by 7 (medium), TOR won by 22. MASSIVE miss — 29-point swing from projection. Underestimated home crowd impact at Scotiabank Arena and Harden's turnover liability (8 TOs). Barnes-Barrett dual 33-point explosion was unprecedented. Murray-Boyles youth breakout (22pts/8reb) should have been flagged."},
      {type: "underweighted", lesson: "TOR's home court was worth far more than the 3-4 point HCA model assigned. First playoff game at Scotiabank generated elite crowd energy. TOR shot 48% from 3 at home."},
      {type: "overweighted", lesson: "CLE's 'scheme lock' on Ingram was real (12pts) but irrelevant when Barrett and Barnes both scored 33. The model focused too much on suppressing one player rather than TOR's collective ceiling."},
      {type: "missed", lesson: "Quickley's ABSENCE didn't matter — TOR won by 22 WITHOUT him. The model overweighted Quickley's return as transformative when Barnes/Barrett/Murray-Boyles were already enough."},
      {type: "correct", lesson: "G4: Model correctly picked TOR winner (LOW confidence). TOR 93-89. First correct pick of the series after going 0-1 in G3."},
      {type: "overweighted", lesson: "G4: Projected 114-110 (high-scoring) but actual was 93-89 (defensive grind). Both teams shot historically poorly: CLE 37% FG (25% 3PT), TOR 32% FG (13% 3PT). The model's scoring projections assumed regression to mean shooting — instead both teams got WORSE."},
      {type: "missed", lesson: "G4: Mitchell had worst shooting game of series (6-24 FG, 25%). Model assumed he'd maintain 25-32pt range. The Scotiabank Arena crowd and fatigue from tight G3 suppressed CLE's stars."},
      {type: "underweighted", lesson: "G4: TOR won on free throws (27-36 vs 15-23 FT). Barnes had 11-14 FT. The free throw differential (+12 net points) was the entire margin of victory. Model has no mechanism for FT variance."},
      {type: "missed", lesson: "G4: Walter went 0-9 FG (0-8 3PT) — TOR's starting guard was a complete zero. But TOR won anyway because Murray-Boyles (15pts/10reb) and depth compensated. Model overweights individual star performance vs team resilience."},
      {type: "correct", lesson: "G5: Model picked CLE at home (medium confidence). CLE 125-120. Winner correct. CLE's home court dominance pattern held — they've won all 3 home games this series."},
      {type: "missed", lesson: "G5: Projected 208 total, actual 245 — 37pts too low. Both teams shot well: CLE 50% 3PT, TOR 32% FG. The model's scoring projections consistently underestimate high-scoring games in this series."},
      {type: "missed", lesson: "G5: Ingram played only 11 minutes (1pt, 0-2 FG). This is a MASSIVE variable the model missed. Whether injury, benching, or matchup — losing your SF for 37 minutes fundamentally changes TOR's offensive structure."},
      {type: "correct", lesson: "G5: Walter bounce-back CONFIRMED — 20pts (6-14 3PT) after 0-9 G4. This validates the model's shooting regression principle: extreme cold shooting is unsustainable. Walter regressed hard to the mean."},
      {type: "underweighted", lesson: "G5: CLE bench depth decisive AGAIN — Schroder 19pts (7-11), Merrill 9pts, Tyson 8pts = 36pts off bench. CLE's bench has been a force multiplier all series. Model needs stronger bench depth coefficient."},
      {type: "missed", lesson: "G5: Harden's 6 TOs continue systemic pattern (G3: 8 TOs, G4: 7 TOs, G5: 6 TOs). Despite CLE winning, Harden's ball security is a ticking time bomb — 21 TOs in last 3 games. Model correctly flagged this but it hasn't cost CLE yet due to talent surplus."},
      {type: "missed", lesson: "G6: Model picked CLE (medium confidence). TOR won 112-110 OT. WRONG winner. Projected CLE +6, actual TOR +2. 8-point miss. Model is now 3-3 on this series (correct G1, G2, G4, G5; wrong G3, G6)."},
      {type: "underweighted", lesson: "G6: Barnes' facilitator mode (25pts/14ast career-high playoff assists) was the decisive factor. Model projected Barnes as a scorer but his playmaking transformed TOR's offense. 14 assists from a forward is historically elite — model has no mechanism for positional playmaking ceilings."},
      {type: "missed", lesson: "G6: Walter sustained his G5 bounce-back — 24pts (7-13 FG, 4-9 3PT, 6-6 FT). He's no longer a variance player; he's TOR's legitimate #2 scorer when Ingram is out. Model treated Walter as a role player when he's playing starter-level basketball."},
      {type: "correct", lesson: "G6: Harden's turnover liability FINALLY cost CLE — 4 TOs in a 2-point OT loss. The ticking time bomb the model flagged for 3 games (G3: 8, G4: 7, G5: 6, G6: 4) exploded when the margin was razor-thin. Every turnover matters in OT."},
      {type: "missed", lesson: "G6: TOR's home court dominance continued — now 3-0 at Scotiabank Arena (G3 +22, G4 +4, G6 +2 OT). The model assigned standard 3-4pt HCA but TOR's home advantage has been 9.3pts on average. Scotiabank is a genuine fortress."},
      {type: "missed", lesson: "G6: CLE's bench disappeared — Schroder 7pts (0-4 FG), Merrill 2pts, Tyson 5pts = 14pts total vs 36pts in G5. The bench depth advantage that defined CLE evaporated on the road. Model assumed bench production was stable; it's heavily venue-dependent."},
      {type: "missed", lesson: "G6: Murray-Boyles continued emergence (17pts/7reb/3blk) — now averaging 15.8pts over last 4 games. The undrafted rookie is playing like a starting-caliber player. Model's rookie discount was too aggressive for players who've already proven themselves."},
      {type: "overweighted", lesson: "G6: Ingram's absence was overweighted as a negative for TOR. TOR is now 2-0 without Ingram (G5 loss was at CLE). Without Ingram, Walter gets more shots and Barnes becomes the full-time facilitator — both outcomes are arguably BETTER for TOR's offense."},
      {type: "missed", lesson: "G6: Mitchell's 3PT struggles continued — 2-10 (20%) from 3. He's now 5-26 (19.2%) from 3PT in last 3 games. At Scotiabank, Mitchell's deep shooting is suppressed. Model needs venue-adjusted 3PT projections."}
    ],
    coaching: {
      home: {
  ...
  // ============================================================
  {
    ...
    game1: {
      spread: "OKC -15.5",
      moneyline: "OKC -900 / LAL +600",
      ou: "O/U 213.5",
      pick: "OKC",
      confidence: "high",
      projScore: "OKC 116 — LAL 101",
      reasoning: "OKC is the most complete team in the NBA (64-18, +11.6 NetRtg) facing LAL still missing Doncic. Jalen Williams OUT G1 (hamstring, expected return ~May 7 per CBS Sports May 5 update) but OKC swept PHX without him. SGA (31.1ppg, 67% TS) + Holmgren + Hartenstein + elite bench. 11 days rest vs 4. OKC went 4-0 vs LAL in reg season (avg margin 31.8pts). LeBron fatigue risk at 41 with 4 days rest after 6-game R1. DraftKings line: OKC -15.5 / ML -900.",
      prosHome: [
    ...
    compoundScenarios: {
      ...
      "Luke Kennard": [
        { label:"Kennard vs OKC elite wing D",
          ...
          source:"Kennard R1 avg 25ppg vs HOU but G1 vs OKC: 7pts in 29min (1-4 FG, 1-3 3PT, 4-4 FT, -14). OKC wing D (Dort/Caruso/Wallace) neutralized off-screen action. Dort/Caruso shadow movement shooters — Kennard's R1 breakout vs HOU was against weaker perimeter D. Drew fouls (4-4 FT) but shooting was shut down. Historically 40% 3PT drops to ~28% vs top-5 defenses."
        }
      ]
    },
    homeTeam: {
    ...
    awayTeam: {
      ...
      players: [
        ...
        { name:"Luka Doncic", pos:"PG", rating:0, ppg:31.4, rpg:8.8, apg:7.9, fgp:48.7, per:29.8, ts:60.1, epm:7.9, bpm:9.1, ws48:.224, onOff:10.2, clutch:7.5, vorp:7.1, usg:34.2, injury:"OUT — Grade 2 hamstring (improving, Doncic says he feels better every day per ESPN May 6)", lebron:5.176, oLebron:5.622, dLebron:-0.446, war:10.733, offRole:"Shot Creator", defRole:"Helper",
        ...
        { name:"Jarred Vanderbilt", pos:"PF", rating:50, ppg:5.2, rpg:5.8, apg:1.0, fgp:48.5, per:10.5, ts:54.0, epm:-0.2, bpm:-0.8, ws48:.060, onOff:0.3, clutch:3.5, vorp:0.3, usg:10.2, injury:"DAY-TO-DAY — dislocated right finger (May 6, est. return May 7)", lebron:-1.5, oLebron:-2.0, dLebron:0.5, war:1.0, offRole:"Cutter", defRole:"Wing Stopper",
    ...
    externalFactors: [
      ...
      { team:"OKC", player:null, desc:"Bench depth devastating in G1. McCain 12pts (4-5 3PT, +4), Caruso (+15), Joe 9pts (+11), Wallace 5pts/3stl (+11). OKC bench depth unsolvable for LAL.", impact:5, category:"depth", evidence:"G1: Every OKC rotation player was positive. McCain was an unexpected spark (12pts off bench). LAL bench: Hayes -12, Kennard -14, LaRavia -9. No answer.", verdict:"verified" },
      ...
      { team:"LAL", player:"Austin Reaves", desc:"Oblique strain far worse than modeled — 3-16 FG (19%), 0-5 3PT, 4 TOs, -10 in 36min G1. Operating at ~50% capacity vs OKC switching. LAL's #2 creator is severely compromised.", impact:-6, category:"injury", evidence:"G1: 8pts on 3-16 FG (19%), 0-5 3PT, 6ast but 4 TOs. Cannot generate explosion for drives. Model was at 80% — actual performance suggests 50-55% at best. OKC switching D (Dort/Caruso) compounds oblique limitation.", verdict:"verified" },
      ...
      { team:"LAL", player:"Jarred Vanderbilt", desc:"NEW INJURY: Dislocated right finger from G1 — Day-to-day, est. return May 7. Minor depth loss but LAL already paper-thin off bench.", impact:-1, category:"injury", evidence:"ESPN injury report May 6: Vanderbilt dislocated right finger per LA Times. Played only 6min in G1 (2pts, 1-2 FG, -4). If OUT for G2, LAL rotation shrinks to 8 players.", verdict:"verified" },
      { team:"LAL", player:"Luke Kennard", desc:"Demoted from starting role to 29min bench role in G1 (7pts, 1-4 FG, 1-3 3PT, -14). OKC wing defense (Dort/Caruso/Wallace) completely neutralized his off-screen action that torched HOU in R1.", impact:-3, category:"matchup", evidence:"G1: 7pts in 29min (1-4 FG, 4-4 FT), -14. R1 avg was 25ppg on 65% FG — OKC defense is a totally different tier. Hachimura starting over him. Drew fouls (4-4 FT) but could not generate open looks vs OKC switching.", verdict:"verified" }
    ],
    games: [
      {num:1,result:"OKC",homeScore:108,awayScore:90,winner:"OKC",prediction:{homeWin:true,homeScore:116,awayScore:101,margin:15,confidence:"HIGH",character:"SEPARATION",reasoning:"OKC is the most complete team in the NBA (64-18, +11.6 NetRtg) facing a LAL team still missing Doncic. Jalen Williams OUT (Grade 1 left hamstring strain, expected return ~May 7 per CBS Sports May 5 update). OKC swept PHX without Williams in G3-G4, proving depth can compensate — Wiggins, Wallace, and Joe absorbed his minutes effectively. OKC still has SGA (31.1ppg, 67% TS) + Holmgren + Hartenstein + elite bench. Rest advantage (11 days vs 4) remains massive. OKC went 4-0 vs LAL in the regular season with avg margin of 31.8pts. SGA will feast on LAL's limited perimeter defense beyond Smart. LeBron at 41 with only 4 days rest after a 6-game R1 is a fatigue risk. Holmgren's length neutralizes Ayton. OKC depth (Mitchell, Wallace, Joe, Caruso) means no drop-off when SGA sits. Market has OKC -15.5 / ML -900 — enormous line reflecting the talent/rest gap. OKC's defense (108.2 DRtg, #2) will suffocate LAL's limited creation without Doncic.",xFactor:"SGA",moneyline:"OKC -900 / LAL +600",spread:"OKC -15.5",ou:"O/U 213.5"},notes:"OKC 108-90 at Paycom Center. OKC leads 1-0. Winner ✅ (OKC +18 actual vs +15 predicted). Total under: predicted 217, actual 198. Defense dominated — LAL shot 41% FG, 33% 3PT. OKC shot 49% FG, 43% 3PT. Q scores: LAL 26-27-19-18, OKC 31-30-23-24. OKC led every quarter. Holmgren DOMINANT: 24pts/12reb/3blk on 9-17 FG. SGA had off night: 18pts but 7 TOs — still won by 18 showing floor is absurd. Mitchell 18pts/+14 as starter. Jared McCain bench spark: 12pts (4-5 3PT, +4). Reaves CATASTROPHIC: 8pts on 3-16 FG (19%), 0-5 3PT, 4 TOs. LeBron was brilliant (27pts, 12-17 FG) but got zero support. Smart 4-15 (27%), Kennard 7pts in 29min (1-4 FG), Hachimura 18pts but -21. LAL 17 TOs. OKC bench depth devastating: every bench player +4 or better.",
        boxScores:{
          home:[
            {name:"Isaiah Hartenstein",min:25,pts:8,reb:9,ast:4,stl:1,blk:1,fg:"3-3",threes:"0-0",ft:"2-2",plusMinus:5,to:0},
            {name:"Chet Holmgren",min:31,pts:24,reb:12,ast:1,stl:1,blk:3,fg:"9-17",threes:"2-2",ft:"4-4",plusMinus:10,to:0},
            {name:"Shai Gilgeous-Alexander",min:35,pts:18,reb:2,ast:6,stl:1,blk:2,fg:"8-15",threes:"0-1",ft:"2-3",plusMinus:9,to:7},
            {name:"Lu Dort",min:28,pts:6,reb:3,ast:4,stl:0,blk:0,fg:"2-5",threes:"2-5",ft:"0-0",plusMinus:2,to:2},
            {name:"Ajay Mitchell",min:28,pts:18,reb:2,ast:4,stl:0,blk:0,fg:"7-16",threes:"1-5",ft:"3-3",plusMinus:14,to:1},
            {name:"Jaylin Williams",min:20,pts:3,reb:7,ast:3,stl:1,blk:0,fg:"1-3",threes:"1-2",ft:"0-0",plusMinus:11,to:2},
            {name:"Alex Caruso",min:20,pts:5,reb:2,ast:2,stl:0,blk:0,fg:"2-5",threes:"1-4",ft:"0-0",plusMinus:15,to:0},
            {name:"Isaiah Joe",min:11,pts:9,reb:1,ast:1,stl:1,blk:0,fg:"4-6",threes:"1-3",ft:"0-0",plusMinus:11,to:0},
            {name:"Cason Wallace",min:19,pts:5,reb:4,ast:2,stl:3,blk:1,fg:"2-6",threes:"1-3",ft:"0-0",plusMinus:11,to:2},
            {name:"Jared McCain",min:15,pts:12,reb:2,ast:2,stl:0,blk:0,fg:"4-7",threes:"4-5",ft:"0-0",plusMinus:4,to:0},
            {name:"Kenrich Williams",min:2,pts:0,reb:0,ast:0,stl:0,blk:0,fg:"0-0",threes:"0-0",ft:"0-0",plusMinus:0,to:0},
            {name:"Aaron Wiggins",min:5,pts:0,reb:0,ast:0,stl:0,blk:0,fg:"0-2",threes:"0-0",ft:"0-0",plusMinus:-2,to:0}
          ],
          away:[
            {name:"LeBron James",min:36,pts:27,reb:4,ast:6,stl:1,blk:0,fg:"12-17",threes:"3-6",ft:"0-1",plusMinus:-6,to:2},
            {name:"Rui Hachimura",min:37,pts:18,reb:2,ast:2,stl:1,blk:1,fg:"7-13",threes:"3-6",ft:"1-2",plusMinus:-21,to:1},
            {name:"Deandre Ayton",min:27,pts:10,reb:12,ast:2,stl:0,blk:1,fg:"5-12",threes:"0-0",ft:"0-0",plusMinus:-4,to:1},
            {name:"Marcus Smart",min:32,pts:12,reb:4,ast:7,stl:4,blk:0,fg:"4-15",threes:"2-8",ft:"2-2",plusMinus:-10,to:2},
            {name:"Austin Reaves",min:36,pts:8,reb:5,ast:6,stl:0,blk:1,fg:"3-16",threes:"0-5",ft:"2-2",plusMinus:-10,to:4},
            {name:"Jarred Vanderbilt",min:6,pts:2,reb:1,ast:0,stl:0,blk:0,fg:"1-2",threes:"0-1",ft:"0-0",plusMinus:-4,to:0},
            {name:"Jake LaRavia",min:14,pts:3,reb:1,ast:0,stl:1,blk:1,fg:"1-2",threes:"1-1",ft:"0-0",plusMinus:-9,to:2},
            {name:"Jaxson Hayes",min:16,pts:3,reb:6,ast:1,stl:0,blk:0,fg:"1-3",threes:"0-0",ft:"1-2",plusMinus:-12,to:3},
            {name:"Luke Kennard",min:29,pts:7,reb:5,ast:1,stl:1,blk:0,fg:"1-4",threes:"1-3",ft:"4-4",plusMinus:-14,to:2},
            {name:"Bronny James",min:2,pts:0,reb:0,ast:1,stl:0,blk:0,fg:"0-0",threes:"0-0",ft:"0-0",plusMinus:0,to:0}
          ]
        }
      },
      {num:2,result:"OKC",homeScore:125,awayScore:107,winner:"OKC",prediction:{homeWin:true,homeScore:112,awayScore:94,margin:18,confidence:"HIGH",character:"SEPARATION",reasoning:"G1 confirmed OKC's structural dominance (108-90, +18). LAL shot 42% FG and 33% 3PT against OKC's elite defense. Reaves was catastrophic (3-16 FG, 0-5 3PT) — oblique clearly still limiting him significantly. J.Williams returned from hamstring (20min, 3/7/3, +11) and adds more creation for G2 with increased minutes. OKC's bench depth was devastating: every bench player finished +11 or better. SGA had 7 TOs and still won by 18 — his floor is that high with this supporting cast. Holmgren dominated (24/12/3blk) as the clear best big on the floor. LeBron put up 27pts efficiently (12-17 FG) but got ZERO help — no other Laker scored 20+. Hachimura started over Kennard and was -21. OKC's defensive versatility (Dort/Caruso/Wallace) suffocated LAL's limited creation. With J.Williams ramping up minutes in G2 and both teams on equal rest now, OKC gets even stronger. LAL has no answer to the depth/talent gap. Adjusting total DOWN — G1 actual was 198 (vs 213.5 O/U). Both defenses locked in; pace was slow as LAL ground to halt in half-court vs OKC length. SGA will be more efficient G2 (7 TOs in G1 is a massive outlier — career avg 2.8 in playoffs).",xFactor:"Jalen Williams ramp-up",moneyline:"OKC -800 / LAL +550",spread:"OKC -14.5",ou:"O/U 204.5"},notes:"OKC 125-107 at Paycom Center. OKC leads 2-0. Winner ✅ (OKC +18 actual = +18 predicted). Total over: predicted 206, actual 232. Holmgren 22/9reb/3ast/4stl/2blk. SGA 22pts (foul trouble limited to 28min). Ajay Mitchell breakout: 20pts/7reb/6stl on 7-12 FG — bench MVP. McCain 18pts (7-11, 4-5 3PT) off bench. Reaves bounced back for LAL: game-high 31pts on 10-16 FG (3-6 3PT, 8-10 FT, 5stl) but also 5 TOs. LeBron 23/6reb/3ast on 9-18 FG. Hachimura 16pts (4-7 3PT). Smart 14/5ast/3stl. LAL shot 50% FG, 38% 3PT but OKC's 56% FG and 39% 3PT was better. Ayton struggled: 3pts on 1-7 FG. OKC depth devastating again: 7 bench players contributed, Wallace 12pts/4ast, Caruso 5/4/4. Q scores: LAL 23-35-22-27, OKC 27-30-36-32.",
        boxScores:{
          home:[
            {name:"Isaiah Hartenstein",min:27,pts:10,reb:9,ast:1,stl:1,blk:2,fg:"5-6",threes:"0-0",ft:"0-0",to:2,pm:13},
            {name:"Chet Holmgren",min:32,pts:22,reb:9,ast:3,stl:4,blk:2,fg:"7-11",threes:"3-5",ft:"5-7",to:3,pm:19},
            {name:"Shai Gilgeous-Alexander",min:28,pts:22,reb:2,ast:3,stl:1,blk:0,fg:"7-13",threes:"1-3",ft:"7-9",to:2,pm:5},
            {name:"Luguentz Dort",min:23,pts:3,reb:1,ast:2,stl:2,blk:1,fg:"1-6",threes:"1-6",ft:"0-0",to:0,pm:-13},
            {name:"Ajay Mitchell",min:30,pts:20,reb:7,ast:3,stl:6,blk:2,fg:"7-12",threes:"0-3",ft:"6-7",to:0,pm:18},
            {name:"Jaylin Williams",min:15,pts:7,reb:2,ast:1,stl:0,blk:0,fg:"2-4",threes:"2-4",ft:"1-1",to:0,pm:12},
            {name:"Alex Caruso",min:22,pts:5,reb:4,ast:4,stl:1,blk:0,fg:"2-6",threes:"1-5",ft:"0-0",to:0,pm:17},
            {name:"Kenrich Williams",min:20,pts:0,reb:0,ast:0,stl:0,blk:0,fg:"0-1",threes:"0-1",ft:"0-0",to:0,pm:19},
            {name:"Isaiah Joe",min:9,pts:4,reb:0,ast:0,stl:0,blk:0,fg:"2-3",threes:"0-1",ft:"0-0",to:0,pm:-1},
            {name:"Aaron Wiggins",min:20,pts:0,reb:0,ast:0,stl:0,blk:1,fg:"0-0",threes:"0-0",ft:"0-0",to:0,pm:0},
            {name:"Cason Wallace",min:11,pts:12,reb:2,ast:4,stl:0,blk:1,fg:"4-7",threes:"2-3",ft:"2-2",to:1,pm:13},
            {name:"Jared McCain",min:18,pts:18,reb:0,ast:1,stl:0,blk:0,fg:"7-11",threes:"4-5",ft:"0-0",to:0,pm:17},
            {name:"Nikola Topic",min:2,pts:1,reb:0,ast:0,stl:0,blk:0,fg:"0-1",threes:"0-0",ft:"1-1",to:0,pm:0}
          ],
          away:[
            {name:"LeBron James",min:38,pts:23,reb:6,ast:3,stl:0,blk:1,fg:"9-18",threes:"1-4",ft:"4-4",to:3,pm:-9},
            {name:"Rui Hachimura",min:39,pts:16,reb:4,ast:2,stl:1,blk:0,fg:"6-10",threes:"4-7",ft:"0-0",to:0,pm:-19},
            {name:"Deandre Ayton",min:27,pts:3,reb:1,ast:0,stl:0,blk:2,fg:"1-7",threes:"0-0",ft:"1-2",to:0,pm:0},
            {name:"Marcus Smart",min:34,pts:14,reb:4,ast:5,stl:3,blk:1,fg:"4-13",threes:"1-7",ft:"5-5",to:2,pm:2},
            {name:"Austin Reaves",min:38,pts:31,reb:2,ast:6,stl:5,blk:0,fg:"10-16",threes:"3-6",ft:"8-10",to:5,pm:-20},
            {name:"Jake LaRavia",min:10,pts:0,reb:0,ast:1,stl:1,blk:0,fg:"0-2",threes:"0-1",ft:"0-0",to:0,pm:-14},
            {name:"Dalton Knecht",min:4,pts:2,reb:0,ast:1,stl:0,blk:0,fg:"1-1",threes:"0-0",ft:"0-0",to:0,pm:-16},
            {name:"Adou Thiero",min:0,pts:0,reb:0,ast:0,stl:0,blk:0,fg:"0-0",threes:"0-0",ft:"0-0",to:0,pm:3},
            {name:"Jaxson Hayes",min:15,pts:6,reb:3,ast:2,stl:2,blk:1,fg:"3-3",threes:"0-0",ft:"0-0",to:0,pm:-1},
            {name:"Luke Kennard",min:26,pts:10,reb:0,ast:1,stl:0,blk:0,fg:"4-5",threes:"2-3",ft:"0-0",to:0,pm:-15},
            {name:"Nick Smith Jr.",min:2,pts:2,reb:0,ast:0,stl:0,blk:0,fg:"1-3",threes:"0-1",ft:"0-0",to:0,pm:-12},
            {name:"Maxi Kleber",min:0,pts:0,reb:0,ast:0,stl:0,blk:0,fg:"0-0",threes:"0-0",ft:"0-0",to:0,pm:0,note:"DNP"}
          ]
        }},
      {num:3,result:"OKC",homeScore:131,awayScore:108,winner:"OKC",prediction:{homeWin:true,homeScore:114,awayScore:104,margin:10,confidence:"MEDIUM",character:"COMPETITIVE",keyTakeaways:[
  "<strong>OKC is up 2-0 with structurally dominant performances.</strong> G1 +18 (Holmgren 24/12, SGA 18 with 7 TOs); G2 +18 (Holmgren 22/9, SGA 22, Reaves 31 in losing effort). Margins identical despite very different game scripts — OKC's edge is structural (depth, defense, length), not variance.",
  "<strong>HCA flips to LAL at Crypto.com — Phase 58 baseline compresses from OKC by 14 to OKC by 9-10.</strong> LAL home crowd worth ~3pts. But LAL has no Doncic, no answer to OKC bench depth (outscored LAL bench 34-15 in G1). Even at home, LAL's ceiling is capped at the Reaves+LeBron combo we saw in G2 (31+23 = 54 from primaries) which still lost by 18.",
  "<strong>Reaves G2 31pt bounce-back was the 'oblique improved' game we waited for.</strong> If he can sustain 25-30pt range, LAL becomes legitimately competitive. But that's a high bar over 32+min vs OKC's defensive rotation (Dort/Caruso/Wallace cycling).",
  "<strong>SGA hasn't gone full-volume yet (18, 22 in G1+G2).</strong> G3 at LAL is when stars typically demand the ball. OKC won G1+G2 with SGA on cruise control — if he scales to 28-32, OKC could blow it open.",
  "<strong>J.Williams full minutes G3.</strong> G2 he played starter minutes back from hamstring. G3 he's 100% — adds another ~3-4pts of OKC scoring depth.",
  "<strong>LAL closeout/desperation factor:</strong> Down 0-2 at home is 0-3 territory if they lose. Expect Redick to rotate aggressively and LeBron to play 38+min. But the depth gap is the issue — even desperate LAL can't overcome a 4-deep matchup deficit.",
],reasoning:"G3 Saturday May 9 at Crypto.com Arena (8:30 PM ET, ABC). OKC leads 2-0. HCA flips to LAL — engine baseline compresses from OKC by 14 to OKC by 9-10 with the venue swap. DK has OKC -8.5 / total 211.5 — market priced LAL home court but still gives OKC nearly a double-digit edge given the 2-0 cushion + structural depth advantage. Reaves bounce-back (31 G2) is the LAL ceiling case; even if he repeats, 31 + LeBron 25 = 56 from primaries, which got LAL to 107 in G2 with bench help. OKC keeps the depth/defense/length structural edges intact on the road. MODEL: OKC 114, LAL 104 (OKC by 10, MEDIUM confidence — LAL home crowd + desperation hedge but the talent gap remains).",xFactor:"SGA aggression + Reaves health + LAL bench production",moneyline:"OKC -375 / LAL +295",spread:"OKC -8.5",ou:"O/U 211.5"},notes:"OKC 131-108 at Crypto.com Arena. OKC leads 3-0 (sweep cliff, 7-0 in playoffs overall and 7-0 vs LAL this season). RIGHT WINNER, margin underestimated by 13 (predicted OKC by 10, actual OKC by 23). Q scores: OKC 33-37-32-29, LAL 24-29-30-25. OKC's bench depth FINALLY broke the game open at LAL. Ajay Mitchell career-high 24pts/10ast (10-17 FG) in 30min — playing on a third-string PG line in any other rotation. Cason Wallace 16pts (6-10, 4-6 3PT, +13). Holmgren 18/9/1blk (9-14 FG). SGA cruise control: 23pts/9ast on 7-20 FG/3-7 3PT, 6-7 FT — won by 23 at 35% efficiency. Hartenstein 12/9 (6-7 FG, +26 BEST +/-). Joe 12 off bench (4-6 3PT). Dort 10 (4-5, 2-2 3PT). LAL: Hachimura 21 (7-14, 5-8 3PT) team-high. LeBron 19/6/8 (7-19, 2-6 3PT) facilitator mode — couldn't carry at 37min/age 41. Reaves regression: 17pts (5-13, 1-5 3PT, 5 TOs) after 31pt G2. Smart 10pts (3-7, 1-2 3PT). Ayton 10/6 (5-9 FG). Kennard bench: 18pts (7-10, 4-6 3PT) — sustained third straight game producing. OKC shot 56% FG (53-94), 45% 3PT (17-38). LAL shot 47% FG, 47% 3PT (14-30) but couldn't keep up with OKC's volume + bench scoring. SGA quote post-game: 'They've kicked our ass 3 straight games' (LAL coach Redick).\n\nKEY MODEL TAKEAWAYS:\n(1) DEPTH ADVANTAGE COMPOUNDED — OKC bench (Mitchell 24, Wallace 16, Joe 12, McCain 3, Wiggins 4 = 59pts) outscored LAL bench (Kennard 18, Smith Jr 6, Thiero 4, Bronny 2, Hayes 1 = 31pts) by 28. Bench gap of this size in a road playoff game with HCA flipped is essentially uncoverable. Phase calibration: when bench differential ≥ 25 in a road playoff game, the favorite's HCA-flip compression is wiped out.\n(2) AJAY MITCHELL EMERGENCE — 24pts/10ast as a depth-chart guard. OKC running 4 PnR initiators (SGA, A.Mitchell, J.Williams, Caruso) crushes any team without comparable defensive depth. LAL's perimeter D was Smart + everyone else; not enough.\n(3) SGA HAS NOT YET GONE FULL VOLUME — 18, 22, 23 in G1-G3. He's averaging 21pts on 31% FG efficiency. The 'ceiling case' (SGA 32+ scoring) hasn't arrived AND OKC is still sweeping. That's the structural depth thesis fully validated.\n(4) REAVES BOUNCE-BACK NOT SUSTAINABLE — 31pts G2 (bounce-back from 8pts G1) regressed to 17pts G3 against the Dort/Caruso/Wallace defensive rotation cycling. The thesis 'Reaves can sustain 25-30 vs OKC's defense' was wrong — the rotation cycling makes any LAL guard work for every shot.\n(5) LEBRON FACILITATOR MODE INSUFFICIENT — 19/6/8 in 37min at age 41. When LeBron has to facilitate AND lead in scoring AND defend, on the road, in a desperation game, with Reaves regressed, the load is unmanageable. The 'LeBron 30+pt closeout game' isn't coming.\n(6) MARGIN UNDERESTIMATED THE SAME WAY G1+G2 WERE — predicted OKC 114-104 (10pt margin); actual 131-108 (23pt margin). For the third straight game, the model underprojected OKC's margin against LAL. When a team has 4-deep advantage and the opponent has structural IC≤2 ceiling, road games with HCA flipped can STILL produce double-digit margins. Calibration note: HCA-flip compression should NOT cap maximum margin — it should only compress the median. Phase 58 needs a 'depth-blowout override' that allows 20+pt margins when bench differential is ≥25.",boxScores:{home:[{name:"Hartenstein",min:31,pts:12,reb:9,ast:2,fg:"6-7",threes:"0-0",ft:"0-0",to:4,stl:1,blk:0,pm:26,note:"BEST +/-"},{name:"Holmgren",min:31,pts:18,reb:9,ast:1,fg:"9-14",threes:"0-4",ft:"0-0",to:1,stl:0,blk:1,pm:18},{name:"SGA",min:33,pts:23,reb:4,ast:9,fg:"7-20",threes:"3-7",ft:"6-7",to:2,stl:1,blk:2,pm:24},{name:"Dort",min:20,pts:10,reb:3,ast:0,fg:"4-5",threes:"2-2",ft:"0-0",to:0,stl:1,blk:0,pm:21},{name:"A.Mitchell",min:30,pts:24,reb:4,ast:10,fg:"10-17",threes:"2-4",ft:"2-3",to:0,stl:3,blk:0,pm:14,note:"career playoff highs in pts + ast"},{name:"J.Williams",min:13,pts:3,reb:4,ast:2,fg:"1-2",threes:"1-2",ft:"0-0",to:0,stl:0,blk:0,pm:0},{name:"Caruso",min:20,pts:6,reb:2,ast:2,fg:"3-6",threes:"0-3",ft:"0-0",to:0,stl:3,blk:0,pm:11},{name:"K.Williams",min:3,pts:0,reb:0,ast:0,fg:"0-2",threes:"0-2",ft:"0-0",to:0,stl:0,blk:0,pm:-1},{name:"Joe",min:18,pts:12,reb:5,ast:2,fg:"4-7",threes:"4-6",ft:"0-0",to:0,stl:1,blk:0,pm:-2},{name:"Wiggins",min:3,pts:4,reb:0,ast:0,fg:"2-2",threes:"0-0",ft:"0-0",to:0,stl:0,blk:0,pm:-1},{name:"Wallace",min:25,pts:16,reb:1,ast:1,fg:"6-10",threes:"4-6",ft:"0-0",to:1,stl:1,blk:0,pm:13},{name:"McCain",min:10,pts:3,reb:0,ast:1,fg:"1-1",threes:"1-1",ft:"0-0",to:0,stl:0,blk:0,pm:-6},{name:"Topic",min:3,pts:0,reb:2,ast:0,fg:"0-1",threes:"0-1",ft:"0-0",to:1,stl:1,blk:0,pm:-2}],away:[{name:"LeBron",min:37,pts:19,reb:6,ast:8,fg:"7-19",threes:"2-6",ft:"3-4",to:3,stl:1,blk:0,pm:-24},{name:"Hachimura",min:39,pts:21,reb:5,ast:4,fg:"7-14",threes:"5-8",ft:"2-2",to:1,stl:1,blk:0,pm:-24},{name:"Ayton",min:24,pts:10,reb:6,ast:0,fg:"5-9",threes:"0-0",ft:"0-0",to:0,stl:1,blk:1,pm:-8},{name:"Smart",min:32,pts:10,reb:3,ast:3,fg:"3-7",threes:"1-2",ft:"3-4",to:2,stl:1,blk:0,pm:-22},{name:"Reaves",min:39,pts:17,reb:3,ast:9,fg:"5-13",threes:"1-5",ft:"6-8",to:5,stl:0,blk:0,pm:-23},{name:"Kleber",min:8,pts:0,reb:1,ast:1,fg:"0-1",threes:"0-0",ft:"0-0",to:2,stl:0,blk:0,pm:-1},{name:"Knecht",min:4,pts:0,reb:1,ast:3,fg:"0-2",threes:"0-1",ft:"0-0",to:0,stl:0,blk:0,pm:0},{name:"Thiero",min:13,pts:4,reb:8,ast:1,fg:"1-3",threes:"0-1",ft:"2-3",to:2,stl:0,blk:0,pm:0},{name:"Hayes",min:9,pts:1,reb:2,ast:0,fg:"0-0",threes:"0-0",ft:"1-2",to:0,stl:0,blk:0,pm:-5},{name:"Kennard",min:29,pts:18,reb:2,ast:2,fg:"7-10",threes:"4-6",ft:"0-0",to:0,stl:1,blk:0,pm:-8},{name:"Smith Jr.",min:4,pts:6,reb:0,ast:0,fg:"2-2",threes:"1-1",ft:"1-2",to:0,stl:1,blk:0,pm:0},{name:"Bronny James",min:4,pts:2,reb:0,ast:0,fg:"1-1",threes:"0-0",ft:"0-0",to:1,stl:0,blk:0,pm:0}]}},{num:4,result:"OKC",homeScore:115,awayScore:110,winner:"OKC",prediction:{homeWin:true,homeScore:108,awayScore:103,margin:5,confidence:"MEDIUM",character:"COMPETITIVE",keyTakeaways:[
          "<strong>Most-likely state: OKC up 3-0 going into G4 (sweep cliff at LAL).</strong> If OKC takes G3 tonight (market favorite -8.5, model OKC by 10), G4 = OKC's first closeout opportunity at LAL. Less likely (~25%): LAL wins G3, G4 is OKC must-not-let-this-slip.",
          "<strong>Engine baseline OKC by 8 (neutral) → OKC by 5 with HCA flip:</strong> Trimmed HCA premium (1.5 instead of 2.0) per the SAS-MIN/NYK-PHI G3 retro lessons. LAL desperation home crowd adds +1-2 → OKC by 4-5. Market will likely sit OKC -3 to -5.",
          "<strong>SGA aggression in closeout games:</strong> SGA's playoff closeout history: averaged 33+ in 4 of his 5 prior closeout opportunities. Look for him to push for 35+pts and a definitive series end. If OKC eases off (typical sweep-cliff variance) the line drops; if SGA leans in, OKC by 8-10.",
          "<strong>LAL ceiling capped at ~104:</strong> Without Doncic, LAL's offensive ceiling is LeBron + one hot game from Reaves/Hachimura/Smart. G2's 107 was Reaves bouncing back to 31pts on heroic shooting — that's not repeatable two nights in a row. G3 at home should give them ~3pts vs G1/G2 baseline.",
          "<strong>Holmgren matchup advantage continues:</strong> Length + mobility vs Ayton's physicality has produced 24/12/3blk and 11/12/2blk in G1/G2. Hayes off bench has zero answer. Holmgren's stretch-5 forces LAL bigs out of the paint where OKC drives.",
          "<strong>J.Williams ramping minutes:</strong> Came back G1 at 20min, G2 near-starter, G3 expected full. By G4 he's at full availability and OKC's #2 scorer adds +3-4pts to OKC's ceiling.",
          "<strong>xFactor:</strong> SGA aggression intensity (closeout-mode = +5pts) + LAL bench production (LAL's only path to win is bench combining for 25-30pts AND LeBron going for 35+)."
        ],reasoning:"G4 (date depends on G3 outcome — likely Monday May 11 or Tuesday May 12) at Crypto.com Arena. Most-likely setup: OKC sweep cliff (3-0) at LAL home. Engine baseline OKC by 8 neutral; HCA flip with trimmed premium (1.5pts) gives OKC by 5; LAL home desperation in elimination adds +1-2 → OKC by 4-5. Less-likely path (LAL won G3): OKC by 3-4 still. The G3 retro confirmed HCA-flip premium was overcalibrated last week — using 1.5pt instead of 2.0pt aligns the engine with reality. SGA in closeout-mode is the swing: 35+pt SGA = OKC by 8+. Conservative SGA = OKC by 3. Predicted final: OKC 108, LAL 103. Verify DK lines morning-of (estimate OKC -185 / LAL +160 / spread OKC -3.5 to -5 / total 209-213).",xFactor:"SGA closeout mode + LAL bench production + J.Williams full minutes",moneyline:"OKC -520 / LAL +390",spread:"OKC -11.5",ou:"O/U 214.5"},notes:"OKC 115-110 at Crypto.com Arena. OKC SWEEPS 4-0, advances to Western Conference Finals (8-0 in playoffs overall). RIGHT WINNER, margin within 2pts (predicted OKC by 5, actual OKC by 5). Toughest playoff win of the postseason for OKC — first single-digit margin after three straight blowouts (+18/+18/+23). SGA 35pts/8ast — first 30+ game of the series after three cruise games (18, 22, 23). Holmgren 16pts/9reb — made the tiebreaking dunk with 32.8 seconds left off a Hartenstein assist; scored 8 of his 16 in the final 5:10 of Q4. Ajay Mitchell 28pts (10 in Q4) — sustained G3 emergence as the OKC closer. Hartenstein 5pts/10reb/5ast/5stl in 28min — defensive disruption masterpiece in a small role. LAL fought hard in elimination at home: Reaves 27pts (team-high) — full bounce-back from G3 regression. Hachimura 25pts (continued hot shooting from G3's 21). LeBron 24pts/12reb at age 41 in his potential final home playoff game — left it all on the court. LAL led 80-84 mid-Q3 before OKC's bench depth and Q4 SGA/Holmgren/Mitchell closeout cycle.\n\nKEY MODEL TAKEAWAYS:\n(1) PREDICTION ACCURACY EXCELLENT — predicted OKC by 5, actual OKC by 5. Bullseye on a closeout game with elevated variance. The trimmed HCA premium (1.5 vs 2.0) + closeout SGA aggression assumption nailed the margin.\n(2) SGA CLOSEOUT MODE VALIDATED — went 35pts in the elimination spot after 18/22/23 cruise control. Phase 59 calibration on SGA's playoff closeout history (33+ in 4 of 5 prior) held — the model correctly anticipated the volume jump.\n(3) HOLMGREN CLUTCH SHOTMAKING — game-winning dunk with 32.8s left and 8pts in final 5:10 of Q4. Quiet game numerically (16/9) but the late-game shotmaking was the swing. clutchNetRtg for stretch-5s in closeout games needs an upward calibration.\n(4) AJAY MITCHELL SUSTAINED — career-high 24/10ast G3, then 28pts with 10 in Q4 G4. Two straight playoff career-best level games. Phase 60 candidate: depth-chart guards who emerge in late-series rotations should get a modifier bump for subsequent games.\n(5) LAL CEILING HIT BUT INSUFFICIENT — Reaves 27 + Hachimura 25 + LeBron 24 = 76 from primaries. That's a top-quartile LAL ceiling and still wasn't enough on the road in elimination. Validates the 'IC≤2 structural cap' thesis — when your roster can produce a high-ceiling night and still lose to a healthy OKC, the talent gap is the determinant.\n(6) SERIES OVER — OKC wins 4-0, advances to WCF vs DEN-MIN-OKC R2 winner. The 8-0 playoff start ties for the 5th-best start in NBA history (eventually 9-0 with G4). OKC's 11-day rest into R1, plus J.Williams returning for R2, plus the bench depth pipeline (Mitchell, Wallace, Joe, McCain) all compounded into a complete series.",boxScores:{home:[{name:"Hartenstein",min:28,pts:5,reb:10,ast:5,fg:"2-4",threes:"0-0",ft:"1-2",to:1,stl:5,blk:0,pm:11,note:"5 STEALS — defensive disruption masterpiece"},{name:"Holmgren",min:34,pts:16,reb:9,ast:1,fg:"6-12",threes:"1-3",ft:"3-4",to:1,stl:0,blk:1,pm:8,note:"GAME-WINNING DUNK 32.8s left; 8pts in final 5:10 of Q4"},{name:"SGA",min:39,pts:35,reb:5,ast:8,fg:"12-25",threes:"3-7",ft:"8-9",to:3,stl:1,blk:0,pm:7,note:"First 30+ of series after 18/22/23 cruise"},{name:"Dort",min:28,pts:9,reb:4,ast:1,fg:"3-7",threes:"2-5",ft:"1-2",to:0,stl:1,blk:0,pm:6,note:"Opened Q3 with a three"},{name:"J.Williams",min:23,pts:8,reb:4,ast:3,fg:"3-8",threes:"1-3",ft:"1-2",to:1,stl:1,blk:0,pm:5},{name:"A.Mitchell",min:28,pts:28,reb:3,ast:4,fg:"10-18",threes:"4-8",ft:"4-5",to:2,stl:1,blk:0,pm:9,note:"10pts in Q4 — sustained G3 emergence as closer"},{name:"Caruso",min:22,pts:5,reb:3,ast:2,fg:"2-5",threes:"1-3",ft:"0-0",to:1,stl:2,blk:0,pm:4},{name:"Joe",min:14,pts:6,reb:2,ast:1,fg:"2-5",threes:"2-5",ft:"0-0",to:0,stl:0,blk:0,pm:-3},{name:"Wallace",min:24,pts:3,reb:1,ast:2,fg:"1-4",threes:"1-3",ft:"0-0",to:0,stl:1,blk:0,pm:1}],away:[{name:"LeBron",min:39,pts:24,reb:12,ast:6,fg:"9-19",threes:"2-5",ft:"4-5",to:3,stl:1,blk:0,pm:-6,note:"Age 41 in potential final home playoff game"},{name:"Reaves",min:38,pts:27,reb:4,ast:7,fg:"9-20",threes:"3-8",ft:"6-7",to:3,stl:1,blk:0,pm:-2,note:"Team-high — full bounce-back from G3 regression"},{name:"Hachimura",min:35,pts:25,reb:6,ast:1,fg:"9-16",threes:"5-9",ft:"2-2",to:0,stl:0,blk:0,pm:-3,note:"Sustained G3 hot shooting (21pts G3, 25 G4)"},{name:"Smart",min:32,pts:11,reb:3,ast:5,fg:"4-10",threes:"2-5",ft:"1-2",to:2,stl:1,blk:0,pm:-7},{name:"Ayton",min:26,pts:10,reb:7,ast:1,fg:"5-9",threes:"0-0",ft:"0-0",to:1,stl:0,blk:0,pm:-4},{name:"Kennard",min:24,pts:7,reb:2,ast:1,fg:"2-6",threes:"2-5",ft:"1-1",to:1,stl:0,blk:0,pm:-1},{name:"Hayes",min:14,pts:4,reb:3,ast:0,fg:"2-3",threes:"0-0",ft:"0-0",to:0,stl:0,blk:0,pm:-2},{name:"Vanderbilt",min:18,pts:2,reb:5,ast:1,fg:"1-3",threes:"0-1",ft:"0-0",to:1,stl:1,blk:1,pm:0}]}}
    ],
    game2: {
      spread: "OKC -14.5",
      ...
      consAway: [
        "Reaves 3-16 FG (19%), 0-5 3PT, 4 TOs in 36min — oblique obviously still severe, limiting explosion",
        ...
        "Kennard struggled: 7pts in 29min (1-4 FG, -14) — OKC wing D neutralized his off-screen action",
      ...
      playerProjections: {
        ...
        away: [
          ...
          {name:"Kennard",pts:"8-12",reb:"3-5",ast:"1-3",fg:"2-8",threes:"1-4",note:"G1: 7pts in 29min (1-4 FG, 4-4 FT, -14). OKC wing D neutralized off-screen action but Redick gave him more run than expected. FT drawing (4-4) shows he can still contribute."},
    ...
    modelLessons: [
      { type:"correct", lesson:"G1: Predicted OKC by 15 (HIGH). Actual OKC by 18. RIGHT WINNER, margin close. Structural dominance thesis (depth+defense+length) validated immediately — won by 18 with SGA having worst game (7 TOs)." },
      { type:"correct", lesson:"G1: Holmgren dominance predicted — 24/12/3blk confirmed the Ayton mismatch is solved. Length + mobility advantage is structural and repeatable." },
      { type:"missed", lesson:"G1: Reaves severity massively underestimated — model had 80% health, actual performance was 50-55% (3-16 FG, 19%, 0-5 3PT). Oblique strain limits explosion/finishing. Adjust severity model for oblique injuries affecting perimeter players." },
      { type:"missed", lesson:"G1: Total miss — predicted 217 total, actual 198. Both defenses better than expected; pace was slow. OKC defense held LAL to 42% FG. Need to lower totals in series where #1/#2 defense faces depleted offense." },
      { type:"correct", lesson:"G2: Predicted OKC by 18. Actual OKC by 18. EXACT MARGIN MATCH. Best single-game prediction of R2. Structural thesis holds — identical margins in G1+G2 despite different game scripts proves OKC's edge is structural, not variance." },
      { type:"missed", lesson:"G2: Reaves bounce-back (31pts, 12-22 FG) was not predicted — model had continued suppression from oblique. He found efficiency in midrange/paint rather than 3PT (1-4). Lesson: oblique injuries suppress 3PT more than overall scoring — players can adapt shot selection." },
      { type:"missed", lesson:"G2: Ajay Mitchell breakout (20pts/7reb/6stl on 7-12 FG) — bench MVP performance not modeled. OKC's developmental pipeline produces playoff-ready contributors. Model underweights OKC bench upside." },
      { type:"correct", lesson:"G2: J.Williams return from hamstring confirmed value — played near-starter minutes, OKC depth overwhelmed LAL even more. Ramped from 20min G1 to full G2." },
      { type:"correct", lesson:"G2: LeBron (23/8/5) continued individual brilliance but zero team support outside Reaves. Confirms LAL ceiling is LeBron + one hot game from Reaves, which still loses by 18." },
      { type:"missed", lesson:"G2: Total predicted 218 (OKC 112, LAL 106), actual 232 (125-107). Massive undershoot on total — Reaves bounce-back + Mitchell breakout inflated scoring. Adjust: when injury-suppressed star bounces back, total increases 10-15pts from baseline." }
    ],
    g2Adjustments: [
      "OKC WON G2 125-107 (+18) — IDENTICAL margin to G1. Structural dominance confirmed, not variance.",
      "Reaves BOUNCE-BACK: 31pts (12-22 FG, 1-4 3PT) after catastrophic G1 (3-16). Found midrange/paint game. Oblique limits 3PT but not overall scoring.",
      "Ajay Mitchell BREAKOUT: 20pts/7reb/6stl (7-12 FG) — bench MVP. OKC depth is even deeper than modeled.",
      "J.Williams ramped to full minutes from hamstring — now G3 GTD again per CBS Sports (hamstring flare).",
      "SGA efficient: 22pts (8-15 FG, 3-5 3PT). Still hasn't gone full-volume — G3 at LAL could be the game he demands the ball.",
      "Holmgren sustained: 22/9/4blk. Matchup vs Ayton is settled.",
      "LeBron 23/8/5 — individual brilliance continues but team support insufficient. No other LAL player besides Reaves scored 20+.",
      "LAL total scored 107 despite Reaves' 31 — without his bounce-back, LAL scores ~80. One-man-plus-LeBron dependency confirmed.",
      "Doncic NOT returning — 8-week timeline confirms he's done for OKC series. LAL creation permanently capped.",
      "HCA flips to LAL for G3 — only structural change. Market still has OKC -8.5, reflecting talent gap even on the road."
    ]
  },
  {
    ...
    game2: {
      spread: "SAS -9.5",
      moneyline: "SAS -360 / MIN +285",
      ou: "O/U 215.5",
      pick: "SAS",
      confidence: "medium",
      projScore: "SAS 111 — MIN 106",
      reasoning: "G1 TAKEAWAYS: MIN upset SAS 104-102 on the road. Wemby's 0-8 3PT (11pts on 5-17 FG) was catastrophic variance — his season avg is 37.5% from 3. This WILL regress to the mean. Edwards off bench was a coaching masterstroke (18pts in 25min, 8-13 FG) but his knee limited minutes. Fox struggled badly (-13, 0-4 3PT) and must be better. SAS shot 28% 3PT as a team (10-36) — historic cold shooting that won't repeat. MARKET SURGE: Line moved from SAS -5.5 to -9.5 per DraftKings (May 5) — market pricing in massive SAS shooting regression + Wemby bounce-back. KEY G2 ADJUSTMENTS: (1) Wemby will attack the rim more instead of settling for 3s — expect 25+ pts. (2) Fox needs to be aggressive in the PnR instead of settling for jumpers. (3) Dosunmu (MIN) upgraded from OUT to GTD — may return for G2 (expected May 6) which gives them a real PG. (4) Edwards likely gets more minutes (30+) if knee held up. (5) SAS bench (Harper 18pts, Castle 17pts) proved reliable — Champagnie/Castle will attack MIN's limited wing depth. Model projects SAS by 5 despite market suggesting SAS by 9.5 — we respect MIN's proven competitiveness and Edwards' effectiveness. The market may be overreacting to Wemby's G1 shooting variance.",
      prosHome: [
    ...
    awayTeam: {
      ...
      players: [
        ...
        { name:"Ayo Dosunmu", pos:"SG", rating:0, ppg:14.4, rpg:4.2, apg:3.5, fgp:52.1, per:15.8, ts:58.5, epm:1.0, bpm:0.8, ws48:.098, onOff:2.0, clutch:4.5, vorp:1.2, usg:20.5, injury:"GTD — sore right calf (expected return May 6 for G2)", lebron:-0.5, oLebron:0.3, dLebron:-0.8, war:2.5, offRole:"Primary Ball Handler", defRole:"Point of Attack",
          matchupNote:"Was OUT G1 with sore right calf. Now GTD per ESPN/CBS Sports (May 5 update). Expected return May 6 (G2). Was starting PG with DiVincenzo out. Stepped up in R1 — 43pts in G4 (!) when Edwards went down. If available for G2, significantly improves MIN's guard depth and transition offense.", baseRating:64, activeInjury:{type:"sore right calf",severity:0.5,note:"May 5: Upgraded from OUT to GTD per ESPN. Expected return May 6 (G2). Calf improving. If available, returns as starting PG."} },
        { name:"Kyle Anderson", pos:"SF", rating:55, ppg:4.6, rpg:3.7, apg:3.3, fgp:44.0, per:10.5, ts:53.0, epm:0.0, bpm:-0.3, ws48:.060, onOff:0.5, clutch:4.0, vorp:0.5, usg:13.0, injury:null, lebron:-0.8, oLebron:-0.5, dLebron:-0.3, war:1.2, offRole:"Primary Ball Handler", defRole:"Wing Stopper",
    ...
    games: [{num:1,result:"MIN",homeScore:102,awayScore:104,winner:"MIN",prediction:{homeWin:true,homeScore:112,awayScore:105,margin:7,confidence:"MEDIUM",character:"COMPETITIVE",reasoning:"MAJOR UPDATE: Edwards EXPECTED TO PLAY G1 per Shams Charania (May 4). This dramatically changes the calculus. SAS was -11.5 when Edwards was expected OUT — line will likely move to SAS -6 to -8 with Edwards in. Edwards at 80% capacity (left knee hyperextension + bone bruise) still transforms MIN from a .500 team to a competitive one. His 36.7ppg vs SAS this season means even at 70% output (~25ppg) he's a difference-maker. However, Dosunmu is OUT G1 (calf), forcing Conley/Hyland at PG — MIN still has guard depth issues. SAS advantages remain: Wemby is healthy and dominant (17/14/6blk closeout), 9 days rest vs MIN's 1 day, Frost Bank Center (62-20), and depth. But Edwards' return gives MIN a perimeter creator that SAS must respect, pulling Wemby out of the paint and opening Randle's mid-range game. Key question: Can Edwards sustain 35+ minutes on a bum knee? If he's on a minutes restriction (25-28min), SAS's depth advantage reasserts in the 4th quarter. Model adjusts from HIGH confidence SAS by 12 to MEDIUM confidence SAS by 7. Wemby is still the best player on the court but Edwards' presence makes this a 2-star vs 1-star game instead of 1-star vs 0-star.",xFactor:"Edwards health + minutes",moneyline:"SAS -300",spread:"SAS -6.5",ou:"O/U 217.5"},notes:"MIN 104-102 upset at Frost Bank Center. Edwards came off bench (25min) but scored 18pts (8-13 FG, 2-3 3PT) — effective despite knee. Randle 21pts/10reb but 8-20 FG (volume scorer). Shannon Jr 16pts (5-13, 6-8 FT). Conley 12pts (4-8, 4-7 3PT) key spacing. Naz Reid 12pts/9reb off bench (+15 best +/-). MIN shot 46% FG, 38% 3PT. SAS: Wemby 11pts (5-17 FG, 0-8 3PT!) but 15reb/12blk — historic block game but shooting was horrendous. Champagnie 17pts (3-7 3PT). Castle 17pts (4-8, 3-5 3PT, 6-8 FT). Harper 18pts off bench (7-13). Fox 10pts (5-14, 0-4 3PT, 6TO, -13). SAS shot 41% FG, 28% 3PT (10-36). Q scores: MIN 24-21-24-35, SAS 23-22-27-30. MIN won Q4 35-30 — Edwards + Randle closed it out. Model predicted SAS by 7 — WRONG WINNER. 9-point miss. Key lesson: Wemby's 3PT shooting (0-8) was catastrophic variance. MIN's defensive intensity on Wemby was elite. Edwards off bench was a coaching masterstroke — fresh legs in Q4.",boxScores:{home:[{name:"Champagnie",min:32,pts:17,reb:7,ast:0,fg:"7-12",threes:"3-7",ft:"0-0",to:1,stl:0,blk:0,pm:7},{name:"Wembanyama",min:40,pts:11,reb:15,ast:5,fg:"5-17",threes:"0-8",ft:"1-2",to:3,stl:0,blk:12,pm:5},{name:"Fox",min:33,pts:10,reb:3,ast:6,fg:"5-14",threes:"0-4",ft:"0-0",to:6,stl:1,blk:0,pm:-13},{name:"Vassell",min:36,pts:14,reb:5,ast:3,fg:"5-11",threes:"3-6",ft:"1-1",to:1,stl:3,blk:1,pm:7},{name:"Castle",min:28,pts:17,reb:5,ast:5,fg:"4-8",threes:"3-5",ft:"6-8",to:0,stl:0,blk:0,pm:4},{name:"Barnes",min:10,pts:2,reb:4,ast:0,fg:"1-1",threes:"0-0",ft:"0-0",to:0,stl:0,blk:1,pm:4},{name:"K.Johnson",min:24,pts:11,reb:2,ast:1,fg:"5-10",threes:"0-2",ft:"1-2",to:0,stl:0,blk:0,pm:-13},{name:"Kornet",min:8,pts:2,reb:2,ast:0,fg:"0-1",threes:"0-0",ft:"2-2",to:2,stl:0,blk:0,pm:-7},{name:"Harper",min:29,pts:18,reb:4,ast:4,fg:"7-13",threes:"1-4",ft:"3-3",to:0,stl:0,blk:0,pm:-4}],away:[{name:"Randle",min:41,pts:21,reb:10,ast:2,fg:"8-20",threes:"2-6",ft:"3-6",to:5,stl:1,blk:0,pm:-3},{name:"McDaniels",min:36,pts:16,reb:5,ast:2,fg:"7-14",threes:"0-2",ft:"2-2",to:1,stl:1,blk:1,pm:-2},{name:"Gobert",min:30,pts:7,reb:10,ast:3,fg:"3-7",threes:"0-0",ft:"1-5",to:1,stl:4,blk:1,pm:2},{name:"Conley",min:24,pts:12,reb:2,ast:6,fg:"4-8",threes:"4-7",ft:"0-0",to:0,stl:0,blk:0,pm:13},{name:"Shannon",min:35,pts:16,reb:5,ast:1,fg:"5-13",threes:"0-1",ft:"6-8",to:0,stl:0,blk:0,pm:-10},{name:"Reid",min:30,pts:12,reb:9,ast:1,fg:"5-8",threes:"2-3",ft:"0-0",to:2,stl:0,blk:1,pm:15},{name:"Clark",min:7,pts:2,reb:1,ast:0,fg:"1-1",threes:"0-0",ft:"0-0",to:0,stl:0,blk:0,pm:-1},{name:"Hyland",min:12,pts:0,reb:1,ast:2,fg:"0-6",threes:"0-4",ft:"0-0",to:0,stl:1,blk:1,pm:-2},{name:"Edwards",min:25,pts:18,reb:3,ast:3,fg:"8-13",threes:"2-3",ft:"0-0",to:1,stl:0,blk:1,pm:-2}]}},{num:2,result:"SAS",homeScore:133,awayScore:95,winner:"SAS",prediction:{homeWin:true,homeScore:111,awayScore:106,margin:5,confidence:"MEDIUM",character:"GRIND",reasoning:"G2 at Frost Bank Center (May 6). SAS lost G1 102-104 in a home upset. KEY REGRESSION: Wemby shot 0-8 3PT (his worst career game from deep) — season avg 37.5% means massive bounce-back expected. Fox was 0-4 3PT (-13) — also due for correction. SAS team shot 28% 3PT (10-36) vs season avg 37.5%. That's a 9.5% miss rate that adds ~7 expected points to SAS's score if they shoot normally. Edwards was effective (18pts/25min) but knee limited minutes. Dosunmu returns for MIN (real PG). SAS adjustments: Wemby attacks rim more, Fox more aggressive in PnR, less 3PT reliance. MIN proved competitive but needs SAS to shoot abnormally cold again. Model: SAS by 5 — tightened from original 7 based on MIN's proven G1 competitiveness but expecting shooting regression.",xFactor:"Wemby 3PT regression + Edwards minutes",moneyline:"SAS -360 / MIN +285",spread:"SAS -9.5",ou:"O/U 215.5"},notes:"SAS 133-95 — LARGEST PLAYOFF LOSS IN MIN FRANCHISE HISTORY (surpassed 30pt loss to LAL 2003). Series tied 1-1. SAS bounce-back validated MASSIVELY — model predicted SAS by 5; actual SAS by 38. MAJOR margin miss but right WINNER and right THESIS (Wemby + Fox bounce-back). Castle 21pts, Wemby 19/15reb, Fox 16pts (Wemby+Fox 12-25 FG combined vs G1's 21pts on terrible efficiency). SAS 50% FG, 41% 3PT (vs G1 41%/28%). MIN trailed 25 at HALFTIME. Edwards 12pts off bench (knee + rust), Randle 12, McDaniels 12, Shannon 12 — 4-way scoring tie at 12 with no one cracking 13 = symptomatic of MIN having NO answer. MIN 29.8% first-half FG, 2-15 first-half 3PT — catastrophic shooting collapse. Finch quote: 'I just told them we got punked.' Series moves to Target Center for G3 (Fri May 8) and G4 (Sun May 10).\n\nKEY MODEL TAKEAWAYS:\n(1) 3PT REGRESSION VALIDATED — Phase 17 / Phase 28 model said SAS would regress UP from 28% 3PT and Wemby from 0-8. Actual: SAS 41% from 3, Wemby attacked rim instead of settling. Regression-toward-mean is real and reliable.\n(2) MARGIN UPSIDE UNDERESTIMATED — model projected modest +5 bounceback, actual +38. When a team has G1 anomaly (28% 3PT, Wemby 0-8) AND has structural advantage (talent, depth, HCA) AND opposing star is at 70-75% (Edwards knee), the 'angry star' bounce game can be a beatdown. Future calibration: post-anomaly home games for top-3 favorites should have a wider variance band (allow up to +25-30 in addition to the regression baseline).\n(3) IC=2 LIMITATION REPEATED — MIN with Edwards compromised effectively had IC=1.5 (Randle + half-Edwards). When SAS's defense locked in, no one could create — entire team capped at 12pts each.\n(4) FRANCHISE-RECORD-LOSS PATTERN — MIN's worst playoff loss came AFTER an upset win (G1). Pattern: when an underdog steals a game, the favorite's bounce-back at home is often disproportionate. See also: BOS-PHI G3 vs PHI G2 upset.",boxScores:{home:[{name:"Castle",min:30,pts:21,reb:4,ast:6,fg:"8-14",threes:"3-6",ft:"2-2",to:1,stl:2,blk:0,pm:23},{name:"Wembanyama",min:32,pts:19,reb:15,ast:4,fg:"7-12",threes:"1-3",ft:"4-5",to:2,stl:0,blk:5,pm:25,note:"bounce-back from G1 0-8 3PT — attacked rim more"},{name:"Fox",min:28,pts:16,reb:3,ast:7,fg:"6-12",threes:"2-4",ft:"2-2",to:2,stl:1,blk:0,pm:21,note:"bounce-back from G1 5-14 / 0-4 3PT"},{name:"Vassell",min:26,pts:12,reb:4,ast:2,fg:"5-10",threes:"2-5",ft:"0-0",to:1,stl:1,blk:0,pm:19},{name:"Champagnie",min:22,pts:11,reb:3,ast:1,fg:"4-7",threes:"3-5",ft:"0-0",to:0,stl:1,blk:0,pm:15},{name:"K.Johnson",min:18,pts:10,reb:2,ast:1,fg:"4-7",threes:"1-2",ft:"1-2",to:0,stl:0,blk:0,pm:8},{name:"Harper",min:24,pts:14,reb:3,ast:5,fg:"6-10",threes:"1-2",ft:"1-2",to:1,stl:1,blk:0,pm:14},{name:"Barnes",min:14,pts:8,reb:5,ast:0,fg:"3-5",threes:"0-0",ft:"2-2",to:0,stl:0,blk:1,pm:9},{name:"Kornet",min:12,pts:6,reb:4,ast:1,fg:"3-4",threes:"0-0",ft:"0-0",to:1,stl:0,blk:1,pm:6}],away:[{name:"Edwards",min:24,pts:12,reb:3,ast:2,fg:"4-13",threes:"1-5",ft:"3-3",to:3,stl:1,blk:0,pm:-22,note:"off bench again, knee + rust limited"},{name:"Randle",min:28,pts:12,reb:6,ast:3,fg:"5-15",threes:"1-4",ft:"1-2",to:4,stl:0,blk:0,pm:-18},{name:"McDaniels",min:30,pts:12,reb:5,ast:1,fg:"5-12",threes:"0-3",ft:"2-2",to:1,stl:1,blk:1,pm:-25},{name:"Shannon",min:28,pts:12,reb:3,ast:2,fg:"5-13",threes:"1-3",ft:"1-1",to:2,stl:0,blk:0,pm:-15},{name:"Gobert",min:24,pts:8,reb:9,ast:1,fg:"3-6",threes:"0-0",ft:"2-4",to:1,stl:1,blk:1,pm:-21},{name:"Conley",min:22,pts:7,reb:1,ast:5,fg:"2-7",threes:"2-5",ft:"1-2",to:2,stl:0,blk:0,pm:-19},{name:"Reid",min:18,pts:9,reb:5,ast:1,fg:"4-9",threes:"1-3",ft:"0-0",to:1,stl:0,blk:0,pm:-14},{name:"Dosunmu",min:18,pts:6,reb:2,ast:3,fg:"2-6",threes:"0-1",ft:"2-2",to:1,stl:1,blk:0,pm:-10,note:"returned from calf"},{name:"Hyland",min:8,pts:5,reb:0,ast:1,fg:"2-5",threes:"1-3",ft:"0-0",to:0,stl:0,blk:0,pm:-3}]}},{num:3,result:"SAS",homeScore:115,awayScore:108,winner:"SAS",prediction:{homeWin:false,homeScore:102,awayScore:111,margin:9,confidence:"MEDIUM",character:"COMPETITIVE",keyTakeaways:[
  "<strong>SAS's tactical overhaul was the engine of the 38pt blowout — not just regression.</strong> Recognizing MIN's G1 size advantage, SAS shifted to (a) faster pace + attack-early to deny MIN's half-court defense, (b) increased ball pressure and double-teams on Conley/Randle, (c) Wemby attacking the rim relentlessly instead of settling for 3s (opened with a putback dunk vs G1's 0-8 from deep). Result: Wemby 19/15 in just 26min, MIN held to season-low 35 first-half points.",
  "<strong>MIN's 4-way 12pt tie</strong> (Edwards/Randle/McDaniels/Shannon) was symptomatic of NO ONE stepping up. Edwards on knee restriction (24min off bench, 4-13 FG, 1-5 from 3) was hunted by SAS's defensive rotations and couldn't generate his usual rim drives. With nobody breaking SAS's pressure, MIN's IC effectively dropped to 1.5.",
  "<strong>MIN G3 adjustments expected:</strong> Finch's 'we got punked' is a desperation flag. Expect (a) Edwards starting if knee permits, with a longer leash; (b) quick-decision passes vs SAS's pressure instead of dribble-iso; (c) Gobert getting more touches in PnR vs Wemby's drop coverage; (d) expanded Naz Reid role (12/9reb off bench was MIN's only positive). Target Center home wins by 16.5pt avg margin in playoffs — crowd amplifies.",
  "<strong>SAS counter-adjustments + road regression:</strong> Will keep pace + pressure scheme but expect shooting regression — 50%/41% at home vs 41%/28% road in G1. Cross-series pattern: home teams' shooting regresses ~5pp on the road (PHI G2 was 45/38 on the road). Castle/Fox/Vassell back to ~46%/36% range expected.",
  "<strong>Wemby keeps the rim-attack approach</strong> — higher-EV than settling for 3s, SAS staff won't undo. Expect 22-26pts on efficient shooting (Gobert now positioned to contest more at rim).",
  "<strong>Why SAS by 9 (engine baseline):</strong> Phase 58 engine fix now applies HCA flip correctly (G3 venue at MIN). Engine projects SAS by 9 (vs SAS by 11 pre-fix) — the baseline already accounts for HCA flip, MIN's home crowd, and the round-scaled HCA value of 1.7. Tactical add-ons (MIN desperation after worst playoff loss, Edwards potentially expanded) could compress this another 3-5pts toward MIN. PRIMARY HEDGE: Edwards minutes — 32+ at G1 efficiency (8-13, 18pts/25min) flips this to MIN by 2-3.",
],reasoning:"G3 Friday May 8 at Target Center. Series tied 1-1. HCA flips to MIN — Phase 58 engine fix correctly applies the venue change for G3-G4 of the 2-2-1-1-1 format, bringing baseline from SAS by 11 to SAS by 9. MIN is coming off worst playoff loss in franchise history (Finch: 'we got punked'); Target Center is one of the league's loudest playoff environments. SAS's G2 tactical overhaul (pace + pressure + Wemby rim attacks) is structural and likely persists. Edwards minutes (knee permitting) are the biggest swing factor for MIN's ceiling. MODEL: SAS 111, MIN 102 (SAS by 9, MEDIUM confidence — but if Edwards plays 32+min near G1 efficiency, expect a tighter game in the SAS by 2-3 range). <strong>5/8 update:</strong> DK has SAS -3.5 / total 215.5 — market priced the Edwards-back-and-engaged scenario. Model still likes SAS but at a tighter spread than its baseline (SAS -8.5 was authored before market repriced). Edwards QUESTIONABLE (bone bruise) — trending toward playing, completed full shootaround. Dosunmu GTD (heel, was calf). Edwards status is the single biggest swing factor.",xFactor:"Edwards minutes + MIN 3PT shooting + SAS pace/pressure scheme on the road",moneyline:"SAS -198 / MIN +164",spread:"SAS -3.5",ou:"O/U 215.5"},notes:"SAS 115-108 at Target Center. SAS leads 2-1. Q scores: SAS 23-28-35-29, MIN 22-29-28-29. Wembanyama MASTERPIECE: 39pts/15reb/5blk (13-18 FG, 3-5 3PT, 10-12 FT, 5 fouls) — joined Kareem/Hakeem/Shaq company. 16pts in Q4, hit clutch 3 with 3:06 left to push lead to 6. Sat out 1min after 5th foul then returned and never flinched. Edwards MONSTER GAME: 32pts/14reb/6ast (12-26 FG, 3-9 3PT, 5-6 FT, 41min) — returned to starting lineup, had 22pts in first half, hit buzzer-beating 31-footer end of Q1. Finch: 'He needed that. We needed that.' But it wasn't enough. McDaniels 17pts (5-22 FG) and Randle 12pts (3-12 FG) combined 8-34 — Wemby's paint presence killed their short-range game. Reid 18pts/9reb off bench (+3). Gobert 13pts (6-7 FG)/7reb/3blk. Dosunmu 11pts (4-12)/7reb/5ast but 4 TOs. Conley only 4min (0pts, 0-1 FG). Shannon Jr 5pts (2-6) in 28min (+19 best +/-). SAS: Fox 17pts (7-19 FG, 1-5 3PT)/5ast. Castle 13pts (3-11)/12ast/+17 — facilitator mode. Vassell 13pts (6-14)/6reb. Champagnie 6pts/12reb (8 OREB). K.Johnson 11pts (3-7) off bench. Bryant 6pts (2-2, 2-2 3PT). Harper 8pts (2-6)/4reb. SAS 46% FG, 36% 3PT, 76% FT. MIN missed first 12 shots, fell 18-3 early, but fought back to 51-51 at halftime. SAS dominated Q3 (35-28). MIN got within 99-98 (McDaniels drew Wemby's 5th foul with 6:18 left) but SAS never trailed in 2H. MODEL: predicted SAS 111-MIN 102 (SAS by 9, MEDIUM); ACTUAL SAS 115-108 (SAS by 7) — RIGHT WINNER, margin within 2pts. Strong prediction.\n\nKEY MODEL TAKEAWAYS:\n(1) PREDICTION ACCURACY STRONG — SAS by 9 predicted, SAS by 7 actual. Only 2pt miss. Market had SAS -3.5; model's SAS -9 was closer to the actual margin (7) than the market spread (3.5). Model outperformed the market.\n(2) WEMBY TRANSCENDENT GAMES ARE THE NEW BASELINE — 39pts/15reb/5blk on the road, joining Kareem/Hakeem/Shaq company. Back-to-back 15-rebound games. Model treated Wemby as 'star with variance' but his ceiling games are now showing up consistently. Phase 32 ceiling lift for franchise-cornerstone bigs needs an 'on-the-road / hostile-crowd' bump (~+4 expected pts).\n(3) EDWARDS FULLY BACK — 32pts/14reb/6ast in 41min DEMOLISHES the 'Edwards at 75%' thesis. He's clearly healthy enough for full output. Model was WRONG to project Edwards capped at ~18pts. His knee has healed sufficiently for star-level production. G4 projection must upgrade Edwards to ~85-90% baseline (28-32pts expected).\n(4) MIN'S PROBLEM IS DEPTH, NOT EDWARDS — Edwards had 32pts and it wasn't enough because Randle (3-12) and McDaniels (5-22) were neutralized by Wemby's paint presence. Combined 8-34 FG. MIN's IC is effectively Edwards + role players vs SAS's 5-deep scoring.\n(5) CONLEY ABSENCE SIGNIFICANT — only 4min played (was 24min/12pts G1, 22min/7pts G2). Lost a key spacing and playmaking option. If this persists in G4, MIN's guard depth is severely limited.\n(6) CHAMPAGNIE'S REBOUNDING — 6pts but 12reb (8 OREB!) gave SAS multiple extra possessions. The rebounding battle (SAS 48-46 MIN) was closer than G2 but Champagnie's offensive boards were backbreaking.",boxScores:{home:[{name:"Champagnie",min:29,pts:6,reb:12,ast:3,fg:"2-7",threes:"2-6",ft:"0-0",to:0,stl:2,blk:0,pm:5,orb:8},{name:"Wembanyama",min:37,pts:39,reb:15,ast:1,fg:"13-18",threes:"3-5",ft:"10-12",to:1,stl:1,blk:5,pm:16},{name:"Fox",min:35,pts:17,reb:3,ast:5,fg:"7-19",threes:"1-5",ft:"2-3",to:2,stl:1,blk:0,pm:-2},{name:"Vassell",min:36,pts:13,reb:6,ast:3,fg:"6-14",threes:"1-6",ft:"0-0",to:1,stl:2,blk:0,pm:10},{name:"Castle",min:40,pts:13,reb:4,ast:12,fg:"3-11",threes:"1-3",ft:"6-8",to:4,stl:0,blk:0,pm:17},{name:"Barnes",min:6,pts:0,reb:1,ast:0,fg:"0-0",threes:"0-0",ft:"0-0",to:0,stl:1,blk:0,pm:3},{name:"K.Johnson",min:19,pts:11,reb:2,ast:1,fg:"3-7",threes:"2-4",ft:"3-4",to:0,stl:1,blk:0,pm:-11},{name:"Bryant",min:8,pts:6,reb:0,ast:0,fg:"2-2",threes:"2-2",ft:"0-0",to:0,stl:0,blk:0,pm:7},{name:"Kornet",min:11,pts:2,reb:1,ast:0,fg:"1-1",threes:"0-0",ft:"0-0",to:0,stl:0,blk:1,pm:-9},{name:"Harper",min:20,pts:8,reb:4,ast:1,fg:"2-6",threes:"0-2",ft:"4-6",to:1,stl:1,blk:1,pm:-1}],away:[{name:"Randle",min:31,pts:12,reb:6,ast:0,fg:"3-12",threes:"0-3",ft:"6-6",to:2,stl:1,blk:0,pm:-11},{name:"McDaniels",min:40,pts:17,reb:7,ast:2,fg:"5-22",threes:"3-8",ft:"4-4",to:1,stl:1,blk:1,pm:-15},{name:"Gobert",min:31,pts:13,reb:7,ast:2,fg:"6-7",threes:"0-0",ft:"1-1",to:1,stl:0,blk:3,pm:-6},{name:"Conley",min:4,pts:0,reb:2,ast:0,fg:"0-1",threes:"0-1",ft:"0-0",to:1,stl:0,blk:0,pm:-10},{name:"Edwards",min:41,pts:32,reb:14,ast:6,fg:"12-26",threes:"3-9",ft:"5-6",to:2,stl:0,blk:1,pm:-10,note:"STARTED — 22pts first half, buzzer-beating 31-footer end Q1"},{name:"Reid",min:32,pts:18,reb:9,ast:5,fg:"6-13",threes:"4-8",ft:"2-4",to:0,stl:0,blk:2,pm:3},{name:"Dosunmu",min:32,pts:11,reb:7,ast:5,fg:"4-12",threes:"3-8",ft:"0-0",to:4,stl:1,blk:0,pm:-5},{name:"Shannon",min:28,pts:5,reb:2,ast:2,fg:"2-6",threes:"1-3",ft:"0-0",to:1,stl:0,blk:0,pm:19}]}},{num:4,result:"MIN",homeScore:109,awayScore:114,winner:"MIN",prediction:{homeWin:true,homeScore:107,awayScore:104,margin:3,confidence:"MEDIUM",character:"COMPETITIVE",keyTakeaways:[
      "<strong>SAS road momentum + Wemby transcendent form:</strong> SAS won G3 at MIN behind Wemby's 39/15/5blk Kareem-tier line (13-18 FG, 10-12 FT). Going for 3-1 series lead. Wemby is in 'transcendent' mode — 16pts in Q4 with 5 fouls, never flinched. Worth ~+8 vs his season baseline. But Edwards' 32/14/6 means MIN has a legit star counter now.",
      "<strong>Engine baseline SAS by 5 with HCA flip → SAS by 2-3:</strong> But applying the trimmed HCA premium (1.5 instead of 2.0 for road favorites with clear talent edge), SAS by 3. MIN home desperation adds +2 → MIN ceiling slightly higher. Predicted: SAS 107, MIN 104. Confidence MEDIUM (not HIGH) because Edwards on full availability is the meaningful unknown.",
      "<strong>Edwards G4 expectation:</strong> BREAKOUT G3: 32pts/14reb/6ast in 41min (12-26 FG, 3-9 3PT) — he's fully back. Knee is clearly not limiting his production anymore. Expect 28-32pts again G4. The question is whether Randle (3-12 G3) and McDaniels (5-22 G3) can provide secondary scoring. Edwards alone isn't enough when his supporting cast shoots 8-34 combined.",
      "<strong>SAS Q4 closing edge:</strong> Castle is the closer — 21pts on 8-14 G2, and 13pts/12ast G3 as facilitator. Wemby's 16 Q4 points in G3 (with 5 fouls!) show he won't defer. Coordinates with Wemby in 5-out spacing, Fox as floor-spacer. SAS has positional flexibility MIN doesn't.",
      "<strong>3PT regression watch:</strong> SAS shot 41% 3PT G2, decent G3. If they fall back to 33-35%, MIN has a path. 3PT volatility is the single biggest variance driver in this matchup.",
      "<strong>xFactor:</strong> Edwards minutes (full = MIN ceiling 110, capped = MIN ceiling 100). Wemby variance (transcendent mode = +6 vs baseline; normal = +0)."
    ],reasoning:"G4 Sunday May 10 at Target Center. SAS leads 2-1 after a road win in G3. MIN must hold serve to send series back to SAS tied 2-2. Engine baseline SAS by 5; HCA flip with trimmed premium (1.5pts vs the 2.0 baseline that overshot in G3) gives SAS by 3. Edwards proved fully healthy G3 (32pts/14reb/6ast in 41min) — upgrades MIN's IC to ~2.0 stars. But Randle/McDaniels combined 8-34 G3 = secondary scoring crisis persists. SAS 107, MIN 104 final. The G3 retro confirmed HCA flip + 'home desperation' was previously overcalibrated; G4 prediction now uses a tighter 1.5pt HCA premium and a +2 desperation bump (instead of the +3-4 the earlier model implied). Wemby is the swing factor: transcendent form sustained = SAS by 5+; reverts to mean = SAS by 0-2 / coin flip. Edwards full minutes = MIN ceiling rises 4-6 (still not enough to flip). MIN must combine Wemby off-night + Edwards 30+ + 3PT variance to win. That's not a high-probability conjunction. <strong>5/10 update:</strong> DK has SAS -4.5 / total 218.5 — market is MORE bullish on SAS than the engine (which says SAS by 3). Edwards confirmed no minutes restriction (per Wolves beat). Total moved up from G3's 215.5 → 218.5 reflecting both teams' G3 efficiency. Lean: model says SAS spread is too rich — fade SAS -4.5 by taking MIN +4.5, OR play SAS ML at -195 instead of the spread. Total 218.5 is at the engine's projection (107+104=211, but with Edwards and Wemby both in transcendent form, the over has merit at slightly higher pace).",xFactor:"Wemby variance + Edwards minutes/health + 3PT volatility",moneyline:"SAS -195 / MIN +162",spread:"SAS -4.5",ou:"O/U 218.5"},notes:"MIN 114-109 at Target Center. Series tied 2-2. WEMBANYAMA EJECTED early Q2 (Flagrant 2 — elbow to Naz Reid's neck/jaw on a double-team) — first career ejection. Wemby line: 4pts/4reb/0blk/1ast in 13min (2-5 FG) before the toss. Edwards 36pts (16 in Q4) — closed the door with a 4-point swing in the final 4 minutes. Naz Reid 15pts/9reb (the player who took the elbow). McDaniels 14pts. Randle 12pts. Gobert 11pts/13reb. SAS guards held the line with Wemby out: Harper 24, Fox 24, Castle 20 (68 combined). SAS led 102-99 with ~4min left before Edwards' Q4 takeover. League will rule on Wemby's G5 status (Flagrant 2 carries supplemental discipline risk per recent precedent). MODEL: predicted SAS 107-MIN 104 (SAS by 3, MEDIUM); ACTUAL MIN 114-SAS 109 (MIN by 5) — WRONG WINNER but margin within 8pts because the ejection produced the swing.\\n\\nKEY MODEL TAKEAWAYS:\\n(1) WEMBY EJECTION = WIN-PROBABILITY CRATER — losing your 39/15/5blk star in Q2 of a road game is worth roughly +12-15pts of margin swing against you. Model can't predict ejections (random shock). Counterfactual reset: SAS by 3 with Wemby → MIN by ~6-8 without him. Actual: MIN by 5. The COUNTERFACTUAL was accurate; the model just couldn't anticipate the ejection event.\\n(2) SAS GUARD DEPTH VALIDATED — Harper/Fox/Castle combined 68pts with their star gone. Staying within 5pts on the road minus your franchise player validates the structural roster build. The 'we got punked' framing from G2 was the wrong interpretation; this is a legit 2-2 series even with the wrong-winner G4 outcome.\\n(3) EDWARDS Q4 SIGNATURE — 16pts in Q4 to close out a 4-point swing game (had 22pts in 1H per G3 narrative too — Edwards is FULLY back from knee). Phase 22 clutchNetRtg flag for Edwards needs upward calibration. He had 16 of MIN's ~26 Q4 points.\\n(4) NAZ REID = PHYSICAL CANARY — took an elbow to the neck, finished 15/9. The kind of player whose presence on the floor changes how SAS plays him in G5. Sets up potential chippy G5 in San Antonio with Wemby's status TBD.\\n(5) MIN +4.5 BACK DOOR HIT — pre-game bet card had MIN +4.5 (-110); the Wemby ejection was the variance event that made it cash. Honest accounting: the +4.5 win is luck-mediated, NOT a model 'right' call. Bet was made on the +3 thesis with Wemby playing; the +5 actual is downstream of the ejection.",boxScores:{home:[{name:"Wembanyama",min:13,pts:4,reb:4,ast:1,fg:"2-5",threes:"0-1",ft:"0-0",to:1,stl:0,blk:0,pm:-2,note:"EJECTED early Q2 — Flagrant 2 for elbow to Naz Reid's neck (3 fouls). First career ejection."},{name:"Dylan Harper",pts:24,reb:4,ast:5,fg:"9-19",threes:"2-6",ft:"4-5",to:2,stl:1,blk:0,pm:-3},{name:"Fox",pts:24,reb:3,ast:7,fg:"9-21",threes:"2-7",ft:"4-5",to:3,stl:2,blk:0,pm:-4},{name:"Stephon Castle",pts:20,reb:5,ast:8,fg:"7-15",threes:"3-7",ft:"3-4",to:2,stl:1,blk:0,pm:-5},{name:"Vassell",pts:14,reb:4,ast:2,fg:"5-13",threes:"2-5",ft:"2-2",to:1,stl:0,blk:0,pm:-6},{name:"Champagnie",pts:7,reb:8,ast:1,fg:"3-6",threes:"1-3",ft:"0-0",to:1,stl:1,blk:0,pm:-2}],away:[{name:"Anthony Edwards",pts:36,reb:5,ast:6,fg:"13-26",threes:"4-10",ft:"6-7",to:3,stl:1,blk:0,pm:8,note:"16pts in Q4 — closed the game"},{name:"Naz Reid",pts:15,reb:9,ast:2,fg:"6-12",threes:"3-7",ft:"0-0",to:1,stl:0,blk:1,pm:6,note:"Took the elbow on the Wemby Flagrant 2 — finished the game"},{name:"Jaden McDaniels",pts:14,reb:5,ast:1,fg:"5-13",threes:"2-6",ft:"2-2",to:1,stl:1,blk:1,pm:4},{name:"Julius Randle",pts:12,reb:7,ast:4,fg:"4-12",threes:"1-4",ft:"3-3",to:2,stl:0,blk:0,pm:2},{name:"Rudy Gobert",pts:11,reb:13,ast:1,fg:"5-7",threes:"0-0",ft:"1-2",to:1,stl:0,blk:2,pm:7},{name:"Mike Conley",pts:8,reb:2,ast:5,fg:"3-7",threes:"2-5",ft:"0-0",to:1,stl:1,blk:0,pm:5}]}},{num:5,result:"SAS",homeScore:126,awayScore:97,winner:"SAS",prediction:{homeWin:true,homeScore:113,awayScore:105,margin:8,confidence:"MEDIUM",character:"COMPETITIVE",keyTakeaways:[
      "<strong>Series tied 2-2, back at SAS for the swing game:</strong> Frost Bank Center HCA + SAS up-tempo scheme that worked at home in G1 (won 104-102) and G2 (won 133-95). MIN has shown they can win at Target Center (G1, G4) but hasn't beaten SAS in San Antonio. Home-court swing here is meaningful given the road favorite faltered without Wemby in G4.",
      "<strong>Wemby CLEARED — plays full minutes:</strong> NBA review completed, no suspension or fine for the Flagrant 2 elbow to Reid's neck. Reasoning: Wemby has no prior history, the contact was during a double-team basketball play (not a fight), and the postseason point system requires 4 points (two Flagrant 2s, or a F2 + two F1s) for suspension — he's at 2. Engine baseline stays at SAS by 8-9.",
      "<strong>Engine baseline SAS by 9 (with Wemby, full strength) → SAS by 8 after MIN momentum bump:</strong> MIN got the road-game scare in G4 even with the Wemby ejection forcing a depleted-roster scenario. They now know they can hang. Confidence MEDIUM because (a) Wemby's first-game post-ejection mindset is unknown — re-aggression risk or measured play, (b) Reid's neck soreness from the elbow is a one-game minutes concern.",
      "<strong>Edwards Q4 closing pattern validated:</strong> 16pts in Q4 of G4 to close out a 4-point swing. Phase 22 clutchNetRtg flag for Edwards needs upward calibration. Expect MIN to target Edwards iso in late-game scenarios, especially if Wemby's rim protection is missing.",
      "<strong>SAS guard depth absorbs Wemby absence partially:</strong> G4 showed Harper/Fox/Castle can combine for ~70pts without their star. Floor without Wemby: SAS 100-105. Ceiling with Wemby: SAS 115-120 at home. Predicted final assumes Wemby plays at ~85%: SAS 113, MIN 105.",
      "<strong>xFactor:</strong> Wemby suspension ruling (expected Sunday-Monday) + Edwards Q4 minutes + Reid health after the elbow. Reid finished G4 but neck contact tends to produce next-day soreness that limits minutes."
    ],reasoning:"G5 Tuesday May 12 at Frost Bank Center (8:00 PM ET, NBC/Peacock). Series tied 2-2. Pivotal swing game in the 2-2-1-1-1 format. HCA goes to SAS (the higher seed); engine baseline returns to SAS by 9 with Wemby in full effect. <strong>5/12 update:</strong> Wemby OFFICIALLY CLEARED — NBA review completed, no suspension or fine. Plays full minutes. DK now has SAS -10.5 / total 218.5 / SAS ML -410. Market priced the no-suspension news and now sits at the engine's 'Wemby healthy + home' ceiling. Engine baseline: SAS by 8-9, the model thinks the -10.5 spread is too rich (slight lean MIN +10.5). Edwards' Q4 closing (32pts G3, 36pts G4 with 16 in Q4) is the chief MIN threat. SAS guard depth (Harper 24, Fox 24, Castle 20 in G4 without Wemby) plus Wemby back at home is the structural advantage. MIN's secondary scoring (Randle 3-12 G3, McDaniels 5-22 G3) remains the depth concern even with Edwards full. The Naz Reid post-elbow status is the X-factor: he finished G4 and should play but neck contact often produces next-day soreness. MODEL: SAS 113, MIN 105 (SAS by 8, MEDIUM confidence — Wemby healthy + home + structural depth + Edwards counter all priced in).",xFactor:"Wemby first-game post-ejection mindset + Edwards Q4 closing + Reid neck-soreness severity",moneyline:"SAS -410 / MIN +320",spread:"SAS -10.5",ou:"O/U 218.5"},notes:"SAS 126-97 at Frost Bank Center. SAS leads 3-2. WEMBANYAMA HISTORIC RETURN FROM EJECTION: 27pts/17reb/5ast/3blk + 2 made 3s — first player in NBA postseason history with that stat line since the 3PT line was introduced in 1979-80. 18 of his 27 came in Q1, setting the tone. SAS led by as many as 30; 68-36 points-in-the-paint advantage. K.Johnson 21pts (8-11 FG) bench spark. Fox 18pts/4reb/5ast. Castle 17pts (facilitator role, 7ast). Vassell 12pts. Harper 12pts/10reb (5 OREB). SAS shot 47-89 FG (52%), 50reb, 25ast. MIN: Randle 17pts/10reb DD. Edwards 20pts (sharp regression from G3-G4 32/36 — knee fatigue + foul trouble + SAS Wemby-anchored paint defense). Dosunmu 16pts off bench. McDaniels limited (foul trouble). Naz Reid quiet (post-elbow neck soreness). MIN 32-83 FG (38%), 42reb, 17ast. MODEL: predicted SAS 113-MIN 105 (SAS by 8, MEDIUM); ACTUAL SAS 126-97 (SAS by 29) — RIGHT WINNER, +21 margin underestimate.\n\nKEY MODEL TAKEAWAYS:\n(1) RE-AGGRESSION TAIL-EVENT — Wemby's 27/17/5/3blk with 18pts in Q1 was textbook 'angry-star-post-ejection' bounce. Phase 32 ceiling lift fires correctly but model still didn't anticipate +21 margin. Future calibration: home + post-ejection + healthy + Q1 dominance should allow a wider variance band (post-anomaly home + structural advantage = up to +25-30 above baseline, same lesson as G2 retro).\n(2) EDWARDS POST-Q4-HEROICS REGRESSION — went from 32+36 last 2 games to 20pts. Combination of knee fatigue across the 5-game stretch, SAS targeting him defensively, and Castle perimeter D when Wemby anchored the paint. The engine's Edwards O26.5 lean missed; regression-toward-mean signal was strong after back-to-back career-tier games.\n(3) BLOWOUT WAS STRUCTURAL — SAS 25 ast on 47 makes = unselfish ball movement, not hero ball. Wemby as decoy + finisher (5ast); MIN's defense collapsed to him, freeing Fox/Castle/K.Johnson. Repeatable when MIN respects Wemby's paint gravity.\n(4) SERIES NOW SAS 3-2, ELIMINATION CARD — G6 at Target Center Thu 5/14 (Amazon Prime). SAS closes → WCF vs OKC. MIN holds serve → G7 Sat 5/16 at SAS.",boxScores:{home:[{name:"Wembanyama",pts:27,reb:17,ast:5,fg:"10-19",threes:"2-4",ft:"5-7",to:1,stl:1,blk:3,pm:24,note:"18pts Q1; first player in NBA postseason history with 27p/17r/5a/3blk/2 3PM line since 3PT line introduced (1979-80)"},{name:"K.Johnson",pts:21,reb:5,ast:1,fg:"8-11",threes:"2-3",ft:"3-4",to:0,stl:1,blk:0,pm:18,note:"Bench spark — efficient outside scoring"},{name:"Fox",pts:18,reb:4,ast:5,fg:"7-15",threes:"2-5",ft:"2-2",to:2,stl:1,blk:0,pm:16},{name:"Castle",pts:17,reb:3,ast:7,fg:"6-13",threes:"2-4",ft:"3-3",to:2,stl:1,blk:0,pm:14,note:"Facilitator role"},{name:"Harper",pts:12,reb:10,ast:3,fg:"5-11",threes:"1-3",ft:"1-2",to:1,stl:0,blk:1,pm:11,orb:5,note:"5 OREB"},{name:"Vassell",pts:12,reb:5,ast:2,fg:"4-10",threes:"2-5",ft:"2-2",to:1,stl:1,blk:0,pm:10},{name:"Champagnie",pts:8,reb:4,ast:1,fg:"3-6",threes:"2-4",ft:"0-0",to:0,stl:0,blk:0,pm:9},{name:"Barnes",pts:5,reb:2,ast:0,fg:"2-3",threes:"1-2",ft:"0-0",to:0,stl:0,blk:1,pm:6},{name:"Kornet",pts:4,reb:3,ast:0,fg:"2-3",threes:"0-0",ft:"0-0",to:1,stl:0,blk:1,pm:5},{name:"Bryant",pts:2,reb:1,ast:0,fg:"0-1",threes:"0-1",ft:"2-2",to:0,stl:0,blk:0,pm:2}],away:[{name:"Anthony Edwards",pts:20,reb:4,ast:5,fg:"7-19",threes:"2-7",ft:"4-5",to:3,stl:1,blk:0,pm:-22,note:"Sharp regression from G3-G4 32/36 — knee fatigue + foul trouble + Castle perimeter D"},{name:"Julius Randle",pts:17,reb:10,ast:2,fg:"6-15",threes:"1-4",ft:"4-6",to:2,stl:0,blk:0,pm:-18,note:"DD but couldn't carry"},{name:"Ayo Dosunmu",pts:16,reb:3,ast:4,fg:"6-12",threes:"2-5",ft:"2-2",to:2,stl:1,blk:0,pm:-15,note:"Bench-led MIN's scoring response"},{name:"Jaden McDaniels",pts:8,reb:4,ast:1,fg:"3-9",threes:"1-4",ft:"1-2",to:1,stl:1,blk:1,pm:-20,note:"Foul trouble limited minutes"},{name:"Rudy Gobert",pts:8,reb:8,ast:1,fg:"3-5",threes:"0-0",ft:"2-3",to:1,stl:0,blk:2,pm:-19},{name:"Naz Reid",pts:7,reb:6,ast:1,fg:"3-9",threes:"1-4",ft:"0-0",to:1,stl:0,blk:1,pm:-16,note:"Post-elbow neck soreness — quiet shooting night"},{name:"Mike Conley",pts:5,reb:1,ast:3,fg:"2-6",threes:"1-3",ft:"0-0",to:1,stl:0,blk:0,pm:-14},{name:"Terrence Shannon",pts:6,reb:2,ast:0,fg:"2-7",threes:"0-2",ft:"2-2",to:1,stl:0,blk:0,pm:-12},{name:"Jaylen Clark",pts:5,reb:1,ast:0,fg:"2-3",threes:"1-1",ft:"0-0",to:0,stl:1,blk:0,pm:-3},{name:"Bones Hyland",pts:5,reb:1,ast:0,fg:"2-5",threes:"1-3",ft:"0-0",to:1,stl:1,blk:0,pm:-2}]}},{num:6,result:"SAS",homeScore:139,awayScore:109,winner:"SAS",prediction:{homeWin:false,homeScore:108,awayScore:110,margin:2,confidence:"LOW",character:"COMPETITIVE",keyTakeaways:[
      "<strong>SAS leads 3-2; G6 at Target Center, Fri May 15, 7:00 PM ET (Amazon Prime Video). MIN's elimination game.</strong> If SAS wins → advances to WCF vs OKC. If MIN wins → G7 at SAS Sat May 16.",
      "<strong>Engine baseline SAS by 4 (talent edge + Wemby) → SAS by 1-2 with HCA flip + MIN home-desperation:</strong> Phase 59 trimmed HCA premium (1.5pt) plus +2 MIN elimination-game desperation produces a near-coin-flip. Slight SAS lean on talent; slight MIN lean on venue. Predicted final: SAS 108, MIN 110 (MIN by 2 with home-desperation pickup). The G5 +21 margin came from Wemby Q1 dominance + Edwards regression — both regress toward mean for G6.",
      "<strong>Wemby G6 expectation:</strong> 24-30pts/14-16reb range. The 27/17 line in G5 was the new transcendent-mode baseline. Target Center crowd hostility + MIN's renewed defensive intensity (must-win mode) shaves 3-5pts off the ceiling but the floor stays at ~22/13.",
      "<strong>Edwards regression UP — must-win mode:</strong> Last 4 games: 12, 32, 36, 20. Variance high. In a closeout home game with elimination on the line + 2-day rest, expect 28-34pts ceiling. Will demand 38-40 minutes.",
      "<strong>Randle/McDaniels secondary scoring is the swing variable:</strong> Combined 25pts in G5. MIN cannot win G6 with that contribution. Need 35+ combined. Reid bouncing back from neck contact would help.",
      "<strong>xFactor:</strong> Wemby foul trouble risk at Target Center (his ejection happened the last time he played there) + Edwards' fifth game in 9 days (knee endurance) + MIN's bench production in must-win minutes."
    ],reasoning:"G6 Friday May 15 at Target Center (7:00 PM ET, Amazon Prime Video). SAS leads 3-2. MIN's elimination game; SAS chasing the close-out and WCF berth vs OKC. Engine baseline SAS by 4 (talent edge + Wemby in transcendent mode); HCA flip applies trimmed 1.5pt premium to MIN, and elimination-game desperation adds another ~+2 for MIN. Net: near-coin-flip with a slight MIN home-court tilt. The G5 +21 margin will regress hard — Wemby Q1 dominance + Edwards off-night both regress toward mean. Pattern in this series: home team has won every game (MIN G1, SAS G2-G3, MIN G4, SAS G5). If pattern holds, MIN wins G6 and forces G7. MODEL: SAS 108, MIN 110 (MIN by 2, LOW confidence — closest projected game of the series; anywhere from SAS by 8 to MIN by 7 is plausible). Verify DK lines morning-of (estimate MIN -2 to -3 / total 215-218).",xFactor:"Wemby foul trouble (Target Center ejection memory) + Edwards endurance + MIN bench in must-win minutes",moneyline:"TBD",spread:"TBD",ou:"TBD"},notes:"SAS 139-109 at Target Center. SERIES OVER: SAS WINS 4-2, ADVANCES TO WCF VS OKC. The 'home team wins every game' pattern BROKE in the elimination spot. SAS led wire-to-wire, by as many as 34, and the game was a structural blowout. Castle MASTERPIECE: 32pts/11reb/6ast on 11-of-16 FG (5-of-7 3PT) — backcourt headliner game in the most important game of the series. Wemby quiet by his standards: 19pts/6reb/3blk/6ast in 27min (limited by blowout — sat much of Q4). Fox: 21pts/9ast (efficient PnR). All five SAS starters in double figures. Castle + Fox combined to score or assist 28 of SAS's 36 Q1 points (7-of-8 contested attempts in first half). 20-0 SAS run early Q2 built the lead that never came back. MIN: Edwards 24pts on 9-of-26 FG (3-of-12 3PT) in must-win mode — efficiency cratered against Castle's perimeter D. Randle + Gobert COMBINED 3 PTS on 1-of-12 FG in an elimination game (catastrophic). McDaniels limited, Reid quiet. MIN couldn't manufacture secondary offense at any point. MODEL: predicted MIN by 2 (LOW); ACTUAL SAS by 30 — WRONG WINNER, +32 margin miss (the largest miss of the series).\n\nKEY MODEL TAKEAWAYS:\n(1) HOME-WIN PATTERN BROKE IN ELIMINATION — the load-bearing 'home team wins every game' data point this series got shattered by a road blowout. Lesson: even single-series patterns are noise when the talent gap + Q1 momentum stack against them. The pattern was 5-deep (G1-G5 all home wins) but priors that thin don't survive a single blowout.\n(2) RANDLE STRUCTURAL SUPPRESSION CONFIRMED — Randle's series scoring: 21, 12, 12, 12, 17, ~2 (G6). Five out of six games at or below 17pts, four straight at exactly 12 or lower. Wemby's paint gravity makes Randle's mid-range game structurally unviable. Phase 59 'Randle suppressed by Wemby paint presence' compoundScenario validated definitively.\n(3) CASTLE AS SECONDARY STAR — 32pts/11reb/6ast in the closeout shows Castle is no longer just SAS's third option; he's a closer-grade scorer at age 19. The 5-7 3PT shooting is the new ceiling, not the variance.\n(4) EDWARDS EFFICIENCY GAP IN MUST-WIN — Edwards 9-26 FG (35%), 3-12 3PT (25%) in elimination. The volume came (26 attempts) but the efficiency didn't. Castle's perimeter D when Wemby anchored the paint locked down both creators.\n(5) BLOWOUT REGRESSION ASYMMETRIC — G5 SAS +29 → G6 SAS +30. The 'G5 +21 will regress' thesis was directionally wrong; SAS sustained the blowout rather than regressing. When a road favorite is in transcendent form AND has structural-depth advantage AND opponent's secondary scoring collapses, the pattern can persist game-to-game.\n(6) HOME-WIN PATTERN MAY BE EARLY-SERIES PHENOMENON — first 5 games all home wins (G1-G5) often reflect emotional swings and HCA-flip variance. Elimination games at home are different — desperation can become panic, and Edwards' 9-26 night suggests that's what happened.",boxScores:{home:[{name:"Castle",pts:32,reb:11,ast:6,fg:"11-16",threes:"5-7",ft:"5-6",to:1,stl:2,blk:0,pm:24,note:"Closeout masterpiece — 5-7 from 3"},{name:"Fox",pts:21,reb:3,ast:9,fg:"8-15",threes:"2-5",ft:"3-3",to:2,stl:1,blk:0,pm:22,note:"Efficient PnR — 9 ast"},{name:"Wembanyama",pts:19,reb:6,ast:6,fg:"7-15",threes:"1-4",ft:"4-5",to:2,stl:1,blk:3,pm:18,note:"Quiet by his standards — 27min limited by blowout"},{name:"Vassell",pts:15,reb:4,ast:2,fg:"6-12",threes:"2-5",ft:"1-2",to:0,stl:1,blk:0,pm:20},{name:"Champagnie",pts:11,reb:7,ast:1,fg:"4-7",threes:"2-4",ft:"1-2",to:0,stl:0,blk:0,pm:16},{name:"K.Johnson",pts:14,reb:3,ast:2,fg:"5-9",threes:"2-4",ft:"2-2",to:1,stl:0,blk:0,pm:12},{name:"Harper",pts:13,reb:4,ast:3,fg:"5-10",threes:"1-3",ft:"2-2",to:1,stl:1,blk:0,pm:14},{name:"Bryant",pts:8,reb:2,ast:0,fg:"3-5",threes:"2-3",ft:"0-0",to:0,stl:0,blk:1,pm:8},{name:"Barnes",pts:4,reb:3,ast:1,fg:"2-4",threes:"0-0",ft:"0-0",to:0,stl:0,blk:1,pm:5},{name:"Kornet",pts:2,reb:2,ast:0,fg:"1-2",threes:"0-0",ft:"0-0",to:1,stl:0,blk:1,pm:4}],away:[{name:"Edwards",pts:24,reb:5,ast:5,fg:"9-26",threes:"3-12",ft:"3-4",to:4,stl:1,blk:0,pm:-26,note:"Volume came, efficiency didn't — Castle perimeter D"},{name:"Randle",pts:2,reb:6,ast:2,fg:"1-9",threes:"0-3",ft:"0-0",to:3,stl:0,blk:0,pm:-30,note:"Wemby paint gravity = structural suppression"},{name:"McDaniels",pts:11,reb:4,ast:2,fg:"4-11",threes:"1-4",ft:"2-2",to:1,stl:1,blk:0,pm:-22},{name:"Gobert",pts:1,reb:7,ast:1,fg:"0-3",threes:"0-0",ft:"1-2",to:1,stl:0,blk:1,pm:-25,note:"Combined 3pts on 1-of-12 with Randle — catastrophic interior"},{name:"Reid",pts:14,reb:5,ast:1,fg:"5-12",threes:"2-6",ft:"2-2",to:1,stl:0,blk:1,pm:-18},{name:"Dosunmu",pts:11,reb:2,ast:3,fg:"4-9",threes:"1-3",ft:"2-3",to:2,stl:1,blk:0,pm:-15},{name:"Conley",pts:8,reb:1,ast:4,fg:"3-7",threes:"2-5",ft:"0-0",to:1,stl:0,blk:0,pm:-12},{name:"Shannon",pts:16,reb:3,ast:1,fg:"6-13",threes:"2-5",ft:"2-2",to:2,stl:0,blk:0,pm:-8},{name:"Hyland",pts:12,reb:1,ast:2,fg:"4-9",threes:"3-6",ft:"1-2",to:1,stl:0,blk:0,pm:-5},{name:"Clark",pts:6,reb:2,ast:0,fg:"2-4",threes:"1-2",ft:"1-2",to:0,stl:1,blk:0,pm:-2},{name:"Nowell",pts:4,reb:0,ast:0,fg:"2-5",threes:"0-1",ft:"0-0",to:0,stl:0,blk:0,pm:-3}]}}]
,
    modelLessons: [
      { type:"missed", lesson:"G1: Predicted SAS by 7 (MEDIUM). Actual MIN by 2. WRONG WINNER — 9-point miss. MIN's coaching (Edwards off bench for fresh Q4 legs) was a masterstroke the model had no mechanism for." },
      { type:"missed", lesson:"G1: Wemby 0-8 3PT was catastrophic variance — model assumed ~37.5% baseline would hold. But MIN's defensive scheme (Gobert rim protection + McDaniels length) FORCED Wemby outside. Not pure variance — partly scheme-driven." },
      { type:"missed", lesson:"G1: Fox 0-4 3PT, 6 TOs, -13 — worst game of his playoffs. Model assumed reliable #2 scorer but MIN's defense collapsed both SAS creators simultaneously." },
      { type:"correct", lesson:"G1: Edwards at 80% still transformed MIN — 18pts/25min (8-13 FG) validated the 'even at 70-80% he's a difference-maker' thesis." },
      { type:"correct", lesson:"G2: Predicted SAS by 5 (MEDIUM). Actual SAS by 38. RIGHT WINNER but margin was 33 points off — largest miss of any prediction. The 3PT regression thesis was correct but magnitude of bounce-back was unprecedented." },
      { type:"missed", lesson:"G2: Model projected modest +5 bounce-back; actual +38 was a franchise-record loss for MIN. Post-anomaly home games for top-3 favorites need a wider variance band. When team has G1 anomaly (28% 3PT) AND structural advantage AND opponent star is compromised — allow up to +25-30 in addition to regression baseline." },
      { type:"correct", lesson:"G2: 3PT regression validated — SAS went from 28% (G1) to 41% (G2). Wemby attacked rim instead of settling. Fox corrected from 0-4 to 2-4 3PT. Regression-toward-mean is real and reliable." },
      { type:"missed", lesson:"G2: Edwards dropped to 4-13 FG (12pts in 24min) — knee + rust after G1's hot shooting. Model expected Edwards to expand minutes; instead he regressed. Knee injuries have game-to-game variance that's hard to predict." },
      { type:"missed", lesson:"G2: MIN's IC collapsed to ~1.5 — Edwards/Randle/McDaniels/Shannon all capped at exactly 12pts each. When SAS's defense locked in, nobody could create. Team-wide scoring cap is a sign of defensive scheme dominance, not individual failure." },
      { type:"correct", lesson:"G3: Predicted SAS by 9 (MEDIUM). Actual SAS by 7. RIGHT WINNER, only 2pt margin miss. Model outperformed market (SAS -3.5). Strong prediction — best accuracy of the series so far." },
      { type:"missed", lesson:"G3: Edwards had 32pts/14reb/6ast in 41min — model projected him capped at ~18pts due to knee. His 22 first-half points and buzzer-beating 31-footer showed the knee is no longer limiting. Must upgrade Edwards projection to 85-90% baseline for G4." },
      { type:"correct", lesson:"G3: Wemby 39/15/5blk (13-18 FG) — transcendent mode sustained from G2. Model correctly identified Wemby as the primary variance driver. His Q4 16pts with 5 fouls was the difference-maker." },
      { type:"underweighted", lesson:"G3: Randle (3-12 FG) and McDaniels (5-22 FG) combined 8-34 — Wemby's paint presence is structurally suppressing MIN's interior scorers. This isn't variance, it's scheme. G4 must weight Wemby's defensive gravity on MIN's non-Edwards scorers." },
      { type:"missed", lesson:"G3: Conley only played 4 minutes (0pts, 0-1 FG). Down from 24min/12pts G1 and 22min/7pts G2. If this persists, MIN loses a key spacing option. Model had no mechanism for Conley's minutes collapse." }
    ],
    g2Adjustments: [
      "SAS WON G2 133-95 — LARGEST PLAYOFF LOSS IN MIN FRANCHISE HISTORY. Series tied 1-1.",
      "Wemby bounce-back: 19/15reb/5blk in 32min — attacked rim instead of settling for 3s. Tactical overhaul, not just regression.",
      "SAS 50% FG, 41% 3PT — massive regression UP from G1's 41%/28%. Castle 21pts led scoring.",
      "Edwards 12pts (4-13 FG, 1-5 3PT) in 24min off bench — knee + rust limited. G3 status: QUESTIONABLE but trending toward playing, completed full shootaround.",
      "Dosunmu returned from calf (18min, 6pts, 2-6 FG) but was ineffective. Now listed GTD with heel (different injury than calf).",
      "MIN trailed by 25 at halftime — 29.8% first-half FG, 2-15 3PT. Catastrophic shooting collapse.",
      "Finch quote: 'I just told them we got punked' — desperation flag for G3 adjustments.",
      "HCA flips to MIN for G3 — Target Center is one of the loudest playoff environments. Target Center home wins avg +16.5pt margin in playoffs.",
      "Edwards starting (if healthy) is the expected G3 adjustment — no more bench role. Longer leash, 32+ minutes.",
      "SAS pace + pressure scheme is structural and will persist on the road. Expect shooting regression DOWN for SAS at Target Center (~46%/36% range)."
    ]
  },
  {
    ...
    game1: {
      spread: "DET -3.5",
      moneyline: "DET -155 / CLE +130",
      ou: "O/U 215.5",
      pick: "DET",
      confidence: "low",
      projScore: "DET 108 — CLE 105",
      reasoning: "Closest R2 matchup. Both finished 7-game R1 series May 3 (equal rest). G7 takeaways: Cade dual-mode (45pts G5 → 32/12ast G7), CLE depth elite (bench +39-19 G7), Allen 22/19 interior dominance, Harris breakout (30pts, 5-7 3PT). DET #1 defense + home court vs CLE triple-initiator offense. DraftKings line: DET -3.5 / ML -155. Coin flip with slight home tilt.",
      prosHome: [
    ...
    externalFactors: [
      ...
      { team:"CLE", player:"Sam Merrill", desc:"NEW INJURY: Hamstring — exited G1 after 7min, did not return. Day-to-day, est. return May 7 (G2). CLE loses key bench shooter (42.4% 3PT).", impact:-2, category:"injury", evidence:"ESPN injury report May 5: Merrill hamstring, Day-To-Day. Only played 7min in G1 (0pts, 1ast). If OUT for G2, CLE bench depth thins — Strus/Tyson must absorb more minutes. Schroder becomes even more critical.", verdict:"verified" }
    ],
    game2: {
      spread: "DET -4.5",
    ...
    games: [{num:1,result:"DET",homeScore:111,awayScore:101,winner:"DET",prediction:{homeWin:true,homeScore:108,awayScore:105,margin:3,confidence:"LOW",character:"COIN FLIP",reasoning:"The closest R2 matchup — could go either way. Both teams just finished grueling 7-game R1 series on May 3 (DET: 3-1 comeback vs ORL, 116-94; CLE: survived TOR, 114-102). Equal rest (~3 days). Huerter (DET) is GTD with thigh — minor impact. G7 TAKEAWAYS: (1) Cade dual-mode evolution — scored 45 in G5 then facilitated 32/12ast in G7. DET coaching can toggle Cade's role based on matchup. (2) CLE depth is elite — bench outscored TOR bench 39-19 in G7 (Strus +20, Tyson +19, Merrill +16). (3) Allen 22/19 (8 OREB) interior dominance will test Duren physically. Allen's chronic knee tendonitis (GTD) is a concern for a long series. (4) Harris breakout (30pts G7, 5-7 3PT) gives DET a legitimate #2 scorer. Key matchup: A.Thompson (D-LEBRON 2.93) on Mitchell vs Cade vs CLE rotating defenders. DET has #1 defense (107.2 DRtg) and best home record (31-9). CLE has triple-initiator offense (Mitchell/Harden/Mobley). DET home court provides narrow edge. Expect low-scoring, physical game with late-game execution deciding it. Mitchell 8.5 clutch rating gives CLE Q4 edge but DET crowd at LCA is deafening. Coin flip with slight home tilt.",xFactor:"Cade Cunningham",moneyline:"DET -155 / CLE +130",spread:"DET -3.5",ou:"O/U 215.5"},notes:"DET 111-101. DET led 37-21 after Q1, built 18pt lead. CLE rallied to 93-93 tie with 5:28 left (Harden 7 straight pts) before Duren blocked Harden and dunked 3 times off Cade assists. DET ended 12-game postseason losing streak vs CLE (since 2007 ECF). Mitchell's streak of 30+ in 9 straight series openers broken (23pts). Key: DET forced 19 CLE TOs with 12 steals. FTA differential 35-16 DET. Allen limited to 18min/2pts (knee). D.Robinson 5-8 3PT. Jenkins breakout 12/7/3/4stl. Cade 23/7ast on 6-19 FG but 9-11 FT. Harris 20/8.",boxScores:{home:[{name:"Harris",min:39,pts:20,reb:8,ast:1,fg:"6-14",threes:"1-5",ft:"7-8",to:2,stl:2,blk:0,pm:6},{name:"D.Robinson",min:28,pts:19,reb:0,ast:2,fg:"7-12",threes:"5-8",ft:"0-1",to:0,stl:2,blk:0,pm:6},{name:"Duren",min:35,pts:11,reb:12,ast:4,fg:"4-11",threes:"0-0",ft:"3-4",to:1,stl:0,blk:2,pm:17},{name:"Cunningham",min:42,pts:23,reb:3,ast:7,fg:"6-19",threes:"2-5",ft:"9-11",to:4,stl:2,blk:0,pm:12},{name:"A.Thompson",min:33,pts:11,reb:8,ast:5,fg:"4-6",threes:"0-0",ft:"3-4",to:1,stl:1,blk:1,pm:-9},{name:"Stewart",min:13,pts:6,reb:3,ast:1,fg:"2-2",threes:"0-0",ft:"2-2",to:2,stl:0,blk:0,pm:-7},{name:"Holland",min:10,pts:6,reb:1,ast:0,fg:"2-3",threes:"1-2",ft:"1-3",to:0,stl:1,blk:0,pm:8},{name:"Green",min:3,pts:3,reb:1,ast:0,fg:"1-3",threes:"1-3",ft:"0-0",to:0,stl:0,blk:0,pm:-4},{name:"LeVert",min:9,pts:0,reb:2,ast:0,fg:"0-1",threes:"0-0",ft:"0-0",to:0,stl:0,blk:0,pm:13},{name:"Jenkins",min:29,pts:12,reb:7,ast:3,fg:"5-13",threes:"0-3",ft:"2-2",to:1,stl:4,blk:0,pm:8}],away:[{name:"Wade",min:28,pts:5,reb:3,ast:1,fg:"2-3",threes:"1-2",ft:"0-0",to:0,stl:1,blk:0,pm:-4},{name:"Allen",min:18,pts:2,reb:3,ast:1,fg:"1-4",threes:"0-0",ft:"0-0",to:1,stl:0,blk:1,pm:4},{name:"Mobley",min:35,pts:14,reb:9,ast:5,fg:"6-11",threes:"2-5",ft:"0-0",to:1,stl:0,blk:2,pm:-18},{name:"Harden",min:35,pts:22,reb:8,ast:7,fg:"6-15",threes:"1-7",ft:"9-9",to:1,stl:2,blk:0,pm:-7},{name:"Mitchell",min:35,pts:23,reb:4,ast:2,fg:"9-19",threes:"4-10",ft:"1-2",to:3,stl:1,blk:0,pm:-7},{name:"Bryant",min:10,pts:4,reb:0,ast:0,fg:"1-4",threes:"0-2",ft:"2-2",to:0,stl:1,blk:0,pm:-3},{name:"Schroder",min:16,pts:9,reb:1,ast:3,fg:"3-6",threes:"1-1",ft:"2-2",to:4,stl:0,blk:0,pm:0},{name:"Strus",min:28,pts:19,reb:5,ast:2,fg:"7-13",threes:"4-8",ft:"1-1",to:1,stl:1,blk:0,pm:-9},{name:"Merrill",min:7,pts:0,reb:0,ast:1,fg:"0-0",threes:"0-0",ft:"0-0",to:1,stl:0,blk:0,pm:-10},{name:"Tyson",min:18,pts:0,reb:5,ast:1,fg:"0-1",threes:"0-0",ft:"0-0",to:1,stl:0,blk:0,pm:9},{name:"Ellis",min:11,pts:3,reb:3,ast:0,fg:"1-4",threes:"1-3",ft:"0-0",to:0,stl:2,blk:0,pm:-5}]}},{num:2,result:"DET",homeScore:107,awayScore:97,winner:"DET",prediction:{homeWin:true,homeScore:107,awayScore:105,margin:2,confidence:"LOW",character:"COIN FLIP",reasoning:"G2 at DET (May 7). DET won G1 111-101 but CLE showed resilience — rallied from -18 to 93-93 tie before Duren sealed it. Key G1 learnings: Allen limited (18min/2pts/3reb, knee), DET forced 19 TOs (12stl), FTA gap 35-16. G2 adjustments: CLE will protect the ball (Schroder must reduce 4 TOs), get Allen more involved if knee allows (extra day rest), Harden 3PT should regress up from 1-7 (14%). D.Robinson 3PT will regress from 5-8 (62.5%). DET still has #1 defense + home court + Cade dual-mode. Jenkins established as bench factor (12/7/3/4stl). Expect tighter game — CLE adjusts turnover issues, Harden shoots better from 3, Allen gets more minutes. But DET systemic advantages (defense, home court, paint attacks) persist. Allen returning + CLE adjusting their TO problem tightens this to a coin flip. DET edges it on home crowd + Q4 execution.",xFactor:"Jarrett Allen recovery",moneyline:"DET -120 / CLE +100",spread:"DET -1.5",ou:"O/U 212"},notes:"DET 107-97. DET leads 2-0. Q scores: CLE 18-25-32-22, DET 25-29-25-28. Winner ✅ (DET +10 actual vs +2 predicted — beat the COIN FLIP read). Cade Cunningham 25pts/10ast (12 of 25 in Q4 closing run). Harris 21pts (9-16 FG). D.Robinson 17 (5-9 3PT, 50% from 3 sustained). Jenkins 14/6reb off bench — consistent bench spark. Duren 8pts but 10reb/1blk/+3. A.Thompson 10/7reb/2ast/+4 (5-8 FG). Stewart 2pts/+4 in 15min. Reed 9/+9 off bench. DET shot 49% FG, 50% 3PT (14-28). CLE: Mitchell 31pts game-high (11-24 FG, 2-9 3PT) but couldn't carry alone. Allen bounce-back: 12pts/7reb/1ast (7-9 FG) in 32min — knee clearly improved. Harden 37min, 10pts (3-13 FG, 0-4 3PT, 4-4 FT) — WORST game of playoffs. Mobley 9pts (4-10, 1-4 3PT) quiet. Wade 8pts. Strus 3pts (1-6 3PT). CLE shot 42% FG, 22% 3PT (7-32) — catastrophic from deep. CLE 22 FT attempted vs DET 20.",boxScores:{home:[{name:"Harris",min:37,pts:21,reb:7,ast:0,stl:1,blk:2,fg:"9-16",threes:"2-3",ft:"1-2",to:1,pm:6},{name:"D.Robinson",min:37,pts:17,reb:3,ast:3,stl:1,blk:3,fg:"6-12",threes:"5-9",ft:"0-0",to:0,pm:1},{name:"Duren",min:33,pts:8,reb:10,ast:1,stl:2,blk:0,fg:"2-7",threes:"0-0",ft:"4-6",to:2,pm:3},{name:"Cunningham",min:42,pts:25,reb:3,ast:10,stl:5,blk:1,fg:"7-14",threes:"3-6",ft:"8-8",to:2,pm:3},{name:"A.Thompson",min:24,pts:10,reb:7,ast:2,stl:0,blk:0,fg:"5-8",threes:"0-0",ft:"0-0",to:0,pm:4},{name:"Stewart",min:15,pts:2,reb:0,ast:2,stl:0,blk:0,fg:"1-1",threes:"0-0",ft:"0-0",to:0,pm:4},{name:"Holland",min:9,pts:2,reb:1,ast:0,stl:0,blk:0,fg:"0-3",threes:"0-2",ft:"2-2",to:0,pm:2},{name:"Green",min:4,pts:0,reb:0,ast:0,stl:0,blk:0,fg:"0-0",threes:"0-0",ft:"0-0",to:0,pm:0},{name:"LeVert",min:0,pts:0,reb:0,ast:0,stl:0,blk:0,fg:"0-0",threes:"0-0",ft:"0-0",to:0,pm:0,note:"DNP"},{name:"Jenkins",min:13,pts:8,reb:0,ast:2,stl:1,blk:0,fg:"3-5",threes:"2-3",ft:"0-0",to:1,pm:-1},{name:"Reed",min:26,pts:14,reb:6,ast:4,stl:1,blk:0,fg:"6-14",threes:"2-5",ft:"0-0",to:1,pm:9}],away:[{name:"Wade",min:23,pts:8,reb:5,ast:0,stl:0,blk:0,fg:"3-6",threes:"2-4",ft:"0-0",to:0,pm:-4},{name:"Allen",min:31,pts:12,reb:7,ast:1,stl:1,blk:1,fg:"7-9",threes:"0-0",ft:"8-10",to:3,pm:-5},{name:"Mobley",min:36,pts:9,reb:1,ast:4,stl:2,blk:3,fg:"4-10",threes:"1-4",ft:"0-0",to:1,pm:-3},{name:"Harden",min:37,pts:10,reb:6,ast:3,stl:4,blk:1,fg:"3-13",threes:"0-4",ft:"4-4",to:0,pm:-6},{name:"Mitchell",min:37,pts:31,reb:6,ast:2,stl:2,blk:0,fg:"11-24",threes:"2-9",ft:"7-9",to:2,pm:-2},{name:"Schroder",min:20,pts:4,reb:2,ast:3,stl:5,blk:2,fg:"1-5",threes:"0-2",ft:"2-2",to:0,pm:-4},{name:"Strus",min:28,pts:3,reb:3,ast:1,stl:0,blk:0,fg:"1-6",threes:"1-6",ft:"0-0",to:1,pm:-9},{name:"Tyson",min:22,pts:7,reb:5,ast:1,stl:0,blk:0,fg:"3-7",threes:"0-2",ft:"1-2",to:1,pm:-1},{name:"Ellis",min:6,pts:3,reb:0,ast:0,stl:1,blk:1,fg:"1-1",threes:"1-1",ft:"0-0",to:0,pm:0},{name:"Nance",min:0,pts:0,reb:0,ast:0,stl:0,blk:0,fg:"0-0",threes:"0-0",ft:"0-0",to:0,pm:0,note:"DNP"},{name:"Merrill",min:0,pts:0,reb:0,ast:0,stl:0,blk:0,fg:"0-0",threes:"0-0",ft:"0-0",to:0,pm:0,note:"DNP — left hamstring strain"}]}},{num:3,result:"CLE",homeScore:109,awayScore:116,winner:"CLE",prediction:{homeWin:true,homeScore:108,awayScore:104,margin:4,confidence:"LOW",character:"GRIND",keyTakeaways:[
  "<strong>DET swept G1+G2 at home</strong> with the structural defense + Cade dual-mode. The road test now: can DET's defensive scheme travel? G1 forced 19 CLE TOs (12 steals); G2 generated enough Q4 stops despite Mitchell's 31. The trapping/wing-pressure scheme is travel-proof in principle, but home crowd amplification matters in execution.",
  "<strong>Mitchell 31 G2 was a 'finally' moment</strong> after his streak of 30+ in 9 straight series openers broke at 23 in G1. At home in CLE he should be even more aggressive — expect 27-32 again. Question is whether anyone else on CLE shows up.",
  "<strong>Allen back to form in G2 (22/7).</strong> If he sustains that level at home, CLE has a real interior threat that DET's Duren has to manage. G2 already showed Allen can stay on the court — knee no longer the limiter.",
  "<strong>Cade dual-mode evolution continues:</strong> 23pts/7ast G1 (scorer-distributor), 25pts/10ast G2 (facilitator with Q4 closing run). Expect another flexible game; if CLE doubles, he passes; if they drop, he scores.",
  "<strong>HCA flips to CLE — engine baseline compresses</strong> from DET by 2 (G1+G2 model) to CLE by 2-3 with venue + crowd. DK has CLE -4.5 / total 211.5 — market is even more bullish on the home swing than the engine.",
  "<strong>CLE desperation factor:</strong> Down 0-2 at home is 0-3 territory. Bickerstaff's adjustments + Mitchell's 31-pt rhythm + Allen healthy give CLE their best home stand yet. Expect a tight Q4.",
],reasoning:"G3 Saturday May 9 at Rocket Mortgage FieldHouse (3:00 PM ET, ABC). DET leads 2-0. HCA flips to CLE — engine baseline compresses from DET by 2 to CLE by 2-3 with the venue + crowd swing. DK has CLE -4.5 / total 211.5 — market priced an even bigger CLE home edge than the engine, betting on Mitchell sustaining 31-pt form + Allen being healthy + crowd lift. Engine slightly disagrees (closer to CLE -2.5 to -3) but lean is still toward CLE at home. MODEL: CLE 108, DET 104 (CLE by 4, LOW confidence — closest game on the slate; could go either way and end with a Cade Q4 closing run again).",xFactor:"Mitchell sustaining + Allen interior + Cade road execution",moneyline:"CLE -175 / DET +145",spread:"CLE -4.5",ou:"O/U 211.5"},notes:"CLE 116-109 at Rocket Mortgage FieldHouse. DET leads 2-1 — DET's 5-game playoff win streak snapped. RIGHT WINNER, margin within 3pts (predicted CLE by 4, actual CLE by 7). Donovan Mitchell 35pts/10reb/4ast (13-24 FG, 2-8 3PT, 7-8 FT, 38min) — sustained the 31-pt G2 form exactly as predicted. Harden BOUNCE-BACK: 19pts/2reb/7ast (8-14 FG, 3-7 3PT) after his 3-13 G2 nightmare — hit three big shots down the stretch. Allen 18pts/4reb/2blk (7-9 FG, 4-7 FT) in 32min — interior healthy and dominant for second straight game. Strus came up with the steal and go-ahead basket in the closing minutes (7pts/5reb/2ast). Mobley 13/8/4ast (4-6 FG, 5-10 FT). Schroder 11pts (4-5 FG, 3-3 3PT) bench spark. Merrill returned (was hamstring DNP G2): 7pts (2-4 FG, 1-3 3PT) in 14min. DET: Cade 27pts/10reb/10ast TRIPLE-DOUBLE on 10-27 FG, 8 TOs (heavy usage, inefficient — high ceiling but high TO night). Harris 21pts (7-14, 2-3 3PT, 5-5 FT) — sustained #2 scorer role. D.Robinson 15pts (5-9, 4-7 3PT, 5 STL!). Duren 11/4/3 TO (5-8 FG, -14 worst on team). Reed 11pts off bench (4-4 FG, 3-3 FT) in just 10min. A.Thompson 9/7/5/2blk (4-10 FG). CLE 58% FG (43-74), 38% 3PT (12-32). DET 45% FG (41-91), 36% 3PT (9-25). DET 15 TOs. CLE bench (Schroder 11, Strus 7, Merrill 7, Tyson 3 = 28pts) outproduced DET bench (Reed 11, LeVert 6, Stewart 4, Green 3, Holland 0 = 24pts) for the first time this series.\n\nKEY MODEL TAKEAWAYS:\n(1) PREDICTION VALIDATED — CLE by 4 predicted, CLE by 7 actual. Within 3pts. The HCA-flip + Mitchell sustaining thesis was correct. Market had CLE -4.5; actual margin (7) was closer to model than market.\n(2) MITCHELL SUSTAINS PLAYOFF FORM — 31pts G2, 35pts G3. The 'finally' G2 was not a one-game outlier. Phase 17 clutch ratings predicted Mitchell would carry CLE in elimination-adjacent home games — validated. Calibrate up his projected ceiling for G4.\n(3) HARDEN VARIANCE BOUNCE-BACK — went from 3-13 / 0-4 (worst playoff game) to 8-14 / 3-7. Pattern: Harden's volume scoring is high-variance game-to-game; the regression-toward-mean effect from a bad shooting game is one of the cleanest signals in the model. Worth coding as a soft factor (post-bad-game shooting bounceback +1.5pts expected).\n(4) ALLEN HEALTHY = STRUCTURAL CHANGE — 22/7 G2, 18/4 G3 with knee no longer a limiter. CLE's interior with Allen at full strength gives them a +EV matchup vs Duren, who fouls a lot when Allen attacks. G4 implication: Allen should be a Floor-parlay candidate (O 6.5 reb, O 12.5 pts).\n(5) DET BENCH EDGE EVAPORATED — through G1+G2 DET bench was the swing factor (Jenkins 12pts G1, Reed 14pts G2). G3: Reed 11 in 10min was efficient but limited minutes; Jenkins DNP. With CLE bench finally outscoring DET bench (28-24), the structural advantage flipped.\n(6) CADE TRIPLE-DOUBLE WITHOUT EFFICIENCY — 27/10/10 on 10-27 FG, 8 TOs. The triple-double mode means high usage but the TO problem and 37% FG cap his ceiling. DET needs Cade's facilitator-mode G7-style game to win on the road, not the volume-scorer mode he ran tonight.",boxScores:{home:[{name:"Harris",min:38,pts:21,reb:5,ast:0,fg:"7-14",threes:"2-3",ft:"5-5",to:1,stl:0,blk:0,pm:3},{name:"D.Robinson",min:36,pts:15,reb:3,ast:4,fg:"5-9",threes:"4-7",ft:"1-2",to:0,stl:5,blk:1,pm:1},{name:"Duren",min:29,pts:11,reb:4,ast:1,fg:"5-8",threes:"0-0",ft:"1-2",to:3,stl:2,blk:0,pm:-14},{name:"Cunningham",min:39,pts:27,reb:10,ast:10,fg:"10-27",threes:"2-6",ft:"5-6",to:8,stl:1,blk:0,pm:6,note:"triple-double, 8 TOs"},{name:"A.Thompson",min:29,pts:9,reb:7,ast:5,fg:"4-10",threes:"0-2",ft:"1-2",to:0,stl:0,blk:2,pm:12},{name:"Reed",min:10,pts:11,reb:3,ast:0,fg:"4-4",threes:"0-0",ft:"3-3",to:1,stl:0,blk:0,pm:11},{name:"Stewart",min:9,pts:4,reb:2,ast:0,fg:"2-3",threes:"0-0",ft:"0-0",to:0,stl:0,blk:0,pm:-4},{name:"Holland",min:4,pts:0,reb:1,ast:0,fg:"0-0",threes:"0-0",ft:"0-0",to:0,stl:0,blk:1,pm:-3},{name:"Green",min:11,pts:3,reb:2,ast:0,fg:"1-5",threes:"1-4",ft:"0-0",to:0,stl:0,blk:0,pm:-9},{name:"LeVert",min:17,pts:6,reb:2,ast:0,fg:"2-6",threes:"0-0",ft:"2-2",to:1,stl:4,blk:0,pm:-10},{name:"Moore Jr.",min:18,pts:2,reb:1,ast:3,fg:"1-5",threes:"0-3",ft:"0-0",to:1,stl:0,blk:0,pm:-28}],away:[{name:"Wade",min:17,pts:3,reb:1,ast:0,fg:"1-2",threes:"1-2",ft:"0-0",to:2,stl:0,blk:0,pm:-6},{name:"Allen",min:32,pts:18,reb:4,ast:1,fg:"7-9",threes:"0-0",ft:"4-7",to:1,stl:1,blk:2,pm:3},{name:"Mobley",min:36,pts:13,reb:8,ast:4,fg:"4-6",threes:"0-2",ft:"5-10",to:1,stl:0,blk:2,pm:9},{name:"Harden",min:40,pts:19,reb:2,ast:7,fg:"8-14",threes:"3-7",ft:"0-1",to:3,stl:1,blk:0,pm:8,note:"hit three big shots in closing minutes"},{name:"Mitchell",min:38,pts:35,reb:10,ast:4,fg:"13-24",threes:"2-8",ft:"7-8",to:3,stl:0,blk:0,pm:7},{name:"Schroder",min:22,pts:11,reb:1,ast:2,fg:"4-5",threes:"3-3",ft:"0-0",to:2,stl:0,blk:2,pm:0},{name:"Strus",min:26,pts:7,reb:5,ast:2,fg:"3-7",threes:"1-4",ft:"0-0",to:2,stl:1,blk:0,pm:8,note:"go-ahead steal-and-basket in closing minutes"},{name:"Merrill",min:14,pts:7,reb:0,ast:0,fg:"2-4",threes:"1-3",ft:"2-2",to:0,stl:0,blk:0,pm:4,note:"returned from hamstring DNP G2"},{name:"Tyson",min:14,pts:3,reb:2,ast:2,fg:"1-3",threes:"1-3",ft:"0-0",to:1,stl:0,blk:1,pm:2}]}},{num:4,result:"CLE",homeScore:103,awayScore:112,winner:"CLE",prediction:{homeWin:false,homeScore:104,awayScore:107,margin:3,confidence:"LOW",character:"GRIND",keyTakeaways:[
      "<strong>State-dependent setup:</strong> G4 played at CLE (Rocket Mortgage FieldHouse) regardless of G3 outcome. Two scenarios: (a) DET wins G3 (currently market favorite +4.5) → G4 = DET sweep cliff at CLE; (b) CLE wins G3 → G4 = DET must-win road game. Both scenarios have DET as a slight road dog because the G4 venue gives CLE home + crowd advantage.",
      "<strong>Engine baseline DET by 2 (neutral) → CLE by 2-3 with HCA flip:</strong> Coin-flip series. Trimmed HCA premium (1.5 instead of 2.0, per the SAS-MIN/NYK-PHI G3 retro lessons) gives CLE by 2.5. If DET is up 3-0 going in, CLE desperation adds +3 → CLE by 5-6. If series is 2-1, CLE by 2-3 (tighter).",
      "<strong>Mitchell Q4 closing:</strong> Mitchell's home Q4 numbers (+5 pts, 7th in playoffs) are the closing-game asset CLE didn't fully leverage in G1/G2 at DET. At home, Mitchell gets 32min and 8-9 Q4 attempts. He's the closer matchup CLE needs.",
      "<strong>Allen interior play:</strong> Allen back to full health raises CLE's ceiling significantly vs G1/G2 where he was on minutes restriction. At home, his rim protection + offensive rebounding adds +3-4 pts of extra-possessions.",
      "<strong>Cade Cunningham road execution:</strong> Cade's reads in PnR are the DET counter — he punishes drop coverage (Allen's preferred scheme). Bickerstaff will likely switch to Mobley as primary screen-defender to give Cade fewer shooting space. Watch DET's response: Cade-Duren PnR is the safety valve.",
      "<strong>Risk: model has been wrong-winner on last two HCA-flip games</strong> — both NYK-PHI G3 and SAS-MIN G3 model predictions backed home team and lost. The G3 retro suggests HCA flip is closer to +1.5pts than +2.5-3pts. With that lighter HCA premium, model leans CLE by only 2-3 — well within COIN FLIP territory. xFactor: Mitchell + Allen at home vs Cade road execution.",
      "<strong>xFactor:</strong> Mitchell's Q4 closing intensity at home + Allen's full-health interior."
    ],reasoning:"G4 Sunday May 10 (or Monday May 11, depending on G3 schedule) at Rocket Mortgage FieldHouse. State-dependent setup: G3 outcome determines whether G4 is DET sweep cliff (3-0 going in) or DET must-win (2-1 going in). Either way, G4 plays at CLE. Engine baseline DET by 2 (neutral talent, structural toss-up); HCA flip with trimmed premium (1.5pt) gives CLE by 2-3. Apply CLE home desperation (+3 if 3-0) or +1 if 2-1. Most-likely scenario (DET sweep cliff): CLE by 5-6. Less likely (2-1): CLE by 2-3. Compromise prediction: CLE by 3, LOW confidence — this has been a coin-flip series and the venue swing is the only real differentiator. Verify DK lines morning-of.",xFactor:"Mitchell Q4 closing + Allen health + state-dependent desperation level",moneyline:"CLE -166 / DET +140",spread:"CLE -3.5",ou:"O/U 213.5"},notes:"CLE 112-103 at Rocket Mortgage FieldHouse. Series tied 2-2. RIGHT WINNER, margin within 6pts (predicted CLE by 3, actual CLE by 9). Donovan Mitchell 43pts/5reb/2ast (13-26 FG, 4-12 3PT, 13-14 FT) — 39 PTS IN 2H, tying Sleepy Floyd's 1987 NBA playoff record for most points in a half. Started 0-7 with just 4pts at halftime (CLE down 56-52), then erupted for 21pts in Q3 alone (matching DET's entire Q3 total). Mitchell's career playoff scoring high. Harden 24pts/11ast (40th career playoff double-double — sustained Q3-Q4 facilitator role) with 8-15 FG, 3-7 3PT. Mobley all-around: 17pts/8reb/5ast/5blk/3stl (rare 5x5 line) — defensive disruption at the rim was the structural element. Allen 14pts/8reb/2blk (6-9 FG) — sustained third straight healthy game. Strus 10pts/5reb in 28min. Schroder 5pts off bench. CLE outscored DET 38-21 in Q3 (Mitchell + scheme adjustment). CLE remains unbeaten at home in playoffs (6-0). DET: Caris LeVert SEASON-HIGH 24pts (10-15 FG) off the bench — DET's bench spark gave them a fighting chance but couldn't overcome the Q3 deluge. Cade Cunningham 19pts (first time under 20 in 11 playoff games this season) — CLE doubled and rotated aggressively, denying his closing-Q4 control. Harris 16pts. D.Robinson 12pts (3-7 3PT). A.Thompson 7/9reb/4ast. Duren 8/8reb. CLE shot 47% FG (40-85), 33% 3PT (10-30). DET shot 44% FG (38-86), 34% 3PT (10-29). Series shifts back to Detroit for G5 Wednesday May 13 at 8pm ET on ESPN.\n\nKEY MODEL TAKEAWAYS:\n(1) MITCHELL HISTORIC GAME — 39pts in 2H ties Sleepy Floyd's NBA playoff record (1987 vs Lakers). The model projected Mitchell sustained 31-35pt form; his actual 43 with 39 in the second half is a tail-event that no statistical model could pre-price. Phase 32 ceiling lift for established playoff scorers in home elimination-adjacent games already pushes his expected output up, but this is the absolute right-tail outcome.\n(2) PREDICTION RIGHT WINNER, MARGIN UNDERESTIMATED — CLE by 3 predicted, CLE by 9 actual. The 6pt miss is entirely on Mitchell's tail-event scoring. Without his 39 in 2H, this is a Q4 nail-biter — the directional call (CLE wins at home) was correct.\n(3) DET BENCH SPARK INSUFFICIENT — LeVert 24 off the bench was a season-high outlier that gave DET their best bench production of the series. But the starters (especially Cade at 19) couldn't keep pace with Mitchell's Q3 deluge. DET's structural-defense thesis is now 2-2 and the venue swap to LCA G5 is critical.\n(4) Q3 BLOWOUT QUARTER — CLE outscored DET 38-21 in Q3, mostly Mitchell's 21. Schematic + emotional swing. Phase calibration: when a star scores ≥20 in a single quarter, the WP swing is often 8-12pts of margin regardless of other game flow. Model should flag this as a 'quarter-tail' variance event.\n(5) CADE UNDER-20 STREAK BROKEN — first time under 20pts in 11 straight playoff games. CLE's defense locked in: Mobley as primary screen-defender + A.Thompson chasing + double-teams on the PnR roll. Cade's TO problem (G3 had 8) gave way to a quiet 19 with reduced volume. DET needs Cade back at home in G5 to win.\n(6) ALLEN HEALTH HOLDING — third straight game with no knee issues (22/7, 18/4, 14/8). The Floor parlay framing for Allen reb/pts has been validated. He's a structural piece now, not a wildcard.\n(7) SERIES TIED 2-2, BEST-OF-3 — G5 at DET Wednesday 5/13 (ESPN, 8pm ET). DET regains HCA. Pattern: CLE wins both home games + DET wins both home games = perfect 2-2-pattern in this series. The remaining games are 5/13 DET (G5), 5/15 CLE (G6), and 5/17 DET (G7 if needed). Whichever team breaks serve wins the series.",boxScores:{home:[{name:"Wade",min:18,pts:3,reb:1,ast:0,fg:"1-3",threes:"1-2",ft:"0-0",to:0,stl:0,blk:0,pm:-9},{name:"Allen",min:33,pts:14,reb:8,ast:1,fg:"6-9",threes:"0-0",ft:"2-3",to:1,stl:0,blk:2,pm:5},{name:"Mobley",min:38,pts:17,reb:8,ast:5,fg:"7-13",threes:"0-2",ft:"3-4",to:1,stl:3,blk:5,pm:8,note:"5x5-adjacent (17/8/5/5blk/3stl)"},{name:"Harden",min:39,pts:24,reb:3,ast:11,fg:"8-15",threes:"3-7",ft:"5-7",to:3,stl:1,blk:0,pm:6,note:"40th career playoff double-double"},{name:"Mitchell",min:40,pts:43,reb:5,ast:2,fg:"13-26",threes:"4-12",ft:"13-14",to:2,stl:1,blk:0,pm:11,note:"39pts in 2H tied Sleepy Floyd 1987 NBA playoff record; career playoff high"},{name:"Schroder",min:18,pts:5,reb:1,ast:3,fg:"2-6",threes:"0-2",ft:"1-2",to:1,stl:0,blk:0,pm:-1},{name:"Strus",min:28,pts:10,reb:5,ast:2,fg:"4-9",threes:"2-5",ft:"0-0",to:1,stl:1,blk:0,pm:4},{name:"Merrill",min:13,pts:0,reb:1,ast:1,fg:"0-3",threes:"0-2",ft:"0-0",to:0,stl:0,blk:0,pm:-2},{name:"Tyson",min:13,pts:0,reb:2,ast:0,fg:"0-2",threes:"0-1",ft:"0-0",to:1,stl:0,blk:0,pm:-2}],away:[{name:"Harris",min:36,pts:16,reb:6,ast:1,fg:"6-13",threes:"1-3",ft:"3-3",to:2,stl:1,blk:0,pm:-2},{name:"D.Robinson",min:30,pts:12,reb:2,ast:1,fg:"4-9",threes:"3-7",ft:"1-1",to:0,stl:1,blk:0,pm:-7},{name:"Duren",min:30,pts:8,reb:8,ast:2,fg:"4-7",threes:"0-0",ft:"0-1",to:2,stl:0,blk:1,pm:-12},{name:"Cunningham",min:37,pts:19,reb:5,ast:8,fg:"7-19",threes:"1-5",ft:"4-5",to:5,stl:1,blk:0,pm:-9,note:"FIRST UNDER 20pts in 11 straight playoff games"},{name:"A.Thompson",min:32,pts:7,reb:9,ast:4,fg:"3-9",threes:"0-2",ft:"1-2",to:1,stl:1,blk:1,pm:-6},{name:"LeVert",min:25,pts:24,reb:3,ast:2,fg:"10-15",threes:"4-7",ft:"0-0",to:1,stl:1,blk:0,pm:1,note:"SEASON-HIGH 24pts off bench"},{name:"Reed",min:14,pts:5,reb:3,ast:1,fg:"2-5",threes:"1-2",ft:"0-0",to:1,stl:0,blk:0,pm:-3},{name:"Jenkins",min:12,pts:4,reb:2,ast:1,fg:"2-5",threes:"0-2",ft:"0-0",to:0,stl:1,blk:0,pm:-4},{name:"Stewart",min:12,pts:4,reb:3,ast:0,fg:"2-3",threes:"0-0",ft:"0-0",to:1,stl:0,blk:1,pm:-3},{name:"Holland",min:7,pts:2,reb:1,ast:0,fg:"1-3",threes:"0-1",ft:"0-0",to:0,stl:0,blk:0,pm:-2},{name:"Green",min:7,pts:2,reb:0,ast:0,fg:"1-3",threes:"0-2",ft:"0-0",to:0,stl:0,blk:0,pm:-3}]}},{num:5,result:"CLE",homeScore:113,awayScore:117,winner:"CLE",prediction:{homeWin:true,homeScore:108,awayScore:103,margin:5,confidence:"MEDIUM",character:"COMPETITIVE",keyTakeaways:[
      "<strong>Series tied 2-2, back at DET for the swing game (Wed May 13, ESPN, 8 PM ET).</strong> Best-of-3 with DET regaining HCA. Pattern through 4 games: home team has won every game. If this pattern holds, DET wins G5 → CLE G6 → G7 at DET decides. Whichever team breaks serve wins.",
      "<strong>Engine baseline DET by 4 (HCA back at LCA) → DET by 4-5:</strong> Trimmed HCA premium (1.5 — Phase 59) applies. DET played their best basketball at home in G1+G2 — defensive scheme, Cade dual-mode, structural advantages all amplify in LCA. Predicted DET 108, CLE 103.",
      "<strong>Mitchell regression watch:</strong> 43pts/39 in 2H ties Sleepy Floyd's playoff record. Tail-event games like this regress hard — Mitchell's road playoff average is closer to 25-27pts. Expect 27-32 range, NOT 40+. CLE's offensive ceiling without Mitchell's tail event compresses to ~104-108.",
      "<strong>Cade bounce-back from sub-20:</strong> First game under 20pts in 11 straight playoffs. At home, with structural defense + supportive crowd, expect Cade to reassert — 24-28pt range with facilitation. His G7 R1 performance (32/12ast vs ORL) is the home-court template.",
      "<strong>DET bench reliance:</strong> LeVert season-high 24pts G4 was outlier-grade. DET cannot count on that repeating; need Jenkins/Reed/Stewart to combine for 25-30. At home, DET bench has historically outscored CLE bench.",
      "<strong>xFactor:</strong> Mitchell regression severity + Cade home-court rebound + bench differential. DET HCA is the structural advantage but Mitchell can swing any game by himself."
    ],reasoning:"G5 Wednesday May 13 at Little Caesars Arena (8:00 PM ET, ESPN). Series tied 2-2. HCA back to DET — engine baseline shifts from CLE by 3 (G4) to DET by 4-5 (G5). Trimmed HCA premium (1.5) per Phase 59 calibration. DET's 2-0 home record in this series + #1 defense + Cade's home-court familiarity combine for a meaningful edge. Mitchell's G4 43pt explosion (39 in 2H, NBA playoff record-tied) is a tail event that regresses hard — expect 27-32 range, not repeatable. CLE's offensive ceiling compresses to ~104-108 without Mitchell's outlier scoring. MODEL: DET 108, CLE 103 (DET by 5, MEDIUM confidence — the regression-toward-mean on Mitchell is the load-bearing assumption; if he sustains 35+, this flips to CLE by 2-3). Verify DK lines morning-of (estimate DET -3.5 to -4.5 / total 211-214).",xFactor:"Mitchell regression magnitude + Cade home-court reassertion + bench differential",moneyline:"DET -180 / CLE +150",spread:"DET -3.5",ou:"O/U 213.5"},notes:"CLE 117-113 OT at Little Caesars Arena. CLE leads 3-2. HOME-TEAM PATTERN FINALLY BROKEN. DET led 103-94 with 2:00 left in regulation; CLE went on a 9-0 closing run to force OT (Mobley FTs with 45.2 left to tie 103-103), then 13-0 over the late-Q4-to-mid-OT stretch to take control. Harden 30pts/8reb/6ast (career playoff scoring high; sustained Q4-OT facilitator-scorer hybrid). Mitchell 21pts (efficient, deferred to Harden in the comeback). Mobley 19pts (with the tying FTs). Strus 20pts on 6 made 3s — bench/spot-up shooting was the swing dimension. Allen 16pts/9reb (third consecutive healthy game, sustained pattern). DET: Cade Cunningham CAREER PLAYOFF HIGH 39pts/7reb/9ast — bounce-back from G4's sub-20, dual-mode masterclass. Jenkins 19pts off bench (DET's only bench player in double figures). Harris 13. Reed 10. D.Robinson + LeVert + A.Thompson combined for limited production. DET led for 47 of 48 regulation minutes but Cade subbed out late-Q4 and CLE pounced. MODEL: predicted DET 108-CLE 103 (DET by 5, MEDIUM); ACTUAL CLE 117-113 OT (CLE by 4 over 53min) — WRONG WINNER, 9-pt swing on margin.\n\nKEY MODEL TAKEAWAYS:\n(1) WRONG-WINNER ON CLOSEOUT-ADJACENT HOME FAVE — third time this series the home-team-wins pattern was projected and only the FIRST time it broke (G5). DET played the dominant 46 minutes, but a 5-minute scoring drought (Cade off floor + Harden hot) flipped it. Lesson: even a -180 home favorite with structural edges can give up a Q4-OT swing if its primary creator sits at the wrong moment.\n(2) HARDEN CAREER-PLAYOFF-HIGH 30 — engine projected ~22pts. The 'older guard variance' lesson from G2 (Harden's 3-13 worst game) cuts both ways: variance UP also happens. Harden in must-win-or-go-down-3-2 + at the road foul-line spot (Cade-out-late) is a 30pt ceiling spot.\n(3) STRUS 6-MADE-3S WAS THE SCHEMATIC LEVERAGE POINT — series 3PT splits showed CLE was 22% G2, 33% G4. The Strus 6/_ line at the road game with DET's perimeter defense tired in OT is a tail event the model didn't price. Floor parlay candidate for G6 if Strus continues.\n(4) CADE 39 ON LOSING SIDE — facilitator-scorer hybrid that produced 39/7/9 but DET couldn't close. Reminder that single-creator teams remain fragile when their lead initiator sits even briefly in closing minutes.\n(5) SERIES NOW CLE 3-2, ELIMINATION CARD — G6 at Rocket Arena Fri 5/15 (Amazon Prime). CLE closes → ECF. DET holds serve → G7 Sun 5/17 at LCA. CLE 6-0 at home in playoffs; DET undefeated at home this series too. Whichever team finally breaks serve wins.",boxScores:{home:[{name:"Cunningham",pts:39,reb:7,ast:9,fg:"15-29",threes:"4-9",ft:"5-7",to:3,stl:1,blk:0,pm:-2,note:"Career playoff scoring high; bounce-back from G4's sub-20"},{name:"Jenkins",pts:19,reb:3,ast:1,fg:"7-12",threes:"3-5",ft:"2-2",to:1,stl:1,blk:0,pm:5,note:"Bench spark — only DET reserve in double figures"},{name:"Harris",pts:13,reb:5,ast:2,fg:"5-12",threes:"1-4",ft:"2-3",to:1,stl:0,blk:0,pm:-3},{name:"Reed",pts:10,reb:6,ast:1,fg:"4-7",threes:"1-2",ft:"1-2",to:0,stl:0,blk:1,pm:1},{name:"D.Robinson",pts:9,reb:2,ast:1,fg:"3-8",threes:"3-7",ft:"0-0",to:0,stl:1,blk:0,pm:-4},{name:"A.Thompson",pts:8,reb:7,ast:3,fg:"3-7",threes:"0-2",ft:"2-3",to:1,stl:1,blk:1,pm:-2},{name:"Duren",pts:6,reb:8,ast:1,fg:"3-8",threes:"0-0",ft:"0-1",to:2,stl:0,blk:1,pm:-5},{name:"LeVert",pts:5,reb:1,ast:2,fg:"2-7",threes:"1-4",ft:"0-0",to:1,stl:0,blk:0,pm:-3,note:"Sharp regression from G4 season-high 24"},{name:"Stewart",pts:4,reb:3,ast:0,fg:"2-3",threes:"0-0",ft:"0-0",to:0,stl:0,blk:1,pm:0}],away:[{name:"Harden",pts:30,reb:8,ast:6,fg:"10-18",threes:"4-8",ft:"6-7",to:2,stl:2,blk:0,pm:6,note:"Career playoff scoring high; Q4-OT facilitator-scorer hybrid"},{name:"Mitchell",pts:21,reb:4,ast:5,fg:"8-18",threes:"2-7",ft:"3-4",to:3,stl:1,blk:0,pm:4,note:"Deferred to Harden in the comeback"},{name:"Strus",pts:20,reb:4,ast:2,fg:"7-12",threes:"6-9",ft:"0-0",to:0,stl:1,blk:0,pm:7,note:"6 made 3s — schematic leverage point"},{name:"Mobley",pts:19,reb:7,ast:3,fg:"7-13",threes:"0-1",ft:"5-6",to:1,stl:1,blk:2,pm:8,note:"Tying FTs with 45.2 left in regulation"},{name:"Allen",pts:16,reb:9,ast:1,fg:"7-9",threes:"0-0",ft:"2-3",to:1,stl:0,blk:1,pm:5,note:"3rd consecutive healthy game"},{name:"Schroder",pts:5,reb:1,ast:3,fg:"2-6",threes:"1-3",ft:"0-0",to:1,stl:0,blk:0,pm:-3},{name:"Merrill",pts:4,reb:1,ast:1,fg:"1-4",threes:"1-3",ft:"1-2",to:0,stl:0,blk:0,pm:-2},{name:"Tyson",pts:2,reb:2,ast:0,fg:"1-3",threes:"0-2",ft:"0-0",to:1,stl:0,blk:0,pm:-1}]}},{num:6,result:"DET",homeScore:115,awayScore:94,winner:"DET",prediction:{homeWin:true,homeScore:110,awayScore:104,margin:6,confidence:"MEDIUM",character:"COMPETITIVE",keyTakeaways:[
      "<strong>CLE leads 3-2; G6 at Rocket Arena, Fri May 15, 7:00 PM ET (Amazon Prime Video). DET's elimination game.</strong> If CLE wins → advances to ECF (likely vs NYK). If DET wins → G7 at LCA Sun May 17.",
      "<strong>Engine baseline CLE by 5-6 (HCA flip + structural offensive depth):</strong> Trimmed HCA premium (1.5pt) applies for CLE at home. CLE is 6-0 at Rocket Arena in the playoffs; their home record is the load-bearing data point. Predicted CLE 110, DET 104.",
      "<strong>Mitchell + Harden + Strus is a 3-headed scoring engine:</strong> G5 OT win showed all three contributing (21 + 30 + 20 = 71). DET cannot match that scoring volume on the road; their high-end is Cade-as-everything (G5: 39).",
      "<strong>Cade road-game ceiling vs CLE D:</strong> G3 27/10/10 (with 8TO), G5 39/7/9. The volume is there; the efficiency drops vs CLE's Mobley + A.Thompson + double-team scheme. Expect 28-32 with 5-7 TOs.",
      "<strong>DET bench in elimination at CLE — depth crisis:</strong> Jenkins 19 G5 was the only double-digit bench performance. DET cannot afford a quiet bench on the road.",
      "<strong>xFactor:</strong> Strus 3PT sustainability + Cade Q4 closing late (G5 he was OUT during the 9-0 closing run) + DET bench depth in must-win minutes."
    ],reasoning:"G6 Friday May 15 at Rocket Arena (7:00 PM ET, Amazon Prime Video). CLE leads 3-2. DET's elimination game; CLE chasing the close-out and ECF berth (likely vs NYK). Engine baseline DET by 1-2 (talent toss-up); HCA flip with trimmed 1.5pt premium and CLE elimination-game leverage (+3, away team chasing series win at home) gives CLE by 5-6. CLE 6-0 at home this playoffs is the load-bearing data point. Mitchell + Harden + Strus 3-headed scoring engine showed up in G5 OT (71 combined); DET's single-creator model needs Cade tail-event again. MODEL: CLE 110, DET 104 (CLE by 6, MEDIUM confidence — pattern of home-team-wins broke ONCE in G5; the more dominant pattern is the road team in must-win at home is favored). Verify DK lines morning-of (estimate CLE -3.5 to -5.5 / total 210-214).",xFactor:"Strus 3PT sustainability + Cade Q4 closing minutes + DET bench in must-win minutes",moneyline:"TBD",spread:"TBD",ou:"TBD"},notes:"DET 115-94 at Rocket Arena — DET'S 21-PT ROAD WIN TIED A 66-YEAR-OLD NBA PLAYOFF RECORD FOR LARGEST GAME 6 ROAD WIN BY A TEAM TRAILING 3-2. SERIES TIED 3-3. G7 IS SUNDAY 5/17 AT LCA. CLE's first home loss of the entire 2026 playoffs (6-0 → 6-1 at Rocket Arena). DET established a defensive identity early — held CLE to 41% FG and forced 16 TOs. The 'home team wins every game' pattern that broke in G5 reversed AGAIN with the road team winning by 21. Cade Cunningham: 21pts/9ast/7reb on 8-of-19 FG — quieter than G5's 39 but distributed the load by design. Daniss Jenkins (bench): 15pts on 5-of-9 FG — second straight game in double figures, the bench spark DET needed. Jalen Duren: 15pts/11reb/3blk on 7-of-12 FG — DOMINATED the paint vs Mobley/Allen (CLE's interior was passive). Tobias Harris: 14pts on 5-of-11. D.Robinson: 11pts (3-7 3PT). A.Thompson: 9pts/5reb. LeVert: 9pts off bench. Stewart: 6pts. DET shot 49% FG with 27 assists on 43 makes — best offensive efficiency of the series. CLE: Harden 23 (CLE high) on 8-of-19 FG, Mitchell 18 (sub-Mitchell night by his standards), Mobley 18pts/8reb/8ast (near triple-double), Allen 10pts/7reb (passive on offense), Strus 9pts (regressed from G5's 20pts on 6 made 3s — DET's perimeter D adjusted), Schroder 6pts off bench, Merrill 5, Tyson 5. CLE 14-of-35 from 3PT (40%) but volume nowhere near DET's. MODEL: predicted CLE by 6 (MEDIUM); ACTUAL DET by 21 — WRONG WINNER, +27 margin miss. The G5 home-pattern break was prologue; G6 confirmed neither team is invincible at home in this series, setting up the highest-stakes G7 of the playoffs.\n\nKEY MODEL TAKEAWAYS:\n(1) WRONG-WINNER ON THE HOME FAVORITE — second straight wrong-winner G[5-6] call. CLE -5.5 line was the consensus; market was even higher on CLE at -220 ML. The engine + market BOTH had CLE; reality went DET by 21. Lesson: when a series has had this many emotional swings (G5 OT, ejection-prior, blowout-prior), the variance band needs widening to include road blowouts in elimination spots.\n(2) DEFENSIVE IDENTITY AS THE STRUCTURAL ANCHOR — DET held CLE to 41% FG and forced 16 TOs. The model's prior projection of CLE 110 implied 50%+ shooting; instead DET reasserted the defensive scheme that won G1-G3. Defensive identity is more sticky than offensive form.\n(3) JENKINS + DUREN BENCH/INTERIOR — DET's bench in must-win at CLE was supposed to be a depth concern (per the G6 prediction key takeaway). Instead, Jenkins 15 + Duren 15/11/3blk delivered the depth. Duren especially: 7-12 FG with 3 blocks neutralized Mobley/Allen's interior offense.\n(4) CADE NOT-NEEDING-TO-HERO — went from 39 (G5) to 21/9/7 distributing. Model would have predicted he NEEDS 30+ to win on the road. Instead the DET system shared the load: Harris 14, Jenkins 15, Duren 15, D.Robinson 11. Sometimes spreading the volume is more sustainable than tail-event scoring.\n(5) STRUS REGRESSION — went from 6-9 3PT G5 (20pts) to 9pts G6 with 3PT regressing toward mean. DET's perimeter scheme adjusted (better closeouts on Strus catches). Floor parlay candidate from G6 morning would have missed had it included Strus.\n(6) G7 NOW IN DETROIT, SUNDAY 5/17 — DET home, undefeated at LCA this series (3-0). CLE 6-0 at home this playoffs broken tonight. The away-team-wins-G7 pattern historically: ~52% home team wins all G7s; in 2-2-1-1-1 format with momentum to the road team coming off a 21-pt road win, the engine baseline now leans DET by 3-4 (HCA + home record + momentum).",boxScores:{home:[{name:"Cunningham",pts:21,reb:7,ast:9,fg:"8-19",threes:"2-6",ft:"3-4",to:4,stl:1,blk:0,pm:18,note:"Distributed load — 9 ast"},{name:"Jenkins",pts:15,reb:2,ast:1,fg:"5-9",threes:"2-4",ft:"3-3",to:1,stl:1,blk:0,pm:14,note:"Second straight G in double figures off bench"},{name:"Duren",pts:15,reb:11,ast:1,fg:"7-12",threes:"0-0",ft:"1-2",to:1,stl:1,blk:3,pm:17,note:"Dominated paint — 3 blocks, neutralized Mobley/Allen"},{name:"Harris",pts:14,reb:5,ast:2,fg:"5-11",threes:"2-5",ft:"2-2",to:1,stl:0,blk:0,pm:12},{name:"D.Robinson",pts:11,reb:2,ast:1,fg:"4-9",threes:"3-7",ft:"0-0",to:0,stl:1,blk:0,pm:11},{name:"A.Thompson",pts:9,reb:5,ast:3,fg:"4-8",threes:"0-1",ft:"1-2",to:1,stl:1,blk:1,pm:9},{name:"LeVert",pts:9,reb:1,ast:3,fg:"4-9",threes:"1-3",ft:"0-0",to:1,stl:0,blk:0,pm:7},{name:"Reed",pts:8,reb:6,ast:1,fg:"3-6",threes:"0-1",ft:"2-2",to:0,stl:0,blk:1,pm:8},{name:"Beasley",pts:7,reb:1,ast:0,fg:"3-7",threes:"1-3",ft:"0-0",to:1,stl:0,blk:0,pm:4},{name:"Stewart",pts:6,reb:4,ast:0,fg:"3-5",threes:"0-0",ft:"0-0",to:0,stl:0,blk:1,pm:5}],away:[{name:"Harden",pts:23,reb:6,ast:7,fg:"8-19",threes:"4-9",ft:"3-3",to:3,stl:1,blk:0,pm:-15,note:"CLE high — efficient but couldn't lift the team"},{name:"Mitchell",pts:18,reb:4,ast:5,fg:"7-19",threes:"2-7",ft:"2-2",to:2,stl:1,blk:0,pm:-18,note:"Sub-Mitchell night vs DET defensive scheme"},{name:"Mobley",pts:18,reb:8,ast:8,fg:"7-13",threes:"0-1",ft:"4-5",to:3,stl:1,blk:1,pm:-12,note:"Near triple-double but couldn't anchor D"},{name:"Allen",pts:10,reb:7,ast:1,fg:"4-7",threes:"0-0",ft:"2-3",to:1,stl:0,blk:1,pm:-19,note:"Passive on offense — Duren dominated interior"},{name:"Strus",pts:9,reb:3,ast:2,fg:"3-10",threes:"3-8",ft:"0-0",to:1,stl:0,blk:0,pm:-13,note:"Regression from G5 20pts/6 made 3s"},{name:"Schroder",pts:6,reb:1,ast:4,fg:"2-6",threes:"1-3",ft:"1-2",to:2,stl:0,blk:0,pm:-9},{name:"Merrill",pts:5,reb:2,ast:1,fg:"2-5",threes:"1-3",ft:"0-0",to:0,stl:1,blk:0,pm:-7},{name:"Tyson",pts:5,reb:3,ast:0,fg:"2-4",threes:"1-2",ft:"0-0",to:1,stl:0,blk:0,pm:-5}]}},{num:7,result:"CLE",homeScore:94,awayScore:125,winner:"CLE",prediction:{homeWin:true,homeScore:108,awayScore:104,margin:4,confidence:"LOW",character:"COIN FLIP",keyTakeaways:[
      "<strong>Series tied 3-3; G7 at Little Caesars Arena, Sun May 17, TBD ET. WINNER ADVANCES TO ECF (likely vs NYK).</strong> Both teams undefeated at home in this series (DET 3-0 at LCA, CLE 3-0 at Rocket — until G6 broke that 6-0 home streak).",
      "<strong>Engine baseline DET by 3-4 (HCA + home record + G6 momentum):</strong> Trimmed HCA premium (1.5pt) plus DET's 3-0 LCA series record plus the structural defensive identity reasserted in G6 (+27 margin swing from prediction) puts DET as the slight favorite. Predicted DET 108, CLE 104.",
      "<strong>The Cade-vs-CLE-defense ceiling vs the Mitchell-vs-DET-defense ceiling:</strong> Cade has hit 39 (G5) and 27 (G3, 10ast/10reb) on the road; Mitchell hit 43 (G4) at home and 35 (G3) at home. Both stars play to ~30+ when their team needs them.",
      "<strong>DET's defensive identity is the structural edge:</strong> G6 they held CLE to 41% FG and forced 16 TOs at the ROAD venue. At home in G7, that defensive ceiling rises another 2-3 efficiency points. DET allowed 94 at CLE; expect ~98-104 at LCA.",
      "<strong>G7 home-court win rate is ~58% historically:</strong> Li et al. 2025 (cited in HCA_GAME7_OVERRIDE) finds game location does NOT significantly affect G7 outcomes — EFG% and TOV% are the decisive factors. DET's defense forced 16 TOs G6; if that holds, DET wins.",
      "<strong>xFactor:</strong> Cade's Q4 closing minutes (G5 he sat during the CLE comeback — coaching decision will be different in G7) + Mitchell's mental toughness in a hostile road G7 + which bench (DET Jenkins/LeVert or CLE Schroder/Merrill) delivers ~15+pts."
    ],reasoning:"G7 Sunday May 17 at Little Caesars Arena (time TBD, likely 3:30 PM ET on ABC or 8:00 PM ET on ESPN). Series tied 3-3. WINNER ADVANCES TO ECF VS NYK (NYK swept PHI). Engine baseline DET by 1-2 (talent + #1 defense); HCA flip applies trimmed 1.5pt premium for DET at LCA, plus G6 momentum carryover (+27 swing from prediction) puts DET by ~3-4. The G6 road blowout established that DET's defensive identity travels — at home in G7 that ceiling rises another 2-3 efficiency points. Both teams are undefeated at home this series (was, until G6); DET 3-0 at LCA pre-G7, CLE was 6-0 at Rocket and went 6-1 with the G6 loss. Mitchell + Harden + Strus 3-headed scoring engine vs Cade-as-everything-with-distributed-bench. Phase 17 Li et al. 2025 finding: G7 location is NOT significant; EFG% and TOV% are the decisive factors. DET forced 16 TOs G6; if that defensive intensity holds, DET wins. MODEL: DET 108, CLE 104 (DET by 4, LOW confidence — anywhere from DET by 9 to CLE by 4 is plausible; both teams can run away with a tail-event Q4). Verify DK lines morning-of (estimate DET -3 to -5 / total 210-214).",xFactor:"Cade Q4 closing + Mitchell hostile-road mental toughness + which bench delivers ~15+pts + DET defensive intensity sustainability",moneyline:"DET -135 / CLE +115",spread:"DET -2.5",ou:"O/U 212.5"},notes:"CLE 125-94 at Little Caesars Arena. CLE WINS SERIES 4-3 — ADVANCES TO ECF VS NYK (first ECF since 2018, LeBron's final year). Game wasn't close after halftime — CLE built it on a 31-pt Q3 with Mitchell scoring 15 (game-high 26 total in only 31min). CLE shot 50.6% FG, won boards 50-41, forced 14 DET TOs. Four Cavs scored 20+: Mitchell 26, Allen 23/7reb, Merrill 23 off bench (5-8 3PT — SEASON-DEFINING bench game), Mobley 21/12reb. Harden quiet on the box (9pts/6ast, 2-10 FG, 0-6 3PT) but his playmaking and the gravity he commanded freed everyone else; +/- was massively positive. DET COLLAPSED at home: Cade 13pts/5ast on 5-16 FG / 0-7 3PT — worst playoff performance of his career in the biggest moment. Duren 7/9 (3 TOs vs Allen/Mobley). Harris 5pts on 0-6 FG (0 from 3) — biggest no-show. Jenkins led DET with 17 off the bench but on 4-12 shooting. D.Robinson 13pts (3-7 3PT) the only DET shooter to function. CLE's 6th straight G7 win — Mitchell now 5-0 in G7s. MODEL: predicted DET by 4 (LOW); ACTUAL CLE by 31 — WRONG WINNER, +35 margin miss (one of the largest of the playoffs). The G7 prediction's 'DET home defensive edge' thesis got obliterated by Mitchell+Merrill+depth from the road.\n\nKEY MODEL TAKEAWAYS:\n(1) WRONG-WINNER ON A G7 — third straight wrong-winner DET-CLE call (G5 OT, G6 road blowout, G7 road blowout). The series' variance band kept widening; the engine never recalibrated fast enough. Lesson: when consecutive elimination games produce 20+ pt blowouts in opposite directions, the next prediction should default to MAX uncertainty bands, not lean on home-court.\n(2) CADE'S CEILING DEPENDS ON CLE'S DEFENSIVE SCHEME — 39 in G5 vs CLE not blitzing → 21 in G6 distributing → 13 in G7 with CLE fully focused on him. CLE's switch-everything + early double on Cade limited him to 5-16. The engine modeled Cade as 'tail event ceiling vs CLE'; in G7 CLE took the tail off the table.\n(3) BENCH VARIANCE IS BIDIRECTIONAL — Merrill 23pts (5-8 3PT) is the EXACT mirror of Strus 9pts G6 (3-10 3PT regression). Both at home, both deep alt-line bets, both moved game outcomes. Lesson: in close G7s with 50/50 model probabilities, a 15-pt bench swing decides the game; don't anchor predictions to STAR projections alone.\n(4) HARRIS 0-6 FROM THE FLOOR — the structural #2 scorer who broke out for 30 in R1 G7 and 20+ in R2 G1-G6 went 0-fer in the biggest game. Phase 71 audit's G6/G7 elimination context (MAE 19.8pt) just got reinforced. DET's secondary scoring evaporated when the moment was largest.\n(5) MITCHELL G7 LEGEND — 5-0 record, 26pts in only 31min. His 15 in Q3 was the dagger run that turned a 7-pt halftime game into a 26-pt blowout. The 'Mitchell vs DET defensive scheme' framing was right in G6 (sub-Mitchell night, 18pts); G7 he flipped it (efficient, low-volume scoring, 8 ast).\n(6) CLE ADVANCES — ECF G1 is Tuesday 5/19 at MSG vs NYK. NYK swept PHI 4-0, rested 9 days. CLE on 1 day rest after a road G7 blowout. Rest-vs-rust dynamic will dominate the ECF G1 narrative.",boxScores:{home:[{name:"Cunningham",pts:13,reb:4,ast:5,fg:"5-16",threes:"0-7",ft:"3-3",to:3,stl:2,blk:0,pm:-28,note:"Worst playoff game of his career — CLE schemed him off the floor"},{name:"Jenkins",pts:17,reb:2,ast:1,fg:"4-12",threes:"2-6",ft:"7-8",to:1,stl:0,blk:0,pm:-12,note:"Team-high but inefficient — bench couldn't carry"},{name:"Duren",pts:7,reb:9,ast:3,fg:"3-8",threes:"0-0",ft:"1-2",to:3,stl:0,blk:1,pm:-25,note:"Overpowered by Allen/Mobley interior — 3 TOs"},{name:"Harris",pts:5,reb:5,ast:2,fg:"0-6",threes:"0-3",ft:"5-5",to:1,stl:1,blk:1,pm:-22,note:"0-FOR-FROM-THE-FLOOR — biggest no-show in the biggest moment"},{name:"D.Robinson",pts:13,reb:2,ast:0,fg:"4-7",threes:"3-7",ft:"2-2",to:0,stl:0,blk:0,pm:-15},{name:"A.Thompson",pts:8,reb:4,ast:2,fg:"3-8",threes:"1-3",ft:"1-2",to:1,stl:1,blk:0,pm:-18},{name:"LeVert",pts:11,reb:2,ast:3,fg:"4-10",threes:"1-3",ft:"2-2",to:2,stl:0,blk:0,pm:-10},{name:"Stewart",pts:6,reb:5,ast:0,fg:"3-5",threes:"0-0",ft:"0-0",to:1,stl:0,blk:1,pm:-7},{name:"Beasley",pts:9,reb:1,ast:0,fg:"3-9",threes:"2-7",ft:"1-1",to:0,stl:0,blk:0,pm:-8},{name:"Reed",pts:5,reb:5,ast:1,fg:"2-5",threes:"0-1",ft:"1-2",to:1,stl:0,blk:1,pm:-6}],away:[{name:"Mitchell",pts:26,reb:6,ast:8,fg:"10-19",threes:"3-8",ft:"3-3",to:0,stl:1,blk:1,pm:30,note:"15 in Q3 dagger run — 5-0 in G7s, 0 TOs in 31min"},{name:"Allen",pts:23,reb:7,ast:1,fg:"10-14",threes:"0-0",ft:"3-4",to:1,stl:1,blk:1,pm:28,note:"Knee held up — efficient interior scoring"},{name:"Merrill",pts:23,reb:3,ast:2,fg:"7-11",threes:"5-8",ft:"4-4",to:0,stl:1,blk:0,pm:25,note:"Bench game of the playoffs — 5-8 from 3PT in 24min"},{name:"Mobley",pts:21,reb:12,ast:3,fg:"8-13",threes:"1-2",ft:"4-5",to:2,stl:2,blk:2,pm:27,note:"Two-way star — DD, 2blk/2stl"},{name:"Harden",pts:9,reb:5,ast:6,fg:"2-10",threes:"0-6",ft:"5-5",to:2,stl:1,blk:0,pm:18,note:"Box-score quiet but gravity freed everyone else"},{name:"Strus",pts:10,reb:3,ast:1,fg:"4-9",threes:"2-5",ft:"0-0",to:1,stl:0,blk:0,pm:14},{name:"Schroder",pts:8,reb:1,ast:5,fg:"3-7",threes:"1-3",ft:"1-2",to:1,stl:1,blk:0,pm:12},{name:"Tyson",pts:3,reb:3,ast:1,fg:"1-3",threes:"1-2",ft:"0-0",to:0,stl:0,blk:0,pm:8},{name:"Wade",pts:2,reb:2,ast:1,fg:"1-3",threes:"0-1",ft:"0-0",to:0,stl:0,blk:0,pm:6}]}}],
    modelLessons: [
      { type:"correct", lesson:"G1: Predicted DET by 3 (LOW/COIN FLIP). Actual DET by 10. RIGHT WINNER but margin significantly underestimated. DET's #1 defense generated 19 TOs/12 steals — defensive disruption was MORE impactful than modeled." },
      { type:"correct", lesson:"G1: A.Thompson defensive assignment on Mitchell worked — Mitchell's streak of 30+ in 9 straight series openers broken at 23. D-LEBRON 2.93 validated." },
      { type:"missed", lesson:"G1: Allen's knee severity underestimated — 2pts/3reb in only 18min was far worse than the model's 'GTD but playable' assumption. CLE interior collapsed without him." },
      { type:"missed", lesson:"G1: Jenkins breakout (12/7/3/4stl in 29min) not modeled — DET bench depth is deeper than projected. 9-man rotation with Jenkins as a real contributor." },
      { type:"correct", lesson:"G2: Predicted DET by 2 (LOW/COIN FLIP). Actual DET by 10. RIGHT WINNER again, margin off again. Model's 'coin flip' framing is too conservative — DET's defensive edge is structural, not variance." },
      { type:"missed", lesson:"G2: Harden COLLAPSE — 10pts on 3-13 FG, 0-4 3PT in 37min. WORST game of his playoffs. Model predicted 3PT regression UP from G1's 1-7 — instead he got WORSE. DET's defensive pressure on older guards is a structural suppression, not variance." },
      { type:"missed", lesson:"G2: CLE 22% 3PT (7-32) — CATASTROPHIC team shooting. G1 was 39% (reasonable), G2 was 22%. DET's wing defense (A.Thompson, D.Robinson length, Jenkins active hands) is structurally suppressing CLE's perimeter game. Not variance — scheme-driven." },
      { type:"correct", lesson:"G2: Cade dual-mode validated — 25pts/10ast with 12 of 25 in Q4 closing run. Facilitator mode when CLE defends, scorer mode when they drop. His flexibility is the series X-factor." },
      { type:"missed", lesson:"G2: D.Robinson SUSTAINED 50% 3PT (5-9 after 5-8 G1). Model predicted regression — he's now 10-17 (59%) from 3 in the series. This may be DET's scheme opening him up, not variance." },
      { type:"correct", lesson:"G2: Allen bounce-back (12pts/7reb in 32min) validated the 'extra rest helps knee' thesis. But CLE still lost by 10 even with Allen functional — DET's edge is not just Allen-dependent." },
      { type:"missed", lesson:"G2: Merrill DNP (hamstring) — CLE loses key bench shooter for G3 at minimum. Strus 1-6 3PT without Merrill spacing. CLE bench shooting is in crisis." },
      { type:"missed", lesson:"G2: Reed 14pts/6reb/+9 off DET bench — another unmodeled bench contributor. DET's developmental pipeline is producing playoff-ready players. Model underweights DET bench upside." }
    ],
    g2Adjustments: [
      "DET WON G2 107-97 — leads 2-0. Two home wins with average margin of +10. 'COIN FLIP' framing was wrong — DET has a structural defensive edge.",
      "Harden 3-13 FG (0-4 3PT) was his WORST game of playoffs. DET's defensive pressure on older guards is structural suppression — Harden can't get separation against DET's wing length/athleticism.",
      "CLE 22% 3PT (7-32) is catastrophic. 2-game 3PT: 11-42 (26%). DET's perimeter defense is scheme-driven suppression, not variance.",
      "Merrill DNP (left hamstring strain) — CLE loses 42.4% 3PT bench shooter. GTD for G3. Strus absorbing minutes but shot 1-6 3PT G2.",
      "Allen bounce-back to 12/7 in 32min — knee improved. But CLE still lost by 10 even with Allen functional.",
      "Cade 25/10ast with Q4 closing run — dual-mode validated again. 12 of his 25 in Q4.",
      "D.Robinson now 10-17 (59%) from 3PT in series — sustained, not a fluke. DET scheme opens him up.",
      "Reed 14/6/+9 adds another DET bench dimension. DET's depth advantage is growing, not shrinking.",
      "Mitchell 31pts but couldn't carry — CLE needs 2+ players scoring 20+. Only Mitchell scored 20+ in G2.",
      "HCA flips to CLE for G3 — biggest adjustment. CLE home crowd + desperation (0-2) should produce more fight."
    ]
  },
  {
    ...
    awayTeam: {
      ...
      advStats: { ortg:113.2, drtg:112.5, netRtg:0.7, pace:97.8, ts:56.8, efg:53.1, tov:13.5, reb:49.5, ortgRk:16, drtgRk:17, clutchNetRtg:0.8, last10:"5-5", fgPct:50.1, threePct:33.2, ftPct:75.6, orbPct:23.6 },
      players: [
        { name:"Joel Embiid", pos:"C", rating:78, ppg:26.9, rpg:7.7, apg:3.9, fgp:49.2, per:29.2, ts:64.5, epm:7.8, bpm:9.0, ws48:.250, onOff:13.2, clutch:8.8, vorp:6.2, usg:33.0, injury:"GTD G3 — right ankle sprain + right hip soreness (OUT G2 May 6 after waking with increased soreness; day-to-day per ESPN heading into Friday's G3 in PHI, no guarantee per Heavy/Inquirer May 7). Two days rest before G3.", lebron:1.736, oLebron:2.452, dLebron:-0.716, war:3.154, offRole:"Shot Creator", defRole:"Anchor Big",
          matchupNote:"R1: returned G3 from appendectomy. G7 in Boston: 34/12/6 — franchise-defining performance. G1: 14pts (3-11), -24. OUT G2 May 6 (right ankle sprain + hip soreness — woke up sore, missed shootaround, ruled out morning-of). Day-to-day heading into G3 Fri May 8 in PHI. Two extra days rest. Even if he plays, expect compromised conditioning. Rating reduced to 78 reflecting injury drag + back-to-back appendectomy/ankle/hip concerns.", baseRating:92, starCeiling:2, injuryRisk:0.7, activeInjury:{type:"right ankle sprain + hip soreness",severity:0.6,status:"GTD",note:"OUT G2 May 6. Day-to-day for G3 Fri May 8 in PHI. Two days rest to recover. If active, expect 25-28 min compromised; ankle limits explosion + hip limits drop coverage. If OUT, Drummond starts again with Bona/Barlow rotation. Severity 0.6 reflects mid-point between full OUT (1.0) and healthy (0.0) given day-to-day status."} },
        { name:"Tyrese Maxey", pos:"PG", rating:84, ppg:28.3, rpg:4.1, apg:6.6, fgp:45.5, per:25.2, ts:60.5, epm:5.5, bpm:6.0, ws48:.185, onOff:8.0, clutch:7.8, vorp:4.7, usg:31.5, injury:null, lebron:2.933, oLebron:3.584, dLebron:-0.651, war:8.951, offRole:"Shot Creator", defRole:"Chaser",
    ...
    externalFactors: [
      ...
      { team:"PHI", player:null, desc:"Nick Nurse left team May 5 to attend brother's funeral. Expected to return for G2 (May 6) per ESPN. Assistant coaches managing prep in interim.", impact:-1, category:"coaching", evidence:"ESPN (May 5): Nurse attending funeral. Expected back for G2 tip-off. Emotional toll + disrupted prep, but minimal tactical impact if he returns in time.", verdict:"verified" }
    ],
    games: [{num:1,result:"NYK",homeScore:137,awayScore:98,winner:"NYK",prediction:{homeWin:true,homeScore:110,awayScore:101,margin:9,confidence:"MEDIUM",character:"CONTROL",reasoning:"NYK -7.5 (O/U 213.5) per DraftKings. NYK has massive structural advantages: 6 days rest vs PHI's 2 (after grueling G7 in Boston where Embiid played 39min, Maxey 45min). MSG home court (9.2 clutch NetRtg). Embiid is PROBABLE per ESPN (May 3) — expected to play but hip contusion + post-appendectomy + 48hr turnaround is a ticking time bomb. Sochan (NYK) is QUESTIONABLE with hamstring — if OUT, NYK adjusts rotation slightly but has elite depth to compensate. Edgecombe (23pts, +19 in G7) is a legit weapon but a rookie on 2 days rest at MSG is a different animal. PHI's 3-1 comeback proves mental toughness but the physical toll is severe — this is the classic emotional letdown spot after a historic achievement. NYK depth (OG/Bridges/Hart/McBride/Shamet) will grind PHI's 7-man rotation into dust by Q3. KAT stretch-5 game forces Drummond out of the paint. Brunson (9.2 clutch, playoff ascension 1.5) feasts in PnR vs compromised Embiid laterally. Model aligns with market: NYK by 9. Lower total (213.5) reflects PHI fatigue depressing pace.",xFactor:"Brunson",moneyline:"NYK -290",spread:"NYK -7.5",ou:"O/U 213.5"},notes:"NYK 137-98 BLOWOUT at MSG. Biggest R2 G1 blowout. Brunson 35pts (12-18 FG, 3-6 3PT, 8-8 FT, +27) — DOMINANT. Bridges 17pts (7-10 FG, 3-5 3PT, +19). OG 18pts (7-8, 2-2 3PT, +22). KAT 17pts (7-11, 3-5 3PT). Hart 8pts/8reb/6ast (+24). NYK shot 63% FG (53-84), 51% 3PT (19-37) — absurd. 10 NYK players scored. McBride 8pts (3-6, 2-5 3PT, +16). Kolek 8pts (3-5, 2-2 3PT, +8). PHI: George 17pts (6-11, 4-6 3PT, -26). Embiid 14pts (3-11, 0-2 3PT, 8-9 FT, -24) — fatigue was REAL. Maxey 13pts (3-9, 0-3 3PT, -28, 4TO). Edgecombe 12pts (5-11, 2-5 3PT, -15). Oubre 12pts. J.Edwards (PHI bench) 8pts. PHI shot 41% FG, 37% 3PT. Q scores: NYK 33-41-35-28, PHI 25-26-27-20. NYK led every quarter. Model predicted NYK by 9 — RIGHT WINNER but 30-point margin miss. Key lesson: rest differential (6 days vs 2) produced catastrophic PHI fatigue. Embiid was a shell. NYK depth (10 scorers) overwhelmed PHI 7-man rotation exactly as predicted but magnitude was unprecedented.",boxScores:{home:[{name:"Anunoby",min:30,pts:18,reb:3,ast:1,fg:"7-8",threes:"2-2",ft:"2-2",to:2,stl:0,blk:1,pm:22},{name:"Towns",min:20,pts:17,reb:6,ast:6,fg:"7-11",threes:"3-5",ft:"0-0",to:3,stl:0,blk:2,pm:11},{name:"Hart",min:26,pts:8,reb:8,ast:6,fg:"3-7",threes:"1-2",ft:"1-2",to:1,stl:3,blk:1,pm:24},{name:"Bridges",min:27,pts:17,reb:2,ast:5,fg:"7-10",threes:"3-5",ft:"0-0",to:0,stl:1,blk:0,pm:19},{name:"Brunson",min:31,pts:35,reb:1,ast:3,fg:"12-18",threes:"3-6",ft:"8-8",to:1,stl:0,blk:0,pm:27},{name:"Dadiet",min:9,pts:4,reb:1,ast:2,fg:"2-3",threes:"0-1",ft:"0-0",to:0,stl:1,blk:0,pm:7},{name:"Diawara",min:8,pts:5,reb:2,ast:1,fg:"2-3",threes:"1-2",ft:"0-0",to:0,stl:0,blk:0,pm:9},{name:"Robinson",min:12,pts:2,reb:4,ast:1,fg:"1-1",threes:"0-0",ft:"0-4",to:0,stl:0,blk:0,pm:6},{name:"Hukporti",min:17,pts:5,reb:9,ast:0,fg:"2-2",threes:"0-0",ft:"1-1",to:1,stl:0,blk:2,pm:22},{name:"Clarkson",min:14,pts:2,reb:2,ast:0,fg:"1-2",threes:"0-1",ft:"0-0",to:4,stl:1,blk:0,pm:11},{name:"Shamet",min:12,pts:3,reb:0,ast:2,fg:"1-4",threes:"1-3",ft:"0-0",to:1,stl:1,blk:0,pm:8},{name:"Alvarado",min:9,pts:5,reb:1,ast:1,fg:"2-4",threes:"1-3",ft:"0-0",to:0,stl:1,blk:0,pm:5},{name:"McBride",min:16,pts:8,reb:0,ast:2,fg:"3-6",threes:"2-5",ft:"0-0",to:0,stl:0,blk:0,pm:16},{name:"Kolek",min:10,pts:8,reb:0,ast:4,fg:"3-5",threes:"2-2",ft:"0-0",to:1,stl:0,blk:0,pm:8}],away:[{name:"George",min:26,pts:17,reb:3,ast:3,fg:"6-11",threes:"4-6",ft:"1-1",to:1,stl:0,blk:0,pm:-26},{name:"Embiid",min:25,pts:14,reb:4,ast:1,fg:"3-11",threes:"0-2",ft:"8-9",to:1,stl:0,blk:0,pm:-24},{name:"Oubre",min:27,pts:12,reb:5,ast:1,fg:"5-8",threes:"1-2",ft:"1-1",to:2,stl:1,blk:1,pm:-25},{name:"Maxey",min:27,pts:13,reb:3,ast:2,fg:"3-9",threes:"0-3",ft:"7-7",to:4,stl:0,blk:0,pm:-28},{name:"Edgecombe",min:28,pts:12,reb:1,ast:2,fg:"5-11",threes:"2-5",ft:"0-2",to:1,stl:1,blk:0,pm:-15},{name:"Watford",min:14,pts:5,reb:1,ast:1,fg:"1-4",threes:"0-1",ft:"3-4",to:2,stl:1,blk:0,pm:-12},{name:"Walker",min:10,pts:2,reb:2,ast:0,fg:"0-2",threes:"0-0",ft:"2-2",to:1,stl:0,blk:0,pm:-8},{name:"Terry",min:12,pts:3,reb:0,ast:1,fg:"1-4",threes:"1-2",ft:"0-0",to:0,stl:1,blk:0,pm:-8},{name:"Broome",min:5,pts:0,reb:1,ast:0,fg:"0-1",threes:"0-1",ft:"0-0",to:0,stl:0,blk:0,pm:0},{name:"J.Edwards",min:16,pts:8,reb:0,ast:0,fg:"2-4",threes:"2-4",ft:"2-4",to:2,stl:0,blk:0,pm:-10},{name:"Barlow",min:13,pts:7,reb:3,ast:0,fg:"3-3",threes:"0-0",ft:"1-2",to:1,stl:1,blk:0,pm:-8},{name:"Drummond",min:9,pts:0,reb:3,ast:0,fg:"0-1",threes:"0-1",ft:"0-0",to:0,stl:0,blk:0,pm:-3},{name:"Bona",min:4,pts:0,reb:1,ast:0,fg:"0-0",threes:"0-0",ft:"0-0",to:0,stl:0,blk:0,pm:-4},{name:"Grimes",min:24,pts:5,reb:1,ast:4,fg:"1-4",threes:"1-3",ft:"2-2",to:0,stl:1,blk:0,pm:-24}]}},{num:2,result:"NYK",homeScore:108,awayScore:102,winner:"NYK",prediction:{homeWin:true,homeScore:112,awayScore:106,margin:6,confidence:"MEDIUM",character:"CONTROL",reasoning:"G2 at MSG (May 6). PHI has 2 extra days rest since G1 blowout (137-98). Embiid's hip has settled but conditioning still compromised post-appendectomy. NYK shooting will regress from 63% FG (unsustainable) — expect tighter game. Brunson remains dominant in PnR vs PHI's compromised switching. NYK depth (10 scorers in G1) still overwhelms PHI's thin bench. PHI adjustments: more Edgecombe, less Drummond, Maxey off-ball more. But NYK's systemic advantages persist. Model: NYK by 6.",xFactor:"Embiid bounce-back vs Brunson consistency",moneyline:"NYK -270 / PHI +220",spread:"NYK -7.5",ou:"O/U 214.5"},notes:"NYK 108-102 at MSG. NYK leads 2-0. INSTANT-CLASSIC margin: model predicted NYK 112-106 (margin 6); actual NYK 108-102 (margin 6) — EXACT MARGIN MATCH despite Embiid being ruled OUT day-of (right ankle sprain + hip soreness, missed shootaround). 25 lead changes (most in any playoff game in 11 yrs), 14 ties — neither team led by more than 7 all night. Q scores: PHI 33-29-28-12, NYK 31-30-28-19. Brunson 26pts (9-21 FG) — go-ahead bucket with 5:06 left, 'staying poised, one play at a time.' OG Anunoby 24pts (left late with unspecified issue, didn't return — G3 GTD). KAT 20/10reb/7ast. Bridges 18pts. Josh Hart's 3 with 6:52 remaining (after PHI led 99-96) sparked the 9-0 NYK Q4 run. Maxey 26pts (9-23 FG) — 15 in Q2, 19 first half, then went COLD (3-16 / 18.8% team Q4 FG, scoreless ~6 min). George 19pts. Oubre 19pts. Edgecombe 17pts (strong perimeter D on Brunson early). Drummond start with 8reb (replaced Embiid). Bona/Barlow emergency Cs. NYK 51% FG / 27% 3PT. PHI 45% FG / 38% 3PT (PHI shot BETTER from 3 yet lost). NYK 13 TO vs PHI 18 TO — turnover differential decisive. Mike Brown credited Q4 defense as the key.\n\nKEY MODEL TAKEAWAYS:\n(1) ENGINE WAS RIGHT, PHASE 56 NARRATIVE OVERREACTED — pre-Phase-56 prediction NYK +6 was EXACT; Phase 56 bet card said 'NYK +12-15 with Embiid OUT' which would have been wrong by 6-9pts. Day-of-OUT rulings produce LESS margin expansion than full-game-time rulings because (a) opponent had no extra prep time, (b) team gets emotional rally, (c) replacement rotation is well-rehearsed. Saving as 'Day-of-OUT Compression' soft factor — apply ~50% of normal absence penalty for that one game.\n(2) STAR ABSENCE LIBERATION VALIDATED (Phase 32) — PHI scored 102 without Embiid. Maxey/George/Oubre/Edgecombe combined for 81pts. Phase 32's 35% clawback for teams with 4+ depth players was approximately right.\n(3) Q4 EXECUTION DIFFERENTIAL — NYK won Q4 19-12 in a game where they were outshot 51% to 45% through Q1-Q3. Closing teams (high clutchNetRtg) win these. NYK's +9.2 clutch NetRtg validated.\n(4) IC=2 LIMITATION — when Maxey went cold Q4, PHI had no third option (Embiid OUT meant only George + Maxey as primary creators). PHI 3-16 Q4 FG = catastrophic shot-making collapse with no safety valve.\n(5) BUG FOUND: Embiid had DUPLICATE `activeInjury` keys in series-data — Phase 56's severity:1.0 was silently overwritten by an older severity:0.4 entry. Engine never saw him as truly OUT. Fixed in this commit.",boxScores:{home:[{name:"Brunson",min:38,pts:26,reb:3,ast:5,fg:"9-21",threes:"2-7",ft:"6-7",to:2,stl:1,blk:0,pm:8},{name:"Anunoby",min:30,pts:24,reb:4,ast:1,fg:"10-15",threes:"2-4",ft:"2-2",to:1,stl:1,blk:1,pm:10,note:"left late with unspecified issue, did not return"},{name:"Towns",min:36,pts:20,reb:10,ast:7,fg:"7-13",threes:"2-4",ft:"4-5",to:3,stl:0,blk:1,pm:6},{name:"Bridges",min:33,pts:18,reb:3,ast:3,fg:"7-15",threes:"2-6",ft:"2-2",to:1,stl:1,blk:0,pm:7},{name:"Hart",min:32,pts:9,reb:7,ast:5,fg:"3-7",threes:"1-2",ft:"2-3",to:1,stl:2,blk:0,pm:6,note:"crucial 3 with 6:52 left after PHI led 99-96"},{name:"McBride",min:18,pts:6,reb:1,ast:2,fg:"2-5",threes:"2-4",ft:"0-0",to:1,stl:1,blk:0,pm:0},{name:"Robinson",min:12,pts:3,reb:5,ast:0,fg:"1-2",threes:"0-0",ft:"1-2",to:1,stl:0,blk:1,pm:-2},{name:"Shamet",min:8,pts:2,reb:0,ast:1,fg:"1-3",threes:"0-2",ft:"0-0",to:0,stl:0,blk:0,pm:-3}],away:[{name:"Maxey",min:42,pts:26,reb:3,ast:5,fg:"9-23",threes:"2-7",ft:"6-7",to:3,stl:1,blk:0,pm:-7,note:"15 in Q2 / 19 first half, then cold Q4"},{name:"George",min:36,pts:19,reb:5,ast:3,fg:"7-16",threes:"3-7",ft:"2-2",to:2,stl:1,blk:0,pm:-3},{name:"Oubre",min:32,pts:19,reb:4,ast:1,fg:"7-14",threes:"2-5",ft:"3-4",to:2,stl:1,blk:1,pm:-4},{name:"Edgecombe",min:34,pts:17,reb:5,ast:2,fg:"6-13",threes:"3-7",ft:"2-2",to:1,stl:2,blk:0,pm:-2,note:"strong perimeter D on Brunson early"},{name:"Drummond",min:24,pts:8,reb:8,ast:1,fg:"3-7",threes:"0-0",ft:"2-4",to:2,stl:0,blk:1,pm:-9,note:"started in place of Embiid"},{name:"Barlow",min:18,pts:6,reb:4,ast:0,fg:"3-5",threes:"0-0",ft:"0-0",to:1,stl:0,blk:1,pm:-2,note:"emergency minutes after Drummond + Bona foul trouble"},{name:"Bona",min:14,pts:4,reb:5,ast:0,fg:"2-3",threes:"0-0",ft:"0-0",to:0,stl:0,blk:1,pm:-1,note:"foul trouble"},{name:"Walker",min:18,pts:3,reb:1,ast:2,fg:"1-4",threes:"1-3",ft:"0-0",to:1,stl:0,blk:0,pm:-3}]}},{num:3,result:"NYK",homeScore:108,awayScore:94,winner:"NYK",prediction:{homeWin:false,homeScore:105,awayScore:111,margin:6,confidence:"LOW",character:"GRIND",keyTakeaways:[
  "<strong>PHI's Brunson PnR coverage change (worked partially):</strong> G1 used Embiid drop coverage (NYK ran 1-5 PnR with Embiid's man as screener-defender, 10 of 15 screens led to a shot/TO/FT, NYK scored 19pts on those 10 possessions). G2 shifted to BLITZING/DOUBLE-TEAMING Brunson + Oubre/Edgecombe coverage. Held Brunson to 9-21 FG (43%) vs his 60%+ G1 ceiling — primary reason the game stayed close (25 lead changes, no team led by more than 7).",
  "<strong>PHI shot-making was actually better than NYK's in G2 — but lost anyway.</strong> 45/38% FG/3PT vs NYK's 51/27%. They lost on (a) TOV differential (+5 NYK, driven by NYK wing-pressure on PHI's secondary creators) and (b) Q4 shot-making collapse (3-16 / 18.8%, scoreless ~6 minutes after Hart's 3 with 6:52 left). IC dropped to 2 without Embiid.",
  "<strong>NYK's Q4 closing edge is structural.</strong> NYK won Q4 19-12 despite being outshot 51-45% through Q1-Q3. NYK +9.2 clutchNetRtg. Mike Brown specifically credited Q4 defense as the win key. Pattern likely repeats in any close G3 finish.",
  "<strong>NYK G3 counter-adjustments:</strong> Brunson playing more off-ball out of Brunson-KAT PnR variants. KAT's stretch-5 already pulled Drummond out (G2: 20/10/7). If Embiid plays, NYK hunts him in PnR exactly as G1 (compromised lateral mobility). NYK drives at Drummond/Bona/Barlow in foul trouble — PHI's bigs are 1-deep without Embiid.",
  "<strong>Embiid GTD swing factor:</strong> If he plays at ~60% (severity 0.6) — tightens game by 4-5pts (anchor, FT trips, post-up safety valve). If OUT — NYK structural edge widens. Weighted average: NYK by ~4 (HCA flip + desperation pull from engine's NYK by 9).",
  "<strong>Risks:</strong> (a) OG Anunoby's unspecified G2 issue — if OUT, NYK's wing depth thins from 4 to 3 and PHI hunts Bridges on Maxey. (b) NYK shooting regression: G1 63% → G2 51% → expected 47-49% G3 as PHI's home defense tightens. (c) PHI fatigue if Embiid plays 35+ on a compromised ankle.",
],reasoning:"G3 Friday May 8 at Wells Fargo Center. NYK leads 2-0. PHI desperation game — a loss drops them to 0-3 (no team has come back from 0-3 without WAR-tier roster). HCA flips to PHI (Phase 58 engine fix now applies this correctly — the venue swap brings the engine baseline from NYK by 9 to NYK by 6). Embiid GTD; OG also GTD. NYK's depth, KAT stretch-5 vs PHI's thin C rotation, and +9.2 clutchNetRtg keep them favored even on the road, but the margin compresses with the HCA flip + PHI desperation. MODEL: NYK 111, PHI 105 (NYK by 6, LOW confidence — Embiid status is the biggest swing factor). <strong>5/8 update:</strong> DK has the line at PHI -1.5 / total 214.5, implying PHI by 1-2 with Embiid expected back. Model still leans NYK on structure, but the disagreement narrows if Embiid plays AND OG is OUT (which is the path-of-least-resistance scenario per pre-game reports). OG Anunoby diagnosed with left hamstring strain (QUESTIONABLE G3) — was 'unspecified issue' in G2. Hart upgraded to PROBABLE (thumb sprain). Embiid intends to warm up pre-game (ankle + hip), QUESTIONABLE but trending toward playing.",xFactor:"Embiid availability + OG Anunoby hamstring + PHI Brunson double-team continuation",moneyline:"PHI -118 / NYK +100",spread:"PHI -1.5",ou:"O/U 214.5"},notes:"NYK 108-94 at Wells Fargo Center. NYK leads 3-0 (sweep cliff). Brunson 33pts/5reb/9ast (11-22 FG, 38min) — 24th 30-point playoff game (most in Knicks franchise history). Bridges 23pts (8-14 FG). Hart 12pts/11reb (workhorse double-double). KAT 8pts/12reb/7ast (4 OREB in <26min — passive on offense, dominant on glass). Shamet bench spark: 15pts (more than his entire prior 2026 playoff total combined). NYK shot 23-of-32 FT. PHI: Oubre 22pts (team-high), Embiid returned with 18pts in 35min (back from 5/6 ankle/hip OUT — looked rusty but functional), Maxey 17pts, George 15pts (all in Q1, then 0-of-9 the rest of the way — historic disappearance). PHI shot 13-of-16 FT. OG Anunoby OUT (left hamstring strain). NYK turned back repeated PHI rallies — Wells Fargo crowd never got the run that flips momentum. MODEL: predicted PHI 105-NYK 111 (NYK by 6, LOW); ACTUAL NYK 108-94 (NYK by 14) — RIGHT WINNER, margin underestimated by 8 (model didn't fully price George's shooting collapse + Embiid rust). Series: NYK leads 3-0; G4 in PHI Sunday May 10.\n\nKEY MODEL TAKEAWAYS:\n(1) HCA-FLIP + DESPERATION OVERWEIGHTED — model went LOW-confidence PHI by 6 leaning on the engine's HCA-flip baseline (from NYK by 9 to NYK by 6) plus a desperation bump for PHI at 0-2 facing elimination at home. Reality: NYK won by 14 — the desperation effect was negligible because PHI's offensive ceiling was structurally capped. PHI scored 94 (lowest playoff total since 2024). Calibration note: 'down 0-2 facing elimination at home' is NOT an automatic bounce-back — when the underdog's IC stays at 2 (Embiid rusty + OG-out variant didn't help PHI; Maxey + George were the only creators) and the favorite's depth stays intact, the venue swing is the only effect and it's worth roughly +3 not +6.\n(2) GEORGE-MAXEY DUAL COLLAPSE — George scored 15 ALL IN Q1 then went 0-of-9 the rest of the way. Maxey 17pts on inefficient volume. With Embiid rusty and OG out for NYK, this should have been a high-scoring track meet. Instead PHI's two healthy creators no-showed Q2 onward — the kind of failure mode that's not in any model lever. Underweighted: 'top creator collapse on elimination night' as a known PHI tendency under Nurse.\n(3) NYK Q4 EXECUTION REPEATED (validated again) — NYK closed Q4 at PHI just like G2 at MSG. +9.2 clutchNetRtg held on the road. Brunson 9ast playmaking was the new wrinkle — NYK getting their star to play distributor in close Q4s as defenses load up is a sustainable counter to PnR aggression. Phase 22 clutchNetRtg flag is well-calibrated.\n(4) SHAMET BENCH ANOMALY — 15pts off bench (more than his entire 2026 playoff total combined). Outlier event, not repeatable. Don't recalibrate Shamet projections.\n(5) EMBIID 35-MIN AT 60% PRODUCED RUSTY-NOT-IMPACTFUL OUTPUT — 18pts/35min after 5/6 OUT for ankle+hip. Anchor minutes weren't enough to keep PHI competitive. Future: returning-from-OUT bigs at 60% capacity should NOT get full minutes credit; engine should cap their contribution at ~70% of scaled output."},{num:4,result:"NYK",homeScore:144,awayScore:114,winner:"NYK",prediction:{homeWin:true,homeScore:107,awayScore:103,margin:4,confidence:"MEDIUM",character:"COMPETITIVE",keyTakeaways:[
      "<strong>Sweep-cliff dynamic + PHI desperation:</strong> NYK leads 3-0 (no team has come back from 0-3 in 154 attempts). PHI's last home game of the season + pride + roster depth means they bring legit Q4 effort even with playoff death sentence. Historical 'desperation Game 4 home' sample: home team wins ~45% of these elimination games (favorites still cover ~40% ATS). Bake a +3 home-desperation bump into the engine but don't flip the line.",
      "<strong>Engine baseline NYK by 8-9 with HCA flip → NYK by 5-6:</strong> Phase 58 venue swap correctly compresses the road favorite. Combined with PHI desperation: NYK by 4. Confidence MEDIUM (not LOW) because we now know G3 settled the 'PHI bounceback' question — there isn't one. PHI's IC=2 ceiling capped them at ~95 even at home with their full lineup.",
      "<strong>OG return tightens NYK rotation:</strong> If OG Anunoby's hamstring lets him play (PROBABLE per Saturday morning report), NYK has full wing depth back. Without OG (G3 absence), Bridges absorbed extra defensive load — manageable for one game but compounding fatigue is a real risk in the closeout game. With OG: NYK structural advantage tightens; without OG: PHI's ceiling rises ~2pts.",
      "<strong>Brunson off-ball wrinkle stays in playbook:</strong> Brunson 9ast G3 (career playoff high). PHI's blitz coverage forces NYK into KAT-Bridges secondary creation. NYK adopts: Brunson hunts the screen-setter's defender (Drummond/Bona) on switches → PnR slip → KAT 3 or Bridges drive. PHI has NO answer if Embiid is hobbled.",
      "<strong>PHI scoring ceiling estimate:</strong> 100-105 (G3 was 94; expect ~5pt bump from extra prep + Maxey not having TWO bad halves in a row). NYK ceiling: 105-112 depending on shooting variance. Predicted final: NYK 107, PHI 103.",
      "<strong>xFactor:</strong> Embiid effort level (does he play 35min at full / 28min at 75% / sit?). 35min full = PHI ceiling raises to 108. Sit = PHI ceiling 95. Most likely middle: 28-32min at 75% capacity → PHI 100-103."
    ],reasoning:"G4 Sunday May 10 at Wells Fargo Center. NYK leads 3-0 — closeout game. PHI's last stand at home before the season ends. Engine baseline NYK by 8-9; HCA flip compresses to NYK by 5-6; PHI home desperation bump trims to NYK by 4. Confidence MEDIUM because the 'down 0-3 dynamic' is well-charted (favorites win ~70% of G4 closeouts but cover only ~50% ATS — backdoor losses by underdogs in clinchers are common). PHI desperation effect is REAL but capped (~+3) — model knows now from G3 that PHI's IC=2 ceiling caps their offensive ceiling around 100-105. NYK structural edges (Brunson, KAT, depth, +9.2 clutchNetRtg) keep them favored. <strong>5/10 update:</strong> DK opens with NYK -1.5 / total 213.5 / NYK -122 / PHI +102 — much tighter than the engine's NYK by 4. Embiid PROBABLE (hip only — ankle off the report), OG QUESTIONABLE (hamstring strain, missed G3). The market is leaning into PHI's full-strength desperation game; the model still likes NYK on structural edges but acknowledges the spread compression. Lean: NYK ML at -122 (engine ~63% vs market 55%); pass on the alt spread until OG status confirms. NYK -1.5 is a backdoor risk in a closeout vs full-strength PHI.",xFactor:"Embiid minutes/effort + OG return + NYK closing-game intensity",moneyline:"NYK -122 / PHI +102",spread:"NYK -1.5",ou:"O/U 213.5"},notes:"NYK 144-114 at Wells Fargo Center. NYK SWEEPS 4-0 — advances to Eastern Conference Finals. NYK tied NBA postseason record with 25 made 3-pointers (25-44, 56.8%); set new playoff record with 11 made threes in Q1. McBride 25pts (7-9 3PT, started for injured OG Anunoby) — first Knick since 1997 with four 3PM in Q1 of a playoff game. Brunson 22pts. Hart 17pts. KAT 17pts/4reb/10ast/2blk (passive scoring, dimes in flow, light on glass). Shamet 12pts (4 threes off bench). NYK 47-30 rebounding edge. PHI: Embiid 24pts (season over), Maxey 17pts, PHI 8-35 3PT (22%), 35-51 2PT (68%) — couldn't keep up with the 3PT barrage. MODEL: predicted NYK 107-PHI 103 (NYK by 4, MEDIUM); ACTUAL NYK 144-114 (NYK by 30) — RIGHT WINNER, massive miss on magnitude (off by +26).\\n\\nKEY MODEL TAKEAWAYS:\\n(1) 3PT VARIANCE EXPLOSION DRIVES THE GAP — NYK shot 56.8% from 3 on 44 attempts. Model can't predict outlier shooting nights; this is the upper tail of the 3PT variance distribution. Expected ~107 + ~37 from outlier 3PT shooting → 144. The miss is variance, not model bias.\\n(2) MCBRIDE START + 7 THREES NOT PRICED — With OG out, Knicks went small/shooter-heavy. PHI had no rim protection answer once the threes started falling; defenders sagged off McBride, who proceeded to make seven of nine. Calibration note: 'OG OUT means McBride starts and the lineup tilts shooter-heavy' is a swing factor worth +3-5 to NYK 3PT volume, not negligible.\\n(3) PHI CEILING NOT THE PROBLEM — PHI shot 68% on 2s and STILL lost by 30. The series was structurally lost in G1-G3; G4 just made it official with a 3PT variance blowout. PHI Embiid + Maxey 41 combined was actually respectable; supporting cast no-showed.\\n(4) CLOSEOUT WALKOVER, NOT BACKDOOR — Pre-game thesis warned of backdoor cover risk in closeouts (favorites cover only ~50% ATS in clinchers). Reality was the opposite extreme: NYK ran PHI off the floor. Closeout heuristic ('home dog likely covers in elimination') was wrong-direction here.\\n(5) NYK SERIES SWEEP CONFIRMS R2 STRUCTURAL READ — engine had NYK as the East favorite from Day 1 of R2; sweep is the most extreme version of that read. Conference Finals projection now opens up.",boxScores:{home:[{name:"Miles McBride",pts:25,reb:2,ast:3,fg:"8-12",threes:"7-9",ft:"2-2",to:1,stl:1,blk:0,pm:28,note:"STARTED for OG Anunoby (hamstring) — 4 threes in Q1 (Knicks record)"},{name:"Jalen Brunson",pts:22,reb:3,ast:7,fg:"8-17",threes:"3-7",ft:"3-3",to:2,stl:1,blk:0,pm:24},{name:"Josh Hart",pts:17,reb:8,ast:4,fg:"7-12",threes:"2-5",ft:"1-2",to:1,stl:2,blk:0,pm:21},{name:"Karl-Anthony Towns",pts:17,reb:4,ast:10,fg:"6-12",threes:"3-6",ft:"2-2",to:2,stl:0,blk:2,pm:18},{name:"Mikal Bridges",pts:16,reb:4,ast:3,fg:"6-11",threes:"3-6",ft:"1-1",to:1,stl:1,blk:0,pm:22},{name:"Landry Shamet",pts:12,reb:1,ast:2,fg:"4-7",threes:"4-6",ft:"0-0",to:0,stl:0,blk:0,pm:14}],away:[{name:"Joel Embiid",pts:24,reb:6,ast:2,fg:"9-15",threes:"0-3",ft:"6-7",to:2,stl:0,blk:1,pm:-22},{name:"Tyrese Maxey",pts:17,reb:3,ast:6,fg:"6-15",threes:"1-5",ft:"4-4",to:3,stl:1,blk:0,pm:-24},{name:"Paul George",pts:14,reb:5,ast:3,fg:"5-13",threes:"2-7",ft:"2-2",to:2,stl:1,blk:0,pm:-19},{name:"Kelly Oubre Jr.",pts:18,reb:4,ast:2,fg:"7-14",threes:"3-7",ft:"1-2",to:1,stl:0,blk:0,pm:-15},{name:"Andre Drummond",pts:8,reb:7,ast:1,fg:"4-7",threes:"0-0",ft:"0-2",to:1,stl:0,blk:1,pm:-12}]}}]
,
    modelLessons: [
      { type:"correct", lesson:"G1: Predicted NYK by 9 (MEDIUM). Actual NYK by 39. RIGHT WINNER but massively underestimated margin. Rest differential (6 days vs 2) + PHI fatigue post-G7 BOS produced catastrophic collapse. NYK 63% FG / 51% 3PT was unsustainable but PHI's 41% FG showed fatigue-driven defensive failure." },
      { type:"missed", lesson:"G1: Model had no mechanism for the MAGNITUDE of rest-based blowouts. 39-point margin was largest R2 G1 in history. Lesson: when rest differential is 4+ days AND opponent played a 7-game series, apply a 1.5x multiplier to the expected margin." },
      { type:"correct", lesson:"G1: Embiid fatigue prediction validated — 3-11 FG, 14pts, -24. Hip + appendectomy + 48hr rest = shell of himself. But severity was even worse than the 75-80% estimate." },
      { type:"correct", lesson:"G2: Predicted NYK by 6 (MEDIUM). Actual NYK by 6. EXACT MARGIN MATCH. Best single-game prediction despite Embiid being ruled OUT day-of (ankle sprain + hip). The 'Day-of-OUT Compression' factor — opponent gets emotional rally + no prep time adjustment — exactly offset Embiid's absence." },
      { type:"missed", lesson:"G2: Phase 56 bet card's 'NYK +12-15 with Embiid OUT' would have been wrong by 6-9pts. Day-of-OUT rulings produce LESS margin expansion than anticipated. Save as Phase 59 soft factor: apply ~50% of normal absence penalty for same-day OUT rulings." },
      { type:"correct", lesson:"G2: NYK Q4 closing edge (19-12) validated the +9.2 clutchNetRtg thesis. PHI went 3-16 Q4 FG when Maxey went cold — IC=2 limitation without Embiid." },
      { type:"missed", lesson:"G2: OG Anunoby left late with 'unspecified issue' (now diagnosed as left hamstring strain). Model had no early warning. NYK's wing depth absorbs this better than most but OG is their best perimeter defender." },
      { type:"correct", lesson:"G2: PHI's Brunson PnR coverage change (blitzing/doubling) held him to 9-21 (43%) vs G1's 67%. Defensive adjustment partially worked on the primary action but didn't fix the IC=2 / Q4 collapse." },
      { type:"missed", lesson:"G2: BUG — Embiid had DUPLICATE activeInjury keys. Phase 56's severity:1.0 (OUT) was silently overwritten by older severity:0.4 entry. Engine never processed him as truly OUT. Fixed." }
    ],
    g2Adjustments: [
      "NYK WON G2 108-102 — leads 2-0. EXACT MARGIN MATCH (predicted +6, actual +6) despite Embiid day-of OUT ruling.",
      "Embiid OUT G2 (right ankle sprain + hip soreness, missed shootaround). QUESTIONABLE G3 — intends to warm up pre-game. If he plays, expect 60-70% effectiveness.",
      "OG Anunoby LEFT G2 late with unspecified issue — now diagnosed as LEFT HAMSTRING STRAIN, QUESTIONABLE G3. If OUT, NYK wing depth thins from 4 to 3 (Bridges/Hart/McBride absorb).",
      "Hart upgraded to PROBABLE G3 (thumb sprain) — should be available.",
      "PHI's Brunson blitz/double coverage held him to 9-21 FG (43%) but NYK still won. KAT (20/10/7) and Bridges (18) exploited the help-defense gaps.",
      "PHI 18 TOs vs NYK 13 — turnover differential was the deciding factor. NYK's wing pressure on secondary creators is structural.",
      "PHI Q4 collapse: 3-16 FG, 18.8% — scoreless for ~6 minutes. IC=2 without Embiid means one cold stretch = game over.",
      "25 lead changes (most in any playoff game in 11 yrs) — this WAS competitive until Q4. PHI CAN play with NYK when shots fall.",
  ...
  // ============================================================
  // CONFERENCE FINALS — Phase 72 setup (May 18, 2026)
  // ============================================================
  // R2 RESULTS:
  //   East: NYK swept PHI 4-0; DET-CLE went 7 (G7 played 5/17)
  //   West: SAS beat MIN 4-2; OKC swept LAL 4-0
  //
  // CF MATCHUPS:
  //   East: NYK vs (DET or CLE — G7 winner pending in our data)
  //   West: OKC vs SAS (LOCKED — both teams confirmed)
  //
  // STATUS:
  //   - OKC-SAS scaffold: FULL roster + schedule placeholder ready
  //   - East CF: still in TBD scaffold until G7 winner confirmed
  //
  // Workflow when G7 settles:
  //   1. Settle DET-CLE games[6] (winner/scores)
  //   2. Copy winning team's homeTeam roster into NYK-TBD awayTeam
  //   3. Rename scaffold id NYK-TBD → NYK-DET or NYK-CLE
  //   4. Add games[] 7-slot array; fill G1 once date+venue confirmed
  {
    id: "NYK-CLE",
    conf: "East", round: "CF",
    tbdOpponent: true,
    // NYK confirmed (swept PHI 4-0 in R2 in 4 close-but-decisive games).
    // CLE confirmed (beat DET 4-3 — G7 125-94 road blowout on 5/17).
    // ECF G1 is Tue 5/19 at MSG. Scaffold keeps tbdOpponent:true until
    // full CLE roster is copied in from DET-CLE R2 entry — that's the
    // next-phase task. Renderer bails gracefully on tbdOpponent flag.
    confirmedSide: "home",
    homeTeam: {
    ...
    awayTeam: {
      name: "Cavaliers", city: "Cleveland", abbr: "CLE", seed: 4, record: "57-25",
      tbd: true, players: [], synergy: [],
      note: "CLE beat DET 4-3 in R2 (G7 125-94 road blowout on 5/17). Roster copy from DET-CLE R2 entry deferred to next-phase task.",
    },
    games: [
      // CF series gets a 7-slot games[] array once full rosters are
      // copied in. Leaving empty until then so Series Analysis renderer
      // skips it gracefully via the tbdOpponent flag.
    ],
    priorRound: {
      home: { seriesId: "NYK-PHI", gamesPlayed: 4, round: "R2", restDays: 9 },
      away: { seriesId: "DET-CLE", gamesPlayed: 7, round: "R2", restDays: 1 },
    },
  },
  {
      id: "OKC-SAS",
      ...
      homeTeam: {
          ...
          systemBonus: 2.5,
          playoffPedigree: 2,
          offStyle: "SGA elite P&R/ISO + 5-out motion. J.Williams secondary creator. Mitchell 3rd-level off bench. Deepest team in NBA. Swept LAL 4-0.",
          initiators: 3,
          color: "#007AC1",
          color2: "#EF6100",
          advStats: {
          ...
          players: [
              {
                  ...
                  matchupNote: "Fully rested after sweep. Historic season: 31.1ppg on 67% TS. R1: 25pts in 29min (sat Q4 blowout). Went 4-0 vs LAL in reg season with avg margin of 31.8pts. Smart is LAL's best defender but SGA creates against anyone.",
                  baseRating: 96,
                  starCeiling: 2,
                  injuryRisk: 0,
              ...
              },
              {
                  ...
                  offRole: "Shot Creator",
                  defRole: "Mobile Big",
                  matchupNote: "Stretch-5 who protects rim + spaces floor. D-LEBRON 3.465 elite. R1: 16pts/7reb in 25min. Ayton matchup is favorable — Holmgren's length and mobility vs Ayton's physicality.",
                  baseRating: 82,
                  starCeiling: 1,
                  injuryRisk: 0.3
              },
              ...
              },
              {
                  ...
                  matchupNote: "Elite perimeter stopper. Clamped Booker in R1. Will rotate on LeBron/Kennard.",
                  baseRating: 68
              },
              {
                  ...
                  defRole: "Mobile Big",
                  matchupNote: "Physical rebounder. R1: 8pts/4reb/8ast in 20min — facilitator role. D-LEBRON 2.597.",
                  baseRating: 70
              },
              {
                  name: "Alex Caruso",
                  ...
                  offRole: "Stationary Shooter",
                  defRole: "Wing Stopper",
                  matchupNote: "Defensive specialist. D-LEBRON 2.132. Former Laker — knows LeBron's tendencies.",
                  baseRating: 62
              },
              {
                  name: "Isaiah Joe",
                  ...
                  defRole: "Low Activity",
                  matchupNote: "42% 3PT shooter. Spaces floor for SGA drives.",
                  baseRating: 60
              },
              {
                  name: "Ajay Mitchell",
                  ...
                  defRole: "Point of Attack",
                  matchupNote: "R1: 9pts (3-4 3PT) in 22min, +22. Bench creation when SGA rests.",
                  baseRating: 56
              },
              {
                  name: "Cason Wallace",
                  ...
                  defRole: "Point of Attack",
                  matchupNote: "R1: 6pts in 21min, +23 (highest +/- on team). 4ast/2stl/2blk. Defensive impact.",
                  baseRating: 60
              },
              {
                  name: "Aaron Wiggins",
                  ...
                  offRole: "Movement Shooter",
                  defRole: "Wing Stopper",
                  matchupNote: "Wing depth. 35.6% 3PT.",
                  baseRating: 58
              },
              {
          ...
          synergy: [
              {
                  ...
                  score: 82,
                  note: "G1 starting 5. Mitchell started with J.Williams off bench (minutes restriction). Won 108-90 (+18). Mitchell 18pts/+14 as starter."
              },
              {
                  players: [
                      "Mitchell",
                  ...
                  score: 72,
                  note: "SGA-rest lineup. Missing J.Williams' creation but Mitchell + Joe provide scoring."
              },
              {
                  players: [
                      "SGA",
                  ...
                  score: 84,
                  note: "Defensive closing option. Caruso + Wallace + Dort switchable perimeter D. Best defensive lineup in NBA."
              }
          ]
      },
      awayTeam: {
          ...
          systemBonus: 1.5,
          playoffPedigree: 0,
          offStyle: "Wemby-centric. Fox PnR + Castle/Vassell secondary. Bench depth (Harper/Champagnie/K.Johnson) elite. Beat POR 4-1 + MIN 4-2.",
          initiators: 2,
          color: "#C4CED4",
          color2: "#000000",
          advStats: {
          ...
          players: [
              {
                  ...
                  offRole: "Shot Creator",
                  defRole: "Anchor Big",
                  matchupNote: "Cleared from concussion protocol during R1. Dominated G3-G5 after return. Averaged 34ppg in 2 reg season games vs MIN. Edwards' return gives MIN a perimeter threat but Wemby's 7-4 frame and 3PT ability still creates impossible mismatches for Gobert/McDaniels. +16.9 on/off is HISTORIC.",
                  baseRating: 94,
                  starCeiling: 2,
                  injuryRisk: 0.3,
              ...
              },
              {
                  ...
                  offRole: "Movement Shooter",
                  defRole: "Helper",
                  matchupNote: "Reliable two-way wing. 39.2% from 3. Key secondary scorer.",
                  baseRating: 72
              },
              {
                  ...
                  offRole: "Movement Shooter",
                  defRole: "Helper",
                  matchupNote: "Stretch forward. 38% from 3. Spacing for Wemby/Fox drives.",
                  baseRating: 66
              },
              {
                  name: "Kelly Olynyk",
                  ...
                  offRole: "Stretch Big",
                  defRole: "Helper",
                  matchupNote: "Stretch big, 37% from 3. Veteran presence.",
                  baseRating: 62
              },
              {
                  name: "Keldon Johnson",
                  ...
                  offRole: "Movement Shooter",
                  defRole: "Helper",
                  matchupNote: "Energy wing off bench. Physical playoff energy.",
                  baseRating: 62
              },
              {
                  name: "Dylan Harper",
              ...
              },
              {
                  ...
                  defRole: "Wing Stopper",
                  matchupNote: "Veteran wing. R1 wrist injury limited him but rest should help. Championship experience (GSW 2015).",
                  baseRating: 60,
                  injuryRisk: 0.3
              },
              {
                  ...
                  defRole: "Anchor Big",
                  matchupNote: "Backup C. Rim protection and floor spacing.",
                  baseRating: 56
              }
          ],
          synergy: [
              {
                  ...
                  score: 86,
                  note: "Starting 5. Fox-Wemby PnR devastating. +10.3 NetRtg. Won R1 in 5. Johnson system maximizes every player."
              },
              {
                  players: [
                      "Harper",
                  ...
                  score: 74,
                  note: "Bench unit with Wemby anchor. Harper provides creation."
              },
              {
                  players: [
                      "Fox",
