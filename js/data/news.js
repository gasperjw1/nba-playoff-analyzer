...
const NEWS = [
  ...
  },
  {
    ...
    severity: 'major',
    series: 'SAS-NYK',
    headline: '🏆 KNICKS WIN IT ALL — Brunson 45 & Finals MVP, NYK beats Spurs 94-90 for first title since 1973',
    body: 'The <strong>New York Knicks are NBA CHAMPIONS</strong> — their first title in 53 years (since 1973) — closing out San Antonio <strong>94-90 in Game 5</strong> to win the Finals 4-1 ON THE ROAD. Fittingly, the Spurs led by 16 in the first half and by 10 in the fourth quarter before New York surged back behind <strong>Jalen Brunson</strong> and a clamp-down defense — the fifth straight game SAS won the first quarter and NYK won the game in the second half. Brunson, named <strong>FINALS MVP</strong>, scored a Knicks Finals-record <strong>45 points</strong> (14-27, 13-15 FT) despite rolling his left ankle, hitting the go-ahead free throws with 1:08 left. Josh Hart added 13/11, OG Anunoby 10/6 with 3 steals, Mikal Bridges 13, and Karl-Anthony Towns ground out 2/10/3stl before fouling out at 1:53. San Antonio\'s stars cratered in their first Finals closeout — <strong>De\'Aaron Fox 7 on 3-15, Stephon Castle 6 on 1-10, Victor Wembanyama a quiet 19/14/5blk on 7-18</strong> — while rookie Dylan Harper led the Spurs with 25/5/4 and Champagnie added 14/7. <strong>Model:</strong> predicted SAS by 3 → actual NYK by 4 (WRONG WINNER a fourth time; the Finals winner pick finishes 1-4). But the other reads held: NYK +3 cashed (the spread-value side finished a perfect 5-for-5), the UNDER 211.5 hit on a 184 total (lowest of the series), and all three SAS role-PRA floors cleared (Harper 34, Wemby 35, Champagnie 22). Bets 5-1, parlays 3-0 (+$415). The Knicks\' 16-3 playoff run (+15.4 net rating) is the best since play-by-play tracking began in 1997.',
    source: 'NBA.com / ESPN',
  },
  {
    date: '2026-06-16',
    severity: 'major',
    series: 'SAS-NYK',
    headline: '2025-26 season complete: Knicks crowned champions; Wemby era underway but title waits',
    body: 'The 2025-26 NBA season is in the books, with the <strong>New York Knicks</strong> ending a 53-year championship drought and <strong>Jalen Brunson</strong> taking Finals MVP. The series will be remembered for its defining pattern — San Antonio won the first quarter of all five games (by 57 points total) but New York roared back every time, outscoring the Spurs by 29/14/27 in the second, third, and fourth quarters — and for the largest comeback in Finals history (down 29 in Game 4). For the model, the Finals were a study in what to trust: the engine\'s WINNER pick finished a dismal 1-4 (the home/elimination lean was misleading every game), but its <strong>margin/spread/total calibration held</strong> (spread-value side a flawless 5-for-5) and the <strong>minutes-vetted role-PRA floor</strong> went a perfect 5-for-5 — the single most reliable dimension of the playoffs. For San Antonio, <strong>Victor Wembanyama</strong>\'s Finals debut ended in defeat (19/14/5blk in the clincher) — the Wemby era is clearly underway, but his first ring will have to wait. Attention now turns to building the analyzer out for the upcoming regular season.',
    source: 'NBA.com / ESPN',
  },
];
