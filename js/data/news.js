...
const NEWS = [
  ...
  },
  {
    ...
    severity: 'major',
    series: 'SAS-NYK',
    headline: 'Spurs stave off elimination — Wemby 33/14/4, SAS holds off NYK 106-104 to force G6',
    body: 'San Antonio kept its season alive, controlling a defensive grind and surviving a late New York push to win <strong>106-104</strong> and cut the Knicks\' lead to 3-2. <strong>Brunson\'s potential game-tying three rimmed out at the buzzer.</strong> <strong>Victor Wembanyama</strong> delivered the elimination masterpiece — <strong>33/14/4 with 4 blocks (51 PRA)</strong> on 12-22 — and <strong>De\'Aaron Fox</strong> atoned for his G4 collapse with <strong>24/9</strong> as the closer SAS needed; Vassell added 16 (4-9 from 3) and the minutes-vetted bench floors held a fifth straight time (Champagnie 15 PRA, Harper 17 PRA). New York got 30/9 from Brunson (10-25, Castle held the efficiency again), a bounce-back <strong>23/12 from Karl-Anthony Towns</strong>, and 22 from OG Anunoby (4-9 from 3), but the offense stalled in the half-court and couldn\'t solve Wemby\'s rim protection late. <strong>Model:</strong> predicted SAS by 3 → actual SAS by 2 — a CORRECT WINNER (the home/closeout read finally lands on the home team; the Finals winner pick improves to 2-3) with a near-exact margin. Every read cashed again: SAS ML, NYK +3 covered (the spread-value side is now a perfect 5-for-5), UNDER 211.5 on a 210 total (all three Frost Bank games went under: 200, 209, 210), and all three PRA floors (Wemby 51, Harper 17, Champagnie 15). Bets went 6-0 and all three featured parlays WON (+$135 / +$115 / +$165 = +$415) — the cleanest model alignment of the series. NYK still leads 3-2; Game 6 is back at MSG.',
    source: 'NBA.com / ESPN',
  },
  {
    date: '2026-06-16',
    severity: 'major',
    series: 'SAS-NYK',
    headline: 'Finals G6 TONIGHT at MSG — Knicks get a second shot at their first title since 1973',
    body: 'The Finals return to Madison Square Garden for <strong>Game 6 tonight (Tue 6/16, 8:30 PM ET on ABC)</strong> with New York leading 3-2 and a chance to clinch its <strong>first championship since 1973</strong> at home, after San Antonio extended the series with a controlled 106-104 elimination win in G5. <strong>The stakes:</strong> a NYK win ENDS it (title at MSG); a SAS win forces a winner-take-all Game 7 back at Frost Bank Center. DK opener (6/15): <strong>NYK -4.5 / total 214.5 / ML NYK -190, SAS +160</strong>. <strong>Model view:</strong> the engine leans NYK at home to close it out, but the running R4 rule holds — the raw winner pick is 2-3 in the Finals, so weight the margin/spread (<strong>the spread-value side is a perfect 5-for-5</strong>) over the side, and read the total per-venue (MSG split 226 OVER / 213 UNDER vs the Frost Bank UNDERs). <strong>The reliable threads:</strong> the SAS role-PRA floors (Wemby, Harper, Champagnie — cleared every Finals game) remain the series\' most dependable dimension regardless of who wins. <strong>The swing:</strong> whether NYK\'s closeout poise and the MSG crowd overcome a desperate Wembanyama-led SAS that just found its half-court control. Phase 71 R3 out-of-sample stake cap stays 50%. G6 picks are live in Featured Parlays.',
    source: 'DraftKings / NBA.com',
  },
];
